import{a as m}from"./api-DOrd53Me.js";const $e=Object.create(null);$e.open="0";$e.close="1";$e.ping="2";$e.pong="3";$e.message="4";$e.upgrade="5";$e.noop="6";const Ze=Object.create(null);Object.keys($e).forEach(t=>{Ze[$e[t]]=t});const kt={type:"error",data:"parser error"},Cs=typeof Blob=="function"||typeof Blob<"u"&&Object.prototype.toString.call(Blob)==="[object BlobConstructor]",xs=typeof ArrayBuffer=="function",Ss=t=>typeof ArrayBuffer.isView=="function"?ArrayBuffer.isView(t):t&&t.buffer instanceof ArrayBuffer,Ot=({type:t,data:e},s,a)=>Cs&&e instanceof Blob?s?a(e):is(e,a):xs&&(e instanceof ArrayBuffer||Ss(e))?s?a(e):is(new Blob([e]),a):a($e[t]+(e||"")),is=(t,e)=>{const s=new FileReader;return s.onload=function(){const a=s.result.split(",")[1];e("b"+(a||""))},s.readAsDataURL(t)};function os(t){return t instanceof Uint8Array?t:t instanceof ArrayBuffer?new Uint8Array(t):new Uint8Array(t.buffer,t.byteOffset,t.byteLength)}let ft;function ra(t,e){if(Cs&&t.data instanceof Blob)return t.data.arrayBuffer().then(os).then(e);if(xs&&(t.data instanceof ArrayBuffer||Ss(t.data)))return e(os(t.data));Ot(t,!1,s=>{ft||(ft=new TextEncoder),e(ft.encode(s))})}const ls="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/",Oe=typeof Uint8Array>"u"?[]:new Uint8Array(256);for(let t=0;t<ls.length;t++)Oe[ls.charCodeAt(t)]=t;const ia=t=>{let e=t.length*.75,s=t.length,a,n=0,i,o,c,l;t[t.length-1]==="="&&(e--,t[t.length-2]==="="&&e--);const u=new ArrayBuffer(e),p=new Uint8Array(u);for(a=0;a<s;a+=4)i=Oe[t.charCodeAt(a)],o=Oe[t.charCodeAt(a+1)],c=Oe[t.charCodeAt(a+2)],l=Oe[t.charCodeAt(a+3)],p[n++]=i<<2|o>>4,p[n++]=(o&15)<<4|c>>2,p[n++]=(c&3)<<6|l&63;return u},oa=typeof ArrayBuffer=="function",Vt=(t,e)=>{if(typeof t!="string")return{type:"message",data:Is(t,e)};const s=t.charAt(0);return s==="b"?{type:"message",data:la(t.substring(1),e)}:Ze[s]?t.length>1?{type:Ze[s],data:t.substring(1)}:{type:Ze[s]}:kt},la=(t,e)=>{if(oa){const s=ia(t);return Is(s,e)}else return{base64:!0,data:t}},Is=(t,e)=>{switch(e){case"blob":return t instanceof Blob?t:new Blob([t]);case"arraybuffer":default:return t instanceof ArrayBuffer?t:t.buffer}},Ls="",ca=(t,e)=>{const s=t.length,a=new Array(s);let n=0;t.forEach((i,o)=>{Ot(i,!1,c=>{a[o]=c,++n===s&&e(a.join(Ls))})})},da=(t,e)=>{const s=t.split(Ls),a=[];for(let n=0;n<s.length;n++){const i=Vt(s[n],e);if(a.push(i),i.type==="error")break}return a};function ua(){return new TransformStream({transform(t,e){ra(t,s=>{const a=s.length;let n;if(a<126)n=new Uint8Array(1),new DataView(n.buffer).setUint8(0,a);else if(a<65536){n=new Uint8Array(3);const i=new DataView(n.buffer);i.setUint8(0,126),i.setUint16(1,a)}else{n=new Uint8Array(9);const i=new DataView(n.buffer);i.setUint8(0,127),i.setBigUint64(1,BigInt(a))}t.data&&typeof t.data!="string"&&(n[0]|=128),e.enqueue(n),e.enqueue(s)})}})}let vt;function Ye(t){return t.reduce((e,s)=>e+s.length,0)}function Je(t,e){if(t[0].length===e)return t.shift();const s=new Uint8Array(e);let a=0;for(let n=0;n<e;n++)s[n]=t[0][a++],a===t[0].length&&(t.shift(),a=0);return t.length&&a<t[0].length&&(t[0]=t[0].slice(a)),s}function pa(t,e){vt||(vt=new TextDecoder);const s=[];let a=0,n=-1,i=!1;return new TransformStream({transform(o,c){for(s.push(o);;){if(a===0){if(Ye(s)<1)break;const l=Je(s,1);i=(l[0]&128)===128,n=l[0]&127,n<126?a=3:n===126?a=1:a=2}else if(a===1){if(Ye(s)<2)break;const l=Je(s,2);n=new DataView(l.buffer,l.byteOffset,l.length).getUint16(0),a=3}else if(a===2){if(Ye(s)<8)break;const l=Je(s,8),u=new DataView(l.buffer,l.byteOffset,l.length),p=u.getUint32(0);if(p>Math.pow(2,21)-1){c.enqueue(kt);break}n=p*Math.pow(2,32)+u.getUint32(4),a=3}else{if(Ye(s)<n)break;const l=Je(s,n);c.enqueue(Vt(i?l:vt.decode(l),e)),a=0}if(n===0||n>t){c.enqueue(kt);break}}}})}const Bs=4;function J(t){if(t)return ha(t)}function ha(t){for(var e in J.prototype)t[e]=J.prototype[e];return t}J.prototype.on=J.prototype.addEventListener=function(t,e){return this._callbacks=this._callbacks||{},(this._callbacks["$"+t]=this._callbacks["$"+t]||[]).push(e),this};J.prototype.once=function(t,e){function s(){this.off(t,s),e.apply(this,arguments)}return s.fn=e,this.on(t,s),this};J.prototype.off=J.prototype.removeListener=J.prototype.removeAllListeners=J.prototype.removeEventListener=function(t,e){if(this._callbacks=this._callbacks||{},arguments.length==0)return this._callbacks={},this;var s=this._callbacks["$"+t];if(!s)return this;if(arguments.length==1)return delete this._callbacks["$"+t],this;for(var a,n=0;n<s.length;n++)if(a=s[n],a===e||a.fn===e){s.splice(n,1);break}return s.length===0&&delete this._callbacks["$"+t],this};J.prototype.emit=function(t){this._callbacks=this._callbacks||{};for(var e=new Array(arguments.length-1),s=this._callbacks["$"+t],a=1;a<arguments.length;a++)e[a-1]=arguments[a];if(s){s=s.slice(0);for(var a=0,n=s.length;a<n;++a)s[a].apply(this,e)}return this};J.prototype.emitReserved=J.prototype.emit;J.prototype.listeners=function(t){return this._callbacks=this._callbacks||{},this._callbacks["$"+t]||[]};J.prototype.hasListeners=function(t){return!!this.listeners(t).length};const pt=typeof Promise=="function"&&typeof Promise.resolve=="function"?e=>Promise.resolve().then(e):(e,s)=>s(e,0),pe=typeof self<"u"?self:typeof window<"u"?window:Function("return this")(),ma="arraybuffer";function _s(t,...e){return e.reduce((s,a)=>(t.hasOwnProperty(a)&&(s[a]=t[a]),s),{})}const ga=pe.setTimeout,fa=pe.clearTimeout;function ht(t,e){e.useNativeTimers?(t.setTimeoutFn=ga.bind(pe),t.clearTimeoutFn=fa.bind(pe)):(t.setTimeoutFn=pe.setTimeout.bind(pe),t.clearTimeoutFn=pe.clearTimeout.bind(pe))}const va=1.33;function ya(t){return typeof t=="string"?ba(t):Math.ceil((t.byteLength||t.size)*va)}function ba(t){let e=0,s=0;for(let a=0,n=t.length;a<n;a++)e=t.charCodeAt(a),e<128?s+=1:e<2048?s+=2:e<55296||e>=57344?s+=3:(a++,s+=4);return s}function As(){return Date.now().toString(36).substring(3)+Math.random().toString(36).substring(2,5)}function wa(t){let e="";for(let s in t)t.hasOwnProperty(s)&&(e.length&&(e+="&"),e+=encodeURIComponent(s)+"="+encodeURIComponent(t[s]));return e}function ka(t){let e={},s=t.split("&");for(let a=0,n=s.length;a<n;a++){let i=s[a].split("=");e[decodeURIComponent(i[0])]=decodeURIComponent(i[1])}return e}class $a extends Error{constructor(e,s,a){super(e),this.description=s,this.context=a,this.type="TransportError"}}class Ht extends J{constructor(e){super(),this.writable=!1,ht(this,e),this.opts=e,this.query=e.query,this.socket=e.socket,this.supportsBinary=!e.forceBase64}onError(e,s,a){return super.emitReserved("error",new $a(e,s,a)),this}open(){return this.readyState="opening",this.doOpen(),this}close(){return(this.readyState==="opening"||this.readyState==="open")&&(this.doClose(),this.onClose()),this}send(e){this.readyState==="open"&&this.write(e)}onOpen(){this.readyState="open",this.writable=!0,super.emitReserved("open")}onData(e){const s=Vt(e,this.socket.binaryType);this.onPacket(s)}onPacket(e){super.emitReserved("packet",e)}onClose(e){this.readyState="closed",super.emitReserved("close",e)}pause(e){}createUri(e,s={}){return e+"://"+this._hostname()+this._port()+this.opts.path+this._query(s)}_hostname(){const e=this.opts.hostname;return e.indexOf(":")===-1?e:"["+e+"]"}_port(){return this.opts.port&&(this.opts.secure&&Number(this.opts.port)!==443||!this.opts.secure&&Number(this.opts.port)!==80)?":"+this.opts.port:""}_query(e){const s=wa(e);return s.length?"?"+s:""}}class Ea extends Ht{constructor(){super(...arguments),this._polling=!1}get name(){return"polling"}doOpen(){this._poll()}pause(e){this.readyState="pausing";const s=()=>{this.readyState="paused",e()};if(this._polling||!this.writable){let a=0;this._polling&&(a++,this.once("pollComplete",function(){--a||s()})),this.writable||(a++,this.once("drain",function(){--a||s()}))}else s()}_poll(){this._polling=!0,this.doPoll(),this.emitReserved("poll")}onData(e){const s=a=>{if(this.readyState==="opening"&&a.type==="open"&&this.onOpen(),a.type==="close")return this.onClose({description:"transport closed by the server"}),!1;this.onPacket(a)};da(e,this.socket.binaryType).forEach(s),this.readyState!=="closed"&&(this._polling=!1,this.emitReserved("pollComplete"),this.readyState==="open"&&this._poll())}doClose(){const e=()=>{this.write([{type:"close"}])};this.readyState==="open"?e():this.once("open",e)}write(e){this.writable=!1,ca(e,s=>{this.doWrite(s,()=>{this.writable=!0,this.emitReserved("drain")})})}uri(){const e=this.opts.secure?"https":"http",s=this.query||{};return this.opts.timestampRequests!==!1&&(s[this.opts.timestampParam]=As()),!this.supportsBinary&&!s.sid&&(s.b64=1),this.createUri(e,s)}}let Ms=!1;try{Ms=typeof XMLHttpRequest<"u"&&"withCredentials"in new XMLHttpRequest}catch{}const Ca=Ms;function xa(){}class Sa extends Ea{constructor(e){if(super(e),typeof location<"u"){const s=location.protocol==="https:";let a=location.port;a||(a=s?"443":"80"),this.xd=typeof location<"u"&&e.hostname!==location.hostname||a!==e.port}}doWrite(e,s){const a=this.request({method:"POST",data:e});a.on("success",s),a.on("error",(n,i)=>{this.onError("xhr post error",n,i)})}doPoll(){const e=this.request();e.on("data",this.onData.bind(this)),e.on("error",(s,a)=>{this.onError("xhr poll error",s,a)}),this.pollXhr=e}}class ke extends J{constructor(e,s,a){super(),this.createRequest=e,ht(this,a),this._opts=a,this._method=a.method||"GET",this._uri=s,this._data=a.data!==void 0?a.data:null,this._create()}_create(){var e;const s=_s(this._opts,"agent","pfx","key","passphrase","cert","ca","ciphers","rejectUnauthorized","autoUnref");s.xdomain=!!this._opts.xd;const a=this._xhr=this.createRequest(s);try{a.open(this._method,this._uri,!0);try{if(this._opts.extraHeaders){a.setDisableHeaderCheck&&a.setDisableHeaderCheck(!0);for(let n in this._opts.extraHeaders)this._opts.extraHeaders.hasOwnProperty(n)&&a.setRequestHeader(n,this._opts.extraHeaders[n])}}catch{}if(this._method==="POST")try{a.setRequestHeader("Content-type","text/plain;charset=UTF-8")}catch{}try{a.setRequestHeader("Accept","*/*")}catch{}(e=this._opts.cookieJar)===null||e===void 0||e.addCookies(a),"withCredentials"in a&&(a.withCredentials=this._opts.withCredentials),this._opts.requestTimeout&&(a.timeout=this._opts.requestTimeout),a.onreadystatechange=()=>{var n;a.readyState===3&&((n=this._opts.cookieJar)===null||n===void 0||n.parseCookies(a.getResponseHeader("set-cookie"))),a.readyState===4&&(a.status===200||a.status===1223?this._onLoad():this.setTimeoutFn(()=>{this._onError(typeof a.status=="number"?a.status:0)},0))},a.send(this._data)}catch(n){this.setTimeoutFn(()=>{this._onError(n)},0);return}typeof document<"u"&&(this._index=ke.requestsCount++,ke.requests[this._index]=this)}_onError(e){this.emitReserved("error",e,this._xhr),this._cleanup(!0)}_cleanup(e){if(!(typeof this._xhr>"u"||this._xhr===null)){if(this._xhr.onreadystatechange=xa,e)try{this._xhr.abort()}catch{}typeof document<"u"&&delete ke.requests[this._index],this._xhr=null}}_onLoad(){const e=this._xhr.responseText;e!==null&&(this.emitReserved("data",e),this.emitReserved("success"),this._cleanup())}abort(){this._cleanup()}}ke.requestsCount=0;ke.requests={};if(typeof document<"u"){if(typeof attachEvent=="function")attachEvent("onunload",cs);else if(typeof addEventListener=="function"){const t="onpagehide"in pe?"pagehide":"unload";addEventListener(t,cs,!1)}}function cs(){for(let t in ke.requests)ke.requests.hasOwnProperty(t)&&ke.requests[t].abort()}const Ia=function(){const t=Ts({xdomain:!1});return t&&t.responseType!==null}();class La extends Sa{constructor(e){super(e);const s=e&&e.forceBase64;this.supportsBinary=Ia&&!s}request(e={}){return Object.assign(e,{xd:this.xd},this.opts),new ke(Ts,this.uri(),e)}}function Ts(t){const e=t.xdomain;try{if(typeof XMLHttpRequest<"u"&&(!e||Ca))return new XMLHttpRequest}catch{}if(!e)try{return new pe[["Active"].concat("Object").join("X")]("Microsoft.XMLHTTP")}catch{}}const Ps=typeof navigator<"u"&&typeof navigator.product=="string"&&navigator.product.toLowerCase()==="reactnative";class Ba extends Ht{get name(){return"websocket"}doOpen(){const e=this.uri(),s=this.opts.protocols,a=Ps?{}:_s(this.opts,"agent","perMessageDeflate","pfx","key","passphrase","cert","ca","ciphers","rejectUnauthorized","localAddress","protocolVersion","origin","maxPayload","family","checkServerIdentity");this.opts.extraHeaders&&(a.headers=this.opts.extraHeaders);try{this.ws=this.createSocket(e,s,a)}catch(n){return this.emitReserved("error",n)}this.ws.binaryType=this.socket.binaryType,this.addEventListeners()}addEventListeners(){this.ws.onopen=()=>{this.opts.autoUnref&&this.ws._socket.unref(),this.onOpen()},this.ws.onclose=e=>this.onClose({description:"websocket connection closed",context:e}),this.ws.onmessage=e=>this.onData(e.data),this.ws.onerror=e=>this.onError("websocket error",e)}write(e){this.writable=!1;for(let s=0;s<e.length;s++){const a=e[s],n=s===e.length-1;Ot(a,this.supportsBinary,i=>{try{this.doWrite(a,i)}catch{}n&&pt(()=>{this.writable=!0,this.emitReserved("drain")},this.setTimeoutFn)})}}doClose(){typeof this.ws<"u"&&(this.ws.onerror=()=>{},this.ws.close(),this.ws=null)}uri(){const e=this.opts.secure?"wss":"ws",s=this.query||{};return this.opts.timestampRequests&&(s[this.opts.timestampParam]=As()),this.supportsBinary||(s.b64=1),this.createUri(e,s)}}const yt=pe.WebSocket||pe.MozWebSocket;class _a extends Ba{createSocket(e,s,a){return Ps?new yt(e,s,a):s?new yt(e,s):new yt(e)}doWrite(e,s){this.ws.send(s)}}class Aa extends Ht{get name(){return"webtransport"}doOpen(){try{this._transport=new WebTransport(this.createUri("https"),this.opts.transportOptions[this.name])}catch(e){return this.emitReserved("error",e)}this._transport.closed.then(()=>{this.onClose()}).catch(e=>{this.onError("webtransport error",e)}),this._transport.ready.then(()=>{this._transport.createBidirectionalStream().then(e=>{const s=pa(Number.MAX_SAFE_INTEGER,this.socket.binaryType),a=e.readable.pipeThrough(s).getReader(),n=ua();n.readable.pipeTo(e.writable),this._writer=n.writable.getWriter();const i=()=>{a.read().then(({done:c,value:l})=>{c||(this.onPacket(l),i())}).catch(c=>{})};i();const o={type:"open"};this.query.sid&&(o.data=`{"sid":"${this.query.sid}"}`),this._writer.write(o).then(()=>this.onOpen())})})}write(e){this.writable=!1;for(let s=0;s<e.length;s++){const a=e[s],n=s===e.length-1;this._writer.write(a).then(()=>{n&&pt(()=>{this.writable=!0,this.emitReserved("drain")},this.setTimeoutFn)})}}doClose(){var e;(e=this._transport)===null||e===void 0||e.close()}}const Ma={websocket:_a,webtransport:Aa,polling:La},Ta=/^(?:(?![^:@\/?#]+:[^:@\/]*@)(http|https|ws|wss):\/\/)?((?:(([^:@\/?#]*)(?::([^:@\/?#]*))?)?@)?((?:[a-f0-9]{0,4}:){2,7}[a-f0-9]{0,4}|[^:\/?#]*)(?::(\d*))?)(((\/(?:[^?#](?![^?#\/]*\.[^?#\/.]+(?:[?#]|$)))*\/?)?([^?#\/]*))(?:\?([^#]*))?(?:#(.*))?)/,Pa=["source","protocol","authority","userInfo","user","password","host","port","relative","path","directory","file","query","anchor"];function $t(t){if(t.length>8e3)throw"URI too long";const e=t,s=t.indexOf("["),a=t.indexOf("]");s!=-1&&a!=-1&&(t=t.substring(0,s)+t.substring(s,a).replace(/:/g,";")+t.substring(a,t.length));let n=Ta.exec(t||""),i={},o=14;for(;o--;)i[Pa[o]]=n[o]||"";return s!=-1&&a!=-1&&(i.source=e,i.host=i.host.substring(1,i.host.length-1).replace(/;/g,":"),i.authority=i.authority.replace("[","").replace("]","").replace(/;/g,":"),i.ipv6uri=!0),i.pathNames=Ra(i,i.path),i.queryKey=qa(i,i.query),i}function Ra(t,e){const s=/\/{2,9}/g,a=e.replace(s,"/").split("/");return(e.slice(0,1)=="/"||e.length===0)&&a.splice(0,1),e.slice(-1)=="/"&&a.splice(a.length-1,1),a}function qa(t,e){const s={};return e.replace(/(?:^|&)([^&=]*)=?([^&]*)/g,function(a,n,i){n&&(s[n]=i)}),s}const Et=typeof addEventListener=="function"&&typeof removeEventListener=="function",et=[];Et&&addEventListener("offline",()=>{et.forEach(t=>t())},!1);class Ie extends J{constructor(e,s){if(super(),this.binaryType=ma,this.writeBuffer=[],this._prevBufferLen=0,this._pingInterval=-1,this._pingTimeout=-1,this._maxPayload=-1,this._pingTimeoutTime=1/0,e&&typeof e=="object"&&(s=e,e=null),e){const a=$t(e);s.hostname=a.host,s.secure=a.protocol==="https"||a.protocol==="wss",s.port=a.port,a.query&&(s.query=a.query)}else s.host&&(s.hostname=$t(s.host).host);ht(this,s),this.secure=s.secure!=null?s.secure:typeof location<"u"&&location.protocol==="https:",s.hostname&&!s.port&&(s.port=this.secure?"443":"80"),this.hostname=s.hostname||(typeof location<"u"?location.hostname:"localhost"),this.port=s.port||(typeof location<"u"&&location.port?location.port:this.secure?"443":"80"),this.transports=[],this._transportsByName={},s.transports.forEach(a=>{const n=a.prototype.name;this.transports.push(n),this._transportsByName[n]=a}),this.opts=Object.assign({path:"/engine.io",agent:!1,withCredentials:!1,upgrade:!0,timestampParam:"t",rememberUpgrade:!1,addTrailingSlash:!0,rejectUnauthorized:!0,perMessageDeflate:{threshold:1024},transportOptions:{},closeOnBeforeunload:!1},s),this.opts.path=this.opts.path.replace(/\/$/,"")+(this.opts.addTrailingSlash?"/":""),typeof this.opts.query=="string"&&(this.opts.query=ka(this.opts.query)),Et&&(this.opts.closeOnBeforeunload&&(this._beforeunloadEventListener=()=>{this.transport&&(this.transport.removeAllListeners(),this.transport.close())},addEventListener("beforeunload",this._beforeunloadEventListener,!1)),this.hostname!=="localhost"&&(this._offlineEventListener=()=>{this._onClose("transport close",{description:"network connection lost"})},et.push(this._offlineEventListener))),this.opts.withCredentials&&(this._cookieJar=void 0),this._open()}createTransport(e){const s=Object.assign({},this.opts.query);s.EIO=Bs,s.transport=e,this.id&&(s.sid=this.id);const a=Object.assign({},this.opts,{query:s,socket:this,hostname:this.hostname,secure:this.secure,port:this.port},this.opts.transportOptions[e]);return new this._transportsByName[e](a)}_open(){if(this.transports.length===0){this.setTimeoutFn(()=>{this.emitReserved("error","No transports available")},0);return}const e=this.opts.rememberUpgrade&&Ie.priorWebsocketSuccess&&this.transports.indexOf("websocket")!==-1?"websocket":this.transports[0];this.readyState="opening";const s=this.createTransport(e);s.open(),this.setTransport(s)}setTransport(e){this.transport&&this.transport.removeAllListeners(),this.transport=e,e.on("drain",this._onDrain.bind(this)).on("packet",this._onPacket.bind(this)).on("error",this._onError.bind(this)).on("close",s=>this._onClose("transport close",s))}onOpen(){this.readyState="open",Ie.priorWebsocketSuccess=this.transport.name==="websocket",this.emitReserved("open"),this.flush()}_onPacket(e){if(this.readyState==="opening"||this.readyState==="open"||this.readyState==="closing")switch(this.emitReserved("packet",e),this.emitReserved("heartbeat"),e.type){case"open":this.onHandshake(JSON.parse(e.data));break;case"ping":this._sendPacket("pong"),this.emitReserved("ping"),this.emitReserved("pong"),this._resetPingTimeout();break;case"error":const s=new Error("server error");s.code=e.data,this._onError(s);break;case"message":this.emitReserved("data",e.data),this.emitReserved("message",e.data);break}}onHandshake(e){this.emitReserved("handshake",e),this.id=e.sid,this.transport.query.sid=e.sid,this._pingInterval=e.pingInterval,this._pingTimeout=e.pingTimeout,this._maxPayload=e.maxPayload,this.onOpen(),this.readyState!=="closed"&&this._resetPingTimeout()}_resetPingTimeout(){this.clearTimeoutFn(this._pingTimeoutTimer);const e=this._pingInterval+this._pingTimeout;this._pingTimeoutTime=Date.now()+e,this._pingTimeoutTimer=this.setTimeoutFn(()=>{this._onClose("ping timeout")},e),this.opts.autoUnref&&this._pingTimeoutTimer.unref()}_onDrain(){this.writeBuffer.splice(0,this._prevBufferLen),this._prevBufferLen=0,this.writeBuffer.length===0?this.emitReserved("drain"):this.flush()}flush(){if(this.readyState!=="closed"&&this.transport.writable&&!this.upgrading&&this.writeBuffer.length){const e=this._getWritablePackets();this.transport.send(e),this._prevBufferLen=e.length,this.emitReserved("flush")}}_getWritablePackets(){if(!(this._maxPayload&&this.transport.name==="polling"&&this.writeBuffer.length>1))return this.writeBuffer;let s=1;for(let a=0;a<this.writeBuffer.length;a++){const n=this.writeBuffer[a].data;if(n&&(s+=ya(n)),a>0&&s>this._maxPayload)return this.writeBuffer.slice(0,a);s+=2}return this.writeBuffer}_hasPingExpired(){if(!this._pingTimeoutTime)return!0;const e=Date.now()>this._pingTimeoutTime;return e&&(this._pingTimeoutTime=0,pt(()=>{this._onClose("ping timeout")},this.setTimeoutFn)),e}write(e,s,a){return this._sendPacket("message",e,s,a),this}send(e,s,a){return this._sendPacket("message",e,s,a),this}_sendPacket(e,s,a,n){if(typeof s=="function"&&(n=s,s=void 0),typeof a=="function"&&(n=a,a=null),this.readyState==="closing"||this.readyState==="closed")return;a=a||{},a.compress=a.compress!==!1;const i={type:e,data:s,options:a};this.emitReserved("packetCreate",i),this.writeBuffer.push(i),n&&this.once("flush",n),this.flush()}close(){const e=()=>{this._onClose("forced close"),this.transport.close()},s=()=>{this.off("upgrade",s),this.off("upgradeError",s),e()},a=()=>{this.once("upgrade",s),this.once("upgradeError",s)};return(this.readyState==="opening"||this.readyState==="open")&&(this.readyState="closing",this.writeBuffer.length?this.once("drain",()=>{this.upgrading?a():e()}):this.upgrading?a():e()),this}_onError(e){if(Ie.priorWebsocketSuccess=!1,this.opts.tryAllTransports&&this.transports.length>1&&this.readyState==="opening")return this.transports.shift(),this._open();this.emitReserved("error",e),this._onClose("transport error",e)}_onClose(e,s){if(this.readyState==="opening"||this.readyState==="open"||this.readyState==="closing"){if(this.clearTimeoutFn(this._pingTimeoutTimer),this.transport.removeAllListeners("close"),this.transport.close(),this.transport.removeAllListeners(),Et&&(this._beforeunloadEventListener&&removeEventListener("beforeunload",this._beforeunloadEventListener,!1),this._offlineEventListener)){const a=et.indexOf(this._offlineEventListener);a!==-1&&et.splice(a,1)}this.readyState="closed",this.id=null,this.emitReserved("close",e,s),this.writeBuffer=[],this._prevBufferLen=0}}}Ie.protocol=Bs;class Da extends Ie{constructor(){super(...arguments),this._upgrades=[]}onOpen(){if(super.onOpen(),this.readyState==="open"&&this.opts.upgrade)for(let e=0;e<this._upgrades.length;e++)this._probe(this._upgrades[e])}_probe(e){let s=this.createTransport(e),a=!1;Ie.priorWebsocketSuccess=!1;const n=()=>{a||(s.send([{type:"ping",data:"probe"}]),s.once("packet",g=>{if(!a)if(g.type==="pong"&&g.data==="probe"){if(this.upgrading=!0,this.emitReserved("upgrading",s),!s)return;Ie.priorWebsocketSuccess=s.name==="websocket",this.transport.pause(()=>{a||this.readyState!=="closed"&&(p(),this.setTransport(s),s.send([{type:"upgrade"}]),this.emitReserved("upgrade",s),s=null,this.upgrading=!1,this.flush())})}else{const v=new Error("probe error");v.transport=s.name,this.emitReserved("upgradeError",v)}}))};function i(){a||(a=!0,p(),s.close(),s=null)}const o=g=>{const v=new Error("probe error: "+g);v.transport=s.name,i(),this.emitReserved("upgradeError",v)};function c(){o("transport closed")}function l(){o("socket closed")}function u(g){s&&g.name!==s.name&&i()}const p=()=>{s.removeListener("open",n),s.removeListener("error",o),s.removeListener("close",c),this.off("close",l),this.off("upgrading",u)};s.once("open",n),s.once("error",o),s.once("close",c),this.once("close",l),this.once("upgrading",u),this._upgrades.indexOf("webtransport")!==-1&&e!=="webtransport"?this.setTimeoutFn(()=>{a||s.open()},200):s.open()}onHandshake(e){this._upgrades=this._filterUpgrades(e.upgrades),super.onHandshake(e)}_filterUpgrades(e){const s=[];for(let a=0;a<e.length;a++)~this.transports.indexOf(e[a])&&s.push(e[a]);return s}}let Na=class extends Da{constructor(e,s={}){const a=typeof e=="object"?e:s;(!a.transports||a.transports&&typeof a.transports[0]=="string")&&(a.transports=(a.transports||["polling","websocket","webtransport"]).map(n=>Ma[n]).filter(n=>!!n)),super(e,a)}};function Fa(t,e="",s){let a=t;s=s||typeof location<"u"&&location,t==null&&(t=s.protocol+"//"+s.host),typeof t=="string"&&(t.charAt(0)==="/"&&(t.charAt(1)==="/"?t=s.protocol+t:t=s.host+t),/^(https?|wss?):\/\//.test(t)||(typeof s<"u"?t=s.protocol+"//"+t:t="https://"+t),a=$t(t)),a.port||(/^(http|ws)$/.test(a.protocol)?a.port="80":/^(http|ws)s$/.test(a.protocol)&&(a.port="443")),a.path=a.path||"/";const i=a.host.indexOf(":")!==-1?"["+a.host+"]":a.host;return a.id=a.protocol+"://"+i+":"+a.port+e,a.href=a.protocol+"://"+i+(s&&s.port===a.port?"":":"+a.port),a}const Ua=typeof ArrayBuffer=="function",Oa=t=>typeof ArrayBuffer.isView=="function"?ArrayBuffer.isView(t):t.buffer instanceof ArrayBuffer,Rs=Object.prototype.toString,Va=typeof Blob=="function"||typeof Blob<"u"&&Rs.call(Blob)==="[object BlobConstructor]",Ha=typeof File=="function"||typeof File<"u"&&Rs.call(File)==="[object FileConstructor]";function zt(t){return Ua&&(t instanceof ArrayBuffer||Oa(t))||Va&&t instanceof Blob||Ha&&t instanceof File}function tt(t,e){if(!t||typeof t!="object")return!1;if(Array.isArray(t)){for(let s=0,a=t.length;s<a;s++)if(tt(t[s]))return!0;return!1}if(zt(t))return!0;if(t.toJSON&&typeof t.toJSON=="function"&&arguments.length===1)return tt(t.toJSON(),!0);for(const s in t)if(Object.prototype.hasOwnProperty.call(t,s)&&tt(t[s]))return!0;return!1}function za(t){const e=[],s=t.data,a=t;return a.data=Ct(s,e),a.attachments=e.length,{packet:a,buffers:e}}function Ct(t,e){if(!t)return t;if(zt(t)){const s={_placeholder:!0,num:e.length};return e.push(t),s}else if(Array.isArray(t)){const s=new Array(t.length);for(let a=0;a<t.length;a++)s[a]=Ct(t[a],e);return s}else if(typeof t=="object"&&!(t instanceof Date)){const s={};for(const a in t)Object.prototype.hasOwnProperty.call(t,a)&&(s[a]=Ct(t[a],e));return s}return t}function ja(t,e){return t.data=xt(t.data,e),delete t.attachments,t}function xt(t,e){if(!t)return t;if(t&&t._placeholder===!0){if(typeof t.num=="number"&&t.num>=0&&t.num<e.length)return e[t.num];throw new Error("illegal attachments")}else if(Array.isArray(t))for(let s=0;s<t.length;s++)t[s]=xt(t[s],e);else if(typeof t=="object")for(const s in t)Object.prototype.hasOwnProperty.call(t,s)&&(t[s]=xt(t[s],e));return t}const Qa=["connect","connect_error","disconnect","disconnecting","newListener","removeListener"];var O;(function(t){t[t.CONNECT=0]="CONNECT",t[t.DISCONNECT=1]="DISCONNECT",t[t.EVENT=2]="EVENT",t[t.ACK=3]="ACK",t[t.CONNECT_ERROR=4]="CONNECT_ERROR",t[t.BINARY_EVENT=5]="BINARY_EVENT",t[t.BINARY_ACK=6]="BINARY_ACK"})(O||(O={}));class Wa{constructor(e){this.replacer=e}encode(e){return(e.type===O.EVENT||e.type===O.ACK)&&tt(e)?this.encodeAsBinary({type:e.type===O.EVENT?O.BINARY_EVENT:O.BINARY_ACK,nsp:e.nsp,data:e.data,id:e.id}):[this.encodeAsString(e)]}encodeAsString(e){let s=""+e.type;return(e.type===O.BINARY_EVENT||e.type===O.BINARY_ACK)&&(s+=e.attachments+"-"),e.nsp&&e.nsp!=="/"&&(s+=e.nsp+","),e.id!=null&&(s+=e.id),e.data!=null&&(s+=JSON.stringify(e.data,this.replacer)),s}encodeAsBinary(e){const s=za(e),a=this.encodeAsString(s.packet),n=s.buffers;return n.unshift(a),n}}class jt extends J{constructor(e){super(),this.reviver=e}add(e){let s;if(typeof e=="string"){if(this.reconstructor)throw new Error("got plaintext data when reconstructing a packet");s=this.decodeString(e);const a=s.type===O.BINARY_EVENT;a||s.type===O.BINARY_ACK?(s.type=a?O.EVENT:O.ACK,this.reconstructor=new Ga(s),s.attachments===0&&super.emitReserved("decoded",s)):super.emitReserved("decoded",s)}else if(zt(e)||e.base64)if(this.reconstructor)s=this.reconstructor.takeBinaryData(e),s&&(this.reconstructor=null,super.emitReserved("decoded",s));else throw new Error("got binary data when not reconstructing a packet");else throw new Error("Unknown type: "+e)}decodeString(e){let s=0;const a={type:Number(e.charAt(0))};if(O[a.type]===void 0)throw new Error("unknown packet type "+a.type);if(a.type===O.BINARY_EVENT||a.type===O.BINARY_ACK){const i=s+1;for(;e.charAt(++s)!=="-"&&s!=e.length;);const o=e.substring(i,s);if(o!=Number(o)||e.charAt(s)!=="-")throw new Error("Illegal attachments");a.attachments=Number(o)}if(e.charAt(s+1)==="/"){const i=s+1;for(;++s&&!(e.charAt(s)===","||s===e.length););a.nsp=e.substring(i,s)}else a.nsp="/";const n=e.charAt(s+1);if(n!==""&&Number(n)==n){const i=s+1;for(;++s;){const o=e.charAt(s);if(o==null||Number(o)!=o){--s;break}if(s===e.length)break}a.id=Number(e.substring(i,s+1))}if(e.charAt(++s)){const i=this.tryParse(e.substr(s));if(jt.isPayloadValid(a.type,i))a.data=i;else throw new Error("invalid payload")}return a}tryParse(e){try{return JSON.parse(e,this.reviver)}catch{return!1}}static isPayloadValid(e,s){switch(e){case O.CONNECT:return ds(s);case O.DISCONNECT:return s===void 0;case O.CONNECT_ERROR:return typeof s=="string"||ds(s);case O.EVENT:case O.BINARY_EVENT:return Array.isArray(s)&&(typeof s[0]=="number"||typeof s[0]=="string"&&Qa.indexOf(s[0])===-1);case O.ACK:case O.BINARY_ACK:return Array.isArray(s)}}destroy(){this.reconstructor&&(this.reconstructor.finishedReconstruction(),this.reconstructor=null)}}class Ga{constructor(e){this.packet=e,this.buffers=[],this.reconPack=e}takeBinaryData(e){if(this.buffers.push(e),this.buffers.length===this.reconPack.attachments){const s=ja(this.reconPack,this.buffers);return this.finishedReconstruction(),s}return null}finishedReconstruction(){this.reconPack=null,this.buffers=[]}}function ds(t){return Object.prototype.toString.call(t)==="[object Object]"}const Ka=Object.freeze(Object.defineProperty({__proto__:null,Decoder:jt,Encoder:Wa,get PacketType(){return O}},Symbol.toStringTag,{value:"Module"}));function fe(t,e,s){return t.on(e,s),function(){t.off(e,s)}}const Ya=Object.freeze({connect:1,connect_error:1,disconnect:1,disconnecting:1,newListener:1,removeListener:1});class qs extends J{constructor(e,s,a){super(),this.connected=!1,this.recovered=!1,this.receiveBuffer=[],this.sendBuffer=[],this._queue=[],this._queueSeq=0,this.ids=0,this.acks={},this.flags={},this.io=e,this.nsp=s,a&&a.auth&&(this.auth=a.auth),this._opts=Object.assign({},a),this.io._autoConnect&&this.open()}get disconnected(){return!this.connected}subEvents(){if(this.subs)return;const e=this.io;this.subs=[fe(e,"open",this.onopen.bind(this)),fe(e,"packet",this.onpacket.bind(this)),fe(e,"error",this.onerror.bind(this)),fe(e,"close",this.onclose.bind(this))]}get active(){return!!this.subs}connect(){return this.connected?this:(this.subEvents(),this.io._reconnecting||this.io.open(),this.io._readyState==="open"&&this.onopen(),this)}open(){return this.connect()}send(...e){return e.unshift("message"),this.emit.apply(this,e),this}emit(e,...s){var a,n,i;if(Ya.hasOwnProperty(e))throw new Error('"'+e.toString()+'" is a reserved event name');if(s.unshift(e),this._opts.retries&&!this.flags.fromQueue&&!this.flags.volatile)return this._addToQueue(s),this;const o={type:O.EVENT,data:s};if(o.options={},o.options.compress=this.flags.compress!==!1,typeof s[s.length-1]=="function"){const p=this.ids++,g=s.pop();this._registerAckCallback(p,g),o.id=p}const c=(n=(a=this.io.engine)===null||a===void 0?void 0:a.transport)===null||n===void 0?void 0:n.writable,l=this.connected&&!(!((i=this.io.engine)===null||i===void 0)&&i._hasPingExpired());return this.flags.volatile&&!c||(l?(this.notifyOutgoingListeners(o),this.packet(o)):this.sendBuffer.push(o)),this.flags={},this}_registerAckCallback(e,s){var a;const n=(a=this.flags.timeout)!==null&&a!==void 0?a:this._opts.ackTimeout;if(n===void 0){this.acks[e]=s;return}const i=this.io.setTimeoutFn(()=>{delete this.acks[e];for(let c=0;c<this.sendBuffer.length;c++)this.sendBuffer[c].id===e&&this.sendBuffer.splice(c,1);s.call(this,new Error("operation has timed out"))},n),o=(...c)=>{this.io.clearTimeoutFn(i),s.apply(this,c)};o.withError=!0,this.acks[e]=o}emitWithAck(e,...s){return new Promise((a,n)=>{const i=(o,c)=>o?n(o):a(c);i.withError=!0,s.push(i),this.emit(e,...s)})}_addToQueue(e){let s;typeof e[e.length-1]=="function"&&(s=e.pop());const a={id:this._queueSeq++,tryCount:0,pending:!1,args:e,flags:Object.assign({fromQueue:!0},this.flags)};e.push((n,...i)=>(this._queue[0],n!==null?a.tryCount>this._opts.retries&&(this._queue.shift(),s&&s(n)):(this._queue.shift(),s&&s(null,...i)),a.pending=!1,this._drainQueue())),this._queue.push(a),this._drainQueue()}_drainQueue(e=!1){if(!this.connected||this._queue.length===0)return;const s=this._queue[0];s.pending&&!e||(s.pending=!0,s.tryCount++,this.flags=s.flags,this.emit.apply(this,s.args))}packet(e){e.nsp=this.nsp,this.io._packet(e)}onopen(){typeof this.auth=="function"?this.auth(e=>{this._sendConnectPacket(e)}):this._sendConnectPacket(this.auth)}_sendConnectPacket(e){this.packet({type:O.CONNECT,data:this._pid?Object.assign({pid:this._pid,offset:this._lastOffset},e):e})}onerror(e){this.connected||this.emitReserved("connect_error",e)}onclose(e,s){this.connected=!1,delete this.id,this.emitReserved("disconnect",e,s),this._clearAcks()}_clearAcks(){Object.keys(this.acks).forEach(e=>{if(!this.sendBuffer.some(a=>String(a.id)===e)){const a=this.acks[e];delete this.acks[e],a.withError&&a.call(this,new Error("socket has been disconnected"))}})}onpacket(e){if(e.nsp===this.nsp)switch(e.type){case O.CONNECT:e.data&&e.data.sid?this.onconnect(e.data.sid,e.data.pid):this.emitReserved("connect_error",new Error("It seems you are trying to reach a Socket.IO server in v2.x with a v3.x client, but they are not compatible (more information here: https://socket.io/docs/v3/migrating-from-2-x-to-3-0/)"));break;case O.EVENT:case O.BINARY_EVENT:this.onevent(e);break;case O.ACK:case O.BINARY_ACK:this.onack(e);break;case O.DISCONNECT:this.ondisconnect();break;case O.CONNECT_ERROR:this.destroy();const a=new Error(e.data.message);a.data=e.data.data,this.emitReserved("connect_error",a);break}}onevent(e){const s=e.data||[];e.id!=null&&s.push(this.ack(e.id)),this.connected?this.emitEvent(s):this.receiveBuffer.push(Object.freeze(s))}emitEvent(e){if(this._anyListeners&&this._anyListeners.length){const s=this._anyListeners.slice();for(const a of s)a.apply(this,e)}super.emit.apply(this,e),this._pid&&e.length&&typeof e[e.length-1]=="string"&&(this._lastOffset=e[e.length-1])}ack(e){const s=this;let a=!1;return function(...n){a||(a=!0,s.packet({type:O.ACK,id:e,data:n}))}}onack(e){const s=this.acks[e.id];typeof s=="function"&&(delete this.acks[e.id],s.withError&&e.data.unshift(null),s.apply(this,e.data))}onconnect(e,s){this.id=e,this.recovered=s&&this._pid===s,this._pid=s,this.connected=!0,this.emitBuffered(),this._drainQueue(!0),this.emitReserved("connect")}emitBuffered(){this.receiveBuffer.forEach(e=>this.emitEvent(e)),this.receiveBuffer=[],this.sendBuffer.forEach(e=>{this.notifyOutgoingListeners(e),this.packet(e)}),this.sendBuffer=[]}ondisconnect(){this.destroy(),this.onclose("io server disconnect")}destroy(){this.subs&&(this.subs.forEach(e=>e()),this.subs=void 0),this.io._destroy(this)}disconnect(){return this.connected&&this.packet({type:O.DISCONNECT}),this.destroy(),this.connected&&this.onclose("io client disconnect"),this}close(){return this.disconnect()}compress(e){return this.flags.compress=e,this}get volatile(){return this.flags.volatile=!0,this}timeout(e){return this.flags.timeout=e,this}onAny(e){return this._anyListeners=this._anyListeners||[],this._anyListeners.push(e),this}prependAny(e){return this._anyListeners=this._anyListeners||[],this._anyListeners.unshift(e),this}offAny(e){if(!this._anyListeners)return this;if(e){const s=this._anyListeners;for(let a=0;a<s.length;a++)if(e===s[a])return s.splice(a,1),this}else this._anyListeners=[];return this}listenersAny(){return this._anyListeners||[]}onAnyOutgoing(e){return this._anyOutgoingListeners=this._anyOutgoingListeners||[],this._anyOutgoingListeners.push(e),this}prependAnyOutgoing(e){return this._anyOutgoingListeners=this._anyOutgoingListeners||[],this._anyOutgoingListeners.unshift(e),this}offAnyOutgoing(e){if(!this._anyOutgoingListeners)return this;if(e){const s=this._anyOutgoingListeners;for(let a=0;a<s.length;a++)if(e===s[a])return s.splice(a,1),this}else this._anyOutgoingListeners=[];return this}listenersAnyOutgoing(){return this._anyOutgoingListeners||[]}notifyOutgoingListeners(e){if(this._anyOutgoingListeners&&this._anyOutgoingListeners.length){const s=this._anyOutgoingListeners.slice();for(const a of s)a.apply(this,e.data)}}}function Ne(t){t=t||{},this.ms=t.min||100,this.max=t.max||1e4,this.factor=t.factor||2,this.jitter=t.jitter>0&&t.jitter<=1?t.jitter:0,this.attempts=0}Ne.prototype.duration=function(){var t=this.ms*Math.pow(this.factor,this.attempts++);if(this.jitter){var e=Math.random(),s=Math.floor(e*this.jitter*t);t=Math.floor(e*10)&1?t+s:t-s}return Math.min(t,this.max)|0};Ne.prototype.reset=function(){this.attempts=0};Ne.prototype.setMin=function(t){this.ms=t};Ne.prototype.setMax=function(t){this.max=t};Ne.prototype.setJitter=function(t){this.jitter=t};class St extends J{constructor(e,s){var a;super(),this.nsps={},this.subs=[],e&&typeof e=="object"&&(s=e,e=void 0),s=s||{},s.path=s.path||"/socket.io",this.opts=s,ht(this,s),this.reconnection(s.reconnection!==!1),this.reconnectionAttempts(s.reconnectionAttempts||1/0),this.reconnectionDelay(s.reconnectionDelay||1e3),this.reconnectionDelayMax(s.reconnectionDelayMax||5e3),this.randomizationFactor((a=s.randomizationFactor)!==null&&a!==void 0?a:.5),this.backoff=new Ne({min:this.reconnectionDelay(),max:this.reconnectionDelayMax(),jitter:this.randomizationFactor()}),this.timeout(s.timeout==null?2e4:s.timeout),this._readyState="closed",this.uri=e;const n=s.parser||Ka;this.encoder=new n.Encoder,this.decoder=new n.Decoder,this._autoConnect=s.autoConnect!==!1,this._autoConnect&&this.open()}reconnection(e){return arguments.length?(this._reconnection=!!e,e||(this.skipReconnect=!0),this):this._reconnection}reconnectionAttempts(e){return e===void 0?this._reconnectionAttempts:(this._reconnectionAttempts=e,this)}reconnectionDelay(e){var s;return e===void 0?this._reconnectionDelay:(this._reconnectionDelay=e,(s=this.backoff)===null||s===void 0||s.setMin(e),this)}randomizationFactor(e){var s;return e===void 0?this._randomizationFactor:(this._randomizationFactor=e,(s=this.backoff)===null||s===void 0||s.setJitter(e),this)}reconnectionDelayMax(e){var s;return e===void 0?this._reconnectionDelayMax:(this._reconnectionDelayMax=e,(s=this.backoff)===null||s===void 0||s.setMax(e),this)}timeout(e){return arguments.length?(this._timeout=e,this):this._timeout}maybeReconnectOnOpen(){!this._reconnecting&&this._reconnection&&this.backoff.attempts===0&&this.reconnect()}open(e){if(~this._readyState.indexOf("open"))return this;this.engine=new Na(this.uri,this.opts);const s=this.engine,a=this;this._readyState="opening",this.skipReconnect=!1;const n=fe(s,"open",function(){a.onopen(),e&&e()}),i=c=>{this.cleanup(),this._readyState="closed",this.emitReserved("error",c),e?e(c):this.maybeReconnectOnOpen()},o=fe(s,"error",i);if(this._timeout!==!1){const c=this._timeout,l=this.setTimeoutFn(()=>{n(),i(new Error("timeout")),s.close()},c);this.opts.autoUnref&&l.unref(),this.subs.push(()=>{this.clearTimeoutFn(l)})}return this.subs.push(n),this.subs.push(o),this}connect(e){return this.open(e)}onopen(){this.cleanup(),this._readyState="open",this.emitReserved("open");const e=this.engine;this.subs.push(fe(e,"ping",this.onping.bind(this)),fe(e,"data",this.ondata.bind(this)),fe(e,"error",this.onerror.bind(this)),fe(e,"close",this.onclose.bind(this)),fe(this.decoder,"decoded",this.ondecoded.bind(this)))}onping(){this.emitReserved("ping")}ondata(e){try{this.decoder.add(e)}catch(s){this.onclose("parse error",s)}}ondecoded(e){pt(()=>{this.emitReserved("packet",e)},this.setTimeoutFn)}onerror(e){this.emitReserved("error",e)}socket(e,s){let a=this.nsps[e];return a?this._autoConnect&&!a.active&&a.connect():(a=new qs(this,e,s),this.nsps[e]=a),a}_destroy(e){const s=Object.keys(this.nsps);for(const a of s)if(this.nsps[a].active)return;this._close()}_packet(e){const s=this.encoder.encode(e);for(let a=0;a<s.length;a++)this.engine.write(s[a],e.options)}cleanup(){this.subs.forEach(e=>e()),this.subs.length=0,this.decoder.destroy()}_close(){this.skipReconnect=!0,this._reconnecting=!1,this.onclose("forced close")}disconnect(){return this._close()}onclose(e,s){var a;this.cleanup(),(a=this.engine)===null||a===void 0||a.close(),this.backoff.reset(),this._readyState="closed",this.emitReserved("close",e,s),this._reconnection&&!this.skipReconnect&&this.reconnect()}reconnect(){if(this._reconnecting||this.skipReconnect)return this;const e=this;if(this.backoff.attempts>=this._reconnectionAttempts)this.backoff.reset(),this.emitReserved("reconnect_failed"),this._reconnecting=!1;else{const s=this.backoff.duration();this._reconnecting=!0;const a=this.setTimeoutFn(()=>{e.skipReconnect||(this.emitReserved("reconnect_attempt",e.backoff.attempts),!e.skipReconnect&&e.open(n=>{n?(e._reconnecting=!1,e.reconnect(),this.emitReserved("reconnect_error",n)):e.onreconnect()}))},s);this.opts.autoUnref&&a.unref(),this.subs.push(()=>{this.clearTimeoutFn(a)})}}onreconnect(){const e=this.backoff.attempts;this._reconnecting=!1,this.backoff.reset(),this.emitReserved("reconnect",e)}}const Ue={};function st(t,e){typeof t=="object"&&(e=t,t=void 0),e=e||{};const s=Fa(t,e.path||"/socket.io"),a=s.source,n=s.id,i=s.path,o=Ue[n]&&i in Ue[n].nsps,c=e.forceNew||e["force new connection"]||e.multiplex===!1||o;let l;return c?l=new St(a,e):(Ue[n]||(Ue[n]=new St(a,e)),l=Ue[n]),s.query&&!e.query&&(e.query=s.queryKey),l.socket(s.path,e)}Object.assign(st,{Manager:St,Socket:qs,io:st,connect:st});class Ja{constructor(){this.socket=null,this.listeners=new Map,this.subscribedMangas=new Set}connect(){var e;(e=this.socket)!=null&&e.connected||(this.socket=st({autoConnect:!0,reconnection:!0,reconnectionDelay:1e3,reconnectionAttempts:10}),this.socket.on("connect",()=>{console.log("[Socket] Connected:",this.socket.id),this.subscribedMangas.forEach(s=>{this.socket.emit("subscribe:manga",s)}),this.socket.emit("subscribe:global")}),this.socket.on("disconnect",s=>{console.log("[Socket] Disconnected:",s)}),this.socket.on("connect_error",s=>{console.error("[Socket] Connection error:",s.message)}))}disconnect(){this.socket&&(this.socket.disconnect(),this.socket=null)}subscribeToManga(e){var s;this.subscribedMangas.add(e),(s=this.socket)!=null&&s.connected&&this.socket.emit("subscribe:manga",e)}unsubscribeFromManga(e){var s;this.subscribedMangas.delete(e),(s=this.socket)!=null&&s.connected&&this.socket.emit("unsubscribe:manga",e)}on(e,s){this.listeners.has(e)||this.listeners.set(e,new Set),this.listeners.get(e).add(s),this.socket&&this.socket.on(e,s)}off(e,s){this.listeners.has(e)&&this.listeners.get(e).delete(s),this.socket&&this.socket.off(e,s)}emit(e,s){var a;(a=this.socket)!=null&&a.connected&&this.socket.emit(e,s)}}const we={CHAPTER_DOWNLOADED:"chapter:downloaded",CHAPTER_HIDDEN:"chapter:hidden",CHAPTER_UNHIDDEN:"chapter:unhidden",MANGA_UPDATED:"manga:updated",MANGA_ADDED:"manga:added",MANGA_DELETED:"manga:deleted",DOWNLOAD_PROGRESS:"download:progress",DOWNLOAD_COMPLETED:"download:completed",QUEUE_UPDATED:"queue:updated",ACTION_RECORDED:"action:recorded",ACTION_UNDONE:"action:undone"},he=new Ja,ie={bookmarks:[],series:[],categories:[],favorites:{favorites:{},listOrder:[]}},ve=new Set,K=new Map,Ve=new Map;function Xa(t){return ie[t]}function Za(t,e){ie[t]=e,ve.add(t),Ge(t)}function en(t,e){return Ve.has(t)||Ve.set(t,new Set),Ve.get(t).add(e),()=>{var s;return(s=Ve.get(t))==null?void 0:s.delete(e)}}function Ge(t){const e=Ve.get(t);e&&e.forEach(s=>s(ie[t]))}function He(t){ve.delete(t),K.delete(t)}function tn(t){return ve.has(t)}async function ze(t=!1){if(!t&&ve.has("bookmarks"))return ie.bookmarks;if(K.has("bookmarks"))return K.get("bookmarks");const e=m.getBookmarks().then(s=>(ie.bookmarks=s||[],ve.add("bookmarks"),K.delete("bookmarks"),Ge("bookmarks"),ie.bookmarks)).catch(s=>{throw K.delete("bookmarks"),s});return K.set("bookmarks",e),e}async function sn(t=!1){if(!t&&ve.has("series"))return ie.series;if(K.has("series"))return K.get("series");const e=m.get("/series").then(s=>(ie.series=s||[],ve.add("series"),K.delete("series"),Ge("series"),ie.series)).catch(s=>{throw K.delete("series"),s});return K.set("series",e),e}async function an(t=!1){if(!t&&ve.has("categories"))return ie.categories;if(K.has("categories"))return K.get("categories");const e=m.get("/categories").then(s=>(ie.categories=s.categories||[],ve.add("categories"),K.delete("categories"),Ge("categories"),ie.categories)).catch(s=>{throw K.delete("categories"),s});return K.set("categories",e),e}async function nn(t=!1){if(!t&&ve.has("favorites"))return ie.favorites;if(K.has("favorites"))return K.get("favorites");const e=m.getFavorites().then(s=>(ie.favorites=s||{favorites:{},listOrder:[]},ve.add("favorites"),K.delete("favorites"),Ge("favorites"),ie.favorites)).catch(s=>{throw K.delete("favorites"),s});return K.set("favorites",e),e}function rn(){he.on(we.MANGA_UPDATED,()=>{He("bookmarks"),ze(!0)}),he.on(we.MANGA_ADDED,()=>{He("bookmarks"),ze(!0)}),he.on(we.MANGA_DELETED,()=>{He("bookmarks"),ze(!0)}),he.on(we.DOWNLOAD_COMPLETED,()=>{He("bookmarks"),ze(!0)})}rn();const oe={get:Xa,set:Za,subscribe:en,invalidate:He,isLoaded:tn,loadBookmarks:ze,loadSeries:sn,loadCategories:an,loadFavorites:nn};function d(t,e="info"){document.querySelectorAll(".toast").forEach(n=>{n.classList.contains("show")&&n.classList.remove("show")});const a=document.createElement("div");a.className=`toast toast-${e}`,a.textContent=t,document.body.appendChild(a),requestAnimationFrame(()=>a.classList.add("show")),setTimeout(()=>{a.classList.remove("show"),setTimeout(()=>a.remove(),300)},3e3)}const on={library:'<path d="m16 6 4 14"/><path d="M12 6v14"/><path d="M8 8v12"/><path d="M4 4v16"/>',"book-open":'<path d="M12 7v14"/><path d="M3 18a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1h5a4 4 0 0 1 4 4 4 4 0 0 1 4-4h5a1 1 0 0 1 1 1v13a1 1 0 0 1-1 1h-6a3 3 0 0 0-3 3 3 3 0 0 0-3-3z"/>',"book-marked":'<path d="M10 2v8l3-3 3 3V2"/><path d="M4 19.5v-15A2.5 2.5 0 0 1 6.5 2H19a1 1 0 0 1 1 1v18a1 1 0 0 1-1 1H6.5a1 1 0 0 1 0-5H20"/>',"layout-grid":'<rect width="7" height="7" x="3" y="3" rx="1"/><rect width="7" height="7" x="14" y="3" rx="1"/><rect width="7" height="7" x="14" y="14" rx="1"/><rect width="7" height="7" x="3" y="14" rx="1"/>',star:'<polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/>',trophy:'<path d="M6 9H4.5a2.5 2.5 0 0 1 0-5H6"/><path d="M18 9h1.5a2.5 2.5 0 0 0 0-5H18"/><path d="M4 22h16"/><path d="M10 14.66V17c0 .55-.47.98-.97 1.21C7.85 18.75 7 20.24 7 22"/><path d="M14 14.66V17c0 .55.47.98.97 1.21C16.15 18.75 17 20.24 17 22"/><path d="M18 2H6v7a6 6 0 0 0 12 0V2Z"/>',plus:'<path d="M5 12h14"/><path d="M12 5v14"/>',check:'<path d="M20 6 9 17l-5-5"/>',pencil:'<path d="M21.174 6.812a1 1 0 0 0-3.986-3.987L3.842 16.174a2 2 0 0 0-.5.83l-1.321 4.352a.5.5 0 0 0 .623.622l4.353-1.32a2 2 0 0 0 .83-.497z"/>',"trash-2":'<path d="M3 6h18"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6"/><path d="M8 6V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/><line x1="10" x2="10" y1="11" y2="17"/><line x1="14" x2="14" y1="11" y2="17"/>',"undo-2":'<path d="M9 14 4 9l5-5"/><path d="M4 9h10.5a5.5 5.5 0 0 1 5.5 5.5a5.5 5.5 0 0 1-5.5 5.5H11"/>',scissors:'<circle cx="6" cy="6" r="3"/><path d="M8.12 8.12 12 12"/><path d="M20 4 8.12 15.88"/><circle cx="6" cy="18" r="3"/><path d="M14.8 14.8 20 20"/>',image:'<rect width="18" height="18" x="3" y="3" rx="2" ry="2"/><circle cx="9" cy="9" r="2"/><path d="m21 15-3.086-3.086a2 2 0 0 0-2.828 0L6 21"/>',palette:'<path d="M12 22a1 1 0 0 1 0-20 10 9 0 0 1 10 9 5 5 0 0 1-5 5h-2.25a1.75 1.75 0 0 0-1.4 2.8l.3.4a1.75 1.75 0 0 1-1.4 2.8z"/><circle cx="13.5" cy="6.5" r=".5" fill="currentColor"/><circle cx="17.5" cy="10.5" r=".5" fill="currentColor"/><circle cx="6.5" cy="12.5" r=".5" fill="currentColor"/><circle cx="8.5" cy="7.5" r=".5" fill="currentColor"/>',tag:'<path d="M12.586 2.586A2 2 0 0 0 11.172 2H4a2 2 0 0 0-2 2v7.172a2 2 0 0 0 .586 1.414l8.704 8.704a2.426 2.426 0 0 0 3.42 0l6.58-6.58a2.426 2.426 0 0 0 0-3.42z"/><circle cx="7.5" cy="7.5" r=".5" fill="currentColor"/>',play:'<polygon points="6 3 20 12 6 21 6 3"/>',pause:'<rect x="14" y="4" width="4" height="16" rx="1"/><rect x="6" y="4" width="4" height="16" rx="1"/>',download:'<path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" x2="12" y1="15" y2="3"/>',upload:'<path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="17 8 12 3 7 8"/><line x1="12" x2="12" y1="3" y2="15"/>',"hard-drive":'<line x1="22" x2="2" y1="12" y2="12"/><path d="M5.45 5.11 2 12v6a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-6l-3.45-6.89A2 2 0 0 0 16.76 4H7.24a2 2 0 0 0-1.79 1.11z"/><line x1="6" x2="6.01" y1="16" y2="16"/><line x1="10" x2="10.01" y1="16" y2="16"/>',save:'<path d="M15.2 3a2 2 0 0 1 1.4.6l3.8 3.8a2 2 0 0 1 .6 1.4V19a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2z"/><path d="M17 21v-7a1 1 0 0 0-1-1H8a1 1 0 0 0-1 1v7"/><path d="M7 3v4a1 1 0 0 0 1 1h7"/>',package:'<path d="M11 21.73a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73z"/><path d="M12 22V12"/><path d="m3.3 7 7.703 4.734a2 2 0 0 0 1.994 0L20.7 7"/>',folder:'<path d="M20 20a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2h-7.9a2 2 0 0 1-1.69-.9L9.6 3.9A2 2 0 0 0 7.93 3H4a2 2 0 0 0-2 2v13a2 2 0 0 0 2 2Z"/>',eye:'<path d="M2 12s3-7 10-7 10 7 10 7-3 7-10 7-10-7-10-7Z"/><circle cx="12" cy="12" r="3"/>',"eye-off":'<path d="M10.733 5.076a10.744 10.744 0 0 1 11.205 6.575 1 1 0 0 1 0 .696 10.747 10.747 0 0 1-1.444 2.49"/><path d="M14.084 14.158a3 3 0 0 1-4.242-4.242"/><path d="M17.479 17.499a10.75 10.75 0 0 1-15.417-5.151 1 1 0 0 1 0-.696 10.75 10.75 0 0 1 4.446-5.143"/><path d="m2 2 20 20"/>',circle:'<circle cx="12" cy="12" r="10"/>',lock:'<rect width="18" height="11" x="3" y="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/>',"lock-open":'<rect width="18" height="11" x="3" y="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 9.9-1"/>',"triangle-alert":'<path d="m21.73 18-8-14a2 2 0 0 0-3.48 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3"/><path d="M12 9v4"/><path d="M12 17h.01"/>',"shield-alert":'<path d="M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z"/><path d="M12 8v4"/><path d="M12 16h.01"/>',"circle-help":'<circle cx="12" cy="12" r="10"/><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"/><path d="M12 17h.01"/>',"traffic-cone":'<path d="M9.3 6.2a4.55 4.55 0 0 0 5.4 0"/><path d="M7.9 10.7c.9.8 2.4 1.3 4.1 1.3s3.2-.5 4.1-1.3"/><path d="M13.9 3.5a1.93 1.93 0 0 0-3.8 0L6.1 19.5a1.93 1.93 0 0 0 1.9 2.5h8a1.93 1.93 0 0 0 1.9-2.5z"/><path d="M2 21h20"/>',sparkles:'<path d="M9.937 15.5A2 2 0 0 0 8.5 14.063l-6.135-1.582a.5.5 0 0 1 0-.962L8.5 9.936A2 2 0 0 0 9.937 8.5l1.582-6.135a.5.5 0 0 1 .963 0L14.063 8.5A2 2 0 0 0 15.5 9.937l6.135 1.581a.5.5 0 0 1 0 .964L15.5 14.063a2 2 0 0 0-1.437 1.437l-1.582 6.135a.5.5 0 0 1-.963 0z"/><path d="M20 3v4"/><path d="M22 5h-4"/>',zap:'<path d="M4 14a1 1 0 0 1-.78-1.63l9.9-10.2a.5.5 0 0 1 .86.46l-1.92 6.02A1 1 0 0 0 13 10h7a1 1 0 0 1 .78 1.63l-9.9 10.2a.5.5 0 0 1-.86-.46l1.92-6.02A1 1 0 0 0 11 14z"/>',clock:'<circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/>',"alarm-clock":'<circle cx="12" cy="13" r="8"/><path d="M12 9v4l2 2"/><path d="M5 3 2 6"/><path d="m22 6-3-3"/><path d="M6.38 18.7 4 21"/><path d="M17.64 18.67 20 21"/>',loader:'<path d="M12 2v4"/><path d="m16.2 7.8 2.9-2.9"/><path d="M18 12h4"/><path d="m16.2 16.2 2.9 2.9"/><path d="M12 18v4"/><path d="m4.9 19.1 2.9-2.9"/><path d="M2 12h4"/><path d="m4.9 4.9 2.9 2.9"/>',search:'<circle cx="11" cy="11" r="8"/><path d="m21 21-4.3-4.3"/>',"search-x":'<path d="m13.5 8.5-5 5"/><path d="m8.5 8.5 5 5"/><circle cx="11" cy="11" r="8"/><path d="m21 21-4.3-4.3"/>',list:'<path d="M8 6h13"/><path d="M8 12h13"/><path d="M8 18h13"/><path d="M3 6h.01"/><path d="M3 12h.01"/><path d="M3 18h.01"/>',"list-checks":'<path d="m3 17 2 2 4-4"/><path d="m3 7 2 2 4-4"/><path d="M13 6h8"/><path d="M13 12h8"/><path d="M13 18h8"/>',"log-out":'<path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"/><polyline points="16 17 21 12 16 7"/><line x1="21" x2="9" y1="12" y2="12"/>',settings:'<path d="M12.22 2h-.44a2 2 0 0 0-2 2v.18a2 2 0 0 1-1 1.73l-.43.25a2 2 0 0 1-2 0l-.15-.08a2 2 0 0 0-2.73.73l-.22.38a2 2 0 0 0 .73 2.73l.15.1a2 2 0 0 1 1 1.72v.51a2 2 0 0 1-1 1.74l-.15.09a2 2 0 0 0-.73 2.73l.22.38a2 2 0 0 0 2.73.73l.15-.08a2 2 0 0 1 2 0l.43.25a2 2 0 0 1 1 1.73V20a2 2 0 0 0 2 2h.44a2 2 0 0 0 2-2v-.18a2 2 0 0 1 1-1.73l.43-.25a2 2 0 0 1 2 0l.15.08a2 2 0 0 0 2.73-.73l.22-.39a2 2 0 0 0-.73-2.73l-.15-.08a2 2 0 0 1-1-1.74v-.5a2 2 0 0 1 1-1.74l.15-.09a2 2 0 0 0 .73-2.73l-.22-.38a2 2 0 0 0-2.73-.73l-.15.08a2 2 0 0 1-2 0l-.43-.25a2 2 0 0 1-1-1.73V4a2 2 0 0 0-2-2z"/><circle cx="12" cy="12" r="3"/>',sliders:'<path d="M20 7h-9"/><path d="M14 17H5"/><circle cx="17" cy="17" r="3"/><circle cx="7" cy="7" r="3"/>',wrench:'<path d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94z"/>',"chevron-up":'<path d="m18 15-6-6-6 6"/>',"chevron-down":'<path d="m6 9 6 6 6-6"/>',"chevron-left":'<path d="m15 18-6-6 6-6"/>',"chevron-right":'<path d="m9 18 6-6-6-6"/>',x:'<path d="M18 6 6 18"/><path d="m6 6 12 12"/>',images:'<path d="M18 22H4a2 2 0 0 1-2-2V6"/><path d="m22 13-1.296-1.296a2.41 2.41 0 0 0-3.408 0L11 18"/><circle cx="12" cy="8" r="2"/><rect width="16" height="16" x="6" y="2" rx="2"/>',"columns-2":'<rect width="18" height="18" x="3" y="3" rx="2"/><path d="M12 3v18"/>',"rectangle-vertical":'<rect width="12" height="20" x="6" y="2" rx="2"/>',maximize:'<path d="M8 3H5a2 2 0 0 0-2 2v3"/><path d="M21 8V5a2 2 0 0 0-2-2h-3"/><path d="M3 16v3a2 2 0 0 0 2 2h3"/><path d="M16 21h3a2 2 0 0 0 2-2v-3"/>',"arrow-left-right":'<path d="M8 3 4 7l4 4"/><path d="M4 7h16"/><path d="m16 21 4-4-4-4"/><path d="M20 17H4"/>',"refresh-cw":'<path d="M3 12a9 9 0 0 1 9-9 9.75 9.75 0 0 1 6.74 2.74L21 8"/><path d="M21 3v5h-5"/><path d="M3 21v-5h5"/><path d="M21 12a9 9 0 0 1-9 9 9.75 9.75 0 0 1-6.74-2.74L3 16"/>',"rotate-cw":'<path d="M21 12a9 9 0 1 1-9-9c2.52 0 4.93 1 6.74 2.74L21 8"/><path d="M21 3v5h-5"/>',"wifi-off":'<path d="M12 20h.01"/><path d="M8.5 16.429a5 5 0 0 1 7 0"/><path d="M5 12.859a10 10 0 0 1 5.17-2.69"/><path d="M19 12.859a10 10 0 0 0-2.007-1.523"/><path d="M2 8.82a15 15 0 0 1 4.177-2.643"/><path d="M22 8.82a15 15 0 0 0-11.288-3.764"/><path d="m2 2 20 20"/>',globe:'<circle cx="12" cy="12" r="10"/><path d="M12 2a14.5 14.5 0 0 0 0 20 14.5 14.5 0 0 0 0-20"/><path d="M2 12h20"/>',plug:'<path d="M12 22v-5"/><path d="M9 8V2"/><path d="M15 8V2"/><path d="M18 8v5a4 4 0 0 1-4 4h-4a4 4 0 0 1-4-4V8Z"/>',link:'<path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"/><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"/>',"message-circle":'<path d="M7.9 20A9 9 0 1 0 4 16.1L2 22Z"/>'};function h(t,e={}){const s=on[t];if(!s)return console.warn("[icons] unknown icon:",t),"";const{size:a,cls:n="",title:i,spin:o=!1}=e,c=["icon",o?"icon-spin":"",n].filter(Boolean).join(" "),l=a?` width="${a}" height="${a}"`:"",u=i?` role="img" aria-label="${String(i).replace(/"/g,"&quot;")}"`:' aria-hidden="true"';return`<svg class="${c}"${l} viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"${u}>${s}</svg>`}function ce(t="book"){return`<div class="placeholder" data-icon="${t}"></div>`}function Ce(t,e,s={}){const{kind:a="book",self:n=!1,attrs:i=""}=s,o=String(e??"").replace(/"/g,"&quot;"),c=`<div class=&quot;placeholder&quot; data-icon=&quot;${a}&quot;></div>`,l=n?"this.outerHTML":"this.parentElement.innerHTML";return`<img src="${t}" alt="${o}" loading="lazy"${i?" "+i:""} onerror="${l}='${c}'">`}const us=`${h("folder")} Scan Folder`,ps=`${h("loader",{spin:!0})} Scanning...`;async function ln(t,e,s){try{t&&(t.disabled=!0,t.innerHTML=ps),e&&(e.innerHTML=ps),d("Scanning downloads folder...","info");const n=(await m.scanLibrary()).found||[];if(n.length===0){d("Scan complete: No new manga found","info"),s&&s();return}cn(n,s)}catch(a){d("Scan failed: "+a.message,"error")}finally{t&&(t.disabled=!1,t.innerHTML=us),e&&(e.innerHTML=us)}}async function cn(t,e){const s=document.createElement("div");s.id="import-modal-overlay",s.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.7);z-index:9999;display:flex;align-items:center;justify-content:center;";const a=document.createElement("div");a.style.cssText="background:var(--bg-primary);border-radius:8px;padding:24px;max-width:500px;width:90%;max-height:80vh;overflow-y:auto;",a.innerHTML=`
  ...
  `}function pn(t){var n;const e=t.alias||t.title,s=((n=t.entries)==null?void 0:n.length)||t.entry_count||0;let a=null;return t.localCover&&t.coverBookmarkId?a=`/api/public/covers/${t.coverBookmarkId}/${encodeURIComponent(t.localCover.split(/[/\\]/).pop())}`:t.cover&&(a=t.cover),`
    <div class="manga-card series-card" data-series-id="${t.id}">
      <div class="manga-card-cover">
        ${a?Ce(a,e,{kind:"series"}):ce("series")}
        <div class="manga-card-badges">
  ...
  `}function ot(){const t=localStorage.getItem("library_view_mode");if(t&&t!==C.viewMode&&(C.viewMode=t),C.activeCategory==="Favorites")return N.go("/favorites"),"";let e="";if(C.viewMode==="series"){const s=C.series.map(pn).join("");e=`
    ...
    `}else{const s=Qt(),n=C.searchAuthor&&C.searchQuery===C.searchAuthor?`
      ...
      `:""}
      <div class="library-grid" id="library-grid">
        ${C.loading?'<div class="loading-spinner"></div>':i||Gt()}
      </div>
    `}return`
    ${re(C.viewMode)}
    <div class="container">
  ...
  `}function gn(){return`
    ...
    `;const t=r.manga.alias||r.manga.title,e=(p=r.chapter)==null?void 0:p.number,s=r.isCollectionMode||r.isStreamingMode?"":Tn(),n=ee().length,i=r.images.length;let o,c;r.mode==="webtoon"?(o=i-1,c=`${i} pages`):r.singlePageMode?(o=i-1,c=`${r.currentPage+1} / ${i}`):(o=n-1,c=`${r.currentPage+1} / ${n}`);const l=Vs(),u=Qs();return`
    <div class="reader ${r.mode}-mode ${r.showControls?"":"controls-hidden"}">
      ...
      <div class="reader-content" id="reader-content" style="${r.mode==="webtoon"?`zoom: ${r.zoom}%`:""}">
        ${r.isCollectionMode?Hs():r.mode==="webtoon"?zs():js()}
      </div>
  ...
  `}function Hs(){const t=r.mode==="manga";if(t&&!r.singlePageMode){const e=r.images[r.currentPage];if(!e)return"";const s=e.urls||[e.url],a=e.displayMode||"single";return e.displaySide,a==="double"&&s.length>=2?`
  ...
  `}function js(){if(r.singlePageMode)return Pn();const e=ee()[r.currentPage];if(!e)return"";if(e.type==="link"){const s=e.pages[0],a=r.images[s],n=typeof a=="string"?a:a.url,i=r.trophyPages[s];return`
  ...
  `}function Pn(){const t=r.currentPage,e=r.trophyPages[t];if(e&&!e.isSingle&&e.pages&&e.pages.length===2){const[i,o]=e.pages,c=r.images[i],l=r.images[o],u=typeof c=="string"?c:c==null?void 0:c.url,p=typeof l=="string"?l:l==null?void 0:l.url;if(u&&p)return`
            <div class="manga-spread ${r.direction}">
  ...
  `}function ee(){const t=[],e=r.images.length;let s=0;if(r.isCollectionMode){for(let n=0;n<e;n++)t.push([n]);return t}let a=!r.firstPageSingle;for(;s<e;){const n=r.trophyPages[s];if(n){if(!n.isSingle&&n.pages&&n.pages.length===2){const[i,o]=n.pages;t.push([i,o]),s=Math.max(i,o)+1}else t.push([s]),s++;continue}if(!a){a=!0,t.push([s]),s++;continue}if(r.lastPageSingle&&s===e-1){r.nextChapterImage?t.push({type:"link",pages:[s],nextImage:r.nextChapterImage,nextChapter:r.nextChapterNum}):t.push([s]),s++;break}s+1<e?r.trophyPages[s+1]?(t.push([s]),s++):r.lastPageSingle&&s+1===e-1?(t.push([s]),r.nextChapterImage?t.push({type:"link",pages:[s+1],nextImage:r.nextChapterImage,nextChapter:r.nextChapterNum}):t.push([s+1]),s+=2):(t.push([s,s+1]),s+=2):(t.push([s]),s++)}return t}function Qs(){if(r.singlePageMode)return!!r.trophyPages[r.currentPage];const e=ee()[r.currentPage];return e?(Array.isArray(e)?e:e.pages||[]).some(a=>!!r.trophyPages[a]):!1}function Xt(){if(r.singlePageMode)return[r.currentPage];const e=ee()[r.currentPage];return e?Array.isArray(e)?e:e.pages||[]:[]}async function Rn(){if(!r.manga||!r.chapter||r.isCollectionMode)return;const t=Xt();if(t.length===0)return;if(t.some(s=>!!r.trophyPages[s])){const s=[...t];if(r.singlePageMode){const a=r.trophyPages[r.currentPage];a&&!a.isSingle&&a.pages&&a.pages.length>1&&(s.length=0,s.push(...a.pages))}s.forEach(a=>delete r.trophyPages[a]),d(`Page${s.length>1?"s":""} unmarked as trophy`,"info")}else{let s=t,a=r.singlePageMode||t.length===1;if(!r.singlePageMode&&t.length===2){const i=await Js(t,"Mark as trophy");if(!i)return;s=i.pages,a=i.pages.length===1}s.forEach(i=>{r.trophyPages[i]={isSingle:a,pages:[...s]}});const n=a?"single":"double";d(`Page${s.length>1?"s":""} marked as trophy (${n})`,"success")}try{await m.saveTrophyPages(r.manga.id,r.chapter.number,r.trophyPages)}catch(s){console.error("Failed to save trophy pages:",s)}Ee(),Ws()}function Ws(){const t=document.getElementById("trophy-btn");if(t){const e=Qs();t.classList.toggle("active",e),t.title=e?"Unmark trophy":"Mark as trophy"}}function Gs(){if(!r.manga||!r.chapter||r.isCollectionMode||r.isStreamingMode||!r.images.length)return null;const t=r.images.length;let e=1,s=!1;if(r.mode==="manga"){const a=Xt();a.length>0&&(e=Math.min(...a)+1),s=a.includes(t-1)}else{const a=document.getElementById("reader-content");if(a){const n=[...a.querySelectorAll("img")],i=a.scrollTop;let o=0;n.forEach((u,p)=>{i>=o&&(e=p+1),o+=u.offsetHeight});const c=a.scrollHeight>a.clientHeight+10,l=n.length>0&&n.every(u=>u.complete&&u.naturalHeight>0);s=c?i+a.clientHeight>=a.scrollHeight-4:l}}return s&&(e=t),{mangaId:r.manga.id,chapterNumber:r.chapter.number,currentPage:e,totalPages:t}}async function Fe(t=Gs()){var e;if(!(!t||ne.isDemo))try{if(await m.updateReadingProgress(t.mangaId,t.chapterNumber,t.currentPage,t.totalPages),t.currentPage>=t.totalPages&&((e=r.manga)==null?void 0:e.id)===t.mangaId){const s=new Set(r.manga.readChapters||[]);s.add(t.chapterNumber),r.manga.readChapters=[...s]}}catch(s){console.error("Failed to save progress:",s)}}let Be=null;function Ks(){Be&&clearTimeout(Be),Be=setTimeout(()=>{Be=null,Fe()},1500)}function lt(){var s,a,n,i,o,c,l,u,p,g,v,E,x,f,S,$,M,P,q,D;const t=document.getElementById("app");(s=document.getElementById("reader-close-btn"))==null||s.addEventListener("click",async()=>{r.isStreamingMode||(await Fe(),await Se()),r.isStreamingMode?N.go("/scrapers"):r.manga&&r.manga.id!=="gallery"?N.go(`/manga/${r.manga.id}`):N.go("/")}),(a=document.getElementById("reader-back-btn"))==null||a.addEventListener("click",()=>{N.go(r.isStreamingMode?"/scrapers":"/")}),(n=document.getElementById("reader-settings-btn"))==null||n.addEventListener("click",()=>{var I;(I=document.getElementById("reader-settings"))==null||I.classList.toggle("hidden")}),(i=document.getElementById("close-settings-btn"))==null||i.addEventListener("click",()=>{var I;(I=document.getElementById("reader-settings"))==null||I.classList.add("hidden")}),(o=document.getElementById("single-page-btn"))==null||o.addEventListener("click",()=>{if(r.singlePageMode){const I=ee();let w=0;for(let B=0;B<I.length;B++)if(I[B].includes(r.currentPage)){w=B;break}r.singlePageMode=!1,r.currentPage=w}else{const w=ee()[r.currentPage];r.singlePageMode=!0,r.currentPage=w?w[0]:0}localStorage.setItem("reader_single_page",r.singlePageMode?"1":"0"),je()}),(c=document.getElementById("trophy-btn"))==null||c.addEventListener("click",()=>{Rn()}),t.querySelectorAll("[data-mode]").forEach(I=>{I.addEventListener("click",()=>{var Q,F;const w=I.dataset.mode;let B=Mt();if(r.mode=w,localStorage.setItem("reader_mode",r.mode),w==="webtoon")r.currentPage=B;else if(r.singlePageMode)r.currentPage=B;else{const H=ee();let X=0;for(let y=0;y<H.length;y++)if(H[y].includes(B)){X=y;break}r.currentPage=X}(Q=r.manga)!=null&&Q.id&&((F=r.chapter)!=null&&F.number)&&Se(),je(),w==="webtoon"&&setTimeout(()=>{const H=document.getElementById("reader-content");if(H){const X=H.querySelectorAll("img");X[B]&&X[B].scrollIntoView({behavior:"auto",block:"start"})}},100)})}),t.querySelectorAll("[data-direction]").forEach(I=>{I.addEventListener("click",async()=>{var w,B;r.direction=I.dataset.direction,localStorage.setItem("reader_direction",r.direction),(w=r.manga)!=null&&w.id&&((B=r.chapter)!=null&&B.number)&&await Se(),je()})}),(l=document.getElementById("first-page-single"))==null||l.addEventListener("change",async I=>{r.firstPageSingle=I.target.checked,await Se(),Ee()}),(u=document.getElementById("last-page-single"))==null||u.addEventListener("change",async I=>{var w,B;r.lastPageSingle=I.target.checked,await Se(),r.lastPageSingle&&((w=r.manga)!=null&&w.id)&&((B=r.chapter)!=null&&B.number)?await Ys():(r.nextChapterImage=null,r.nextChapterNum=null),Ee()}),(p=document.getElementById("zoom-slider"))==null||p.addEventListener("input",I=>{r.zoom=parseInt(I.target.value);const w=document.getElementById("reader-content");w&&(w.style.zoom=`${r.zoom}%`)});const e=document.getElementById("page-slider");if(e&&(e.addEventListener("input",I=>{const w=parseInt(I.target.value),B=document.getElementById("page-indicator");B&&(r.singlePageMode?B.textContent=`${w+1} / ${r.images.length}`:B.textContent=`${w+1} / ${ee().length}`)}),e.addEventListener("change",I=>{r.currentPage=parseInt(I.target.value),Ee()})),r.mode==="manga"){const I=document.getElementById("reader-content");I==null||I.addEventListener("click",w=>{var H;if(w.target.closest("button, a, .link-overlay"))return;const B=I.getBoundingClientRect(),F=(w.clientX-B.left)/B.width;F<.3?Tt():F>.7?at():(r.showControls=!r.showControls,(H=document.querySelector(".reader"))==null||H.classList.toggle("controls-hidden",!r.showControls))})}document.addEventListener("keydown",Xs),(g=document.getElementById("prev-chapter-btn"))==null||g.addEventListener("click",()=>ct(-1)),(v=document.getElementById("next-chapter-btn"))==null||v.addEventListener("click",()=>ct(1)),r.mode==="webtoon"&&((E=document.getElementById("reader-content"))==null||E.addEventListener("click",()=>{var I;r.showControls=!r.showControls,(I=document.querySelector(".reader"))==null||I.classList.toggle("controls-hidden",!r.showControls)}),(x=document.getElementById("reader-content"))==null||x.addEventListener("scroll",Ks,{passive:!0})),(f=document.getElementById("rotate-btn"))==null||f.addEventListener("click",async()=>{const I=bt();if(!(!I||!r.manga||!r.chapter))try{d("Rotating...","info");const w=await m.rotatePage(r.manga.id,r.chapter.number,I,90,r.versionUrl);w.images&&(await wt(w.images),d("Page rotated","success"))}catch(w){d("Rotate failed: "+w.message,"error")}}),(S=document.getElementById("swap-btn"))==null||S.addEventListener("click",async()=>{const w=ee()[r.currentPage];if(!w||w.length!==2||!r.manga||!r.chapter){d("Select a spread with 2 pages to swap","info");return}const B=We(r.images[w[0]]),Q=We(r.images[w[1]]);if(!(!B||!Q))try{d("Swapping...","info");const F=await m.swapPages(r.manga.id,r.chapter.number,B,Q,r.versionUrl);F.images&&(await wt(F.images),d("Pages swapped","success"))}catch(F){d("Swap failed: "+F.message,"error")}}),($=document.getElementById("split-btn"))==null||$.addEventListener("click",async()=>{const I=bt();if(!I||!r.manga||!r.chapter||!confirm("Split this page into halves? This is permanent."))return;const w=document.getElementById("split-btn");try{d("Preparing to split...","info"),w&&(w.disabled=!0),r.images=[],r.loading=!0,t.innerHTML=Ae(),await new Promise(Q=>setTimeout(Q,2e3)),d("Splitting page...","info");const B=await m.splitPage(r.manga.id,r.chapter.number,I,r.versionUrl);w&&(w.disabled=!1),await Le(r.manga.id,r.chapter.number,r.versionUrl),t.innerHTML=Ae(),lt(),Ee(),B.warning?d(B.warning,"warning"):d("Page split into halves","success")}catch(B){w&&(w.disabled=!1),d("Split failed: "+B.message,"error"),await Le(r.manga.id,r.chapter.number,r.versionUrl),t.innerHTML=Ae(),lt()}}),(M=document.getElementById("delete-page-btn"))==null||M.addEventListener("click",async()=>{const I=bt();if(!(!I||!r.manga||!r.chapter)&&confirm(`Delete page "${I}" permanently? This cannot be undone.`))try{d("Deleting...","info");const w=await m.deletePage(r.manga.id,r.chapter.number,I,r.versionUrl);w.images&&(await wt(w.images),d("Page deleted","success"))}catch(w){d("Delete failed: "+w.message,"error")}}),(P=document.getElementById("favorites-btn"))==null||P.addEventListener("click",async()=>{try{const B=await m.getFavorites();r.allFavorites=B,r.favoriteLists=Object.keys(B.favorites||B||{})}catch(B){console.error("Failed to load favorites",B),d("Failed to load favorites","error");return}let w=[Mt()];if(r.mode==="manga"&&!r.singlePageMode){const Q=ee()[r.currentPage];Q&&Array.isArray(Q)?w=Q:Q&&Q.pages&&(w=Q.pages)}if(w.length>1){const B=await Js(w,"Select Page for Favorites");if(!B)return;w=B.pages}Nn(w)}),(q=document.getElementById("fullscreen-btn"))==null||q.addEventListener("click",()=>{document.fullscreenElement?document.exitFullscreen():document.documentElement.requestFullscreen().catch(()=>{d("Fullscreen not supported","info")})}),(D=document.getElementById("stream-add-lib-btn"))==null||D.addEventListener("click",async()=>{var B;const I=document.getElementById("stream-add-lib-btn");if(!((B=r.manga)!=null&&B._streamUrl)){d("No URL to add","error");return}const w=I.innerHTML;I.innerHTML=h("loader",{spin:!0}),I.disabled=!0;try{const Q=await m.addBookmark(r.manga._streamUrl);if(!Q.jobId)throw new Error("No job ID returned");d("Adding to library...","info");const F=setInterval(async()=>{var H;try{const y=(await m.getQueueHistory(20)).find(L=>L.id===Q.jobId);y&&(y.status==="completed"?(clearInterval(F),(H=y.result)!=null&&H.bookmark&&(d("Added to library!","success"),I.innerHTML=h("check"),I.title="Added! Click to view",I.disabled=!1,I.onclick=()=>{N.go(`/manga/${y.result.bookmark.id}`)})):y.status==="failed"&&(clearInterval(F),d("Failed to add: "+(y.error||"Unknown error"),"error"),I.innerHTML=w,I.disabled=!1))}catch{}},1500)}catch(Q){d("Failed to add: "+Q.message,"error"),I.innerHTML=w,I.disabled=!1}}),document.body.classList.add("reader-active")}function We(t){var n;const e=typeof t=="string"?t:(t==null?void 0:t.url)||((n=t==null?void 0:t.urls)==null?void 0:n[0]);if(!e)return null;const a=e.split("?")[0].split("/");return decodeURIComponent(a[a.length-1])}function bt(){const t=Xt();return t.length===0?null:We(r.images[t[0]])}async function wt(t){var s,a;(s=r.manga)!=null&&s.id&&((a=r.chapter)!=null&&a.number)&&!r.isStreamingMode&&Mn.refreshOfflineChapter(r.manga.id,r.chapter.number).then(n=>{n&&console.log("[Reader] Refreshed offline copy after page edit")}).catch(n=>console.warn("[Reader] Offline refresh failed:",n));const e=Date.now();if(r.images=t.map(n=>{const i=typeof n=="string"?n:n==null?void 0:n.url;if(!i)return n;const o=i+(i.includes("?")?"&":"?")+`_t=${e}`;return typeof n=="string"?o:{...n,url:o}}),r.mode==="manga")if(r.singlePageMode)r.currentPage=Math.min(r.currentPage,r.images.length-1);else{const n=ee();r.currentPage=Math.min(r.currentPage,n.length-1)}r.currentPage=Math.max(0,r.currentPage),Ee()}async function Ys(){var t,e;if(!(!((t=r.manga)!=null&&t.id)||!((e=r.chapter)!=null&&e.number)))try{const s=await m.getNextChapterPreview(r.manga.id,r.chapter.number);r.nextChapterImage=s.firstImage||null,r.nextChapterNum=s.nextChapter||null}catch{r.nextChapterImage=null,r.nextChapterNum=null}}async function qn(){var i,o;if(!((i=r.manga)!=null&&i.id)||!((o=r.chapter)!=null&&o.number)||r.isCollectionMode)return;const e=[...r.manga.downloadedChapters||[]].sort((c,l)=>c-l),s=e.indexOf(r.chapter.number);if(s<0||s>=e.length-1)return;const a=e[s+1],n=r.manga.id;if(!(r._preloadCache&&r._preloadCache.chapterNum===a&&r._preloadCache.mangaId===n))try{const l=(r.manga.downloadedVersions||{})[a]||[],u=Array.isArray(l)?l[0]:l,p=u?`/bookmarks/${n}/chapters/${a}/reader-images?version=${encodeURIComponent(u)}`:`/bookmarks/${n}/chapters/${a}/reader-images`,v=(await m.get(p)).images||[];if(v.length===0)return;const E=v.map(x=>{const f=new Image,S=typeof x=="string"?x:x.url;return S&&(f.src=S),f});r._preloadCache={chapterNum:a,mangaId:n,images:v,imageObjects:E,versionUrl:u},console.log(`[Reader] Preloaded ${v.length} images for chapter ${a}`)}catch(c){console.warn("[Reader] Failed to preload next chapter:",c)}}function Dn(t,e,s=r.manga,a=[]){return new Promise(n=>{const i=document.createElement("div");i.className="version-modal-overlay",i.innerHTML=`
        ...
        `;const o=i.querySelector(".version-list");t.forEach((c,l)=>{const u=document.createElement("button");u.className="version-item";const p=Os(c,s)||`Version ${l+1}`,g=a.find(E=>E.url===c),v=[];g!=null&&g.imageCount&&v.push(`${g.imageCount} pages`),g!=null&&g.folder&&v.push(g.folder),u.innerHTML=`<span class="version-item-title"></span>${v.length?'<span class="version-item-meta"></span>':""}`,u.querySelector(".version-item-title").textContent=p,v.length&&(u.querySelector(".version-item-meta").textContent=v.join(" · ")),u.title=c,u.addEventListener("click",()=>{i.remove(),n(c)}),o.appendChild(u)}),i.querySelector(".version-cancel").addEventListener("click",()=>{i.remove(),n(null)}),i.addEventListener("click",c=>{c.target===i&&(i.remove(),n(null))}),document.body.appendChild(i)})}function Nn(t){if(!r.manga||!r.chapter)return;const e=t.map(l=>{const u=We(r.images[l]);return u?{filename:u}:null}).filter(Boolean),s=l=>{if(!r.allFavorites||!r.allFavorites.favorites)return-1;const u=r.allFavorites.favorites[l];if(!Array.isArray(u))return-1;for(let p=0;p<u.length;p++){const g=u[p];if(g.mangaId===r.manga.id&&g.chapterNum===r.chapter.number&&g.imagePaths)for(const v of g.imagePaths){const E=typeof v=="string"?v:(v==null?void 0:v.filename)||(v==null?void 0:v.path);for(const x of e)if(x&&x.filename===E)return p}}return-1},a=document.createElement("div");a.className="page-picker-overlay";let n="";r.favoriteLists.length===0?n='<div style="margin: 20px 0; color: #888;">No favorite lists available.</div>':(n='<div class="favorite-list-selection" style="display: flex; flex-direction: column; gap: 10px; margin-bottom: 20px; max-height: 400px; overflow-y: auto;">',r.favoriteLists.forEach(l=>{const p=s(l)!==-1;n+=`
    ...
    `,a.appendChild(i),a.querySelector(".page-picker-cancel").addEventListener("click",()=>{a.remove(),At()}),a.addEventListener("click",l=>{l.target===a&&(a.remove(),At())}),a.querySelectorAll(".list-option").forEach(l=>{l.addEventListener("click",async()=>{const u=l.dataset.list,p=s(u),g=p!==-1;l.style.opacity="0.5",l.style.pointerEvents="none";try{if(g){await m.removeFavoriteItem(u,p);const v=await m.getFavorites();r.allFavorites=v,l.classList.remove("active-list"),l.querySelector("span:last-child").innerHTML=h("plus")}else{const v=t.length>1?"double":"single",E={mangaId:r.manga.id,chapterNum:r.chapter.number,title:`${r.manga.alias||r.manga.title} Ch.${r.chapter.number} p${t[0]+1}`,imagePaths:e,displayMode:v,displaySide:r.direction==="rtl"?"right":"left"};await m.addFavoriteItem(u,E);const x=await m.getFavorites();r.allFavorites=x,l.classList.add("active-list"),l.querySelector("span:last-child").innerHTML=h("check")}}catch(v){console.error(v)}finally{l.style.opacity="1",l.style.pointerEvents="auto"}})}),document.body.appendChild(a)}function Js(t,e){return new Promise(s=>{const[a,n]=t,i=r.images[a],o=r.images[n],c=typeof i=="string"?i:i==null?void 0:i.url,l=typeof o=="string"?o:o==null?void 0:o.url,u=r.direction==="rtl",p=u?n:a,g=u?a:n,v=u?l:c,E=u?c:l,x=document.createElement("div");x.className="page-picker-overlay",x.innerHTML=`
        ...
        `;const f=S=>{x.remove(),s(S)};x.querySelectorAll(".page-picker-option").forEach(S=>{S.addEventListener("click",()=>{const $=S.dataset.choice;$==="left"?f({pages:[p]}):$==="right"?f({pages:[g]}):$==="both"&&f({pages:t})})}),x.querySelector(".page-picker-cancel").addEventListener("click",()=>f(null)),x.addEventListener("click",S=>{S.target===x&&f(null)}),document.body.appendChild(x)})}function Mt(){if(r.mode==="webtoon"){const t=document.getElementById("reader-content");if(t){const e=t.querySelectorAll("img");if(e.length>0){const s=t.scrollTop;if(s>10){let a=0;for(let n=0;n<e.length;n++){const i=e[n].offsetHeight;if(a+i>s)return n;a+=i}}}}return 0}else{if(r.singlePageMode)return r.currentPage;{const e=ee()[r.currentPage];return e&&e.length>0?e[0]:0}}}function Xs(t){var e;if(!(t.target.tagName==="INPUT"||t.target.tagName==="TEXTAREA")){if(t.key==="Escape"){const s=(e=r.manga)==null?void 0:e.id;Promise.all([Fe(),Se()]).finally(()=>{s&&N.go(`/manga/${s}`)});return}if(r.mode==="manga")t.key==="ArrowLeft"?r.direction==="rtl"?at():Tt():t.key==="ArrowRight"?r.direction==="rtl"?Tt():at():t.key===" "&&(t.preventDefault(),at());else if(r.mode==="webtoon"&&t.key===" "){t.preventDefault();const s=document.getElementById("reader-content");if(s){const a=s.clientHeight*.8;s.scrollBy({top:t.shiftKey?-a:a,behavior:"smooth"})}}}}function at(){const t=ee(),e=r.singlePageMode?r.images.length-1:t.length-1;if(r.currentPage<e)r.currentPage++,Ee();else{const s=t[r.currentPage],a=s&&s.type==="link";Fe(),a&&(r.navigationDirection="next-linked"),ct(1)}}function Tt(){r.currentPage>0?(r.currentPage--,Ee()):ct(-1)}function Ee(){const t=document.getElementById("reader-content");if(t){t.innerHTML=r.isCollectionMode?Hs():r.mode==="webtoon"?zs():js();const e=document.getElementById("page-indicator");e&&(r.singlePageMode?e.textContent=`${r.currentPage+1} / ${r.images.length}`:e.textContent=`${r.currentPage+1} / ${ee().length}`);const s=document.getElementById("page-slider");s&&(s.value=r.currentPage,s.max=r.singlePageMode?r.images.length-1:ee().length-1),Ws(),At(),r.mode==="manga"&&Ks()}}function je(){const t=document.getElementById("app");t&&(t.innerHTML=Ae(),lt())}async function ct(t){if(console.log("[Nav] navigateChapter called with delta:",t),r.isStreamingMode)return;if(!r.manga||!r.chapter){console.log("[Nav] early return - no manga or chapter");return}await Fe(),await Se();const s=[...r.manga.downloadedChapters||[]].sort((i,o)=>i-o),a=s.indexOf(r.chapter.number),n=a+t;if(console.log("[Nav]",{delta:t,chapterNumber:r.chapter.number,sorted:s,currentIdx:a,newIdx:n}),n>=0&&n<s.length){r.navigationDirection||(r.navigationDirection=t<0?"prev":null);const i=s[n],c=(r.manga.downloadedVersions||{})[i]||[],l=Array.isArray(c)?c[0]:c,u=l?`?version=${encodeURIComponent(l)}`:"";console.log("[Nav] Calling router.go with:",`/read/${r.manga.id}/${i}${u}`),N.go(`/read/${r.manga.id}/${i}${u}`)}else d(t>0?"Last chapter":"First chapter","info")}async function Le(t,e,s){var a,n,i,o,c;console.log("[Reader] loadData called:",{mangaId:t,chapterNum:e,versionUrl:s});try{if(r.mode=localStorage.getItem("reader_mode")||"manga",r.direction=localStorage.getItem("reader_direction")||"rtl",r.singlePageMode=localStorage.getItem("reader_single_page")!=="0",r.firstPageSingle=!0,r.lastPageSingle=!1,r.versionUrl=null,t==="gallery"){const l=decodeURIComponent(e),p=((a=(await m.getFavorites()).favorites)==null?void 0:a[l])||[];r.images=[];for(const g of p){const v=g.imagePaths||[],E=[];for(const x of v){let f;typeof x=="string"?f=x:x&&typeof x=="object"&&(f=x.filename||x.path||x.name||x.url,f&&f.includes("/")&&(f=f.split("/").pop()),f&&f.includes("\\")&&(f=f.split("\\").pop())),f&&E.push(`/api/public/chapter-images/${g.mangaId}/${g.chapterNum}/${encodeURIComponent(f)}`)}E.length>0&&r.images.push({urls:E,displayMode:g.displayMode||"single",displaySide:g.displaySide||"left"})}r.manga={id:"gallery",title:l,alias:l},r.chapter={number:"Gallery"},r.isGalleryMode=!0,r.isCollectionMode=!0,r.images.length===0&&d("Gallery is empty","warning")}else if(t==="trophies"){const l=e;let u=[],p="Trophies";if(l.startsWith("series-")){const g=l.replace("series-",""),E=(await store.loadSeries()).find(S=>S.id===g);p=E?E.alias||E.title:"Series Trophies";const f=(await store.loadBookmarks()).filter(S=>S.seriesId===g);for(const S of f){const $=await m.getTrophyPagesAll(S.id);for(const M in $)for(const P in $[M]){const q=$[M][P],I=(await m.getChapterImages(S.id,M)).images[P],w=typeof I=="string"?I.split("/").pop():(I==null?void 0:I.filename)||(I==null?void 0:I.path);u.push({mangaId:S.id,chapterNum:M,imagePaths:[{filename:w}],displayMode:q.isSingle?"single":"double",displaySide:"left"})}}}else{const g=await m.getBookmark(l);p=g?g.alias||g.title:"Manga Trophies";const v=await m.getTrophyPagesAll(l);for(const E in v)for(const x in v[E]){const f=v[E][x],$=(await m.getChapterImages(l,E)).images[x],M=typeof $=="string"?$.split("/").pop():($==null?void 0:$.filename)||($==null?void 0:$.path);u.push({mangaId:l,chapterNum:E,imagePaths:[{filename:decodeURIComponent(M)}],displayMode:f.isSingle?"single":"double",displaySide:"left"})}}r.images=u.map(g=>{const v=g.imagePaths[0].filename;return{urls:[`/api/public/chapter-images/${g.mangaId}/${g.chapterNum}/${encodeURIComponent(v)}`],displayMode:g.displayMode,displaySide:g.displaySide}}),r.manga={id:"trophies",title:p,alias:p},r.chapter={number:"🏆"},r.isCollectionMode=!0,r.isGalleryMode=!1}else if(t==="stream"){r.isStreamingMode=!0,r.isCollectionMode=!1,r.isGalleryMode=!1,r.singlePageMode=!0;const l=sessionStorage.getItem("streamPreviewUrl"),u=sessionStorage.getItem("streamPreviewScraper"),p=sessionStorage.getItem("streamPreviewTitle")||"Preview";r.manga={id:"stream",title:p,alias:p,_streamUrl:l},r.chapter={number:1},r.images=[],l?Fn(l,u):d("No stream URL found","error")}else{r.isGalleryMode=!1;const l=await m.getBookmark(t);r.manga=l,console.log("[Reader] manga loaded, finding chapter..."),r.chapter=((n=l.chapters)==null?void 0:n.find(p=>p.number===parseFloat(e)))||{number:parseFloat(e)};const u=parseFloat(e);if(r._preloadCache&&r._preloadCache.mangaId===t&&r._preloadCache.chapterNum===u)console.log("[Reader] Using preloaded images for chapter",e),r.images=r._preloadCache.images||[],r.versionUrl=s||r._preloadCache.versionUrl||null,r._preloadCache=null;else{r.versionUrl=s||null;const p=s?`/bookmarks/${t}/chapters/${e}/reader-images?version=${encodeURIComponent(s)}`:`/bookmarks/${t}/chapters/${e}/reader-images`,g=await m.get(p);console.log("[Reader] images loaded, count:",(i=g.images)==null?void 0:i.length),r.images=g.images||[]}try{const p=await m.getChapterSettings(t,e);if(gs(p))fs(p);else try{const v=[...r.manga.downloadedChapters||[]].sort(($,M)=>$-M),E=parseFloat(e),x=v.indexOf(E),f=[];if(x!==-1){for(let $=x-1;$>=0;$--)f.push(v[$]);for(let $=x+1;$<v.length;$++)f.push(v[$])}const S=12;for(const $ of f.slice(0,S)){const M=await m.getChapterSettings(t,$);if(gs(M)){fs(M),console.log("[Reader] Inherited settings from chapter",$);break}}}catch(g){console.warn("Failed to inherit chapter settings",g)}}catch(p){console.warn("Failed to load chapter settings",p)}try{const p=await m.getTrophyPages(t,e);r.trophyPages=p||{}}catch(p){console.warn("Failed to load trophy pages",p)}try{const p=await m.getFavorites();r.allFavorites=p,r.favoriteLists=Object.keys(p.favorites||p||{})}catch(p){console.warn("Failed to load favorites",p)}}if(r.isStreamingMode)r.currentPage=0;else{const l=parseFloat(e),u=(c=(o=r.manga)==null?void 0:o.readingProgress)==null?void 0:c[l];if(u&&u.page<u.totalPages)if(r.mode==="manga")if(r.singlePageMode)r.currentPage=Math.max(0,u.page-1);else{const p=Math.max(0,u.page-1),g=ee();let v=0;for(let E=0;E<g.length;E++){const x=g[E],f=Array.isArray(x)?x:x.pages||[];if(f.includes(p)||f[0]>=p){v=E;break}v=E}r.currentPage=v}else r.currentPage=0,r._resumeScrollToPage=u.page-1;else r.currentPage=0}}catch(l){console.error("Error loading chapter:",l),d("Failed to load chapter","error")}if(!r.isStreamingMode){if(r.navigationDirection==="prev"&&r.mode==="manga")if(r.singlePageMode)r.currentPage=Math.max(0,r.images.length-1);else{const l=ee();r.currentPage=Math.max(0,l.length-1)}else if(r.navigationDirection==="next-linked"&&r.mode==="manga"&&r.images.length>1)if(r.singlePageMode)r.currentPage=1;else{const l=ee();let u=0;for(let p=0;p<l.length;p++){const g=l[p];if((Array.isArray(g)?g:g.pages||[]).includes(1)){u=p;break}}r.currentPage=u}}r.navigationDirection=null,r.lastPageSingle&&!r.isStreamingMode&&await Ys(),r.loading=!1,je(),r.isStreamingMode||qn(),r.mode==="webtoon"&&r._resumeScrollToPage&&setTimeout(()=>{const l=document.getElementById("reader-content");if(l){const u=l.querySelectorAll("img");u[r._resumeScrollToPage]&&u[r._resumeScrollToPage].scrollIntoView({behavior:"auto",block:"start"})}delete r._resumeScrollToPage},300)}async function Fn(t,e){r._streamAbortController&&r._streamAbortController.abort(),r._streamAbortController=new AbortController;const{signal:s}=r._streamAbortController;try{let a="/api/scrapers/preview-images-stream?";e&&(a+=`scraper=${encodeURIComponent(e)}&`),a+=`url=${encodeURIComponent(t)}`;const n=localStorage.getItem("manga_auth_token"),i={};n&&(i.Authorization=`Bearer ${n}`),console.log("[Reader] Starting stream from:",a);const o=await fetch(a,{headers:i,signal:s});if(!o.ok)throw new Error(`Failed to start stream: ${o.statusText}`);const c=o.body.getReader(),l=new TextDecoder;let u="";for(;;){const{value:p,done:g}=await c.read();if(g||s.aborted)break;u+=l.decode(p,{stream:!0});const v=u.split(`

`);u=v.pop();let E=!1;for(const x of v)if(x.startsWith("data: ")){const f=x.substring(6);try{const S=JSON.parse(f);if(S.type==="metadata")r.manga.title=S.title,r.manga.alias=S.title,je();else if(S.type==="image"){const $=`/api/scrapers/proxy-cover?url=${encodeURIComponent(S.url)}`;r.images.push($),E=!0}else if(S.type==="error")d("Stream error: "+S.message,"error");else if(S.type==="done")break}catch(S){console.error("Parse error for SSE data:",S)}}E&&Ee()}}catch(a){a.name!=="AbortError"&&(console.error("Preview stream error:",a),d("Stream failed: "+a.message,"error"))}finally{r._streamAbortController&&r._streamAbortController.signal===s&&(r._streamAbortController=null)}}async function Un(t=[]){console.log("[Reader] mount called with params:",t);let[e,s]=t,a=null;if(s&&s.includes("?")){const[i,o]=s.split("?");s=i,a=new URLSearchParams(o).get("version")}else{const i=window.location.hash.split("?")[1];i&&(a=new URLSearchParams(i).get("version"))}if(console.log("[Reader] mangaId:",e,"chapterNum:",s,"urlVersion:",a),!e||!s){N.go("/");return}const n=document.getElementById("app");if(r.loading=!0,console.log("[Reader] loading set to true, calling loadData..."),r.images=[],r.singlePageMode=!1,r._resumeScrollToPage=null,r.nextChapterImage=null,r.nextChapterNum=null,n.innerHTML=Ae(),a)await Le(e,s,decodeURIComponent(a));else try{const i=await m.getBookmark(e),o=i.downloadedVersions||{},c=new Set(i.deletedChapterUrls||[]),l=o[parseFloat(s)];let u=[];if(Array.isArray(l)&&(u=l.filter(p=>!c.has(p))),u.length>1){let p=[];try{p=(await m.getChapterVersions(e,s)).versions||[]}catch{}const g=await Dn(u,s,i,p);if(g===null){N.go(`/manga/${e}`);return}await Le(e,s,g)}else u.length===1?await Le(e,s,u[0]):await Le(e,s)}catch(i){console.log("[Reader] Error in version check, falling back:",i),await Le(e,s)}if(n.innerHTML=Ae(),console.log("[Reader] render called, loading:",r.loading,"manga:",!!r.manga,"images:",r.images.length),lt(),r.mode==="webtoon"&&r._resumeScrollToPage!=null){const i=r._resumeScrollToPage;r._resumeScrollToPage=null,setTimeout(()=>{const o=document.getElementById("reader-content");if(o){const c=o.querySelectorAll("img");c[i]&&c[i].scrollIntoView({behavior:"auto",block:"start"})}},300)}}async function On(){console.log("[Reader] unmount called"),r._streamAbortController&&(r._streamAbortController.abort(),r._streamAbortController=null),Be&&(clearTimeout(Be),Be=null);const t=Gs(),e=Zs();document.body.classList.remove("reader-active"),document.removeEventListener("keydown",Xs),r.manga=null,r.chapter=null,r.versionUrl=null,r.images=[],r.loading=!0,r.singlePageMode=!1,r.isStreamingMode=!1,r._resumeScrollToPage=null,r._preloadCache=null,await Fe(t),await Se(e)}function gs(t){return!!t&&(t.mode!==void 0||t.direction!==void 0||t.firstPageSingle!==void 0||t.lastPageSingle!==void 0)}function fs(t){t&&(t.mode&&(r.mode=t.mode),t.direction&&(r.direction=t.direction),t.firstPageSingle!==void 0&&(r.firstPageSingle=t.firstPageSingle),t.lastPageSingle!==void 0&&(r.lastPageSingle=t.lastPageSingle))}function Zs(){return!r.manga||!r.chapter||r.isCollectionMode||r.isStreamingMode?null:{mangaId:r.manga.id,chapterNumber:r.chapter.number,settings:{mode:r.mode,direction:r.direction,firstPageSingle:r.firstPageSingle,lastPageSingle:r.lastPageSingle}}}async function Se(t=Zs()){if(!(!t||ne.isDemo))try{await m.updateChapterSettings(t.mangaId,t.chapterNumber,t.settings)}catch(e){console.error("Failed to save settings:",e)}}async function ea(t){try{const e=await m.getBookmark(t),s=e.downloadedChapters||[],a=new Set(e.readChapters||[]),n=e.readingProgress||{},i=e.downloadedVersions||{},o=[...s].sort((l,u)=>l-u);let c=null;for(const l of o){const u=n[l];if(u&&u.page<u.totalPages&&!a.has(l)){c=l;break}}if(c===null){for(const l of o)if(!a.has(l)){c=l;break}}if(c===null&&o.length>0&&(c=o[0]),c!==null){const l=i[c]||[],u=Array.isArray(l)?l[0]:l,p=u?`?version=${encodeURIComponent(u)}`:"";N.go(`/read/${t}/${c}${p}`)}else d("No downloaded chapters to read","info")}catch(e){d("Failed to continue reading: "+e.message,"error")}}const Vn={mount:Un,unmount:On,render:Ae,continueReading:ea},Qe=50;let b={manga:null,categories:[],currentPage:0,filter:"all",loading:!0,selectionMode:!1,selected:new Set,activeVolume:null,activeVolumeId:null,cbzFiles:[],manageChapters:!1,offlineChapters:new Set,isAutoOffline:!1,volumesCollapsed:!1};const ta=t=>`volumes_collapsed_${t}`;function Hn(t){var s;const e=localStorage.getItem(ta(t==null?void 0:t.id));return e!==null?e==="1":(((s=t==null?void 0:t.volumes)==null?void 0:s.length)||0)>8}function zn(t){if(!(t.autoCheck===!0))return`<button class="btn btn-secondary" id="schedule-btn">${h("alarm-clock")} Schedule</button>`;const s=t.checkSchedule==="weekly"?`${(t.checkDay||"monday").charAt(0).toUpperCase()+(t.checkDay||"monday").slice(1)} ${t.checkTime||"06:00"}`:t.checkSchedule==="daily"?`Daily ${t.checkTime||"06:00"}`:"Every 6h";return`<button class="btn btn-primary" id="schedule-btn">${h("alarm-clock")} ${s}</button>`}function jn(t){const e=t.autoCheck===!0,s=t.checkSchedule||"daily",a=t.checkDay||"monday",n=t.checkTime||"06:00",i=t.autoDownload||!1;return`
  ...
  `}function Pt(){var I;if(b.loading)return`
    ...
    ${D}
        ...
        ${b.activeVolume?b.manageChapters?er(t,g):"":tr(t,a)}
  ...
  `:""}async function dt(){var s,a;const t=document.getElementById("anilist-track-btn"),e=b.manga;if(e)try{const n=await m.anilistStatus();if(!(n!=null&&n.configured)||!(n!=null&&n.connected)||((s=b.manga)==null?void 0:s.id)!==e.id){t&&(t.style.display="none");return}const{mapping:i}=await m.anilistGetMapping(e.id);if(((a=b.manga)==null?void 0:a.id)!==e.id)return;t&&(t.style.display="",t.style.borderColor=i?"var(--accent-primary)":"",t.innerHTML=i?`${h("check")} Tracked`:`${h("link")} Track`,t.title=i?`Linked to ${i.anilist_title}`:"Link this manga to AniList"),Kn(i,e)}catch(n){console.warn("Failed to load AniList state:",n),t&&(t.style.display="none")}}function Kn(t,e){var n,i,o;const s=document.getElementById("anilist-tracked-view"),a=document.getElementById("anilist-search-view");if(!(!s||!a)){if(!t){s.style.display="none",s.innerHTML="",a.style.display="";return}a.style.display="none",s.style.display="",s.innerHTML=`
  ...
  `}function Jn(t,e,s,a,n){var I,w,B,Q;const i=s.has(t),o=a.has(t),c=!Number.isInteger(t),l=((I=n.downloadedVersions)==null?void 0:I[t])||[],u=new Set(n.deletedChapterUrls||[]),p=e.filter(F=>b.filter==="hidden"?!0:!u.has(F.url)),g=!!b.activeVolume,v=n.chapterSettings||{},E=g?!0:!!((w=v[t])!=null&&w.locked);let x=p;if(g||E){const F=p.filter(H=>Array.isArray(l)?l.includes(H.url):l===H.url);x=F.length>0?F:p}x.sort((F,H)=>{const X=Array.isArray(l)?l.includes(F.url):l===F.url;return((Array.isArray(l)?l.includes(H.url):l===H.url)?1:0)-(X?1:0)});const f=x.length>1,S=(B=x[0])!=null&&B.url?encodeURIComponent(x[0].url):null,$=["chapter-item",i?"downloaded":"",o?"read":"",c?"extra":""].filter(Boolean).join(" "),M=Array.isArray(l)?l:l?[l]:[],P=M.length,q=f?`
    <div class="versions-dropdown hidden" id="versions-${t}">
      ${x.map(F=>{const H=encodeURIComponent(F.url),X=M.includes(F.url),y=F.url.startsWith("local://"),L=F.title&&F.title!==`Chapter ${t}`?F.title:"",T=L||F.releaseGroup||"Version",k=[L&&F.releaseGroup?F.releaseGroup:"",Xn(F.uploadedAt)].filter(Boolean).join(" · ");return`
          <div class="version-row ${X?"downloaded":""}"
               data-version-url="${H}" data-num="${t}">
            <span class="version-title" style="cursor: pointer; flex: 1;" title="${Zn(F.url)}">${Rt(T)}${y?' <span class="badge badge-local" style="background: var(--color-info, #2196f3); color: white; font-size: 0.65em; padding: 1px 5px; border-radius: 3px; margin-left: 6px; vertical-align: middle;">Local</span>':""}${k?`<span class="version-meta">${Rt(k)}</span>`:""}${X?`<span class="version-meta version-pages" data-url="${H}"></span>`:""}</span>
            <div class="version-actions">
              ${X?`<button class="btn-icon small success" data-action="read-version" data-num="${t}" data-url="${H}">${h("play",{title:"Read"})}</button>
                   ${P>1?`<button class="btn-icon small" data-action="keep-version" data-num="${t}" data-url="${H}" title="Keep only this version (delete the other ${P-1})">${h("check",{title:"Keep only this version"})}</button>`:""}
                   <button class="btn-icon small danger" data-action="delete-version" data-num="${t}" data-url="${H}">${h("trash-2",{title:"Delete version"})}</button>`:`<button class="btn-icon small" data-action="download-version" data-num="${t}" data-url="${H}">${h("download",{title:"Download"})}</button>`}
              ${u.has(F.url)?`<button class="btn-icon small warning" data-action="restore-version" data-num="${t}" data-url="${H}" title="Restore Version">${h("undo-2",{title:"Restore version"})}</button>`:`<button class="btn-icon small" data-action="hide-version" data-num="${t}" data-url="${H}" title="Hide Version">${h("eye-off",{title:"Hide version"})}</button>`}
            </div>
          </div>
        `}).join("")}
    </div>
    ...
    <div class="chapter-group" data-chapter="${t}">
      <div class="${$}" data-num="${t}" style="${D?"opacity: 0.7":""}">
        ...
        <div class="chapter-actions">
          ...
          ${i?`<button class="btn-icon small danger" data-action="delete-chapter" data-num="${t}" data-url="${S}" title="Delete Files">${h("trash-2",{title:"Delete files"})}</button>
  ...
  `}function er(t,e){return e.length===0?`
  ...
  `}function tr(t,e){var o;const s=t.volumes||[];if(s.length===0)return"";const a=s.map(c=>{const l=c.chapters||[],u=l.filter(p=>e.has(p)).length;return`
    ...
    `}).join(""),n=b.volumesCollapsed,i=s.reduce((c,l)=>c+(l.chapters||[]).filter(u=>e.has(u)).length,0);return`
      ...
      `,document.body.appendChild(L),document.getElementById("close-cover-modal").addEventListener("click",()=>L.remove()),L.addEventListener("click",T=>{T.target===L&&L.remove()}),L.querySelectorAll(".cover-option").forEach(T=>{T.addEventListener("click",()=>{window._selectedCoverPath=T.dataset.path;const k=document.getElementById("cover-preview");k&&(k.innerHTML=`<img src="/api/proxy-image?path=${encodeURIComponent(window._selectedCoverPath)}" style="width:100%;height:100%;object-fit:cover;">`),L.remove(),d("Cover selected","success")})})}catch(y){d("Failed to load images: "+y.message,"error")}}),(P=document.getElementById("delete-manga-btn"))==null||P.addEventListener("click",()=>{const y=document.getElementById("delete-manga-modal");y&&y.classList.add("open")}),(q=document.getElementById("confirm-delete-manga-btn"))==null||q.addEventListener("click",async()=>{var L,T;const y=((L=document.getElementById("delete-files-toggle"))==null?void 0:L.checked)||!1;try{await m.deleteBookmark(e.id,y),(T=document.getElementById("delete-manga-modal"))==null||T.classList.remove("open"),d("Manga deleted","success"),N.go("/")}catch(k){d("Failed to delete: "+k.message,"error")}}),(D=document.getElementById("quick-check-btn"))==null||D.addEventListener("click",async()=>{const y=document.getElementById("quick-check-btn");try{y.disabled=!0,y.innerHTML=`${h("loader",{spin:!0})} Checking...`,d("Quick checking for updates...","info");const L=await m.post(`/bookmarks/${e.id}/quick-check`);await Y(e.id),j([e.id]),L.newChaptersCount>0?d(`Found ${L.newChaptersCount} new chapter(s)!`,"success"):d("No new chapters found","info")}catch(L){d("Quick check failed: "+L.message,"error")}finally{y&&(y.disabled=!1,y.innerHTML=`${h("zap")} Quick Check`)}}),(I=document.getElementById("source-label"))==null||I.addEventListener("click",async()=>{const y=document.getElementById("migrate-source-modal");if(y){y.classList.add("open");const L=document.getElementById("migrate-search-scraper");if(L&&L.options.length<=1)try{const T=await m.get("/scrapers/list");if(T.success){const k=T.scrapers.filter(_=>_.supportsSearch);L.innerHTML='<option value="all">All Sources</option>'+k.map(_=>`<option value="${_.name}">${_.name}</option>`).join(""),L.value="all"}}catch(T){console.warn("Failed to load scrapers:",T)}}});const s=async()=>{var R,U,G;const y=(U=(R=document.getElementById("migrate-search-input"))==null?void 0:R.value)==null?void 0:U.trim(),L=(G=document.getElementById("migrate-search-scraper"))==null?void 0:G.value;if(!y)return;const T=document.getElementById("migrate-search-loading"),k=document.getElementById("migrate-search-results"),_=document.getElementById("migrate-results-grid");T.style.display="block",k.style.display="none";try{const se=(await m.get(`/scrapers/search?q=${encodeURIComponent(y)}&scraper=${encodeURIComponent(L)}`)).results||[];se.length===0?_.innerHTML='<p class="text-muted" style="text-align: center; padding: 20px;">No results found</p>':(_.innerHTML=se.map(W=>{var de;const Z=(de=W.cover)!=null&&de.startsWith("/covers/")?W.cover:W.cover?`/api/scrapers/proxy-cover?url=${encodeURIComponent(W.cover)}`:"";return`
            <div class="manga-card migrate-result-card" data-url="${W.url}" style="cursor: pointer; font-size: 0.85em;">
              <div class="manga-card-cover" style="height: 150px;">
                ${Z?Ce(Z,"Cover",{kind:"series",self:!0}):ce("series")}
          ...
          `}).join(""),_.querySelectorAll(".migrate-result-card").forEach(W=>{W.addEventListener("click",()=>{var de;const Z=W.dataset.url;document.getElementById("migrate-url-input").value=Z,_.querySelectorAll(".migrate-result-card").forEach(Pe=>Pe.style.outline=""),W.style.outline="2px solid var(--color-primary)",d(`Selected: ${(de=W.querySelector(".manga-card-title"))==null?void 0:de.textContent}`,"info")})})),T.style.display="none",k.style.display="block"}catch(V){T.style.display="none",d("Search failed: "+V.message,"error")}};(w=document.getElementById("migrate-search-btn"))==null||w.addEventListener("click",s),(B=document.getElementById("migrate-search-input"))==null||B.addEventListener("keydown",y=>{y.key==="Enter"&&s()}),(Q=document.getElementById("confirm-migrate-btn"))==null||Q.addEventListener("click",async()=>{var T,k,_;const y=(k=(T=document.getElementById("migrate-url-input"))==null?void 0:T.value)==null?void 0:k.trim();if(!y){d("Please enter a URL","warning");return}const L=document.getElementById("confirm-migrate-btn");try{L.disabled=!0,L.textContent="Migrating...",d("Migrating source...","info");const R=await m.migrateSource(e.id,y);d(`Migrated! ${R.migratedChapters} chapters preserved as local`,"success"),d("Running full check on new source...","info"),await m.post(`/bookmarks/${e.id}/check`),(_=document.getElementById("migrate-source-modal"))==null||_.classList.remove("open"),await Y(e.id),j([e.id]),d("Source migration complete!","success")}catch(R){d("Migration failed: "+R.message,"error")}finally{L&&(L.disabled=!1,L.textContent="Migrate Source")}}),(F=document.getElementById("anilist-track-btn"))==null||F.addEventListener("click",()=>{var y;(y=document.getElementById("anilist-modal"))==null||y.classList.add("open"),dt()});const a=async()=>{var _,R;const y=(R=(_=document.getElementById("anilist-search-input"))==null?void 0:_.value)==null?void 0:R.trim();if(!y)return;const L=document.getElementById("anilist-search-loading"),T=document.getElementById("anilist-search-results"),k=document.getElementById("anilist-results-list");L.style.display="block",T.style.display="none";try{const G=(await m.anilistSearch(y)).results||[];G.length===0?k.innerHTML='<p class="text-muted" style="text-align: center; padding: 20px;">No results found</p>':(k.innerHTML=G.map(V=>{var Z,de,Pe,ss,as,ns,rs;const se=((Z=V.title)==null?void 0:Z.romaji)||((de=V.title)==null?void 0:de.english)||((Pe=V.title)==null?void 0:Pe.native)||"Unknown",W=(ss=V.title)!=null&&ss.english&&V.title.english!==se?V.title.english:(as=V.title)!=null&&as.native&&V.title.native!==se?V.title.native:"";return`
            <div style="display: flex; gap: 10px; align-items: center; padding: 8px; border: 1px solid var(--border-color); border-radius: 6px; margin-bottom: 8px;">
              ${(ns=V.coverImage)!=null&&ns.medium?`<img src="${V.coverImage.medium}" alt="" style="width: 48px; height: 68px; object-fit: cover; border-radius: 4px; flex-shrink: 0;">`:""}
              <div style="flex: 1; min-width: 0;">
                <div style="overflow: hidden; text-overflow: ellipsis; white-space: nowrap;" title="${se}"><strong>${se}</strong></div>
                <div class="text-muted" style="font-size: 0.8em;">
                  ${[W,V.format,(rs=V.startDate)==null?void 0:rs.year,`${V.chapters??"?"} ch`].filter(Boolean).join(" • ")}
                </div>
              </div>
              <button class="btn btn-small btn-primary anilist-link-result-btn" data-id="${V.id}" data-title="${se.replace(/"/g,"&quot;")}">Link</button>
            </div>
          `}).join(""),k.querySelectorAll(".anilist-link-result-btn").forEach(V=>{V.addEventListener("click",async()=>{var se,W;try{V.disabled=!0,V.textContent="Linking...";const Z=await m.anilistMap(e.id,Number(V.dataset.id)),de=((se=Z.mapping)==null?void 0:se.anilist_title)||V.dataset.title,Pe=(W=Z.pull)!=null&&W.markedUpTo?` — pulled progress up to ch. ${Z.pull.markedUpTo}`:"";d(`Linked to AniList: ${de}${Pe}`,"success"),dt()}catch(Z){V.disabled=!1,V.textContent="Link",d("Failed to link: "+Z.message,"error")}})})),L.style.display="none",T.style.display="block"}catch(U){L.style.display="none",d("AniList search failed: "+U.message,"error")}};(H=document.getElementById("anilist-search-btn"))==null||H.addEventListener("click",a),(X=document.getElementById("anilist-search-input"))==null||X.addEventListener("keydown",y=>{y.key==="Enter"&&a()}),t.querySelectorAll(".filter-btn").forEach(y=>{y.addEventListener("click",()=>{b.filter=y.dataset.filter,b.currentPage=0,j([e.id])})}),t.querySelectorAll("[data-page]").forEach(y=>{y.addEventListener("click",()=>{const L=y.dataset.page,T=Math.ceil(b.manga.chapters.length/Qe);switch(L){case"first":b.currentPage=0;break;case"prev":b.currentPage=Math.max(0,b.currentPage-1);break;case"next":b.currentPage=Math.min(T-1,b.currentPage+1);break;case"last":b.currentPage=T-1;break}j([e.id])})}),t.querySelectorAll(".chapter-item").forEach(y=>{y.addEventListener("click",L=>{var _;if(L.target.closest(".chapter-actions"))return;const T=parseFloat(y.dataset.num);if((e.downloadedChapters||[]).includes(T)){const R=((_=e.downloadedVersions)==null?void 0:_[T])||[],U=Array.isArray(R)?R[0]:R;U?N.go(`/read/${e.id}/${T}?version=${encodeURIComponent(U)}`):N.go(`/read/${e.id}/${T}`)}else d("Chapter not downloaded","info")})}),t.querySelectorAll("[data-action]").forEach(y=>{y.addEventListener("click",async L=>{L.stopPropagation();const T=y.dataset.action,k=parseFloat(y.dataset.num),_=y.dataset.url?decodeURIComponent(y.dataset.url):null;switch(T){case"lock":await ar(k);break;case"read":await nr(k);break;case"download":await rr(k);break;case"versions":ir(k);break;case"read-version":N.go(`/read/${e.id}/${k}?version=${encodeURIComponent(_)}`);break;case"download-version":await cr(k,_);break;case"delete-version":await dr(k,_);break;case"keep-version":await lr(k,_);break;case"hide-version":await ur(k,_);break;case"restore-version":await pr(k,_);break;case"restore-chapter":await hr(k);break;case"delete-chapter":await mr(k,_);break;case"hide-chapter":await gr(k,_);break;case"unhide-chapter":await fr(k,_);break}})}),t.querySelectorAll(".version-row .version-title").forEach(y=>{y.addEventListener("click",L=>{L.stopPropagation();const T=y.closest(".version-row"),k=parseFloat(T.dataset.num),_=T.dataset.versionUrl?decodeURIComponent(T.dataset.versionUrl):null;T.classList.contains("downloaded")&&_?N.go(`/read/${e.id}/${k}?version=${encodeURIComponent(_)}`):d("Version not downloaded yet","info")})}),t.querySelectorAll(".volume-card").forEach(y=>{y.addEventListener("click",()=>{const L=y.dataset.volumeId;N.go(`/manga/${e.id}/volume/${L}`)})}),wr(t),xe(),he.subscribeToManga(e.id)}async function ar(t){var n;const e=b.manga,s=((n=e.chapterSettings)==null?void 0:n[t])||{},a=!s.locked;try{a?await m.lockChapter(e.id,t):await m.unlockChapter(e.id,t),e.chapterSettings||(e.chapterSettings={}),e.chapterSettings[t]={...s,locked:a},d(a?"Chapter locked":"Chapter unlocked","success"),j([e.id])}catch(i){d("Failed: "+i.message,"error")}}async function nr(t){const e=b.manga,s=new Set(e.readChapters||[]),a=s.has(t);try{await m.post(`/bookmarks/${e.id}/chapters/${t}/read`,{isRead:!a}),a?s.delete(t):s.add(t),e.readChapters=[...s],d(a?"Marked unread":"Marked read","success"),j([e.id])}catch(n){d("Failed: "+n.message,"error")}}async function rr(t){const e=b.manga,s=new Set(e.deletedChapterUrls||[]),a=(e.chapters||[]).find(n=>n.number===t&&!s.has(n.url));try{d(`Downloading chapter ${t}...`,"info"),a?await m.post(`/bookmarks/${e.id}/download-version`,{chapterNumber:t,url:a.url}):await m.post(`/bookmarks/${e.id}/download`,{chapters:[t]}),d("Download queued!","success")}catch(n){d("Failed: "+n.message,"error")}}function ir(t){document.querySelectorAll(".versions-dropdown").forEach(s=>{s.id!==`versions-${t}`&&s.classList.add("hidden")});const e=document.getElementById(`versions-${t}`);e&&(e.classList.toggle("hidden"),e.classList.contains("hidden")||or(t,e))}async function or(t,e){const s=b.manga,a=e.querySelectorAll(".version-pages");if(!(!s||a.length===0||e.dataset.annotated==="1")){e.dataset.annotated="1";try{const n=await m.getChapterVersions(s.id,t),i=new Map((n.versions||[]).filter(o=>o.url).map(o=>[o.url,o]));a.forEach(o=>{const c=decodeURIComponent(o.dataset.url),l=i.get(c);l&&(o.textContent=`${l.imageCount} pages`,o.title=l.folder)})}catch{e.dataset.annotated=""}}}async function lr(t,e){var c;const s=b.manga,a=((c=s.downloadedVersions)==null?void 0:c[t])||[],i=(Array.isArray(a)?a:[a]).filter(l=>l&&l!==e);if(i.length===0){d("This is the only downloaded version","info");return}if(!confirm(`Delete the other ${i.length} downloaded version${i.length>1?"s":""} of chapter ${t}?`))return;let o=0;for(const l of i)try{await m.request(`/bookmarks/${s.id}/chapters`,{method:"DELETE",body:JSON.stringify({chapterNumber:t,url:l})})}catch(u){o++,d("Failed to delete a version: "+u.message,"error")}o===0&&d("Other versions deleted","success"),await Y(s.id),j([s.id])}async function cr(t,e){const s=b.manga;try{d("Downloading version...","info"),await m.post(`/bookmarks/${s.id}/download-version`,{chapterNumber:t,url:e}),d("Download queued!","success")}catch(a){d("Failed: "+a.message,"error")}}async function dr(t,e){const s=b.manga;try{await m.request(`/bookmarks/${s.id}/chapters`,{method:"DELETE",body:JSON.stringify({chapterNumber:t,url:e})}),d("Version deleted","success"),await Y(s.id),j([s.id])}catch(a){d("Failed: "+a.message,"error")}}async function ur(t,e){const s=b.manga;try{await m.hideVersion(s.id,t,e),d("Version hidden","success"),await Y(s.id),j([s.id])}catch(a){d("Failed: "+a.message,"error")}}async function pr(t,e){const s=b.manga;try{await m.unhideVersion(s.id,t,e),d("Version restored","success"),await Y(s.id),j([s.id])}catch(a){d("Failed to restore version: "+a.message,"error")}}async function hr(t){const e=b.manga;try{await m.unexcludeChapter(e.id,t),d("Chapter restored","success"),await Y(e.id),j([e.id])}catch(s){d("Failed to restore chapter: "+s.message,"error")}}async function mr(t,e){const s=b.manga;if(confirm("Delete this chapter's files from disk?"))try{await m.request(`/bookmarks/${s.id}/chapters`,{method:"DELETE",body:JSON.stringify({chapterNumber:t,url:e})}),d("Chapter files deleted","success"),await Y(s.id),j([s.id])}catch(a){d("Failed to delete: "+a.message,"error")}}async function gr(t,e){const s=b.manga;if(confirm("Hide this chapter? It will be moved to the Hidden filter."))try{await m.hideVersion(s.id,t,e),d("Chapter hidden","success"),await Y(s.id),j([s.id])}catch(a){d("Failed to hide chapter: "+a.message,"error")}}async function fr(t,e){const s=b.manga;try{await m.unhideVersion(s.id,t,e),d("Chapter unhidden","success"),await Y(s.id),j([s.id])}catch(a){d("Failed to unhide chapter: "+a.message,"error")}}async function Y(t){try{const[e,s]=await Promise.all([m.getBookmark(t),ne.isDemo?Promise.resolve([]):oe.loadCategories()]);if(b.manga=e,b.categories=s,b.loading=!1,b.volumesCollapsed=Hn(e),e.website==="Local")try{const i=await m.getCbzFiles(t);b.cbzFiles=i||[]}catch(i){console.error("Failed to load CBZ files:",i),b.cbzFiles=[]}else b.cbzFiles=[];const a=new Set((e.chapters||[]).map(i=>i.number)).size,n=Math.ceil(a/Qe);b.currentPage=Math.max(0,n-1),b.activeVolumeId?b.activeVolume=(e.volumes||[]).find(i=>i.id===b.activeVolumeId):b.activeVolume=null}catch{d("Failed to load manga","error"),b.loading=!1}}async function j(t=[]){const[e,s,a]=t;if(!e){N.go("/");return}b.activeVolumeId=s==="volume"?a:null;const n=document.getElementById("app");!b.manga||b.manga.id!==e?(b.loading=!0,b.manga=null,n.innerHTML=Pt(),await Y(e)):b.activeVolumeId?b.activeVolume=(b.manga.volumes||[]).find(i=>i.id===b.activeVolumeId):b.activeVolume=null,n.innerHTML=Pt(),sr(),dt()}function vr(){b.manga&&he.unsubscribeFromManga(b.manga.id),b.manga=null,b.loading=!0}const yr={mount:j,unmount:vr,render:Pt};function br(){return`
      ...
      <div class="series-detail">
        <div class="series-detail-header">
          <div class="series-detail-cover">
            ${n?Ce(n,e,{kind:"series"}):ce("series")}
          </div>
  ...
  `}function $r(t,e,s){var i;const a=t.alias||t.title;let n=null;return t.local_cover?n=`/api/public/covers/${t.bookmark_id}/${encodeURIComponent(t.local_cover.split(/[/\\]/).pop())}`:t.localCover?n=`/api/public/covers/${t.bookmark_id}/${encodeURIComponent(t.localCover.split(/[/\\]/).pop())}`:t.cover&&(n=t.cover),`
  ...
  `}function mt(){var l,u,p;const t=document.getElementById("app"),e=me.series;(l=document.getElementById("back-btn"))==null||l.addEventListener("click",()=>N.go("/")),(u=document.getElementById("back-library-btn"))==null||u.addEventListener("click",()=>N.go("/")),t.querySelectorAll(".series-entry-card").forEach(g=>{g.addEventListener("click",v=>{if(v.target.closest("[data-action]"))return;const E=g.dataset.id;N.go(`/manga/${E}`)})}),t.querySelectorAll("[data-action]").forEach(g=>{g.addEventListener("click",async v=>{v.stopPropagation();const E=g.dataset.action,x=g.dataset.id;switch(E){case"move-up":await bs(x,-1);break;case"move-down":await bs(x,1);break;case"set-cover":const f=g.dataset.entryid;await Er(f);break}})});const s=document.getElementById("add-entry-btn"),a=document.getElementById("add-entry-modal"),n=document.getElementById("available-bookmarks-input"),i=document.getElementById("available-bookmarks-list"),o=document.getElementById("confirm-add-entry-btn");let c=[];s&&a&&(s.addEventListener("click",async()=>{try{s.disabled=!0,n&&(n.value="",n.placeholder="Loading...",n.disabled=!0),i&&(i.innerHTML=""),a.classList.add("open");const g=await m.getAvailableBookmarksForSeries();c=g,g.length===0?(n&&(n.placeholder="No available manga found"),o.disabled=!0):(n&&(n.placeholder="Select or type a manga...",n.disabled=!1),i&&(i.innerHTML=g.map(v=>`<option value="${(v.alias||v.title||"").replace(/"/g,"&quot;")}"></option>`).join("")),o.disabled=!1)}catch{d("Failed to load available manga","error"),a.classList.remove("open")}finally{s.disabled=!1}}),o.addEventListener("click",async()=>{const g=n?n.value:"",v=c.find(x=>(x.alias||x.title||"")===g);if(!v){d("Please select a valid manga from the list","warning");return}const E=v.id;try{o.disabled=!0,o.textContent="Adding...",await m.addSeriesEntry(e.id,E),d("Manga added to series","success"),a.classList.remove("open"),await gt(e.id),t.innerHTML=De(),mt()}catch(x){d("Failed to add manga: "+x.message,"error")}finally{o.disabled=!1,o.textContent="Add to Series"}})),(p=document.getElementById("edit-series-btn"))==null||p.addEventListener("click",()=>{d("Edit series coming soon","info")})}async function bs(t,e){const s=me.series;if(!s)return;const a=s.entries||[],n=a.findIndex(c=>c.bookmark_id===t);if(n===-1)return;const i=n+e;if(i<0||i>=a.length)return;const o=a.map(c=>c.bookmark_id);[o[n],o[i]]=[o[i],o[n]];try{await m.post(`/series/${s.id}/reorder`,{order:o}),d("Order updated","success"),await gt(s.id);const c=document.getElementById("app");c.innerHTML=De(),mt()}catch(c){d("Failed to reorder: "+c.message,"error")}}async function Er(t){const e=me.series;if(e)try{await m.setSeriesCover(e.id,t),d("Series cover updated","success"),await gt(e.id);const s=document.getElementById("app");s.innerHTML=De(),mt()}catch(s){d("Failed to set cover: "+s.message,"error")}}async function gt(t){try{const e=await m.get(`/series/${t}`);me.series=e,me.loading=!1}catch{d("Failed to load series","error"),me.loading=!1}}async function Cr(t=[]){const[e]=t;if(!e){N.go("/");return}const s=document.getElementById("app");me.loading=!0,me.series=null,s.innerHTML=De(),await gt(e),s.innerHTML=De(),mt()}function xr(){me.series=null,me.loading=!0}const Sr={mount:Cr,unmount:xr,render:De},Ir={disabledMangaIds:[],includeLists:!1,includeTrophies:!1,intervalMs:8e3,shuffle:!1};function Lr(t){return String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}const Br={mount:async t=>{const e=document.getElementById("app");e.innerHTML=`
        ...
        `;let s={};try{const $=await m.get("/settings")||{};s=$;const M=document.getElementById("settings-form"),P=document.getElementById("settings-loader");$.theme&&(document.getElementById("theme").value=$.theme),P.style.display="none",M.style.display="",M.addEventListener("submit",async q=>{q.preventDefault();const D=new FormData(M),I={};for(const[w,B]of D.entries())I[w]=B;try{await m.post("/settings/bulk",I),d("Settings saved successfully"),I.theme}catch(w){console.error(w),d("Failed to save settings","error")}})}catch($){console.error($),document.getElementById("settings-loader").textContent="Error loading settings"}window.location.hash.includes("anilist=connected")&&d("AniList connected");const a=document.getElementById("anilist-group"),n=document.getElementById("anilist-status"),i=document.getElementById("anilist-connect"),o=document.getElementById("anilist-sync"),c=document.getElementById("anilist-disconnect"),l=document.getElementById("anilist-sync-result"),u=async()=>{a.style.display="block";try{const $=await m.anilistStatus();$.configured?$.connected?(n.textContent=`Connected as ${$.anilistUsername||"AniList user"}.`,i.style.display="none",o.style.display="",c.style.display=""):(n.textContent="Not connected. Link your AniList account to sync reading progress.",i.style.display="",o.style.display="none",c.style.display="none"):(n.textContent="Not configured — set ANILIST_CLIENT_ID and ANILIST_CLIENT_SECRET in .env and restart the server.",i.style.display="none",o.style.display="none",c.style.display="none")}catch($){console.error($),n.textContent="Failed to load AniList status — is the server running the latest code?"}};i.addEventListener("click",async()=>{try{const{url:$}=await m.anilistAuthUrl();window.location.href=$}catch($){d($.message||"Failed to start AniList connection","error")}}),c.addEventListener("click",async()=>{try{await m.anilistDisconnect(),d("AniList disconnected"),u()}catch{d("Failed to disconnect","error")}}),o.addEventListener("click",async()=>{o.disabled=!0,n.textContent="Syncing from AniList…";try{const $=await m.anilistPull();$.updated.length===0?l.textContent="Everything already up to date.":l.innerHTML="<ul>"+$.updated.map(M=>`<li>${M.title} — marked read up to chapter ${M.markedUpTo}</li>`).join("")+"</ul>",d(`AniList sync: ${$.updated.length} manga updated`)}catch($){l.textContent="",d($.message||"AniList sync failed","error")}finally{o.disabled=!1,u()}}),u();const p={...Ir,...s.slideshow||{}};p.disabledMangaIds=[...p.disabledMangaIds||[]];const g=document.getElementById("slideshow-interval"),v=document.getElementById("slideshow-shuffle"),E=document.getElementById("slideshow-lists"),x=document.getElementById("slideshow-trophies"),f=document.getElementById("slideshow-manga-list");g.value=String(p.intervalMs),g.value||(g.value="8000"),v.checked=!!p.shuffle,E.checked=!!p.includeLists,x.checked=!!p.includeTrophies;const S=async()=>{if(!ne.isDemo)try{await m.post("/settings",{key:"slideshow",value:p})}catch($){console.error($),d("Failed to save slideshow settings","error")}};g.addEventListener("change",()=>{p.intervalMs=parseInt(g.value,10)||8e3,S()}),v.addEventListener("change",()=>{p.shuffle=v.checked,S()}),E.addEventListener("change",()=>{p.includeLists=E.checked,S()}),x.addEventListener("change",()=>{p.includeTrophies=x.checked,S()}),document.getElementById("slideshow-start").addEventListener("click",()=>{var $,M;(M=($=document.documentElement).requestFullscreen)==null||M.call($).catch(()=>{}),N.go("/slideshow")});try{const $=await m.getAllVolumes();if($.length===0)f.innerHTML=`<p class="settings-hint">No manga with volumes yet — create volumes from a manga's page first.</p>`;else{const M=new Set(p.disabledMangaIds);f.innerHTML=$.map(P=>{const q=Lr(P.alias||P.title),D=P.volumes.filter(B=>B.cover).length,I=P.localCover?`/api/public/covers/${P.id}/${encodeURIComponent(P.localCover.split(/[/\\]/).pop())}`:P.cover,w=D===0;return`
                        <label class="slideshow-manga-row${w?" no-covers":""}" title="${w?"No volume covers yet":q}">
                            ...
                            <span class="slideshow-manga-thumb">${I?Ce(I,q,{kind:"book"}):ce("book")}</span>
        ...
        `,document.querySelectorAll(".admin-tab").forEach(s=>{s.addEventListener("click",()=>{document.querySelectorAll(".admin-tab").forEach(a=>a.classList.remove("active")),s.classList.add("active"),document.querySelectorAll(".admin-section").forEach(a=>a.style.display="none"),document.getElementById(`admin-section-${s.dataset.section}`).style.display=""})}),await Promise.all([nt(),Ar(),Mr()])}};async function nt(){const t=document.getElementById("admin-section-users");try{const e=await m.listUsers();t.innerHTML=`
            <h2>Users</h2>
        ...
        `,t.querySelectorAll("tr[data-user-id]").forEach(s=>{const a=Number(s.dataset.userId),n=async()=>{try{await m.updateUser(a,{role:s.querySelector(".user-role").value,canDownload:s.querySelector(".user-can-download").checked,canEdit:s.querySelector(".user-can-edit").checked}),d("User updated","success")}catch(i){d(i.message,"error"),nt()}};s.querySelector(".user-role").addEventListener("change",n),s.querySelector(".user-can-download").addEventListener("change",n),s.querySelector(".user-can-edit").addEventListener("change",n),s.querySelector(".user-reset-pw").addEventListener("click",async()=>{const i=prompt("New password for this user:");if(i)try{await m.updateUser(a,{password:i}),d("Password reset","success")}catch(o){d(o.message,"error")}}),s.querySelector(".user-delete").addEventListener("click",async()=>{if(confirm("Delete this user?"))try{await m.deleteUser(a),d("User deleted","success"),nt()}catch(i){d(i.message,"error")}})}),document.getElementById("add-user-form").addEventListener("submit",async s=>{s.preventDefault();try{await m.createUser({username:document.getElementById("new-username").value.trim(),password:document.getElementById("new-password").value,role:document.getElementById("new-role").value,canDownload:document.getElementById("new-can-download").checked,canEdit:document.getElementById("new-can-edit").checked}),d("User created","success"),nt()}catch(a){d(a.message,"error")}})}catch(e){console.error(e),t.innerHTML='<div class="error">Failed to load users</div>'}}async function Ar(){const t=document.getElementById("admin-section-demo");try{const e=await m.getBookmarks();t.innerHTML=`
            <h2>Demo Content</h2>
        ...
        `,(a=document.getElementById("prev-page"))==null||a.addEventListener("click",()=>Dt(t,e-1)),(n=document.getElementById("next-page"))==null||n.addEventListener("click",()=>Dt(t,e+1))}catch(i){console.error(i),s.innerHTML=`<div class="error">Failed to load data for ${t}</div>`}}let te={favorites:{favorites:{},listOrder:[]},trophyPages:{},bookmarks:[],series:[],loading:!0,activeTab:"galleries"};function Tr(t,e){let s=null;if(e.length>0){const n=e[0];if(n.imagePaths&&n.imagePaths.length>0){const i=n.imagePaths[0];let o;typeof i=="string"?o=i:i&&typeof i=="object"&&(o=i.filename||i.path||i.name||i.url,o&&o.includes("/")&&(o=o.split("/").pop()),o&&o.includes("\\")&&(o=o.split("\\").pop())),o&&(s=`/api/public/chapter-images/${n.mangaId}/${n.chapterNum}/${encodeURIComponent(o)}`)}}const a=e.reduce((n,i)=>{var o;return n+(((o=i.imagePaths)==null?void 0:o.length)||0)},0);return`
    <div class="manga-card gallery-card" data-gallery="${t}">
      <div class="manga-card-cover">
        ${s?Ce(s,t,{kind:"folder"}):ce("folder")}
        <div class="manga-card-badges">
  ...
  `}function Pr(t){const e=te.bookmarks.find(s=>s.id===t);return e?e.alias||e.title:t}function Rr(t){const e=te.bookmarks.find(s=>s.id===t);if(e&&e.seriesId){const s=te.series.find(a=>a.id===e.seriesId);if(s)return{id:s.id,name:s.alias||s.title}}return null}function qr(t,e,s,a=!1){return`
  ...
  `}function Dr(){const t={};console.log("Building trophy groups from:",te.trophyPages);for(const e of Object.keys(te.trophyPages)){const s=te.trophyPages[e];let a=0;for(const[i,o]of Object.entries(s))a+=Object.keys(o).length;if(console.log(`Manga ${e}: ${a} trophies`),a===0)continue;const n=Rr(e);if(n)t[n.id]||(t[n.id]={name:n.name,isSeries:!0,count:0,mangaIds:[]}),t[n.id].count+=a,t[n.id].mangaIds.push(e);else{const i=Pr(e);console.log(`No series for ${e}, using name: ${i}`),t[e]={name:i,isSeries:!1,count:a,mangaIds:[e]}}}return console.log("Trophy groups result:",t),t}function ut(){if(te.loading)return`
      ${re("manga")}
      <div class="container">
        <div class="loading-spinner"></div>
      </div>
  ...
  `;let a="";if(te.activeTab==="galleries")e.length===0?a=`
      ...
      `:a=`
        <div class="library-grid">
          ${e.map(i=>{const o=t&&t[i]||[];return Tr(i,o)}).join("")}
        </div>
      `;else{const n=Dr(),i=Object.keys(n);i.length===0?a=`
        <div class="empty-state">
      ...
      `:a=`
        <div class="library-grid">
          ${i.map(c=>{const l=n[c];return qr(c,l.name,l.count,l.isSeries)}).join("")}
        </div>
      `}return`
    ${re("manga")}
    <div class="container">
  ...
  `}function sa(){xe();const t=document.getElementById("app");t.querySelectorAll(".tab-btn").forEach(s=>{s.addEventListener("click",()=>{te.activeTab=s.dataset.tab,t.innerHTML=ut(),sa()})}),t.querySelectorAll(".gallery-card").forEach(s=>{s.addEventListener("click",()=>{const a=s.dataset.gallery;N.go(`/read/gallery/${encodeURIComponent(a)}`)})}),t.querySelectorAll(".trophy-gallery-card").forEach(s=>{s.addEventListener("click",()=>{const a=s.dataset.trophyId;s.dataset.isSeries==="true"?N.go(`/read/trophies/series-${a}/🏆`):N.go(`/read/trophies/${a}/🏆`)})})}async function Nr(){try{const[t,e,s,a]=await Promise.all([oe.loadFavorites(),m.get("/trophy-pages"),oe.loadBookmarks(),oe.loadSeries()]);te.favorites=t||{favorites:{},listOrder:[]},te.trophyPages=e||{},te.bookmarks=s||[],te.series=a||[],te.loading=!1}catch(t){console.error("Failed to load favorites:",t),d("Failed to load favorites","error"),te.loading=!1}}async function Fr(){console.log("[Favorites] mount called"),te.loading=!0;const t=document.getElementById("app");t.innerHTML=ut(),await Nr(),console.log("[Favorites] Data loaded, rendering..."),t.innerHTML=ut(),console.log("[Favorites] Calling setupListeners..."),sa(),console.log("[Favorites] setupListeners complete")}function Ur(){}const Or={mount:Fr,unmount:Ur,render:ut};let z={downloads:{},queueTasks:[],historyTasks:[],autoCheck:null,loading:!0,showEmptyChecks:!1,collapsed:{active:!1,scheduled:!1,completed:!1,history:!0}},rt=null,le={};function Zt(t){if(!t)return"Never";const e=Date.now()-new Date(t).getTime(),s=Math.floor(e/6e4);if(s<1)return"Just now";if(s<60)return`${s}m ago`;const a=Math.floor(s/60);return a<24?`${a}h ${s%60}m ago`:`${Math.floor(a/24)}d ago`}function Vr(t){if(!t)return"Not scheduled";const e=new Date(t).getTime()-Date.now();if(e<=0)return"Running now...";const s=Math.floor(e/6e4);if(s<60)return`in ${s}m`;const a=Math.floor(s/60),n=s%60;if(a<24)return`in ${a}h ${n}m`;const i=Math.floor(a/24),o=a%24;return`in ${i}d ${o}h`}function aa(t){switch(t){case"download":return h("download");case"scrape":return h("search");case"scan":return h("folder");default:return h("settings")}}function es(t){switch(t){case"running":return"var(--color-success)";case"queued":case"pending":return"var(--color-warning)";case"paused":return"var(--color-info)";case"complete":return"var(--color-success)";case"error":case"failed":case"cancelled":return"var(--color-error)";default:return"var(--text-secondary)"}}function ts(t){switch(t){case"running":return"● Running";case"queued":case"pending":return"◌ Queued";case"paused":return"❚❚ Paused";case"complete":return"✓ Complete";case"error":case"failed":return"✗ Failed";case"cancelled":return"✗ Cancelled";default:return t}}function Hr(t){return!t||t==="default"?"Default (6h)":t==="daily"?"Daily":t==="weekly"?"Weekly":t}function zr(){const t=z.autoCheck;return t?`
  ...
  `:""}function jr(t){const e=t.nextCheck?Vr(t.nextCheck):"Not set",s=t.nextCheck&&new Date(t.nextCheck)<=new Date;return`
        ...
        <div class="task-info">
          ...
          <div>
            ...
            <div class="task-status" style="color: var(--text-secondary)">
              ${Hr(t.schedule)}${t.schedule==="weekly"&&t.day?` · ${t.day.charAt(0).toUpperCase()+t.day.slice(1)}`:""}${(t.schedule==="daily"||t.schedule==="weekly")&&t.time?` · ${t.time}`:""}
            </div>
          </div>
        </div>
  ...
  `}function Qr(t){const e=t.data||{};return`
  ...
  `}function Gr(){var c;const t=Object.entries(z.downloads),e=t.filter(([,l])=>l.status!=="complete"),s=t.filter(([,l])=>l.status==="complete"),a=new Set(e.map(([,l])=>l.bookmarkId).filter(Boolean)),n=z.queueTasks.filter(l=>{var u;return!(l.type==="download"&&((u=l.data)!=null&&u.mangaId)&&a.has(l.data.mangaId))}),i=e.length+n.length,o=((c=z.autoCheck)==null?void 0:c.schedules)||[];return`
    ${re("manga")}
    <div class="container queue-container">
      ...
      ${z.historyTasks&&z.historyTasks.length>0?(()=>{const l=g=>{if(g.type!=="scrape")return!1;const v=g.result||{};return(g.status==="complete"||g.status==="completed")&&(v.newChaptersCount===0||v.updated===!1)},u=z.historyTasks.filter(l).length,p=z.showEmptyChecks?z.historyTasks:z.historyTasks.filter(g=>!l(g));return`
              ...
              <div style="display: flex; gap: 8px; align-items: center;">
                ${u>0?`
                  <button class="btn btn-sm btn-secondary" id="toggle-empty-checks-btn" title="${z.showEmptyChecks?"Hide":"Show"} checks with no new chapters">
                    ${z.showEmptyChecks?`${h("chevron-up")} Hide`:`${h("chevron-down")} Show`} empty checks (${u})
                  </button>
                `:""}
  ...
  `,xe(),await _e(),be(),rt=setInterval(async()=>{await _e(),be()},5e3),le.downloadProgress=e=>{e.taskId&&z.downloads[e.taskId]&&(Object.assign(z.downloads[e.taskId],e),be())},le.downloadCompleted=e=>{_e().then(be)},le.queueUpdated=e=>{_e().then(be)},he.on(we.DOWNLOAD_PROGRESS,le.downloadProgress),he.on(we.DOWNLOAD_COMPLETED,le.downloadCompleted),he.on(we.QUEUE_UPDATED,le.queueUpdated)}function Jr(){rt&&(clearInterval(rt),rt=null),le.downloadProgress&&he.off(we.DOWNLOAD_PROGRESS,le.downloadProgress),le.downloadCompleted&&he.off(we.DOWNLOAD_COMPLETED,le.downloadCompleted),le.queueUpdated&&he.off(we.QUEUE_UPDATED,le.queueUpdated),le={}}const Xr={mount:Yr,unmount:Jr};class Zr{constructor(){this.container=null,this.scrapers=[],this.currentQuery="",this.currentTarget="all",this.isSearching=!1,this.results=[],this.viewMode="main",this.browseScraper=null,this.browseQuery="english",this.browseSort="popular-today",this.browsePage=1,this.browseTotalPages=1,this.isBrowsing=!1,this.browseResults=[],this.previewInfo=null,this.previewImages=[],this.previewIndex=0,this.infoAbortController=null}async mount(e){this.container=document.getElementById("app"),document.body.className="scrapers-mode";const s=new URLSearchParams(window.location.hash.split("?")[1]||""),a=s.get("browse"),n=s.get("q");a&&(this.browseScraper=a,this.viewMode="browse",this.browseQuery=n||this.browseQuery,this.browseSort="popular",this.browsePage=1,this.browseResults=[],this.browseTotalPages=1),this.updateView(),await this.loadScrapers(),this.viewMode==="browse"&&this.browseScraper?this.performBrowse():n&&(this.currentQuery=n,this.updateView(),this.performSearch())}unmount(){this.infoAbortController&&(this.infoAbortController.abort(),this.infoAbortController=null),this.container.innerHTML="",document.body.className=""}async loadScrapers(){try{const e=await m.get("/scrapers/list");e.success&&(this.scrapers=e.scrapers,this.updateView())}catch(e){console.error("Failed to load scrapers",e)}}updateView(){this.render(),this.renderScraperList(),(this.results.length>0||this.isSearching)&&this.renderResults(),this.bindEvents()}render(){this.container.innerHTML=`
    ...
    `;try{const n=await m.get(`/scrapers/search?q=${encodeURIComponent(this.currentQuery)}&scraper=${encodeURIComponent(this.currentTarget)}`);if(n.success)this.results=n.results||[],this.renderResults();else throw new Error(n.error||"Failed to search scrapers")}catch(n){console.error("Search error",n),e.innerHTML=`<div class="error-state" style="margin-top: 2rem;">Failed to perform search: ${n.message}</div>`}finally{this.isSearching=!1,s.textContent="Search",s.disabled=!1}}renderResults(){const e=document.getElementById("scraper-results-container");if(!e)return;if(this.results.length===0){e.innerHTML=`
      ...
      `;return}let s='<div class="library-grid" style="margin-top: 2rem;">';this.results.forEach(a=>{const n=a.cover||"";let i="";n.startsWith("/covers/")?i=n:n&&(i=`/api/scrapers/proxy-cover?url=${encodeURIComponent(n)}`);const o=i?Ce(i,"Cover",{kind:"series",self:!0}):ce("series");s+=`
      ...
      `,a.style.display="none";return}let n="";this.browseResults.forEach((i,o)=>{const c=i.cover||"";let l="";c.startsWith("/covers/")?l=c:c&&(l=`/api/scrapers/proxy-cover?url=${encodeURIComponent(c)}`);const u=l?Ce(l,"Cover",{kind:"series",self:!0}):ce("series");n+=`
    ...
    `,this._setReadBtnEnabled(i,!1);try{const o=await m.get(`/scrapers/info?url=${encodeURIComponent(e.url)}`,{signal:s});if(o.success&&o.info){this.previewInfo={...this.previewInfo,...o.info};let c="";o.info.tags&&o.info.tags.length>0&&(c=`
             ...
             ${l}
             ${c}
          `,this._setReadBtnEnabled(i,!0)}else document.getElementById("preview-extended-info").innerHTML='<p class="error-state" style="margin:0; padding:1rem; text-align:left;">Could not fetch extra details.</p>',(this.previewInfo.galleryId||this.previewInfo.url)&&this._setReadBtnEnabled(i,!0)}catch(o){if(o.name==="AbortError"||s.aborted){console.log("Scraper details fetch aborted successfully.");return}console.error("Info error:",o),document.getElementById("preview-extended-info").innerHTML=`<p class="error-state" style="margin:0; padding:1rem; text-align:left;">Failed to load details: ${o.message}</p>`,this._setReadBtnEnabled(i,!0)}}_setReadBtnEnabled(e,s){e&&(e.disabled=!s,e.style.opacity=s?"1":"0.5",e.style.cursor=s?"pointer":"not-allowed",e.style.pointerEvents=s?"auto":"none")}async openTempReader(){if(!this.previewInfo||!this.previewInfo.url&&!this.previewInfo.galleryId)return;const e=this.previewInfo.url||`https://nhentai.net/g/${this.previewInfo.galleryId}/`,s=this.browseScraper||this.previewInfo.website;sessionStorage.setItem("streamPreviewUrl",e),sessionStorage.setItem("streamPreviewTitle",this.previewInfo.title||"Preview"),s?sessionStorage.setItem("streamPreviewScraper",s):sessionStorage.removeItem("streamPreviewScraper"),document.getElementById("preview-info-modal").style.display="none",window.location.hash="#/read/stream/preview"}}const ei=new Zr,ks={disabledMangaIds:[],includeLists:!1,includeTrophies:!1,intervalMs:8e3,shuffle:!1};let A=null;function ti(t){return String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function $s(t,e=0){for(let s=t.length-1;s>e;s--){const a=e+Math.floor(Math.random()*(s-e+1));[t[s],t[a]]=[t[a],t[s]]}}function si(t){let e;return typeof t=="string"?e=t:t&&typeof t=="object"&&(e=t.filename||t.path||t.name||t.url),e?(e.includes("/")&&(e=e.split("/").pop()),e.includes("\\")&&(e=e.split("\\").pop()),e):null}function ai(t){return h(t==="gallery"?"folder":t==="trophy"?"trophy":"book-open")}function ni(t,e){const s=[];for(const a of t){if(e.has(a.id))continue;const n=a.alias||a.title;for(const i of a.volumes)i.cover&&s.push({url:i.cover,title:n,subtitle:i.name,kind:"volume"})}return s}async function ri(){var a,n;const t=await m.getFavorites(),e=(a=t.listOrder)!=null&&a.length?t.listOrder:Object.keys(t.favorites||{}),s=[];for(const i of e)for(const o of((n=t.favorites)==null?void 0:n[i])||[])for(const c of o.imagePaths||[]){const l=si(c);l&&s.push({url:`/api/public/chapter-images/${o.mangaId}/${o.chapterNum}/${encodeURIComponent(l)}`,title:i,subtitle:o.mangaTitle?`${o.mangaTitle} · Ch. ${o.chapterNum}`:`Ch. ${o.chapterNum}`,kind:"gallery"})}return s}async function ii(t){const e=await m.get("/trophy-pages"),s=await oe.loadBookmarks().catch(()=>[]),a=i=>{const o=s.find(c=>c.id===i);return o?o.alias||o.title:"Trophies"},n=[];for(const[i,o]of Object.entries(e||{}))if(!t.has(i))for(const[c,l]of Object.entries(o||{})){const u=Object.keys(l||{});if(u.length===0)continue;let p;try{p=(await m.getChapterImages(i,c)).images||[]}catch{continue}for(const g of u){const v=p[g];if(!v)continue;let E=typeof v=="string"?v.split("/").pop():(v==null?void 0:v.filename)||(v==null?void 0:v.path);if(E){try{E=decodeURIComponent(E)}catch{}n.push({url:`/api/public/chapter-images/${i}/${c}/${encodeURIComponent(E)}`,title:a(i),subtitle:`Ch. ${c} · Trophy`,kind:"trophy"})}}}return n}function na(){A&&(clearTimeout(A.timer),A.playing&&A.slides.length>1&&(A.timer=setTimeout(()=>ye(A.index+1),A.config.intervalMs)))}function Nt(){if(!A)return;const t=A.slides[A.index],e=document.getElementById("ss-counter"),s=document.getElementById("ss-title"),a=document.getElementById("ss-subtitle");e&&(e.textContent=A.slides.length?`${A.index+1} / ${A.slides.length}`:""),s&&t&&(s.innerHTML=`${ai(t.kind)} ${ti(t.title)}`),a&&t&&(a.textContent=t.subtitle||"")}function ye(t){if(!A||A.slides.length===0)return;const e=(t%A.slides.length+A.slides.length)%A.slides.length;A.index=e;const s=A.slides[e],a=++A.loadToken,n=1-A.activeLayer,i=A.layers[n],o=A.layers[A.activeLayer];i.onload=()=>{if(!(!A||a!==A.loadToken)&&(A.activeLayer=n,i.classList.add("active"),o.classList.remove("active"),Nt(),na(),A.slides.length>1)){const c=A.slides[(e+1)%A.slides.length];c&&(new Image().src=c.url)}},i.onerror=()=>{if(!(!A||a!==A.loadToken)){if(A.slides.splice(e,1),A.slides.length===0){Ut();return}ye(e)}},i.src=s.url,Nt()}function Es(t){if(!A)return;A.playing=t;const e=document.getElementById("ss-play");e&&(e.innerHTML=h(t?"pause":"play")),na()}function ge(){if(!A)return;const t=document.getElementById("slideshow");t&&(t.classList.remove("controls-hidden"),clearTimeout(A.hideTimer),A.hideTimer=setTimeout(()=>{var e;(e=document.getElementById("slideshow"))==null||e.classList.add("controls-hidden")},3e3))}function Ft(){N.go("/settings")}function Ut(){var e;const t=document.getElementById("slideshow");t&&(t.innerHTML=`
    ...
    `,(e=document.getElementById("ss-empty-back"))==null||e.addEventListener("click",Ft))}const oi={mount:async()=>{const t=document.getElementById("app");t.innerHTML=`
