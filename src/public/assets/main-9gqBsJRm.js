import{a as v}from"./api-BPljbFn_.js";const oe=Object.create(null);oe.open="0";oe.close="1";oe.ping="2";oe.pong="3";oe.message="4";oe.upgrade="5";oe.noop="6";const Pe=Object.create(null);Object.keys(oe).forEach(s=>{Pe[oe[s]]=s});const Ze={type:"error",data:"parser error"},Tt=typeof Blob=="function"||typeof Blob<"u"&&Object.prototype.toString.call(Blob)==="[object BlobConstructor]",Mt=typeof ArrayBuffer=="function",Rt=s=>typeof ArrayBuffer.isView=="function"?ArrayBuffer.isView(s):s&&s.buffer instanceof ArrayBuffer,ht=({type:s,data:e},t,a)=>Tt&&e instanceof Blob?t?a(e):Ct(e,a):Mt&&(e instanceof ArrayBuffer||Rt(e))?t?a(e):Ct(new Blob([e]),a):a(oe[s]+(e||"")),Ct=(s,e)=>{const t=new FileReader;return t.onload=function(){const a=t.result.split(",")[1];e("b"+(a||""))},t.readAsDataURL(s)};function St(s){return s instanceof Uint8Array?s:s instanceof ArrayBuffer?new Uint8Array(s):new Uint8Array(s.buffer,s.byteOffset,s.byteLength)}let Ge;function os(s,e){if(Tt&&s.data instanceof Blob)return s.data.arrayBuffer().then(St).then(e);if(Mt&&(s.data instanceof ArrayBuffer||Rt(s.data)))return e(St(s.data));ht(s,!1,t=>{Ge||(Ge=new TextEncoder),e(Ge.encode(t))})}const xt="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/",Ee=typeof Uint8Array>"u"?[]:new Uint8Array(256);for(let s=0;s<xt.length;s++)Ee[xt.charCodeAt(s)]=s;const rs=s=>{let e=s.length*.75,t=s.length,a,n=0,o,r,u,c;s[s.length-1]==="="&&(e--,s[s.length-2]==="="&&e--);const p=new ArrayBuffer(e),y=new Uint8Array(p);for(a=0;a<t;a+=4)o=Ee[s.charCodeAt(a)],r=Ee[s.charCodeAt(a+1)],u=Ee[s.charCodeAt(a+2)],c=Ee[s.charCodeAt(a+3)],y[n++]=o<<2|r>>4,y[n++]=(r&15)<<4|u>>2,y[n++]=(u&3)<<6|c&63;return p},ls=typeof ArrayBuffer=="function",pt=(s,e)=>{if(typeof s!="string")return{type:"message",data:Dt(s,e)};const t=s.charAt(0);return t==="b"?{type:"message",data:cs(s.substring(1),e)}:Pe[t]?s.length>1?{type:Pe[t],data:s.substring(1)}:{type:Pe[t]}:Ze},cs=(s,e)=>{if(ls){const t=rs(s);return Dt(t,e)}else return{base64:!0,data:s}},Dt=(s,e)=>{switch(e){case"blob":return s instanceof Blob?s:new Blob([s]);case"arraybuffer":default:return s instanceof ArrayBuffer?s:s.buffer}},Nt="",ds=(s,e)=>{const t=s.length,a=new Array(t);let n=0;s.forEach((o,r)=>{ht(o,!1,u=>{a[r]=u,++n===t&&e(a.join(Nt))})})},us=(s,e)=>{const t=s.split(Nt),a=[];for(let n=0;n<t.length;n++){const o=pt(t[n],e);if(a.push(o),o.type==="error")break}return a};function hs(){return new TransformStream({transform(s,e){os(s,t=>{const a=t.length;let n;if(a<126)n=new Uint8Array(1),new DataView(n.buffer).setUint8(0,a);else if(a<65536){n=new Uint8Array(3);const o=new DataView(n.buffer);o.setUint8(0,126),o.setUint16(1,a)}else{n=new Uint8Array(9);const o=new DataView(n.buffer);o.setUint8(0,127),o.setBigUint64(1,BigInt(a))}s.data&&typeof s.data!="string"&&(n[0]|=128),e.enqueue(n),e.enqueue(t)})}})}let Ke;function Be(s){return s.reduce((e,t)=>e+t.length,0)}function Ae(s,e){if(s[0].length===e)return s.shift();const t=new Uint8Array(e);let a=0;for(let n=0;n<e;n++)t[n]=s[0][a++],a===s[0].length&&(s.shift(),a=0);return s.length&&a<s[0].length&&(s[0]=s[0].slice(a)),t}function ps(s,e){Ke||(Ke=new TextDecoder);const t=[];let a=0,n=-1,o=!1;return new TransformStream({transform(r,u){for(t.push(r);;){if(a===0){if(Be(t)<1)break;const c=Ae(t,1);o=(c[0]&128)===128,n=c[0]&127,n<126?a=3:n===126?a=1:a=2}else if(a===1){if(Be(t)<2)break;const c=Ae(t,2);n=new DataView(c.buffer,c.byteOffset,c.length).getUint16(0),a=3}else if(a===2){if(Be(t)<8)break;const c=Ae(t,8),p=new DataView(c.buffer,c.byteOffset,c.length),y=p.getUint32(0);if(y>Math.pow(2,21)-1){u.enqueue(Ze);break}n=y*Math.pow(2,32)+p.getUint32(4),a=3}else{if(Be(t)<n)break;const c=Ae(t,n);u.enqueue(pt(o?c:Ke.decode(c),e)),a=0}if(n===0||n>s){u.enqueue(Ze);break}}}})}const qt=4;function j(s){if(s)return ms(s)}function ms(s){for(var e in j.prototype)s[e]=j.prototype[e];return s}j.prototype.on=j.prototype.addEventListener=function(s,e){return this._callbacks=this._callbacks||{},(this._callbacks["$"+s]=this._callbacks["$"+s]||[]).push(e),this};j.prototype.once=function(s,e){function t(){this.off(s,t),e.apply(this,arguments)}return t.fn=e,this.on(s,t),this};j.prototype.off=j.prototype.removeListener=j.prototype.removeAllListeners=j.prototype.removeEventListener=function(s,e){if(this._callbacks=this._callbacks||{},arguments.length==0)return this._callbacks={},this;var t=this._callbacks["$"+s];if(!t)return this;if(arguments.length==1)return delete this._callbacks["$"+s],this;for(var a,n=0;n<t.length;n++)if(a=t[n],a===e||a.fn===e){t.splice(n,1);break}return t.length===0&&delete this._callbacks["$"+s],this};j.prototype.emit=function(s){this._callbacks=this._callbacks||{};for(var e=new Array(arguments.length-1),t=this._callbacks["$"+s],a=1;a<arguments.length;a++)e[a-1]=arguments[a];if(t){t=t.slice(0);for(var a=0,n=t.length;a<n;++a)t[a].apply(this,e)}return this};j.prototype.emitReserved=j.prototype.emit;j.prototype.listeners=function(s){return this._callbacks=this._callbacks||{},this._callbacks["$"+s]||[]};j.prototype.hasListeners=function(s){return!!this.listeners(s).length};const ze=typeof Promise=="function"&&typeof Promise.resolve=="function"?e=>Promise.resolve().then(e):(e,t)=>t(e,0),X=typeof self<"u"?self:typeof window<"u"?window:Function("return this")(),gs="arraybuffer";function Ft(s,...e){return e.reduce((t,a)=>(s.hasOwnProperty(a)&&(t[a]=s[a]),t),{})}const fs=X.setTimeout,vs=X.clearTimeout;function je(s,e){e.useNativeTimers?(s.setTimeoutFn=fs.bind(X),s.clearTimeoutFn=vs.bind(X)):(s.setTimeoutFn=X.setTimeout.bind(X),s.clearTimeoutFn=X.clearTimeout.bind(X))}const ys=1.33;function bs(s){return typeof s=="string"?ws(s):Math.ceil((s.byteLength||s.size)*ys)}function ws(s){let e=0,t=0;for(let a=0,n=s.length;a<n;a++)e=s.charCodeAt(a),e<128?t+=1:e<2048?t+=2:e<55296||e>=57344?t+=3:(a++,t+=4);return t}function Ot(){return Date.now().toString(36).substring(3)+Math.random().toString(36).substring(2,5)}function ks(s){let e="";for(let t in s)s.hasOwnProperty(t)&&(e.length&&(e+="&"),e+=encodeURIComponent(t)+"="+encodeURIComponent(s[t]));return e}function Es(s){let e={},t=s.split("&");for(let a=0,n=t.length;a<n;a++){let o=t[a].split("=");e[decodeURIComponent(o[0])]=decodeURIComponent(o[1])}return e}class $s extends Error{constructor(e,t,a){super(e),this.description=t,this.context=a,this.type="TransportError"}}class mt extends j{constructor(e){super(),this.writable=!1,je(this,e),this.opts=e,this.query=e.query,this.socket=e.socket,this.supportsBinary=!e.forceBase64}onError(e,t,a){return super.emitReserved("error",new $s(e,t,a)),this}open(){return this.readyState="opening",this.doOpen(),this}close(){return(this.readyState==="opening"||this.readyState==="open")&&(this.doClose(),this.onClose()),this}send(e){this.readyState==="open"&&this.write(e)}onOpen(){this.readyState="open",this.writable=!0,super.emitReserved("open")}onData(e){const t=pt(e,this.socket.binaryType);this.onPacket(t)}onPacket(e){super.emitReserved("packet",e)}onClose(e){this.readyState="closed",super.emitReserved("close",e)}pause(e){}createUri(e,t={}){return e+"://"+this._hostname()+this._port()+this.opts.path+this._query(t)}_hostname(){const e=this.opts.hostname;return e.indexOf(":")===-1?e:"["+e+"]"}_port(){return this.opts.port&&(this.opts.secure&&Number(this.opts.port)!==443||!this.opts.secure&&Number(this.opts.port)!==80)?":"+this.opts.port:""}_query(e){const t=ks(e);return t.length?"?"+t:""}}class Cs extends mt{constructor(){super(...arguments),this._polling=!1}get name(){return"polling"}doOpen(){this._poll()}pause(e){this.readyState="pausing";const t=()=>{this.readyState="paused",e()};if(this._polling||!this.writable){let a=0;this._polling&&(a++,this.once("pollComplete",function(){--a||t()})),this.writable||(a++,this.once("drain",function(){--a||t()}))}else t()}_poll(){this._polling=!0,this.doPoll(),this.emitReserved("poll")}onData(e){const t=a=>{if(this.readyState==="opening"&&a.type==="open"&&this.onOpen(),a.type==="close")return this.onClose({description:"transport closed by the server"}),!1;this.onPacket(a)};us(e,this.socket.binaryType).forEach(t),this.readyState!=="closed"&&(this._polling=!1,this.emitReserved("pollComplete"),this.readyState==="open"&&this._poll())}doClose(){const e=()=>{this.write([{type:"close"}])};this.readyState==="open"?e():this.once("open",e)}write(e){this.writable=!1,ds(e,t=>{this.doWrite(t,()=>{this.writable=!0,this.emitReserved("drain")})})}uri(){const e=this.opts.secure?"https":"http",t=this.query||{};return this.opts.timestampRequests!==!1&&(t[this.opts.timestampParam]=Ot()),!this.supportsBinary&&!t.sid&&(t.b64=1),this.createUri(e,t)}}let Vt=!1;try{Vt=typeof XMLHttpRequest<"u"&&"withCredentials"in new XMLHttpRequest}catch{}const Ss=Vt;function xs(){}class Ls extends Cs{constructor(e){if(super(e),typeof location<"u"){const t=location.protocol==="https:";let a=location.port;a||(a=t?"443":"80"),this.xd=typeof location<"u"&&e.hostname!==location.hostname||a!==e.port}}doWrite(e,t){const a=this.request({method:"POST",data:e});a.on("success",t),a.on("error",(n,o)=>{this.onError("xhr post error",n,o)})}doPoll(){const e=this.request();e.on("data",this.onData.bind(this)),e.on("error",(t,a)=>{this.onError("xhr poll error",t,a)}),this.pollXhr=e}}class ie extends j{constructor(e,t,a){super(),this.createRequest=e,je(this,a),this._opts=a,this._method=a.method||"GET",this._uri=t,this._data=a.data!==void 0?a.data:null,this._create()}_create(){var e;const t=Ft(this._opts,"agent","pfx","key","passphrase","cert","ca","ciphers","rejectUnauthorized","autoUnref");t.xdomain=!!this._opts.xd;const a=this._xhr=this.createRequest(t);try{a.open(this._method,this._uri,!0);try{if(this._opts.extraHeaders){a.setDisableHeaderCheck&&a.setDisableHeaderCheck(!0);for(let n in this._opts.extraHeaders)this._opts.extraHeaders.hasOwnProperty(n)&&a.setRequestHeader(n,this._opts.extraHeaders[n])}}catch{}if(this._method==="POST")try{a.setRequestHeader("Content-type","text/plain;charset=UTF-8")}catch{}try{a.setRequestHeader("Accept","*/*")}catch{}(e=this._opts.cookieJar)===null||e===void 0||e.addCookies(a),"withCredentials"in a&&(a.withCredentials=this._opts.withCredentials),this._opts.requestTimeout&&(a.timeout=this._opts.requestTimeout),a.onreadystatechange=()=>{var n;a.readyState===3&&((n=this._opts.cookieJar)===null||n===void 0||n.parseCookies(a.getResponseHeader("set-cookie"))),a.readyState===4&&(a.status===200||a.status===1223?this._onLoad():this.setTimeoutFn(()=>{this._onError(typeof a.status=="number"?a.status:0)},0))},a.send(this._data)}catch(n){this.setTimeoutFn(()=>{this._onError(n)},0);return}typeof document<"u"&&(this._index=ie.requestsCount++,ie.requests[this._index]=this)}_onError(e){this.emitReserved("error",e,this._xhr),this._cleanup(!0)}_cleanup(e){if(!(typeof this._xhr>"u"||this._xhr===null)){if(this._xhr.onreadystatechange=xs,e)try{this._xhr.abort()}catch{}typeof document<"u"&&delete ie.requests[this._index],this._xhr=null}}_onLoad(){const e=this._xhr.responseText;e!==null&&(this.emitReserved("data",e),this.emitReserved("success"),this._cleanup())}abort(){this._cleanup()}}ie.requestsCount=0;ie.requests={};if(typeof document<"u"){if(typeof attachEvent=="function")attachEvent("onunload",Lt);else if(typeof addEventListener=="function"){const s="onpagehide"in X?"pagehide":"unload";addEventListener(s,Lt,!1)}}function Lt(){for(let s in ie.requests)ie.requests.hasOwnProperty(s)&&ie.requests[s].abort()}const _s=function(){const s=Ut({xdomain:!1});return s&&s.responseType!==null}();class Is extends Ls{constructor(e){super(e);const t=e&&e.forceBase64;this.supportsBinary=_s&&!t}request(e={}){return Object.assign(e,{xd:this.xd},this.opts),new ie(Ut,this.uri(),e)}}function Ut(s){const e=s.xdomain;try{if(typeof XMLHttpRequest<"u"&&(!e||Ss))return new XMLHttpRequest}catch{}if(!e)try{return new X[["Active"].concat("Object").join("X")]("Microsoft.XMLHTTP")}catch{}}const Ht=typeof navigator<"u"&&typeof navigator.product=="string"&&navigator.product.toLowerCase()==="reactnative";class Bs extends mt{get name(){return"websocket"}doOpen(){const e=this.uri(),t=this.opts.protocols,a=Ht?{}:Ft(this.opts,"agent","perMessageDeflate","pfx","key","passphrase","cert","ca","ciphers","rejectUnauthorized","localAddress","protocolVersion","origin","maxPayload","family","checkServerIdentity");this.opts.extraHeaders&&(a.headers=this.opts.extraHeaders);try{this.ws=this.createSocket(e,t,a)}catch(n){return this.emitReserved("error",n)}this.ws.binaryType=this.socket.binaryType,this.addEventListeners()}addEventListeners(){this.ws.onopen=()=>{this.opts.autoUnref&&this.ws._socket.unref(),this.onOpen()},this.ws.onclose=e=>this.onClose({description:"websocket connection closed",context:e}),this.ws.onmessage=e=>this.onData(e.data),this.ws.onerror=e=>this.onError("websocket error",e)}write(e){this.writable=!1;for(let t=0;t<e.length;t++){const a=e[t],n=t===e.length-1;ht(a,this.supportsBinary,o=>{try{this.doWrite(a,o)}catch{}n&&ze(()=>{this.writable=!0,this.emitReserved("drain")},this.setTimeoutFn)})}}doClose(){typeof this.ws<"u"&&(this.ws.onerror=()=>{},this.ws.close(),this.ws=null)}uri(){const e=this.opts.secure?"wss":"ws",t=this.query||{};return this.opts.timestampRequests&&(t[this.opts.timestampParam]=Ot()),this.supportsBinary||(t.b64=1),this.createUri(e,t)}}const Ye=X.WebSocket||X.MozWebSocket;class As extends Bs{createSocket(e,t,a){return Ht?new Ye(e,t,a):t?new Ye(e,t):new Ye(e)}doWrite(e,t){this.ws.send(t)}}class Ps extends mt{get name(){return"webtransport"}doOpen(){try{this._transport=new WebTransport(this.createUri("https"),this.opts.transportOptions[this.name])}catch(e){return this.emitReserved("error",e)}this._transport.closed.then(()=>{this.onClose()}).catch(e=>{this.onError("webtransport error",e)}),this._transport.ready.then(()=>{this._transport.createBidirectionalStream().then(e=>{const t=ps(Number.MAX_SAFE_INTEGER,this.socket.binaryType),a=e.readable.pipeThrough(t).getReader(),n=hs();n.readable.pipeTo(e.writable),this._writer=n.writable.getWriter();const o=()=>{a.read().then(({done:u,value:c})=>{u||(this.onPacket(c),o())}).catch(u=>{})};o();const r={type:"open"};this.query.sid&&(r.data=`{"sid":"${this.query.sid}"}`),this._writer.write(r).then(()=>this.onOpen())})})}write(e){this.writable=!1;for(let t=0;t<e.length;t++){const a=e[t],n=t===e.length-1;this._writer.write(a).then(()=>{n&&ze(()=>{this.writable=!0,this.emitReserved("drain")},this.setTimeoutFn)})}}doClose(){var e;(e=this._transport)===null||e===void 0||e.close()}}const Ts={websocket:As,webtransport:Ps,polling:Is},Ms=/^(?:(?![^:@\/?#]+:[^:@\/]*@)(http|https|ws|wss):\/\/)?((?:(([^:@\/?#]*)(?::([^:@\/?#]*))?)?@)?((?:[a-f0-9]{0,4}:){2,7}[a-f0-9]{0,4}|[^:\/?#]*)(?::(\d*))?)(((\/(?:[^?#](?![^?#\/]*\.[^?#\/.]+(?:[?#]|$)))*\/?)?([^?#\/]*))(?:\?([^#]*))?(?:#(.*))?)/,Rs=["source","protocol","authority","userInfo","user","password","host","port","relative","path","directory","file","query","anchor"];function et(s){if(s.length>8e3)throw"URI too long";const e=s,t=s.indexOf("["),a=s.indexOf("]");t!=-1&&a!=-1&&(s=s.substring(0,t)+s.substring(t,a).replace(/:/g,";")+s.substring(a,s.length));let n=Ms.exec(s||""),o={},r=14;for(;r--;)o[Rs[r]]=n[r]||"";return t!=-1&&a!=-1&&(o.source=e,o.host=o.host.substring(1,o.host.length-1).replace(/;/g,":"),o.authority=o.authority.replace("[","").replace("]","").replace(/;/g,":"),o.ipv6uri=!0),o.pathNames=Ds(o,o.path),o.queryKey=Ns(o,o.query),o}function Ds(s,e){const t=/\/{2,9}/g,a=e.replace(t,"/").split("/");return(e.slice(0,1)=="/"||e.length===0)&&a.splice(0,1),e.slice(-1)=="/"&&a.splice(a.length-1,1),a}function Ns(s,e){const t={};return e.replace(/(?:^|&)([^&=]*)=?([^&]*)/g,function(a,n,o){n&&(t[n]=o)}),t}const tt=typeof addEventListener=="function"&&typeof removeEventListener=="function",Te=[];tt&&addEventListener("offline",()=>{Te.forEach(s=>s())},!1);class de extends j{constructor(e,t){if(super(),this.binaryType=gs,this.writeBuffer=[],this._prevBufferLen=0,this._pingInterval=-1,this._pingTimeout=-1,this._maxPayload=-1,this._pingTimeoutTime=1/0,e&&typeof e=="object"&&(t=e,e=null),e){const a=et(e);t.hostname=a.host,t.secure=a.protocol==="https"||a.protocol==="wss",t.port=a.port,a.query&&(t.query=a.query)}else t.host&&(t.hostname=et(t.host).host);je(this,t),this.secure=t.secure!=null?t.secure:typeof location<"u"&&location.protocol==="https:",t.hostname&&!t.port&&(t.port=this.secure?"443":"80"),this.hostname=t.hostname||(typeof location<"u"?location.hostname:"localhost"),this.port=t.port||(typeof location<"u"&&location.port?location.port:this.secure?"443":"80"),this.transports=[],this._transportsByName={},t.transports.forEach(a=>{const n=a.prototype.name;this.transports.push(n),this._transportsByName[n]=a}),this.opts=Object.assign({path:"/engine.io",agent:!1,withCredentials:!1,upgrade:!0,timestampParam:"t",rememberUpgrade:!1,addTrailingSlash:!0,rejectUnauthorized:!0,perMessageDeflate:{threshold:1024},transportOptions:{},closeOnBeforeunload:!1},t),this.opts.path=this.opts.path.replace(/\/$/,"")+(this.opts.addTrailingSlash?"/":""),typeof this.opts.query=="string"&&(this.opts.query=Es(this.opts.query)),tt&&(this.opts.closeOnBeforeunload&&(this._beforeunloadEventListener=()=>{this.transport&&(this.transport.removeAllListeners(),this.transport.close())},addEventListener("beforeunload",this._beforeunloadEventListener,!1)),this.hostname!=="localhost"&&(this._offlineEventListener=()=>{this._onClose("transport close",{description:"network connection lost"})},Te.push(this._offlineEventListener))),this.opts.withCredentials&&(this._cookieJar=void 0),this._open()}createTransport(e){const t=Object.assign({},this.opts.query);t.EIO=qt,t.transport=e,this.id&&(t.sid=this.id);const a=Object.assign({},this.opts,{query:t,socket:this,hostname:this.hostname,secure:this.secure,port:this.port},this.opts.transportOptions[e]);return new this._transportsByName[e](a)}_open(){if(this.transports.length===0){this.setTimeoutFn(()=>{this.emitReserved("error","No transports available")},0);return}const e=this.opts.rememberUpgrade&&de.priorWebsocketSuccess&&this.transports.indexOf("websocket")!==-1?"websocket":this.transports[0];this.readyState="opening";const t=this.createTransport(e);t.open(),this.setTransport(t)}setTransport(e){this.transport&&this.transport.removeAllListeners(),this.transport=e,e.on("drain",this._onDrain.bind(this)).on("packet",this._onPacket.bind(this)).on("error",this._onError.bind(this)).on("close",t=>this._onClose("transport close",t))}onOpen(){this.readyState="open",de.priorWebsocketSuccess=this.transport.name==="websocket",this.emitReserved("open"),this.flush()}_onPacket(e){if(this.readyState==="opening"||this.readyState==="open"||this.readyState==="closing")switch(this.emitReserved("packet",e),this.emitReserved("heartbeat"),e.type){case"open":this.onHandshake(JSON.parse(e.data));break;case"ping":this._sendPacket("pong"),this.emitReserved("ping"),this.emitReserved("pong"),this._resetPingTimeout();break;case"error":const t=new Error("server error");t.code=e.data,this._onError(t);break;case"message":this.emitReserved("data",e.data),this.emitReserved("message",e.data);break}}onHandshake(e){this.emitReserved("handshake",e),this.id=e.sid,this.transport.query.sid=e.sid,this._pingInterval=e.pingInterval,this._pingTimeout=e.pingTimeout,this._maxPayload=e.maxPayload,this.onOpen(),this.readyState!=="closed"&&this._resetPingTimeout()}_resetPingTimeout(){this.clearTimeoutFn(this._pingTimeoutTimer);const e=this._pingInterval+this._pingTimeout;this._pingTimeoutTime=Date.now()+e,this._pingTimeoutTimer=this.setTimeoutFn(()=>{this._onClose("ping timeout")},e),this.opts.autoUnref&&this._pingTimeoutTimer.unref()}_onDrain(){this.writeBuffer.splice(0,this._prevBufferLen),this._prevBufferLen=0,this.writeBuffer.length===0?this.emitReserved("drain"):this.flush()}flush(){if(this.readyState!=="closed"&&this.transport.writable&&!this.upgrading&&this.writeBuffer.length){const e=this._getWritablePackets();this.transport.send(e),this._prevBufferLen=e.length,this.emitReserved("flush")}}_getWritablePackets(){if(!(this._maxPayload&&this.transport.name==="polling"&&this.writeBuffer.length>1))return this.writeBuffer;let t=1;for(let a=0;a<this.writeBuffer.length;a++){const n=this.writeBuffer[a].data;if(n&&(t+=bs(n)),a>0&&t>this._maxPayload)return this.writeBuffer.slice(0,a);t+=2}return this.writeBuffer}_hasPingExpired(){if(!this._pingTimeoutTime)return!0;const e=Date.now()>this._pingTimeoutTime;return e&&(this._pingTimeoutTime=0,ze(()=>{this._onClose("ping timeout")},this.setTimeoutFn)),e}write(e,t,a){return this._sendPacket("message",e,t,a),this}send(e,t,a){return this._sendPacket("message",e,t,a),this}_sendPacket(e,t,a,n){if(typeof t=="function"&&(n=t,t=void 0),typeof a=="function"&&(n=a,a=null),this.readyState==="closing"||this.readyState==="closed")return;a=a||{},a.compress=a.compress!==!1;const o={type:e,data:t,options:a};this.emitReserved("packetCreate",o),this.writeBuffer.push(o),n&&this.once("flush",n),this.flush()}close(){const e=()=>{this._onClose("forced close"),this.transport.close()},t=()=>{this.off("upgrade",t),this.off("upgradeError",t),e()},a=()=>{this.once("upgrade",t),this.once("upgradeError",t)};return(this.readyState==="opening"||this.readyState==="open")&&(this.readyState="closing",this.writeBuffer.length?this.once("drain",()=>{this.upgrading?a():e()}):this.upgrading?a():e()),this}_onError(e){if(de.priorWebsocketSuccess=!1,this.opts.tryAllTransports&&this.transports.length>1&&this.readyState==="opening")return this.transports.shift(),this._open();this.emitReserved("error",e),this._onClose("transport error",e)}_onClose(e,t){if(this.readyState==="opening"||this.readyState==="open"||this.readyState==="closing"){if(this.clearTimeoutFn(this._pingTimeoutTimer),this.transport.removeAllListeners("close"),this.transport.close(),this.transport.removeAllListeners(),tt&&(this._beforeunloadEventListener&&removeEventListener("beforeunload",this._beforeunloadEventListener,!1),this._offlineEventListener)){const a=Te.indexOf(this._offlineEventListener);a!==-1&&Te.splice(a,1)}this.readyState="closed",this.id=null,this.emitReserved("close",e,t),this.writeBuffer=[],this._prevBufferLen=0}}}de.protocol=qt;class qs extends de{constructor(){super(...arguments),this._upgrades=[]}onOpen(){if(super.onOpen(),this.readyState==="open"&&this.opts.upgrade)for(let e=0;e<this._upgrades.length;e++)this._probe(this._upgrades[e])}_probe(e){let t=this.createTransport(e),a=!1;de.priorWebsocketSuccess=!1;const n=()=>{a||(t.send([{type:"ping",data:"probe"}]),t.once("packet",C=>{if(!a)if(C.type==="pong"&&C.data==="probe"){if(this.upgrading=!0,this.emitReserved("upgrading",t),!t)return;de.priorWebsocketSuccess=t.name==="websocket",this.transport.pause(()=>{a||this.readyState!=="closed"&&(y(),this.setTransport(t),t.send([{type:"upgrade"}]),this.emitReserved("upgrade",t),t=null,this.upgrading=!1,this.flush())})}else{const b=new Error("probe error");b.transport=t.name,this.emitReserved("upgradeError",b)}}))};function o(){a||(a=!0,y(),t.close(),t=null)}const r=C=>{const b=new Error("probe error: "+C);b.transport=t.name,o(),this.emitReserved("upgradeError",b)};function u(){r("transport closed")}function c(){r("socket closed")}function p(C){t&&C.name!==t.name&&o()}const y=()=>{t.removeListener("open",n),t.removeListener("error",r),t.removeListener("close",u),this.off("close",c),this.off("upgrading",p)};t.once("open",n),t.once("error",r),t.once("close",u),this.once("close",c),this.once("upgrading",p),this._upgrades.indexOf("webtransport")!==-1&&e!=="webtransport"?this.setTimeoutFn(()=>{a||t.open()},200):t.open()}onHandshake(e){this._upgrades=this._filterUpgrades(e.upgrades),super.onHandshake(e)}_filterUpgrades(e){const t=[];for(let a=0;a<e.length;a++)~this.transports.indexOf(e[a])&&t.push(e[a]);return t}}let Fs=class extends qs{constructor(e,t={}){const a=typeof e=="object"?e:t;(!a.transports||a.transports&&typeof a.transports[0]=="string")&&(a.transports=(a.transports||["polling","websocket","webtransport"]).map(n=>Ts[n]).filter(n=>!!n)),super(e,a)}};function Os(s,e="",t){let a=s;t=t||typeof location<"u"&&location,s==null&&(s=t.protocol+"//"+t.host),typeof s=="string"&&(s.charAt(0)==="/"&&(s.charAt(1)==="/"?s=t.protocol+s:s=t.host+s),/^(https?|wss?):\/\//.test(s)||(typeof t<"u"?s=t.protocol+"//"+s:s="https://"+s),a=et(s)),a.port||(/^(http|ws)$/.test(a.protocol)?a.port="80":/^(http|ws)s$/.test(a.protocol)&&(a.port="443")),a.path=a.path||"/";const o=a.host.indexOf(":")!==-1?"["+a.host+"]":a.host;return a.id=a.protocol+"://"+o+":"+a.port+e,a.href=a.protocol+"://"+o+(t&&t.port===a.port?"":":"+a.port),a}const Vs=typeof ArrayBuffer=="function",Us=s=>typeof ArrayBuffer.isView=="function"?ArrayBuffer.isView(s):s.buffer instanceof ArrayBuffer,zt=Object.prototype.toString,Hs=typeof Blob=="function"||typeof Blob<"u"&&zt.call(Blob)==="[object BlobConstructor]",zs=typeof File=="function"||typeof File<"u"&&zt.call(File)==="[object FileConstructor]";function gt(s){return Vs&&(s instanceof ArrayBuffer||Us(s))||Hs&&s instanceof Blob||zs&&s instanceof File}function Me(s,e){if(!s||typeof s!="object")return!1;if(Array.isArray(s)){for(let t=0,a=s.length;t<a;t++)if(Me(s[t]))return!0;return!1}if(gt(s))return!0;if(s.toJSON&&typeof s.toJSON=="function"&&arguments.length===1)return Me(s.toJSON(),!0);for(const t in s)if(Object.prototype.hasOwnProperty.call(s,t)&&Me(s[t]))return!0;return!1}function js(s){const e=[],t=s.data,a=s;return a.data=st(t,e),a.attachments=e.length,{packet:a,buffers:e}}function st(s,e){if(!s)return s;if(gt(s)){const t={_placeholder:!0,num:e.length};return e.push(s),t}else if(Array.isArray(s)){const t=new Array(s.length);for(let a=0;a<s.length;a++)t[a]=st(s[a],e);return t}else if(typeof s=="object"&&!(s instanceof Date)){const t={};for(const a in s)Object.prototype.hasOwnProperty.call(s,a)&&(t[a]=st(s[a],e));return t}return s}function Qs(s,e){return s.data=at(s.data,e),delete s.attachments,s}function at(s,e){if(!s)return s;if(s&&s._placeholder===!0){if(typeof s.num=="number"&&s.num>=0&&s.num<e.length)return e[s.num];throw new Error("illegal attachments")}else if(Array.isArray(s))for(let t=0;t<s.length;t++)s[t]=at(s[t],e);else if(typeof s=="object")for(const t in s)Object.prototype.hasOwnProperty.call(s,t)&&(s[t]=at(s[t],e));return s}const Ws=["connect","connect_error","disconnect","disconnecting","newListener","removeListener"];var R;(function(s){s[s.CONNECT=0]="CONNECT",s[s.DISCONNECT=1]="DISCONNECT",s[s.EVENT=2]="EVENT",s[s.ACK=3]="ACK",s[s.CONNECT_ERROR=4]="CONNECT_ERROR",s[s.BINARY_EVENT=5]="BINARY_EVENT",s[s.BINARY_ACK=6]="BINARY_ACK"})(R||(R={}));class Gs{constructor(e){this.replacer=e}encode(e){return(e.type===R.EVENT||e.type===R.ACK)&&Me(e)?this.encodeAsBinary({type:e.type===R.EVENT?R.BINARY_EVENT:R.BINARY_ACK,nsp:e.nsp,data:e.data,id:e.id}):[this.encodeAsString(e)]}encodeAsString(e){let t=""+e.type;return(e.type===R.BINARY_EVENT||e.type===R.BINARY_ACK)&&(t+=e.attachments+"-"),e.nsp&&e.nsp!=="/"&&(t+=e.nsp+","),e.id!=null&&(t+=e.id),e.data!=null&&(t+=JSON.stringify(e.data,this.replacer)),t}encodeAsBinary(e){const t=js(e),a=this.encodeAsString(t.packet),n=t.buffers;return n.unshift(a),n}}class ft extends j{constructor(e){super(),this.reviver=e}add(e){let t;if(typeof e=="string"){if(this.reconstructor)throw new Error("got plaintext data when reconstructing a packet");t=this.decodeString(e);const a=t.type===R.BINARY_EVENT;a||t.type===R.BINARY_ACK?(t.type=a?R.EVENT:R.ACK,this.reconstructor=new Ks(t),t.attachments===0&&super.emitReserved("decoded",t)):super.emitReserved("decoded",t)}else if(gt(e)||e.base64)if(this.reconstructor)t=this.reconstructor.takeBinaryData(e),t&&(this.reconstructor=null,super.emitReserved("decoded",t));else throw new Error("got binary data when not reconstructing a packet");else throw new Error("Unknown type: "+e)}decodeString(e){let t=0;const a={type:Number(e.charAt(0))};if(R[a.type]===void 0)throw new Error("unknown packet type "+a.type);if(a.type===R.BINARY_EVENT||a.type===R.BINARY_ACK){const o=t+1;for(;e.charAt(++t)!=="-"&&t!=e.length;);const r=e.substring(o,t);if(r!=Number(r)||e.charAt(t)!=="-")throw new Error("Illegal attachments");a.attachments=Number(r)}if(e.charAt(t+1)==="/"){const o=t+1;for(;++t&&!(e.charAt(t)===","||t===e.length););a.nsp=e.substring(o,t)}else a.nsp="/";const n=e.charAt(t+1);if(n!==""&&Number(n)==n){const o=t+1;for(;++t;){const r=e.charAt(t);if(r==null||Number(r)!=r){--t;break}if(t===e.length)break}a.id=Number(e.substring(o,t+1))}if(e.charAt(++t)){const o=this.tryParse(e.substr(t));if(ft.isPayloadValid(a.type,o))a.data=o;else throw new Error("invalid payload")}return a}tryParse(e){try{return JSON.parse(e,this.reviver)}catch{return!1}}static isPayloadValid(e,t){switch(e){case R.CONNECT:return _t(t);case R.DISCONNECT:return t===void 0;case R.CONNECT_ERROR:return typeof t=="string"||_t(t);case R.EVENT:case R.BINARY_EVENT:return Array.isArray(t)&&(typeof t[0]=="number"||typeof t[0]=="string"&&Ws.indexOf(t[0])===-1);case R.ACK:case R.BINARY_ACK:return Array.isArray(t)}}destroy(){this.reconstructor&&(this.reconstructor.finishedReconstruction(),this.reconstructor=null)}}class Ks{constructor(e){this.packet=e,this.buffers=[],this.reconPack=e}takeBinaryData(e){if(this.buffers.push(e),this.buffers.length===this.reconPack.attachments){const t=Qs(this.reconPack,this.buffers);return this.finishedReconstruction(),t}return null}finishedReconstruction(){this.reconPack=null,this.buffers=[]}}function _t(s){return Object.prototype.toString.call(s)==="[object Object]"}const Ys=Object.freeze(Object.defineProperty({__proto__:null,Decoder:ft,Encoder:Gs,get PacketType(){return R}},Symbol.toStringTag,{value:"Module"}));function se(s,e,t){return s.on(e,t),function(){s.off(e,t)}}const Js=Object.freeze({connect:1,connect_error:1,disconnect:1,disconnecting:1,newListener:1,removeListener:1});class jt extends j{constructor(e,t,a){super(),this.connected=!1,this.recovered=!1,this.receiveBuffer=[],this.sendBuffer=[],this._queue=[],this._queueSeq=0,this.ids=0,this.acks={},this.flags={},this.io=e,this.nsp=t,a&&a.auth&&(this.auth=a.auth),this._opts=Object.assign({},a),this.io._autoConnect&&this.open()}get disconnected(){return!this.connected}subEvents(){if(this.subs)return;const e=this.io;this.subs=[se(e,"open",this.onopen.bind(this)),se(e,"packet",this.onpacket.bind(this)),se(e,"error",this.onerror.bind(this)),se(e,"close",this.onclose.bind(this))]}get active(){return!!this.subs}connect(){return this.connected?this:(this.subEvents(),this.io._reconnecting||this.io.open(),this.io._readyState==="open"&&this.onopen(),this)}open(){return this.connect()}send(...e){return e.unshift("message"),this.emit.apply(this,e),this}emit(e,...t){var a,n,o;if(Js.hasOwnProperty(e))throw new Error('"'+e.toString()+'" is a reserved event name');if(t.unshift(e),this._opts.retries&&!this.flags.fromQueue&&!this.flags.volatile)return this._addToQueue(t),this;const r={type:R.EVENT,data:t};if(r.options={},r.options.compress=this.flags.compress!==!1,typeof t[t.length-1]=="function"){const y=this.ids++,C=t.pop();this._registerAckCallback(y,C),r.id=y}const u=(n=(a=this.io.engine)===null||a===void 0?void 0:a.transport)===null||n===void 0?void 0:n.writable,c=this.connected&&!(!((o=this.io.engine)===null||o===void 0)&&o._hasPingExpired());return this.flags.volatile&&!u||(c?(this.notifyOutgoingListeners(r),this.packet(r)):this.sendBuffer.push(r)),this.flags={},this}_registerAckCallback(e,t){var a;const n=(a=this.flags.timeout)!==null&&a!==void 0?a:this._opts.ackTimeout;if(n===void 0){this.acks[e]=t;return}const o=this.io.setTimeoutFn(()=>{delete this.acks[e];for(let u=0;u<this.sendBuffer.length;u++)this.sendBuffer[u].id===e&&this.sendBuffer.splice(u,1);t.call(this,new Error("operation has timed out"))},n),r=(...u)=>{this.io.clearTimeoutFn(o),t.apply(this,u)};r.withError=!0,this.acks[e]=r}emitWithAck(e,...t){return new Promise((a,n)=>{const o=(r,u)=>r?n(r):a(u);o.withError=!0,t.push(o),this.emit(e,...t)})}_addToQueue(e){let t;typeof e[e.length-1]=="function"&&(t=e.pop());const a={id:this._queueSeq++,tryCount:0,pending:!1,args:e,flags:Object.assign({fromQueue:!0},this.flags)};e.push((n,...o)=>(this._queue[0],n!==null?a.tryCount>this._opts.retries&&(this._queue.shift(),t&&t(n)):(this._queue.shift(),t&&t(null,...o)),a.pending=!1,this._drainQueue())),this._queue.push(a),this._drainQueue()}_drainQueue(e=!1){if(!this.connected||this._queue.length===0)return;const t=this._queue[0];t.pending&&!e||(t.pending=!0,t.tryCount++,this.flags=t.flags,this.emit.apply(this,t.args))}packet(e){e.nsp=this.nsp,this.io._packet(e)}onopen(){typeof this.auth=="function"?this.auth(e=>{this._sendConnectPacket(e)}):this._sendConnectPacket(this.auth)}_sendConnectPacket(e){this.packet({type:R.CONNECT,data:this._pid?Object.assign({pid:this._pid,offset:this._lastOffset},e):e})}onerror(e){this.connected||this.emitReserved("connect_error",e)}onclose(e,t){this.connected=!1,delete this.id,this.emitReserved("disconnect",e,t),this._clearAcks()}_clearAcks(){Object.keys(this.acks).forEach(e=>{if(!this.sendBuffer.some(a=>String(a.id)===e)){const a=this.acks[e];delete this.acks[e],a.withError&&a.call(this,new Error("socket has been disconnected"))}})}onpacket(e){if(e.nsp===this.nsp)switch(e.type){case R.CONNECT:e.data&&e.data.sid?this.onconnect(e.data.sid,e.data.pid):this.emitReserved("connect_error",new Error("It seems you are trying to reach a Socket.IO server in v2.x with a v3.x client, but they are not compatible (more information here: https://socket.io/docs/v3/migrating-from-2-x-to-3-0/)"));break;case R.EVENT:case R.BINARY_EVENT:this.onevent(e);break;case R.ACK:case R.BINARY_ACK:this.onack(e);break;case R.DISCONNECT:this.ondisconnect();break;case R.CONNECT_ERROR:this.destroy();const a=new Error(e.data.message);a.data=e.data.data,this.emitReserved("connect_error",a);break}}onevent(e){const t=e.data||[];e.id!=null&&t.push(this.ack(e.id)),this.connected?this.emitEvent(t):this.receiveBuffer.push(Object.freeze(t))}emitEvent(e){if(this._anyListeners&&this._anyListeners.length){const t=this._anyListeners.slice();for(const a of t)a.apply(this,e)}super.emit.apply(this,e),this._pid&&e.length&&typeof e[e.length-1]=="string"&&(this._lastOffset=e[e.length-1])}ack(e){const t=this;let a=!1;return function(...n){a||(a=!0,t.packet({type:R.ACK,id:e,data:n}))}}onack(e){const t=this.acks[e.id];typeof t=="function"&&(delete this.acks[e.id],t.withError&&e.data.unshift(null),t.apply(this,e.data))}onconnect(e,t){this.id=e,this.recovered=t&&this._pid===t,this._pid=t,this.connected=!0,this.emitBuffered(),this._drainQueue(!0),this.emitReserved("connect")}emitBuffered(){this.receiveBuffer.forEach(e=>this.emitEvent(e)),this.receiveBuffer=[],this.sendBuffer.forEach(e=>{this.notifyOutgoingListeners(e),this.packet(e)}),this.sendBuffer=[]}ondisconnect(){this.destroy(),this.onclose("io server disconnect")}destroy(){this.subs&&(this.subs.forEach(e=>e()),this.subs=void 0),this.io._destroy(this)}disconnect(){return this.connected&&this.packet({type:R.DISCONNECT}),this.destroy(),this.connected&&this.onclose("io client disconnect"),this}close(){return this.disconnect()}compress(e){return this.flags.compress=e,this}get volatile(){return this.flags.volatile=!0,this}timeout(e){return this.flags.timeout=e,this}onAny(e){return this._anyListeners=this._anyListeners||[],this._anyListeners.push(e),this}prependAny(e){return this._anyListeners=this._anyListeners||[],this._anyListeners.unshift(e),this}offAny(e){if(!this._anyListeners)return this;if(e){const t=this._anyListeners;for(let a=0;a<t.length;a++)if(e===t[a])return t.splice(a,1),this}else this._anyListeners=[];return this}listenersAny(){return this._anyListeners||[]}onAnyOutgoing(e){return this._anyOutgoingListeners=this._anyOutgoingListeners||[],this._anyOutgoingListeners.push(e),this}prependAnyOutgoing(e){return this._anyOutgoingListeners=this._anyOutgoingListeners||[],this._anyOutgoingListeners.unshift(e),this}offAnyOutgoing(e){if(!this._anyOutgoingListeners)return this;if(e){const t=this._anyOutgoingListeners;for(let a=0;a<t.length;a++)if(e===t[a])return t.splice(a,1),this}else this._anyOutgoingListeners=[];return this}listenersAnyOutgoing(){return this._anyOutgoingListeners||[]}notifyOutgoingListeners(e){if(this._anyOutgoingListeners&&this._anyOutgoingListeners.length){const t=this._anyOutgoingListeners.slice();for(const a of t)a.apply(this,e.data)}}}function be(s){s=s||{},this.ms=s.min||100,this.max=s.max||1e4,this.factor=s.factor||2,this.jitter=s.jitter>0&&s.jitter<=1?s.jitter:0,this.attempts=0}be.prototype.duration=function(){var s=this.ms*Math.pow(this.factor,this.attempts++);if(this.jitter){var e=Math.random(),t=Math.floor(e*this.jitter*s);s=Math.floor(e*10)&1?s+t:s-t}return Math.min(s,this.max)|0};be.prototype.reset=function(){this.attempts=0};be.prototype.setMin=function(s){this.ms=s};be.prototype.setMax=function(s){this.max=s};be.prototype.setJitter=function(s){this.jitter=s};class nt extends j{constructor(e,t){var a;super(),this.nsps={},this.subs=[],e&&typeof e=="object"&&(t=e,e=void 0),t=t||{},t.path=t.path||"/socket.io",this.opts=t,je(this,t),this.reconnection(t.reconnection!==!1),this.reconnectionAttempts(t.reconnectionAttempts||1/0),this.reconnectionDelay(t.reconnectionDelay||1e3),this.reconnectionDelayMax(t.reconnectionDelayMax||5e3),this.randomizationFactor((a=t.randomizationFactor)!==null&&a!==void 0?a:.5),this.backoff=new be({min:this.reconnectionDelay(),max:this.reconnectionDelayMax(),jitter:this.randomizationFactor()}),this.timeout(t.timeout==null?2e4:t.timeout),this._readyState="closed",this.uri=e;const n=t.parser||Ys;this.encoder=new n.Encoder,this.decoder=new n.Decoder,this._autoConnect=t.autoConnect!==!1,this._autoConnect&&this.open()}reconnection(e){return arguments.length?(this._reconnection=!!e,e||(this.skipReconnect=!0),this):this._reconnection}reconnectionAttempts(e){return e===void 0?this._reconnectionAttempts:(this._reconnectionAttempts=e,this)}reconnectionDelay(e){var t;return e===void 0?this._reconnectionDelay:(this._reconnectionDelay=e,(t=this.backoff)===null||t===void 0||t.setMin(e),this)}randomizationFactor(e){var t;return e===void 0?this._randomizationFactor:(this._randomizationFactor=e,(t=this.backoff)===null||t===void 0||t.setJitter(e),this)}reconnectionDelayMax(e){var t;return e===void 0?this._reconnectionDelayMax:(this._reconnectionDelayMax=e,(t=this.backoff)===null||t===void 0||t.setMax(e),this)}timeout(e){return arguments.length?(this._timeout=e,this):this._timeout}maybeReconnectOnOpen(){!this._reconnecting&&this._reconnection&&this.backoff.attempts===0&&this.reconnect()}open(e){if(~this._readyState.indexOf("open"))return this;this.engine=new Fs(this.uri,this.opts);const t=this.engine,a=this;this._readyState="opening",this.skipReconnect=!1;const n=se(t,"open",function(){a.onopen(),e&&e()}),o=u=>{this.cleanup(),this._readyState="closed",this.emitReserved("error",u),e?e(u):this.maybeReconnectOnOpen()},r=se(t,"error",o);if(this._timeout!==!1){const u=this._timeout,c=this.setTimeoutFn(()=>{n(),o(new Error("timeout")),t.close()},u);this.opts.autoUnref&&c.unref(),this.subs.push(()=>{this.clearTimeoutFn(c)})}return this.subs.push(n),this.subs.push(r),this}connect(e){return this.open(e)}onopen(){this.cleanup(),this._readyState="open",this.emitReserved("open");const e=this.engine;this.subs.push(se(e,"ping",this.onping.bind(this)),se(e,"data",this.ondata.bind(this)),se(e,"error",this.onerror.bind(this)),se(e,"close",this.onclose.bind(this)),se(this.decoder,"decoded",this.ondecoded.bind(this)))}onping(){this.emitReserved("ping")}ondata(e){try{this.decoder.add(e)}catch(t){this.onclose("parse error",t)}}ondecoded(e){ze(()=>{this.emitReserved("packet",e)},this.setTimeoutFn)}onerror(e){this.emitReserved("error",e)}socket(e,t){let a=this.nsps[e];return a?this._autoConnect&&!a.active&&a.connect():(a=new jt(this,e,t),this.nsps[e]=a),a}_destroy(e){const t=Object.keys(this.nsps);for(const a of t)if(this.nsps[a].active)return;this._close()}_packet(e){const t=this.encoder.encode(e);for(let a=0;a<t.length;a++)this.engine.write(t[a],e.options)}cleanup(){this.subs.forEach(e=>e()),this.subs.length=0,this.decoder.destroy()}_close(){this.skipReconnect=!0,this._reconnecting=!1,this.onclose("forced close")}disconnect(){return this._close()}onclose(e,t){var a;this.cleanup(),(a=this.engine)===null||a===void 0||a.close(),this.backoff.reset(),this._readyState="closed",this.emitReserved("close",e,t),this._reconnection&&!this.skipReconnect&&this.reconnect()}reconnect(){if(this._reconnecting||this.skipReconnect)return this;const e=this;if(this.backoff.attempts>=this._reconnectionAttempts)this.backoff.reset(),this.emitReserved("reconnect_failed"),this._reconnecting=!1;else{const t=this.backoff.duration();this._reconnecting=!0;const a=this.setTimeoutFn(()=>{e.skipReconnect||(this.emitReserved("reconnect_attempt",e.backoff.attempts),!e.skipReconnect&&e.open(n=>{n?(e._reconnecting=!1,e.reconnect(),this.emitReserved("reconnect_error",n)):e.onreconnect()}))},t);this.opts.autoUnref&&a.unref(),this.subs.push(()=>{this.clearTimeoutFn(a)})}}onreconnect(){const e=this.backoff.attempts;this._reconnecting=!1,this.backoff.reset(),this.emitReserved("reconnect",e)}}const ke={};function Re(s,e){typeof s=="object"&&(e=s,s=void 0),e=e||{};const t=Os(s,e.path||"/socket.io"),a=t.source,n=t.id,o=t.path,r=ke[n]&&o in ke[n].nsps,u=e.forceNew||e["force new connection"]||e.multiplex===!1||r;let c;return u?c=new nt(a,e):(ke[n]||(ke[n]=new nt(a,e)),c=ke[n]),t.query&&!e.query&&(e.query=t.queryKey),c.socket(t.path,e)}Object.assign(Re,{Manager:nt,Socket:jt,io:Re,connect:Re});class Xs{constructor(){this.socket=null,this.listeners=new Map,this.subscribedMangas=new Set}connect(){var e;(e=this.socket)!=null&&e.connected||(this.socket=Re({autoConnect:!0,reconnection:!0,reconnectionDelay:1e3,reconnectionAttempts:10}),this.socket.on("connect",()=>{console.log("[Socket] Connected:",this.socket.id),this.subscribedMangas.forEach(t=>{this.socket.emit("subscribe:manga",t)}),this.socket.emit("subscribe:global")}),this.socket.on("disconnect",t=>{console.log("[Socket] Disconnected:",t)}),this.socket.on("connect_error",t=>{console.error("[Socket] Connection error:",t.message)}))}disconnect(){this.socket&&(this.socket.disconnect(),this.socket=null)}subscribeToManga(e){var t;this.subscribedMangas.add(e),(t=this.socket)!=null&&t.connected&&this.socket.emit("subscribe:manga",e)}unsubscribeFromManga(e){var t;this.subscribedMangas.delete(e),(t=this.socket)!=null&&t.connected&&this.socket.emit("unsubscribe:manga",e)}on(e,t){this.listeners.has(e)||this.listeners.set(e,new Set),this.listeners.get(e).add(t),this.socket&&this.socket.on(e,t)}off(e,t){this.listeners.has(e)&&this.listeners.get(e).delete(t),this.socket&&this.socket.off(e,t)}emit(e,t){var a;(a=this.socket)!=null&&a.connected&&this.socket.emit(e,t)}}const Q={CHAPTER_DOWNLOADED:"chapter:downloaded",CHAPTER_HIDDEN:"chapter:hidden",CHAPTER_UNHIDDEN:"chapter:unhidden",MANGA_UPDATED:"manga:updated",MANGA_ADDED:"manga:added",MANGA_DELETED:"manga:deleted",DOWNLOAD_PROGRESS:"download:progress",DOWNLOAD_COMPLETED:"download:completed",QUEUE_UPDATED:"queue:updated",ACTION_RECORDED:"action:recorded",ACTION_UNDONE:"action:undone"},V=new Xs,K={bookmarks:[],series:[],categories:[],favorites:{favorites:{},listOrder:[]}},ae=new Set,U=new Map,$e=new Map;function Zs(s){return K[s]}function ea(s,e){K[s]=e,ae.add(s),_e(s)}function ta(s,e){return $e.has(s)||$e.set(s,new Set),$e.get(s).add(e),()=>{var t;return(t=$e.get(s))==null?void 0:t.delete(e)}}function _e(s){const e=$e.get(s);e&&e.forEach(t=>t(K[s]))}function Ce(s){ae.delete(s),U.delete(s)}function sa(s){return ae.has(s)}async function Se(s=!1){if(!s&&ae.has("bookmarks"))return K.bookmarks;if(U.has("bookmarks"))return U.get("bookmarks");const e=v.getBookmarks().then(t=>(K.bookmarks=t||[],ae.add("bookmarks"),U.delete("bookmarks"),_e("bookmarks"),K.bookmarks)).catch(t=>{throw U.delete("bookmarks"),t});return U.set("bookmarks",e),e}async function aa(s=!1){if(!s&&ae.has("series"))return K.series;if(U.has("series"))return U.get("series");const e=v.get("/series").then(t=>(K.series=t||[],ae.add("series"),U.delete("series"),_e("series"),K.series)).catch(t=>{throw U.delete("series"),t});return U.set("series",e),e}async function na(s=!1){if(!s&&ae.has("categories"))return K.categories;if(U.has("categories"))return U.get("categories");const e=v.get("/categories").then(t=>(K.categories=t.categories||[],ae.add("categories"),U.delete("categories"),_e("categories"),K.categories)).catch(t=>{throw U.delete("categories"),t});return U.set("categories",e),e}async function ia(s=!1){if(!s&&ae.has("favorites"))return K.favorites;if(U.has("favorites"))return U.get("favorites");const e=v.getFavorites().then(t=>(K.favorites=t||{favorites:{},listOrder:[]},ae.add("favorites"),U.delete("favorites"),_e("favorites"),K.favorites)).catch(t=>{throw U.delete("favorites"),t});return U.set("favorites",e),e}function oa(){V.on(Q.MANGA_UPDATED,()=>{Ce("bookmarks"),Se(!0)}),V.on(Q.MANGA_ADDED,()=>{Ce("bookmarks"),Se(!0)}),V.on(Q.MANGA_DELETED,()=>{Ce("bookmarks"),Se(!0)}),V.on(Q.DOWNLOAD_COMPLETED,()=>{Ce("bookmarks"),Se(!0)})}oa();const ne={get:Zs,set:ea,subscribe:ta,invalidate:Ce,isLoaded:sa,loadBookmarks:Se,loadSeries:aa,loadCategories:na,loadFavorites:ia};function d(s,e="info"){document.querySelectorAll(".toast").forEach(n=>{n.classList.contains("show")&&n.classList.remove("show")});const a=document.createElement("div");a.className=`toast toast-${e}`,a.textContent=s,document.body.appendChild(a),requestAnimationFrame(()=>a.classList.add("show")),setTimeout(()=>{a.classList.remove("show"),setTimeout(()=>a.remove(),300)},3e3)}async function ra(s,e,t){try{s&&(s.disabled=!0,s.textContent="Scanning..."),e&&(e.textContent="Scanning..."),d("Scanning downloads folder...","info");const n=(await v.scanLibrary()).found||[];if(n.length===0){d("Scan complete: No new manga found","info"),t&&t();return}la(n,t)}catch(a){d("Scan failed: "+a.message,"error")}finally{s&&(s.disabled=!1,s.textContent="📁 Scan Folder"),e&&(e.textContent="📁 Scan Folder")}}async function la(s,e){const t=document.createElement("div");t.id="import-modal-overlay",t.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.7);z-index:9999;display:flex;align-items:center;justify-content:center;";const a=document.createElement("div");a.style.cssText="background:var(--bg-primary);border-radius:8px;padding:24px;max-width:500px;width:90%;max-height:80vh;overflow-y:auto;",a.innerHTML=`
  ...
  `}function ue(){const s=document.querySelector("header");if(s&&s.dataset.listenersBound)return;s&&(s.dataset.listenersBound="true");const e=document.getElementById("hamburger-btn"),t=document.getElementById("mobile-menu");e&&t&&e.addEventListener("click",()=>{t.classList.toggle("hidden")});const a=document.getElementById("logout-btn"),n=document.getElementById("mobile-logout-btn"),o=()=>{localStorage.removeItem("manga_auth_token"),window.location.href="/login.html"};a&&a.addEventListener("click",o),n&&n.addEventListener("click",o),document.querySelectorAll("[data-view]").forEach(g=>{g.addEventListener("click",()=>{const m=g.dataset.view;localStorage.setItem("library_view_mode",m),document.querySelectorAll("[data-view]").forEach(x=>{x.classList.toggle("active",x.dataset.view===m)}),window.dispatchEvent(new CustomEvent("viewModeChange",{detail:{mode:m}}))})});const r=document.querySelector(".logo");r&&r.addEventListener("click",g=>{localStorage.removeItem("library_active_category"),window.dispatchEvent(new CustomEvent("clearFilters"))});const u=document.getElementById("favorites-btn"),c=document.getElementById("mobile-favorites-btn"),p=g=>{g.preventDefault(),P.go("/favorites")};u&&u.addEventListener("click",p),c&&c.addEventListener("click",p);const y=document.getElementById("queue-nav-btn");y&&y.addEventListener("click",g=>{g.preventDefault(),P.go("/queue")});const C=document.getElementById("scan-btn"),b=document.getElementById("mobile-scan-btn");if(C||b){const g=()=>{ra(C,b,async()=>{await ne.loadBookmarks(!0),P.reload()})};C&&C.addEventListener("click",g),b&&b.addEventListener("click",g)}}let $={bookmarks:[],series:[],favorites:{favorites:{},listOrder:[]},activeCategory:localStorage.getItem("library_active_category")||null,artistFilter:null,searchQuery:localStorage.getItem("library_search")||"",sortBy:localStorage.getItem("library_sort")||"updated",viewMode:"manga",loading:!0},Fe=[];function vt(s){return[...s].sort((e,t)=>{var a,n;switch($.sortBy){case"az":return(e.alias||e.title).localeCompare(t.alias||t.title);case"za":return(t.alias||t.title).localeCompare(e.alias||e.title);case"lastread":return(t.lastReadAt||"").localeCompare(e.lastReadAt||"");case"chapters":{const o=((a=e.chapters)==null?void 0:a.length)||e.uniqueChapters||0;return(((n=t.chapters)==null?void 0:n.length)||t.uniqueChapters||0)-o}case"updated":default:return(t.updatedAt||"").localeCompare(e.updatedAt||"")}})}function yt(s){var y,C,b;const e=s.alias||s.title,t=s.downloadedCount??((y=s.downloadedChapters)==null?void 0:y.length)??0,a=new Set(s.excludedChapters||[]),n=(s.chapters||[]).filter(g=>!a.has(g.number)),o=new Set(n.map(g=>g.number)).size||s.uniqueChapters||0,r=s.readCount??((C=s.readChapters)==null?void 0:C.length)??0,u=(s.updatedCount??((b=s.updatedChapters)==null?void 0:b.length)??0)>0,c=s.localCover?`/api/public/covers/${s.id}/${encodeURIComponent(s.localCover.split(/[/\\]/).pop())}`:s.cover,p=s.source==="local";return`
    <div class="manga-card" data-id="${s.id}">
      <div class="manga-card-cover">
        ...
        <div class="manga-card-badges">
          ...
          ${$.activeCategory==="Favorites"?'<span class="badge badge-play" title="Click to Read">▶</span>':""}
        </div>
      </div>
  ...
  `}function Oe(){const s=localStorage.getItem("library_view_mode");if(s&&s!==$.viewMode&&($.viewMode=s),$.activeCategory==="Favorites")return P.go("/favorites"),"";let e="";if($.viewMode==="series"){const t=$.series.map(ca).join("");e=`
      <div class="library-grid" id="library-grid">
        ${$.loading?'<div class="loading-spinner"></div>':t||'<div class="empty-state"><h2>No series yet</h2><p>Create a series to group related manga together.</p><button class="btn btn-primary" id="empty-add-series-btn">+ Create Series</button></div>'}
      </div>
    `}else{let t=$.bookmarks;const a=(Array.isArray($.categories)?$.categories:[]).filter(o=>typeof o=="object"?o.isNsfw:!1).map(o=>o.name);if($.activeCategory==="__nsfw__"?t=t.filter(o=>(o.categories||[]).some(r=>a.includes(r))):$.activeCategory?t=t.filter(o=>(o.categories||[]).includes($.activeCategory)):a.length>0&&(t=t.filter(o=>!(o.categories||[]).some(r=>a.includes(r)))),$.artistFilter&&(t=t.filter(o=>(o.artists||[]).includes($.artistFilter))),$.searchQuery){const o=$.searchQuery.toLowerCase();t=t.filter(r=>(r.title||"").toLowerCase().includes(o)||(r.alias||"").toLowerCase().includes(o)||(r.artists||[]).some(u=>u.toLowerCase().includes(o)))}t=vt(t);const n=t.map(yt).join("");e=`
      ...
      `:""}
      <div class="library-grid" id="library-grid">
        ${$.loading?'<div class="loading-spinner"></div>':n||bt()}
      </div>
    `}return`
    ${Z($.viewMode)}
    <div class="container">
    ...
    ${ha()}
    ${pa()}
  `}function da(){const{activeCategory:s}=$,t=(Array.isArray($.categories)?$.categories:[]).map(n=>typeof n=="object"?n:{name:n,isNsfw:!1}),a=t.some(n=>n.isNsfw);return`
    ...
    ${ua()}
      `}function ua(){const e=(Array.isArray($.categories)?$.categories:[]).map(t=>typeof t=="object"?t:{name:t,isNsfw:!1});return`
  ...
  `}function ha(){return`
      ...
      `}function it(){$.activeCategory=null,$.artistFilter=null,$.searchQuery="",localStorage.removeItem("library_active_category"),localStorage.removeItem("library_artist_filter"),localStorage.removeItem("library_search"),J()}async function ot(s){const e=s.target.closest(".manga-card");if(e){if(e.classList.contains("gallery-card")){const n=e.dataset.gallery;P.go(`/read/gallery/${encodeURIComponent(n)}`);return}const t=e.dataset.id,a=e.dataset.seriesId;if(a){P.go(`/series/${a}`);return}if(t){if($.activeCategory==="Favorites"){const n=$.bookmarks.find(o=>o.id===t);if(n){let o=n.last_read_chapter;if(!o&&n.chapters&&n.chapters.length>0&&(o=[...n.chapters].sort((u,c)=>u.number-c.number)[0].number),o){P.go(`/read/${t}/${o}`);return}else d("No chapters available to read","warning")}}P.go(`/manga/${t}`)}}}function Qt(){var I,M,O,te,re;const s=document.getElementById("app");s.removeEventListener("click",ot),s.addEventListener("click",ot),window._libraryViewModeListenerSet||(window._libraryViewModeListenerSet=!0,window.addEventListener("viewModeChange",A=>{$.viewMode=A.detail.mode;const D=document.getElementById("app");D.innerHTML=Oe(),Qt(),ue()}));const e=document.getElementById("category-fab-btn"),t=document.getElementById("category-fab-menu");e&&t&&(e.addEventListener("click",()=>{t.classList.toggle("hidden")}),t.addEventListener("click",A=>{const D=A.target.closest(".category-menu-item");if(D){const F=D.dataset.category||null;ma(F),t.classList.add("hidden")}})),(I=document.getElementById("manage-categories-btn"))==null||I.addEventListener("click",A=>{A.stopPropagation();const D=document.getElementById("manage-categories-modal");D&&D.classList.add("open")}),(M=document.getElementById("close-manage-categories-btn"))==null||M.addEventListener("click",()=>{var A;(A=document.getElementById("manage-categories-modal"))==null||A.classList.remove("open")}),(O=document.querySelector("#manage-categories-modal .modal-overlay"))==null||O.addEventListener("click",()=>{var A;(A=document.getElementById("manage-categories-modal"))==null||A.classList.remove("open")}),(te=document.querySelector("#manage-categories-modal .modal-close"))==null||te.addEventListener("click",()=>{var A;(A=document.getElementById("manage-categories-modal"))==null||A.classList.remove("open")}),(re=document.getElementById("add-category-btn"))==null||re.addEventListener("click",async()=>{var F;const A=document.getElementById("new-category-input"),D=(F=A==null?void 0:A.value)==null?void 0:F.trim();if(D)try{await v.post("/categories",{name:D}),A.value="",d("Category added","success"),await ve(!0),J()}catch(G){d("Failed: "+G.message,"error")}}),document.querySelectorAll(".nsfw-toggle").forEach(A=>{A.addEventListener("change",async D=>{const F=A.dataset.category;try{await v.put(`/categories/${encodeURIComponent(F)}/nsfw`,{isNsfw:A.checked}),d(`${F} ${A.checked?"marked as 18+":"unmarked"}`,"success"),await ve(!0),J()}catch(G){d("Failed: "+G.message,"error"),A.checked=!A.checked}})}),document.querySelectorAll(".delete-category-btn").forEach(A=>{A.addEventListener("click",async()=>{const D=A.dataset.category;if(confirm(`Delete category "${D}"?`))try{await v.delete(`/categories/${encodeURIComponent(D)}`),d("Category deleted","success"),$.activeCategory===D&&($.activeCategory=null,localStorage.removeItem("library_active_category")),await ve(!0),J()}catch(F){d("Failed: "+F.message,"error")}})});const a=document.getElementById("artist-filter-badge");a&&a.addEventListener("click",()=>{$.artistFilter=null,J()});const n=document.getElementById("library-search");n&&(n.addEventListener("input",A=>{var F;$.searchQuery=A.target.value,localStorage.setItem("library_search",A.target.value);const D=document.getElementById("library-grid");if(D){let G=$.activeCategory?$.bookmarks.filter(fe=>(fe.categories||[]).includes($.activeCategory)):$.bookmarks;if($.artistFilter&&(G=G.filter(fe=>(fe.artists||[]).includes($.artistFilter))),$.searchQuery){const fe=$.searchQuery.toLowerCase();G=G.filter($t=>($t.title||"").toLowerCase().includes(fe)||($t.alias||"").toLowerCase().includes(fe))}G=vt(G),D.innerHTML=G.map(yt).join("")||bt();const we=document.getElementById("search-clear");!we&&$.searchQuery?(n.parentElement.insertAdjacentHTML("beforeend",'<button class="search-clear" id="search-clear">×</button>'),(F=document.getElementById("search-clear"))==null||F.addEventListener("click",()=>{$.searchQuery="",localStorage.removeItem("library_search"),n.value="",J()})):we&&!$.searchQuery&&we.remove()}}),$.searchQuery&&n.focus());const o=document.getElementById("search-clear");o&&o.addEventListener("click",()=>{$.searchQuery="",J()});const r=document.getElementById("library-sort");r&&r.addEventListener("change",A=>{$.sortBy=A.target.value,localStorage.setItem("library_sort",$.sortBy),J()}),window.removeEventListener("clearFilters",it),window.addEventListener("clearFilters",it);const u=document.getElementById("add-manga-btn"),c=document.getElementById("mobile-add-btn"),p=document.getElementById("add-modal"),y=document.getElementById("add-modal-close"),C=document.getElementById("add-modal-cancel"),b=document.getElementById("add-modal-submit"),g=document.getElementById("mobile-menu"),m=()=>{g&&g.classList.add("hidden"),p&&p.classList.add("open")};u&&u.addEventListener("click",m),c&&c.addEventListener("click",m),y&&y.addEventListener("click",()=>p.classList.remove("open")),C&&C.addEventListener("click",()=>p.classList.remove("open")),b&&b.addEventListener("click",async()=>{const A=document.getElementById("manga-url"),D=A.value.trim();if(!D){d("Please enter a URL","error");return}try{b.disabled=!0,b.textContent="Adding...",await v.addBookmark(D),d("Manga added successfully!","success"),p.classList.remove("open"),A.value="",await ve(),J()}catch(F){d("Failed to add manga: "+F.message,"error")}finally{b.disabled=!1,b.textContent="Add"}});const x=document.getElementById("add-series-btn"),_=document.getElementById("mobile-add-series-btn"),L=document.getElementById("add-series-modal"),T=document.getElementById("add-series-modal-close"),B=document.getElementById("add-series-modal-cancel"),w=document.getElementById("add-series-modal-submit"),E=document.getElementById("mobile-menu");if((x||_)&&L){const A=()=>{E&&E.classList.add("hidden"),L.classList.add("open")};x&&x.addEventListener("click",A),_&&_.addEventListener("click",A)}T&&T.addEventListener("click",()=>L.classList.remove("open")),B&&B.addEventListener("click",()=>L.classList.remove("open")),w&&w.addEventListener("click",async()=>{const A=document.getElementById("series-title"),D=document.getElementById("series-alias"),F=A.value.trim(),G=D.value.trim();if(!F){d("Please enter a title","error");return}try{w.disabled=!0,w.textContent="Creating...",await v.createSeries(F,G),d("Series created successfully!","success"),L.classList.remove("open"),A.value="",D.value="",await ve(!0),J()}catch(we){d("Failed to create series: "+we.message,"error")}finally{w.disabled=!1,w.textContent="Create"}});const l=L==null?void 0:L.querySelector(".modal-overlay");l&&l.addEventListener("click",()=>L.classList.remove("open"));const h=document.getElementById("empty-add-btn");h&&p&&h.addEventListener("click",()=>p.classList.add("open"));const k=document.getElementById("empty-add-series-btn");k&&L&&k.addEventListener("click",()=>L.classList.add("open"));const S=p==null?void 0:p.querySelector(".modal-overlay");S&&S.addEventListener("click",()=>p.classList.remove("open")),ue()}function ma(s){$.activeCategory=s,s?localStorage.setItem("library_active_category",s):localStorage.removeItem("library_active_category"),J()}async function ve(s=!1){try{const[e,t,a,n]=await Promise.all([ne.loadBookmarks(s),ne.loadCategories(s),ne.loadSeries(s),ne.loadFavorites(s)]);$.bookmarks=e,$.categories=t,$.series=a,$.favorites=n,$.loading=!1}catch{d("Failed to load library","error"),$.loading=!1}}async function J(){const s=document.getElementById("app"),e=localStorage.getItem("library_active_category");$.activeCategory!==e&&($.activeCategory=e);const t=localStorage.getItem("library_artist_filter");t&&$.artistFilter!==t&&($.artistFilter=t);const a=localStorage.getItem("library_search")||"";$.searchQuery!==a&&($.searchQuery=a),$.loading&&(s.innerHTML=Oe()),$.bookmarks.length===0&&$.loading&&await ve(),s.innerHTML=Oe(),Qt(),Fe.forEach(n=>n()),Fe=[ne.subscribe("bookmarks",n=>{$.bookmarks=n;const o=document.getElementById("library-grid");if(o){let r=$.activeCategory?$.bookmarks.filter(u=>(u.categories||[]).includes($.activeCategory)):$.bookmarks;if($.artistFilter&&(r=r.filter(u=>(u.artists||[]).includes($.artistFilter))),$.searchQuery){const u=$.searchQuery.toLowerCase();r=r.filter(c=>(c.title||"").toLowerCase().includes(u)||(c.alias||"").toLowerCase().includes(u))}r=vt(r),o.innerHTML=r.map(yt).join("")||bt()}})]}function ga(){const s=document.getElementById("app");s&&s.removeEventListener("click",ot),window.removeEventListener("clearFilters",it),Fe.forEach(e=>e()),Fe=[]}const fa={mount:J,unmount:ga,render:Oe};let i={manga:null,chapter:null,images:[],trophyPages:{},mode:"webtoon",direction:"rtl",firstPageSingle:!0,lastPageSingle:!1,singlePageMode:!1,currentPage:0,zoom:100,loading:!0,showControls:!0,isGalleryMode:!1,isCollectionMode:!1,favoriteLists:[],allFavorites:null,navigationDirection:null,nextChapterImage:null,nextChapterNum:null};function Wt(){if(!i.manga||!i.chapter||!i.allFavorites||!i.allFavorites.favorites)return!1;if(i.isCollectionMode)return!0;let e=[lt()];if(i.mode==="manga"&&!i.singlePageMode){const n=H()[i.currentPage];n&&Array.isArray(n)?e=n:n&&n.pages&&(e=n.pages)}const t=e.map(a=>{const n=Le(i.images[a]);return n?{filename:n}:null}).filter(Boolean);for(const a in i.allFavorites.favorites){const n=i.allFavorites.favorites[a];if(Array.isArray(n)){for(const o of n)if(o.mangaId===i.manga.id&&o.chapterNum===i.chapter.number&&o.imagePaths)for(const r of o.imagePaths){const u=typeof r=="string"?r:(r==null?void 0:r.filename)||(r==null?void 0:r.path);for(const c of t)if(c&&c.filename===u)return!0}}}return!1}function rt(){const s=document.getElementById("favorites-btn");s&&(Wt()?s.classList.add("active"):s.classList.remove("active"))}function ge(){var p;if(i.loading)return`
  ...
  `}function H(){const s=[],e=i.images.length;let t=0;if(i.isCollectionMode){for(let n=0;n<e;n++)s.push([n]);return s}let a=!i.firstPageSingle;for(;t<e;){const n=i.trophyPages[t];if(n){if(!n.isSingle&&n.pages&&n.pages.length===2){const[o,r]=n.pages;s.push([o,r]),t=Math.max(o,r)+1}else s.push([t]),t++;continue}if(!a){a=!0,s.push([t]),t++;continue}if(i.lastPageSingle&&t===e-1){i.nextChapterImage?s.push({type:"link",pages:[t],nextImage:i.nextChapterImage,nextChapter:i.nextChapterNum}):s.push([t]),t++;break}t+1<e?i.trophyPages[t+1]?(s.push([t]),t++):i.lastPageSingle&&t+1===e-1?(s.push([t]),i.nextChapterImage?s.push({type:"link",pages:[t+1],nextImage:i.nextChapterImage,nextChapter:i.nextChapterNum}):s.push([t+1]),t+=2):(s.push([t,t+1]),t+=2):(s.push([t]),t++)}return s}function Jt(){if(i.singlePageMode)return!!i.trophyPages[i.currentPage];const e=H()[i.currentPage];return e?(Array.isArray(e)?e:e.pages||[]).some(a=>!!i.trophyPages[a]):!1}function Xt(){if(i.singlePageMode)return[i.currentPage];const e=H()[i.currentPage];return e?Array.isArray(e)?e:e.pages||[]:[]}async function ya(){if(!i.manga||!i.chapter||i.isCollectionMode)return;const s=Xt();if(s.length===0)return;if(s.some(t=>!!i.trophyPages[t])){const t=[...s];if(i.singlePageMode){const a=i.trophyPages[i.currentPage];a&&!a.isSingle&&a.pages&&a.pages.length>1&&(t.length=0,t.push(...a.pages))}t.forEach(a=>delete i.trophyPages[a]),d(`Page${t.length>1?"s":""} unmarked as trophy`,"info")}else{let t=s,a=i.singlePageMode||s.length===1;if(!i.singlePageMode&&s.length===2){const o=await ts(s,"Mark as trophy 🏆");if(!o)return;t=o.pages,a=o.pages.length===1}t.forEach(o=>{i.trophyPages[o]={isSingle:a,pages:[...t]}});const n=a?"single":"double";d(`Page${t.length>1?"s":""} marked as trophy (${n}) 🏆`,"success")}try{await v.saveTrophyPages(i.manga.id,i.chapter.number,i.trophyPages)}catch(t){console.error("Failed to save trophy pages:",t)}ce(),Zt()}function Zt(){const s=document.getElementById("trophy-btn");if(s){const e=Jt();s.classList.toggle("active",e),s.title=e?"Unmark trophy":"Mark as trophy"}}async function Ie(){if(!i.manga||!i.chapter||i.isCollectionMode||!i.images.length)return;let s=1;if(i.mode==="manga")if(i.singlePageMode)s=i.currentPage+1;else{const t=H()[i.currentPage];t&&t.length>0&&(s=t[0]+1)}else{const e=document.getElementById("reader-content");if(e){const t=e.querySelectorAll("img"),a=e.scrollTop;let n=0;t.forEach((o,r)=>{a>=n&&(s=r+1),n+=o.offsetHeight})}}try{await v.updateReadingProgress(i.manga.id,i.chapter.number,s,i.images.length)}catch(e){console.error("Failed to save progress:",e)}}function Ve(){var t,a,n,o,r,u,c,p,y,C,b,g,m,x,_,L,T,B;const s=document.getElementById("app");(t=document.getElementById("reader-close-btn"))==null||t.addEventListener("click",async()=>{await Ie(),await pe(),i.manga&&i.manga.id!=="gallery"?P.go(`/manga/${i.manga.id}`):P.go("/")}),(a=document.getElementById("reader-back-btn"))==null||a.addEventListener("click",()=>{P.go("/")}),(n=document.getElementById("reader-settings-btn"))==null||n.addEventListener("click",()=>{var w;(w=document.getElementById("reader-settings"))==null||w.classList.toggle("hidden")}),(o=document.getElementById("close-settings-btn"))==null||o.addEventListener("click",()=>{var w;(w=document.getElementById("reader-settings"))==null||w.classList.add("hidden")}),(r=document.getElementById("single-page-btn"))==null||r.addEventListener("click",()=>{if(i.singlePageMode){const w=H();let E=0;for(let l=0;l<w.length;l++)if(w[l].includes(i.currentPage)){E=l;break}i.singlePageMode=!1,i.currentPage=E}else{const E=H()[i.currentPage];i.singlePageMode=!0,i.currentPage=E?E[0]:0}Ne()}),(u=document.getElementById("trophy-btn"))==null||u.addEventListener("click",()=>{ya()}),s.querySelectorAll("[data-mode]").forEach(w=>{w.addEventListener("click",()=>{var h,k;const E=w.dataset.mode;let l=lt();if(i.mode=E,localStorage.setItem("reader_mode",i.mode),E==="webtoon")i.currentPage=l;else if(i.singlePageMode)i.currentPage=l;else{const S=H();let I=0;for(let M=0;M<S.length;M++)if(S[M].includes(l)){I=M;break}i.currentPage=I}(h=i.manga)!=null&&h.id&&((k=i.chapter)!=null&&k.number)&&pe(),Ne(),E==="webtoon"&&setTimeout(()=>{const S=document.getElementById("reader-content");if(S){const I=S.querySelectorAll("img");I[l]&&I[l].scrollIntoView({behavior:"auto",block:"start"})}},100)})}),s.querySelectorAll("[data-direction]").forEach(w=>{w.addEventListener("click",async()=>{var E,l;i.direction=w.dataset.direction,localStorage.setItem("reader_direction",i.direction),(E=i.manga)!=null&&E.id&&((l=i.chapter)!=null&&l.number)&&await pe(),Ne()})}),(c=document.getElementById("first-page-single"))==null||c.addEventListener("change",async w=>{i.firstPageSingle=w.target.checked,await pe(),ce()}),(p=document.getElementById("last-page-single"))==null||p.addEventListener("change",async w=>{var E,l;i.lastPageSingle=w.target.checked,await pe(),i.lastPageSingle&&((E=i.manga)!=null&&E.id)&&((l=i.chapter)!=null&&l.number)?await es():(i.nextChapterImage=null,i.nextChapterNum=null),ce()}),(y=document.getElementById("zoom-slider"))==null||y.addEventListener("input",w=>{i.zoom=parseInt(w.target.value);const E=document.getElementById("reader-content");E&&(E.style.zoom=`${i.zoom}%`)});const e=document.getElementById("page-slider");if(e&&(e.addEventListener("input",w=>{const E=parseInt(w.target.value),l=document.getElementById("page-indicator");l&&(i.singlePageMode?l.textContent=`${E+1} / ${i.images.length}`:l.textContent=`${E+1} / ${H().length}`)}),e.addEventListener("change",w=>{i.currentPage=parseInt(w.target.value),ce()})),i.mode==="manga"){const w=document.getElementById("reader-content");w==null||w.addEventListener("click",E=>{var S;if(E.target.closest("button, a, .link-overlay"))return;const l=w.getBoundingClientRect(),k=(E.clientX-l.left)/l.width;k<.3?ct():k>.7?De():(i.showControls=!i.showControls,(S=document.querySelector(".reader"))==null||S.classList.toggle("controls-hidden",!i.showControls))})}document.addEventListener("keydown",ss),(C=document.getElementById("prev-chapter-btn"))==null||C.addEventListener("click",()=>Ue(-1)),(b=document.getElementById("next-chapter-btn"))==null||b.addEventListener("click",()=>Ue(1)),i.mode==="webtoon"&&((g=document.getElementById("reader-content"))==null||g.addEventListener("click",()=>{var w;i.showControls=!i.showControls,(w=document.querySelector(".reader"))==null||w.classList.toggle("controls-hidden",!i.showControls)})),(m=document.getElementById("rotate-btn"))==null||m.addEventListener("click",async()=>{const w=Je();if(!(!w||!i.manga||!i.chapter))try{d("Rotating...","info");const E=await v.rotatePage(i.manga.id,i.chapter.number,w);E.images&&(await Xe(E.images),d("Page rotated","success"))}catch(E){d("Rotate failed: "+E.message,"error")}}),(x=document.getElementById("swap-btn"))==null||x.addEventListener("click",async()=>{const E=H()[i.currentPage];if(!E||E.length!==2||!i.manga||!i.chapter){d("Select a spread with 2 pages to swap","info");return}const l=Le(i.images[E[0]]),h=Le(i.images[E[1]]);if(!(!l||!h))try{d("Swapping...","info");const k=await v.swapPages(i.manga.id,i.chapter.number,l,h);k.images&&(await Xe(k.images),d("Pages swapped","success"))}catch(k){d("Swap failed: "+k.message,"error")}}),(_=document.getElementById("split-btn"))==null||_.addEventListener("click",async()=>{const w=Je();if(!w||!i.manga||!i.chapter||!confirm("Split this page into halves? This is permanent."))return;const E=document.getElementById("split-btn");try{d("Preparing to split...","info"),E&&(E.disabled=!0),i.images=[],i.loading=!0,s.innerHTML=ge(),await new Promise(h=>setTimeout(h,2e3)),d("Splitting page...","info");const l=await v.splitPage(i.manga.id,i.chapter.number,w);E&&(E.disabled=!1),await he(i.manga.id,i.chapter.number,i.chapter.versionUrl),s.innerHTML=ge(),Ve(),ce(),l.warning?d(l.warning,"warning"):d("Page split into halves","success")}catch(l){E&&(E.disabled=!1),d("Split failed: "+l.message,"error"),await he(i.manga.id,i.chapter.number,i.chapter.versionUrl),s.innerHTML=ge(),Ve()}}),(L=document.getElementById("delete-page-btn"))==null||L.addEventListener("click",async()=>{const w=Je();if(!(!w||!i.manga||!i.chapter)&&confirm(`Delete page "${w}" permanently? This cannot be undone.`))try{d("Deleting...","info");const E=await v.deletePage(i.manga.id,i.chapter.number,w);E.images&&(await Xe(E.images),d("Page deleted","success"))}catch(E){d("Delete failed: "+E.message,"error")}}),(T=document.getElementById("favorites-btn"))==null||T.addEventListener("click",async()=>{try{const l=await v.getFavorites();i.allFavorites=l,i.favoriteLists=Object.keys(l.favorites||l||{})}catch(l){console.error("Failed to load favorites",l),d("Failed to load favorites","error");return}let E=[lt()];if(i.mode==="manga"&&!i.singlePageMode){const h=H()[i.currentPage];h&&Array.isArray(h)?E=h:h&&h.pages&&(E=h.pages)}if(E.length>1){const l=await ts(E,"Select Page for Favorites ⭐");if(!l)return;E=l.pages}wa(E)}),(B=document.getElementById("fullscreen-btn"))==null||B.addEventListener("click",()=>{document.fullscreenElement?document.exitFullscreen():document.documentElement.requestFullscreen().catch(()=>{d("Fullscreen not supported","info")})}),document.body.classList.add("reader-active")}function Le(s){var n;const e=typeof s=="string"?s:(s==null?void 0:s.url)||((n=s==null?void 0:s.urls)==null?void 0:n[0]);if(!e)return null;const a=e.split("?")[0].split("/");return decodeURIComponent(a[a.length-1])}function Je(){const s=Xt();return s.length===0?null:Le(i.images[s[0]])}async function Xe(s){const e=Date.now();if(i.images=s.map(t=>t+(t.includes("?")?"&":"?")+`_t=${e}`),i.mode==="manga")if(i.singlePageMode)i.currentPage=Math.min(i.currentPage,i.images.length-1);else{const t=H();i.currentPage=Math.min(i.currentPage,t.length-1)}i.currentPage=Math.max(0,i.currentPage),ce()}async function es(){var s,e;if(!(!((s=i.manga)!=null&&s.id)||!((e=i.chapter)!=null&&e.number)))try{const t=await v.getNextChapterPreview(i.manga.id,i.chapter.number);i.nextChapterImage=t.firstImage||null,i.nextChapterNum=t.nextChapter||null}catch{i.nextChapterImage=null,i.nextChapterNum=null}}function ba(s,e){return new Promise(t=>{const a=document.createElement("div");a.className="version-modal-overlay",a.innerHTML=`
    ...
    `,a.appendChild(o),a.querySelector(".page-picker-cancel").addEventListener("click",()=>{a.remove(),rt()}),a.addEventListener("click",c=>{c.target===a&&(a.remove(),rt())}),a.querySelectorAll(".list-option").forEach(c=>{c.addEventListener("click",async()=>{const p=c.dataset.list,y=t(p),C=y!==-1;c.style.opacity="0.5",c.style.pointerEvents="none";try{if(C){await v.removeFavoriteItem(p,y);const b=await v.getFavorites();i.allFavorites=b,c.classList.remove("active-list"),c.querySelector("span:last-child").textContent="➕"}else{const b=s.length>1?"double":"single",g={mangaId:i.manga.id,chapterNum:i.chapter.number,title:`${i.manga.alias||i.manga.title} Ch.${i.chapter.number} p${s[0]+1}`,imagePaths:e,displayMode:b,displaySide:i.direction==="rtl"?"right":"left"};await v.addFavoriteItem(p,g);const m=await v.getFavorites();i.allFavorites=m,c.classList.add("active-list"),c.querySelector("span:last-child").textContent="✅"}}catch(b){console.error(b)}finally{c.style.opacity="1",c.style.pointerEvents="auto"}})}),document.body.appendChild(a)}function ts(s,e){return new Promise(t=>{const[a,n]=s,o=i.images[a],r=i.images[n],u=typeof o=="string"?o:o==null?void 0:o.url,c=typeof r=="string"?r:r==null?void 0:r.url,p=i.direction==="rtl",y=p?n:a,C=p?a:n,b=p?c:u,g=p?u:c,m=document.createElement("div");m.className="page-picker-overlay",m.innerHTML=`
        ...
        `;const x=_=>{m.remove(),t(_)};m.querySelectorAll(".page-picker-option").forEach(_=>{_.addEventListener("click",()=>{const L=_.dataset.choice;L==="left"?x({pages:[y]}):L==="right"?x({pages:[C]}):L==="both"&&x({pages:s})})}),m.querySelector(".page-picker-cancel").addEventListener("click",()=>x(null)),m.addEventListener("click",_=>{_.target===m&&x(null)}),document.body.appendChild(m)})}function lt(){if(i.mode==="webtoon"){const s=document.getElementById("reader-content");if(s){const e=s.querySelectorAll("img");if(e.length>0){const t=s.scrollTop;if(t>10){let a=0;for(let n=0;n<e.length;n++){const o=e[n].offsetHeight;if(a+o>t)return n;a+=o}}}}return 0}else{if(i.singlePageMode)return i.currentPage;{const e=H()[i.currentPage];return e&&e.length>0?e[0]:0}}}function ss(s){if(!(s.target.tagName==="INPUT"||s.target.tagName==="TEXTAREA")){if(s.key==="Escape"){Ie(),i.manga&&P.go(`/manga/${i.manga.id}`);return}if(i.mode==="manga")s.key==="ArrowLeft"?i.direction==="rtl"?De():ct():s.key==="ArrowRight"?i.direction==="rtl"?ct():De():s.key===" "&&(s.preventDefault(),De());else if(i.mode==="webtoon"&&s.key===" "){s.preventDefault();const e=document.getElementById("reader-content");if(e){const t=e.clientHeight*.8;e.scrollBy({top:s.shiftKey?-t:t,behavior:"smooth"})}}}}function De(){const s=H(),e=i.singlePageMode?i.images.length-1:s.length-1;if(i.currentPage<e)i.currentPage++,ce();else{const t=s[i.currentPage],a=t&&t.type==="link";Ie(),a&&(i.navigationDirection="next-linked"),Ue(1)}}function ct(){i.currentPage>0?(i.currentPage--,ce()):Ue(-1)}function ce(){const s=document.getElementById("reader-content");if(s){s.innerHTML=i.isCollectionMode?Gt():i.mode==="webtoon"?Kt():Yt();const e=document.getElementById("page-indicator");e&&(i.singlePageMode?e.textContent=`${i.currentPage+1} / ${i.images.length}`:e.textContent=`${i.currentPage+1} / ${H().length}`);const t=document.getElementById("page-slider");t&&(t.value=i.currentPage,t.max=i.singlePageMode?i.images.length-1:H().length-1),Zt(),rt()}}function Ne(){const s=document.getElementById("app");s&&(s.innerHTML=ge(),Ve())}async function Ue(s){if(console.log("[Nav] navigateChapter called with delta:",s),!i.manga||!i.chapter){console.log("[Nav] early return - no manga or chapter");return}await Ie(),await pe();const t=[...i.manga.downloadedChapters||[]].sort((o,r)=>o-r),a=t.indexOf(i.chapter.number),n=a+s;if(console.log("[Nav]",{delta:s,chapterNumber:i.chapter.number,sorted:t,currentIdx:a,newIdx:n}),n>=0&&n<t.length){i.navigationDirection||(i.navigationDirection=s<0?"prev":null);const o=t[n],u=(i.manga.downloadedVersions||{})[o]||[],c=Array.isArray(u)?u[0]:u,p=c?`?version=${encodeURIComponent(c)}`:"";console.log("[Nav] Calling router.go with:",`/read/${i.manga.id}/${o}${p}`),P.go(`/read/${i.manga.id}/${o}${p}`)}else d(s>0?"Last chapter":"First chapter","info")}async function he(s,e,t){var a,n,o,r,u;console.log("[Reader] loadData called:",{mangaId:s,chapterNum:e,versionUrl:t});try{if(i.mode=localStorage.getItem("reader_mode")||"webtoon",i.direction=localStorage.getItem("reader_direction")||"rtl",s==="gallery"){const y=decodeURIComponent(e),b=((a=(await v.getFavorites()).favorites)==null?void 0:a[y])||[];i.images=[];for(const g of b){const m=g.imagePaths||[],x=[];for(const _ of m){let L;typeof _=="string"?L=_:_&&typeof _=="object"&&(L=_.filename||_.path||_.name||_.url,L&&L.includes("/")&&(L=L.split("/").pop()),L&&L.includes("\\")&&(L=L.split("\\").pop())),L&&x.push(`/api/public/chapter-images/${g.mangaId}/${g.chapterNum}/${encodeURIComponent(L)}`)}x.length>0&&i.images.push({urls:x,displayMode:g.displayMode||"single",displaySide:g.displaySide||"left"})}i.manga={id:"gallery",title:y,alias:y},i.chapter={number:"Gallery"},i.isGalleryMode=!0,i.isCollectionMode=!0,i.images.length===0&&d("Gallery is empty","warning")}else if(s==="trophies"){const y=e;let C=[],b="Trophies";if(y.startsWith("series-")){const g=y.replace("series-",""),x=(await store.loadSeries()).find(T=>T.id===g);b=x?x.alias||x.title:"Series Trophies";const L=(await store.loadBookmarks()).filter(T=>T.seriesId===g);for(const T of L){const B=await v.getTrophyPagesAll(T.id);for(const w in B)for(const E in B[w]){const l=B[w][E],k=(await v.getChapterImages(T.id,w)).images[E],S=typeof k=="string"?k.split("/").pop():(k==null?void 0:k.filename)||(k==null?void 0:k.path);C.push({mangaId:T.id,chapterNum:w,imagePaths:[{filename:S}],displayMode:l.isSingle?"single":"double",displaySide:"left"})}}}else{const g=await v.getBookmark(y);b=g?g.alias||g.title:"Manga Trophies";const m=await v.getTrophyPagesAll(y);for(const x in m)for(const _ in m[x]){const L=m[x][_],B=(await v.getChapterImages(y,x)).images[_],w=typeof B=="string"?B.split("/").pop():(B==null?void 0:B.filename)||(B==null?void 0:B.path);C.push({mangaId:y,chapterNum:x,imagePaths:[{filename:decodeURIComponent(w)}],displayMode:L.isSingle?"single":"double",displaySide:"left"})}}i.images=C.map(g=>{const m=g.imagePaths[0].filename;return{urls:[`/api/public/chapter-images/${g.mangaId}/${g.chapterNum}/${encodeURIComponent(m)}`],displayMode:g.displayMode,displaySide:g.displaySide}}),i.manga={id:"trophies",title:b,alias:b},i.chapter={number:"🏆"},i.isCollectionMode=!0,i.isGalleryMode=!1}else{i.isGalleryMode=!1;const y=await v.getBookmark(s);i.manga=y,console.log("[Reader] manga loaded, finding chapter..."),i.chapter=((n=y.chapters)==null?void 0:n.find(g=>g.number===parseFloat(e)))||{number:parseFloat(e)};const C=t?`/bookmarks/${s}/chapters/${e}/reader-images?version=${encodeURIComponent(t)}`:`/bookmarks/${s}/chapters/${e}/reader-images`,b=await v.get(C);console.log("[Reader] images loaded, count:",(o=b.images)==null?void 0:o.length),i.images=b.images||[];try{const g=await v.getChapterSettings(s,e);if(g&&(g.mode||g.direction||g.firstPageSingle!==void 0||g.lastPageSingle!==void 0))g.mode&&(i.mode=g.mode),g.direction&&(i.direction=g.direction),g.firstPageSingle!==void 0&&(i.firstPageSingle=g.firstPageSingle),g.lastPageSingle!==void 0&&(i.lastPageSingle=g.lastPageSingle);else try{const _=[...i.manga.downloadedChapters||[]].sort((w,E)=>w-E),L=parseFloat(e),T=_.indexOf(L),B=[];T>0&&B.push(_[T-1]),T<_.length-1&&B.push(_[T+1]);for(const w of B){const E=await v.getChapterSettings(s,w);if(E&&(E.mode||E.direction||E.firstPageSingle!==void 0||E.lastPageSingle!==void 0)){E.mode&&(i.mode=E.mode),E.direction&&(i.direction=E.direction),E.firstPageSingle!==void 0&&(i.firstPageSingle=E.firstPageSingle),E.lastPageSingle!==void 0&&(i.lastPageSingle=E.lastPageSingle),console.log("[Reader] Inherited settings from chapter",w);break}}}catch(x){console.warn("Failed to inherit chapter settings",x)}}catch(g){console.warn("Failed to load chapter settings",g)}try{const g=await v.getTrophyPages(s,e);i.trophyPages=g||{}}catch(g){console.warn("Failed to load trophy pages",g)}try{const g=await v.getFavorites();i.allFavorites=g,i.favoriteLists=Object.keys(g.favorites||g||{})}catch(g){console.warn("Failed to load favorites",g)}}const c=parseFloat(e),p=(u=(r=i.manga)==null?void 0:r.readingProgress)==null?void 0:u[c];if(p&&p.page<p.totalPages)if(i.mode==="manga")if(i.singlePageMode)i.currentPage=Math.max(0,p.page-1);else{const y=Math.max(0,p.page-1),C=H();let b=0;for(let g=0;g<C.length;g++){const m=C[g],x=Array.isArray(m)?m:m.pages||[];if(x.includes(y)||x[0]>=y){b=g;break}b=g}i.currentPage=b}else i.currentPage=0,i._resumeScrollToPage=p.page-1;else i.currentPage=0}catch(c){console.error("Error loading chapter:",c),d("Failed to load chapter","error")}if(i.navigationDirection==="prev"&&i.mode==="manga")if(i.singlePageMode)i.currentPage=Math.max(0,i.images.length-1);else{const c=H();i.currentPage=Math.max(0,c.length-1)}else if(i.navigationDirection==="next-linked"&&i.mode==="manga"&&i.images.length>1)if(i.singlePageMode)i.currentPage=1;else{const c=H();let p=0;for(let y=0;y<c.length;y++){const C=c[y];if((Array.isArray(C)?C:C.pages||[]).includes(1)){p=y;break}}i.currentPage=p}i.navigationDirection=null,i.lastPageSingle&&await es(),i.loading=!1,Ne(),i.mode==="webtoon"&&i._resumeScrollToPage&&setTimeout(()=>{const c=document.getElementById("reader-content");if(c){const p=c.querySelectorAll("img");p[i._resumeScrollToPage]&&p[i._resumeScrollToPage].scrollIntoView({behavior:"auto",block:"start"})}delete i._resumeScrollToPage},300)}async function ka(s=[]){console.log("[Reader] mount called with params:",s);let[e,t]=s,a=null;if(t&&t.includes("?")){const[o,r]=t.split("?");t=o,a=new URLSearchParams(r).get("version")}if(console.log("[Reader] mangaId:",e,"chapterNum:",t,"urlVersion:",a),!e||!t){P.go("/");return}const n=document.getElementById("app");if(i.loading=!0,console.log("[Reader] loading set to true, calling loadData..."),i.images=[],i.singlePageMode=!1,i._resumeScrollToPage=null,i.nextChapterImage=null,i.nextChapterNum=null,n.innerHTML=ge(),a)await he(e,t,decodeURIComponent(a));else try{const o=await v.getBookmark(e),r=o.downloadedVersions||{},u=new Set(o.deletedChapterUrls||[]),c=r[parseFloat(t)];let p=[];if(Array.isArray(c)&&(p=c.filter(y=>!u.has(y))),p.length>1){const y=await ba(p,t);if(y===null){P.go(`/manga/${e}`);return}await he(e,t,y)}else p.length===1?await he(e,t,p[0]):await he(e,t)}catch(o){console.log("[Reader] Error in version check, falling back:",o),await he(e,t)}if(n.innerHTML=ge(),console.log("[Reader] render called, loading:",i.loading,"manga:",!!i.manga,"images:",i.images.length),Ve(),i.mode==="webtoon"&&i._resumeScrollToPage!=null){const o=i._resumeScrollToPage;i._resumeScrollToPage=null,setTimeout(()=>{const r=document.getElementById("reader-content");if(r){const u=r.querySelectorAll("img");u[o]&&u[o].scrollIntoView({behavior:"auto",block:"start"})}},300)}}async function Ea(){console.log("[Reader] unmount called"),await Ie(),await pe(),document.body.classList.remove("reader-active"),document.removeEventListener("keydown",ss),i.manga=null,i.chapter=null,i.images=[],i.loading=!0,i.singlePageMode=!1,i._resumeScrollToPage=null}async function pe(){if(!(!i.manga||!i.chapter||i.manga.id==="gallery"))try{await v.updateChapterSettings(i.manga.id,i.chapter.number,{mode:i.mode,direction:i.direction,firstPageSingle:i.firstPageSingle,lastPageSingle:i.lastPageSingle})}catch(s){console.error("Failed to save settings:",s)}}async function as(s){try{const e=await v.getBookmark(s),t=e.downloadedChapters||[],a=new Set(e.readChapters||[]),n=e.readingProgress||{},o=e.downloadedVersions||{},r=[...t].sort((c,p)=>c-p);let u=null;for(const c of r){const p=n[c];if(p&&p.page<p.totalPages&&!a.has(c)){u=c;break}}if(u===null){for(const c of r)if(!a.has(c)){u=c;break}}if(u===null&&r.length>0&&(u=r[0]),u!==null){const c=o[u]||[],p=Array.isArray(c)?c[0]:c,y=p?`?version=${encodeURIComponent(p)}`:"";P.go(`/read/${s}/${u}${y}`)}else d("No downloaded chapters to read","info")}catch(e){d("Failed to continue reading: "+e.message,"error")}}const $a={mount:ka,unmount:Ea,render:ge,continueReading:as},xe=50;let f={manga:null,categories:[],currentPage:0,filter:"all",loading:!0,selectionMode:!1,selected:new Set,activeVolume:null,activeVolumeId:null,cbzFiles:[],manageChapters:!1};function Ca(s){return s.autoCheck===!0?`<button class="btn btn-primary" id="schedule-btn">⏰ ${s.checkSchedule==="weekly"?`${(s.checkDay||"monday").charAt(0).toUpperCase()+(s.checkDay||"monday").slice(1)} ${s.checkTime||"06:00"}`:s.checkSchedule==="daily"?`Daily ${s.checkTime||"06:00"}`:"Every 6h"}</button>`:'<button class="btn btn-secondary" id="schedule-btn">⏰ Schedule</button>'}function Sa(s){const e=s.autoCheck===!0,t=s.checkSchedule||"daily",a=s.checkDay||"monday",n=s.checkTime||"06:00",o=s.autoDownload||!1;return`
  ...
  `}function dt(){var E;if(f.loading)return`
      ${Z()}
      <div class="container">
    ...
    `;const e=s.alias||s.title,t=s.chapters||[],a=new Set(s.downloadedChapters||[]),n=new Set(s.readChapters||[]),o=new Set(s.excludedChapters||[]),r=new Set(s.deletedChapterUrls||[]),u=s.volumes||[],c=new Set;u.forEach(l=>{(l.chapters||[]).forEach(h=>c.add(h))});let p;f.filter==="hidden"?p=t.filter(l=>o.has(l.number)||r.has(l.url)):p=t.filter(l=>!o.has(l.number)&&!r.has(l.url));const y=p.filter(l=>!c.has(l.number));let C=[];if(f.activeVolume){const l=new Set(f.activeVolume.chapters||[]);C=p.filter(h=>l.has(h.number))}else C=y;const b=new Map;C.forEach(l=>{b.has(l.number)||b.set(l.number,[]),b.get(l.number).push(l)});let g=Array.from(b.entries()).sort((l,h)=>l[0]-h[0]);f.filter==="downloaded"?g=g.filter(([l])=>a.has(l)):f.filter==="not-downloaded"?g=g.filter(([l])=>!a.has(l)):f.filter==="main"?g=g.filter(([l])=>Number.isInteger(l)):f.filter==="extra"&&(g=g.filter(([l])=>!Number.isInteger(l)));const m=Math.max(1,Math.ceil(g.length/xe));f.currentPage>=m&&(f.currentPage=Math.max(0,m-1));const x=f.currentPage*xe,L=[...g.slice(x,x+xe)].reverse(),T=b.size,B=[...b.keys()].filter(l=>a.has(l)).length;n.size;let w="";if(f.activeVolume){const l=f.activeVolume;let h=null;l.local_cover?h=`/api/public/covers/${s.id}/${encodeURIComponent(l.local_cover.split(/[/\\]/).pop())}`:l.cover&&(h=l.cover),w=`
      ${Z()}
      <div class="container">
      ...
      `}else{const l=s.localCover?`/api/public/covers/${s.id}/${encodeURIComponent(s.localCover.split(/[/\\]/).pop())}`:s.cover;w=`
        ${Z()}
        <div class="container">
          <div class="manga-detail">
            <div class="manga-detail-header">
              ...
              <div class="manga-detail-info">
                ...
                <div class="manga-detail-meta">
                  ...
                  <span class="meta-item">${((E=s.chapters)==null?void 0:E.length)||0} Total Chapters</span>
    ...
    ${w}
        ...
        ${f.activeVolume?f.manageChapters?Ba(s,y):"":Aa(s,a)}
  ...
  `}function xa(){const s=f.manga;return s?`
  ...
  `:""}function _a(){var e,t;const s=f.manga;return`
    ${s?Sa(s):""}
    ${Wa()}
    ${xa()}
    ${La()}
  ...
  `}function Ia(s,e,t,a,n){var w,E,l,h;const o=t.has(s),r=a.has(s),u=!Number.isInteger(s),c=((w=n.downloadedVersions)==null?void 0:w[s])||[],p=new Set(n.deletedChapterUrls||[]),y=e.filter(k=>f.filter==="hidden"?!0:!p.has(k.url)),C=!!f.activeVolume;let b=y;C&&(b=y.filter(k=>Array.isArray(c)?c.includes(k.url):c===k.url)),b.sort((k,S)=>{const I=Array.isArray(c)?c.includes(k.url):c===k.url;return((Array.isArray(c)?c.includes(S.url):c===S.url)?1:0)-(I?1:0)});const g=b.length>1,m=(E=b[0])!=null&&E.url?encodeURIComponent(b[0].url):null,x=n.chapterSettings||{},_=C?!0:(l=x[s])==null?void 0:l.locked,L=["chapter-item",o?"downloaded":"",r?"read":"",u?"extra":""].filter(Boolean).join(" "),T=g?`
    <div class="versions-dropdown hidden" id="versions-${s}">
      ${b.map(k=>{const S=encodeURIComponent(k.url),I=Array.isArray(c)?c.includes(k.url):c===k.url,M=k.url.startsWith("local://");return`
          <div class="version-row ${I?"downloaded":""}"
               data-version-url="${S}" data-num="${s}">
            <span class="version-title" style="cursor: pointer; flex: 1;">${k.title||k.releaseGroup||"Version"}${M?' <span class="badge badge-local" style="background: var(--color-info, #2196f3); color: white; font-size: 0.65em; padding: 1px 5px; border-radius: 3px; margin-left: 6px; vertical-align: middle;">Local</span>':""}</span>
            <div class="version-actions">
              ...
              ${p.has(k.url)?`<button class="btn-icon small warning" data-action="restore-version" data-num="${s}" data-url="${S}" title="Restore Version">↩️</button>`:`<button class="btn-icon small" data-action="hide-version" data-num="${s}" data-url="${S}" title="Hide Version">👁️‍🗨️</button>`}
            </div>
          </div>
        `}).join("")}
    </div>
    ...
    <div class="chapter-group" data-chapter="${s}">
      <div class="${L}" data-num="${s}" style="${B?"opacity: 0.7":""}">
        ...
        <div class="chapter-actions">
          ...
          ${!B&&m?p.has((h=b[0])==null?void 0:h.url)?`<button class="btn-icon small warning" data-action="unhide-chapter" data-num="${s}" data-url="${m}" title="Unhide Chapter">↩️</button>`:`<button class="btn-icon small" data-action="hide-chapter" data-num="${s}" data-url="${m}" title="Hide Chapter">👁️‍🗨️</button>`:""}
  ...
  `}function Pa(){var t,a,n,o,r,u,c,p,y,C,b,g,m,x,_,L,T,B,w,E;const s=document.getElementById("app"),e=f.manga;e&&((t=document.getElementById("back-btn"))==null||t.addEventListener("click",()=>P.go("/")),(a=document.getElementById("back-library-btn"))==null||a.addEventListener("click",()=>P.go("/")),s.querySelectorAll(".artist-link").forEach(l=>{l.addEventListener("click",h=>{h.preventDefault();const k=l.dataset.artist;k&&(localStorage.setItem("library_search",k),localStorage.removeItem("library_artist_filter"),P.go("/"))})}),(n=document.getElementById("continue-btn"))==null||n.addEventListener("click",()=>{as(e.id)}),(o=document.getElementById("download-all-btn"))==null||o.addEventListener("click",()=>{const l=document.getElementById("download-all-modal");l&&l.classList.add("open")}),(r=document.getElementById("confirm-download-all-btn"))==null||r.addEventListener("click",async()=>{var l;try{d("Queueing downloads...","info");const h=document.getElementsByName("download-version-mode");let k="single";for(const I of h)I.checked&&(k=I.value);(l=document.getElementById("download-all-modal"))==null||l.classList.remove("open");const S=await v.post(`/bookmarks/${e.id}/download`,{all:!0,versionMode:k});S.chaptersCount>0?d(`Download queued: ${S.chaptersCount} versions`,"success"):d("Already have these chapters downloaded","info")}catch(h){d("Failed to download: "+h.message,"error")}}),(u=document.getElementById("check-updates-btn"))==null||u.addEventListener("click",async()=>{try{d("Checking for updates...","info"),await v.post(`/bookmarks/${e.id}/quick-check`),d("Check complete!","success")}catch(l){d("Check failed: "+l.message,"error")}}),(c=document.getElementById("schedule-btn"))==null||c.addEventListener("click",()=>{const l=document.getElementById("schedule-modal");l&&l.classList.add("open")}),(p=document.getElementById("schedule-type"))==null||p.addEventListener("change",l=>{const h=document.getElementById("schedule-day-group");h&&(h.style.display=l.target.value==="weekly"?"":"none")}),(y=document.getElementById("save-schedule-btn"))==null||y.addEventListener("click",async()=>{var l;try{const h=document.getElementById("schedule-type").value,k=document.getElementById("schedule-day").value,S=document.getElementById("schedule-time").value,I=document.getElementById("auto-download-toggle").checked;await v.updateAutoCheckSchedule(e.id,{enabled:!0,schedule:h,day:k,time:S,autoDownload:I}),f.manga.checkSchedule=h,f.manga.checkDay=k,f.manga.checkTime=S,f.manga.autoDownload=I,(l=document.getElementById("schedule-modal"))==null||l.classList.remove("open"),N([e.id]),d("Schedule updated","success")}catch(h){d("Failed to save schedule: "+h.message,"error")}}),(C=document.getElementById("disable-schedule-btn"))==null||C.addEventListener("click",async()=>{var l;try{await v.toggleAutoCheck(e.id,!1),f.manga.autoCheck=!1,f.manga.checkSchedule=null,f.manga.checkDay=null,f.manga.checkTime=null,f.manga.nextCheck=null,(l=document.getElementById("schedule-modal"))==null||l.classList.remove("open"),N([e.id]),d("Auto-check disabled","success")}catch(h){d("Failed to disable: "+h.message,"error")}}),(b=document.getElementById("refresh-btn"))==null||b.addEventListener("click",async()=>{const l=document.getElementById("refresh-btn");try{l.disabled=!0,l.textContent="⏳ Checking...",d("Checking for updates...","info"),await v.post(`/bookmarks/${e.id}/check`),await z(e.id),N([e.id]),d("Check complete!","success")}catch(h){d("Check failed: "+h.message,"error"),l&&(l.disabled=!1,l.textContent="🔄 Refresh")}}),(g=document.getElementById("scan-folder-btn"))==null||g.addEventListener("click",async()=>{var h,k;const l=document.getElementById("scan-folder-btn");try{l.disabled=!0,l.textContent="⏳ Scanning...",d("Scanning folder...","info");const S=await v.scanBookmark(e.id);await z(e.id),N([e.id]);const I=((h=S.addedChapters)==null?void 0:h.length)||0,M=((k=S.removedChapters)==null?void 0:k.length)||0;I>0||M>0?d(`Scan complete: ${I} added, ${M} removed`,"success"):d("Scan complete: No changes","info")}catch(S){d("Scan failed: "+S.message,"error")}finally{l&&(l.disabled=!1,l.textContent="📁 Scan Folder")}}),document.querySelectorAll("[data-cbz-path]").forEach(l=>{l.addEventListener("click",async()=>{const h=decodeURIComponent(l.dataset.cbzPath),k=parseInt(l.dataset.cbzChapter)||1,S=l.dataset.cbzExtracted==="true",I=prompt("Enter chapter number for extraction:",String(k));if(!I)return;const M=parseFloat(I);if(isNaN(M)){d("Invalid chapter number","error");return}try{l.disabled=!0,l.textContent="Extracting...",d("Extracting CBZ...","info"),await v.extractCbz(e.id,h,M,{forceReExtract:S}),d("CBZ extracted successfully!","success"),await z(e.id),N([e.id])}catch(O){d("Extract failed: "+O.message,"error")}finally{l.disabled=!1,l.textContent=S?"Re-Extract":"Extract"}})}),(m=document.getElementById("edit-btn"))==null||m.addEventListener("click",async()=>{const l=document.getElementById("edit-manga-modal");if(l){document.getElementById("edit-alias-input").value=e.alias||"",window._selectedCoverPath=null;try{const[h,k]=await Promise.all([v.getAllArtists(),v.getAllCategories()]),S=document.getElementById("artist-list"),I=document.getElementById("category-list");window._allArtists=h,window._allCategories=k,S&&(S.innerHTML=h.map(te=>`<option value="${te}">`).join("")),I&&(I.innerHTML=k.map(te=>`<option value="${te}">`).join(""));const M=document.getElementById("edit-artist-input"),O=document.getElementById("edit-categories-input");M==null||M.addEventListener("input",()=>{const te=M.value.toLowerCase(),re=M.value.lastIndexOf(","),A=M.value.substring(re+1).trim().toLowerCase();if(A.length>0&&window._allArtists){const D=window._allArtists.filter(F=>F.toLowerCase().includes(A));if(S&&D.length>0){const F=re>=0?M.value.substring(0,re+1)+" ":"";S.innerHTML=D.map(G=>`<option value="${F}${G}">`).join("")}}}),O==null||O.addEventListener("input",()=>{const te=O.value.lastIndexOf(","),re=O.value.substring(te+1).trim().toLowerCase();if(re.length>0&&window._allCategories){const A=window._allCategories.filter(D=>D.toLowerCase().includes(re));if(I&&A.length>0){const D=te>=0?O.value.substring(0,te+1)+" ":"";I.innerHTML=A.map(F=>`<option value="${D}${F}">`).join("")}}})}catch(h){console.error("Failed to load artists/categories:",h)}l.classList.add("open")}}),(x=document.getElementById("save-manga-btn"))==null||x.addEventListener("click",async()=>{var l;try{const h=document.getElementById("edit-alias-input").value.trim(),k=document.getElementById("edit-artist-input").value.trim(),S=document.getElementById("edit-categories-input").value.trim(),I=k?k.split(",").map(O=>O.trim()).filter(O=>O):[],M=S?S.split(",").map(O=>O.trim()).filter(O=>O):[];await v.updateBookmark(e.id,{alias:h||null}),await v.setBookmarkArtists(e.id,I),await v.setBookmarkCategories(e.id,M),window._selectedCoverPath&&await v.setBookmarkCoverFromImage(e.id,window._selectedCoverPath),f.manga.alias=h||null,f.manga.artists=I,f.manga.categories=M,(l=document.getElementById("edit-manga-modal"))==null||l.classList.remove("open"),N([e.id]),d("Manga updated","success")}catch(h){d("Failed to update: "+h.message,"error")}}),(_=document.getElementById("change-cover-btn"))==null||_.addEventListener("click",async()=>{try{d("Loading images...","info");const l=await v.getFolderImages(e.id);if(l.length===0){d("No images found in manga folder","warning");return}const h=document.createElement("div");h.id="cover-select-modal",h.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.8);z-index:10000;display:flex;align-items:center;justify-content:center;",h.innerHTML=`
      ...
      `,document.body.appendChild(h),document.getElementById("close-cover-modal").addEventListener("click",()=>h.remove()),h.addEventListener("click",k=>{k.target===h&&h.remove()}),h.querySelectorAll(".cover-option").forEach(k=>{k.addEventListener("click",()=>{window._selectedCoverPath=k.dataset.path;const S=document.getElementById("cover-preview");S&&(S.innerHTML=`<img src="/api/proxy-image?path=${encodeURIComponent(window._selectedCoverPath)}" style="width:100%;height:100%;object-fit:cover;">`),h.remove(),d("Cover selected","success")})})}catch(l){d("Failed to load images: "+l.message,"error")}}),(L=document.getElementById("delete-manga-btn"))==null||L.addEventListener("click",()=>{const l=document.getElementById("delete-manga-modal");l&&l.classList.add("open")}),(T=document.getElementById("confirm-delete-manga-btn"))==null||T.addEventListener("click",async()=>{var h,k;const l=((h=document.getElementById("delete-files-toggle"))==null?void 0:h.checked)||!1;try{await v.deleteBookmark(e.id,l),(k=document.getElementById("delete-manga-modal"))==null||k.classList.remove("open"),d("Manga deleted","success"),P.go("/")}catch(S){d("Failed to delete: "+S.message,"error")}}),(B=document.getElementById("quick-check-btn"))==null||B.addEventListener("click",async()=>{const l=document.getElementById("quick-check-btn");try{l.disabled=!0,l.textContent="⏳ Checking...",d("Quick checking for updates...","info");const h=await v.post(`/bookmarks/${e.id}/quick-check`);await z(e.id),N([e.id]),h.newChaptersCount>0?d(`Found ${h.newChaptersCount} new chapter(s)!`,"success"):d("No new chapters found","info")}catch(h){d("Quick check failed: "+h.message,"error")}finally{l&&(l.disabled=!1,l.textContent="⚡ Quick Check")}}),(w=document.getElementById("source-label"))==null||w.addEventListener("click",()=>{const l=document.getElementById("migrate-source-modal");l&&l.classList.add("open")}),(E=document.getElementById("confirm-migrate-btn"))==null||E.addEventListener("click",async()=>{var k,S,I;const l=(S=(k=document.getElementById("migrate-url-input"))==null?void 0:k.value)==null?void 0:S.trim();if(!l){d("Please enter a URL","warning");return}const h=document.getElementById("confirm-migrate-btn");try{h.disabled=!0,h.textContent="Migrating...",d("Migrating source...","info");const M=await v.migrateSource(e.id,l);d(`Migrated! ${M.migratedChapters} chapters preserved as local`,"success"),d("Running full check on new source...","info"),await v.post(`/bookmarks/${e.id}/check`),(I=document.getElementById("migrate-source-modal"))==null||I.classList.remove("open"),await z(e.id),N([e.id]),d("Source migration complete!","success")}catch(M){d("Migration failed: "+M.message,"error")}finally{h&&(h.disabled=!1,h.textContent="Migrate Source")}}),s.querySelectorAll(".filter-btn").forEach(l=>{l.addEventListener("click",()=>{f.filter=l.dataset.filter,f.currentPage=0,N([e.id])})}),s.querySelectorAll("[data-page]").forEach(l=>{l.addEventListener("click",()=>{const h=l.dataset.page,k=Math.ceil(f.manga.chapters.length/xe);switch(h){case"first":f.currentPage=0;break;case"prev":f.currentPage=Math.max(0,f.currentPage-1);break;case"next":f.currentPage=Math.min(k-1,f.currentPage+1);break;case"last":f.currentPage=k-1;break}N([e.id])})}),s.querySelectorAll(".chapter-item").forEach(l=>{l.addEventListener("click",h=>{var I;if(h.target.closest(".chapter-actions"))return;const k=parseFloat(l.dataset.num);if((e.downloadedChapters||[]).includes(k)){const M=((I=e.downloadedVersions)==null?void 0:I[k])||[],O=Array.isArray(M)?M[0]:M;O?P.go(`/read/${e.id}/${k}?version=${encodeURIComponent(O)}`):P.go(`/read/${e.id}/${k}`)}else d("Chapter not downloaded","info")})}),s.querySelectorAll("[data-action]").forEach(l=>{l.addEventListener("click",async h=>{h.stopPropagation();const k=l.dataset.action,S=parseFloat(l.dataset.num),I=l.dataset.url?decodeURIComponent(l.dataset.url):null;switch(k){case"lock":await Ta(S);break;case"read":await Ma(S);break;case"download":await Ra(S);break;case"versions":Da(S);break;case"read-version":P.go(`/read/${e.id}/${S}?version=${encodeURIComponent(I)}`);break;case"download-version":await Na(S,I);break;case"delete-version":await qa(S,I);break;case"hide-version":await Fa(S,I);break;case"restore-version":await Oa(S,I);break;case"restore-chapter":await Va(S);break;case"delete-chapter":await Ua(S,I);break;case"hide-chapter":await Ha(S,I);break;case"unhide-chapter":await za(S,I);break}})}),s.querySelectorAll(".version-row .version-title").forEach(l=>{l.addEventListener("click",h=>{h.stopPropagation();const k=l.closest(".version-row"),S=parseFloat(k.dataset.num),I=k.dataset.versionUrl?decodeURIComponent(k.dataset.versionUrl):null;k.classList.contains("downloaded")&&I?P.go(`/read/${e.id}/${S}?version=${encodeURIComponent(I)}`):d("Version not downloaded yet","info")})}),s.querySelectorAll(".volume-card").forEach(l=>{l.addEventListener("click",()=>{const h=l.dataset.volumeId;P.go(`/manga/${e.id}/volume/${h}`)})}),Ga(s),ue(),V.subscribeToManga(e.id))}async function Ta(s){var n;const e=f.manga,t=((n=e.chapterSettings)==null?void 0:n[s])||{},a=!t.locked;try{a?await v.lockChapter(e.id,s):await v.unlockChapter(e.id,s),e.chapterSettings||(e.chapterSettings={}),e.chapterSettings[s]={...t,locked:a},d(a?"Chapter locked":"Chapter unlocked","success"),N([e.id])}catch(o){d("Failed: "+o.message,"error")}}async function Ma(s){const e=f.manga,t=new Set(e.readChapters||[]),a=t.has(s);try{await v.post(`/bookmarks/${e.id}/chapters/${s}/read`,{read:!a}),a?t.delete(s):t.add(s),e.readChapters=[...t],d(a?"Marked unread":"Marked read","success"),N([e.id])}catch(n){d("Failed: "+n.message,"error")}}async function Ra(s){const e=f.manga,t=new Set(e.deletedChapterUrls||[]),a=(e.chapters||[]).find(n=>n.number===s&&!t.has(n.url));try{d(`Downloading chapter ${s}...`,"info"),a?await v.post(`/bookmarks/${e.id}/download-version`,{chapterNumber:s,url:a.url}):await v.post(`/bookmarks/${e.id}/download`,{chapters:[s]}),d("Download queued!","success")}catch(n){d("Failed: "+n.message,"error")}}function Da(s){document.querySelectorAll(".versions-dropdown").forEach(t=>{t.id!==`versions-${s}`&&t.classList.add("hidden")});const e=document.getElementById(`versions-${s}`);e&&e.classList.toggle("hidden")}async function Na(s,e){const t=f.manga;try{d("Downloading version...","info"),await v.post(`/bookmarks/${t.id}/download-version`,{chapterNumber:s,url:e}),d("Download queued!","success")}catch(a){d("Failed: "+a.message,"error")}}async function qa(s,e){const t=f.manga;try{await v.request(`/bookmarks/${t.id}/chapters`,{method:"DELETE",body:JSON.stringify({chapterNumber:s,url:e})}),d("Version deleted","success"),await z(t.id),N([t.id])}catch(a){d("Failed: "+a.message,"error")}}async function Fa(s,e){const t=f.manga;try{await v.hideVersion(t.id,s,e),d("Version hidden","success"),await z(t.id),N([t.id])}catch(a){d("Failed: "+a.message,"error")}}async function Oa(s,e){const t=f.manga;try{await v.unhideVersion(t.id,s,e),d("Version restored","success"),await z(t.id),N([t.id])}catch(a){d("Failed to restore version: "+a.message,"error")}}async function Va(s){const e=f.manga;try{await v.unexcludeChapter(e.id,s),d("Chapter restored","success"),await z(e.id),N([e.id])}catch(t){d("Failed to restore chapter: "+t.message,"error")}}async function Ua(s,e){const t=f.manga;if(confirm("Delete this chapter's files from disk?"))try{await v.request(`/bookmarks/${t.id}/chapters`,{method:"DELETE",body:JSON.stringify({chapterNumber:s,url:e})}),d("Chapter files deleted","success"),await z(t.id),N([t.id])}catch(a){d("Failed to delete: "+a.message,"error")}}async function Ha(s,e){const t=f.manga;if(confirm("Hide this chapter? It will be moved to the Hidden filter."))try{await v.hideVersion(t.id,s,e),d("Chapter hidden","success"),await z(t.id),N([t.id])}catch(a){d("Failed to hide chapter: "+a.message,"error")}}async function za(s,e){const t=f.manga;try{await v.unhideVersion(t.id,s,e),d("Chapter unhidden","success"),await z(t.id),N([t.id])}catch(a){d("Failed to unhide chapter: "+a.message,"error")}}async function z(s){try{const[e,t]=await Promise.all([v.getBookmark(s),ne.loadCategories()]);if(f.manga=e,f.categories=t,f.loading=!1,e.website==="Local")try{const o=await v.getCbzFiles(s);f.cbzFiles=o||[]}catch(o){console.error("Failed to load CBZ files:",o),f.cbzFiles=[]}else f.cbzFiles=[];const a=new Set((e.chapters||[]).map(o=>o.number)).size,n=Math.ceil(a/xe);f.currentPage=Math.max(0,n-1),f.activeVolumeId?f.activeVolume=(e.volumes||[]).find(o=>o.id===f.activeVolumeId):f.activeVolume=null}catch{d("Failed to load manga","error"),f.loading=!1}}async function N(s=[]){const[e,t,a]=s;if(!e){P.go("/");return}f.activeVolumeId=t==="volume"?a:null;const n=document.getElementById("app");!f.manga||f.manga.id!==e?(f.loading=!0,f.manga=null,n.innerHTML=dt(),await z(e)):f.activeVolumeId?f.activeVolume=(f.manga.volumes||[]).find(o=>o.id===f.activeVolumeId):f.activeVolume=null,n.innerHTML=dt(),Pa()}function ja(){f.manga&&V.unsubscribeFromManga(f.manga.id),f.manga=null,f.loading=!0}const Qa={mount:N,unmount:ja,render:dt};function Wa(){return`
  ...
  `}function Ga(s){const e=f.manga;if(!e)return;const t=s.querySelector("#add-volume-btn"),a=s.querySelector("#add-volume-modal"),n=s.querySelector("#add-volume-submit-btn");t&&a&&t.addEventListener("click",()=>{a.classList.add("open"),s.querySelector("#add-volume-name-input").focus()}),a==null||a.querySelectorAll(".modal-close, .modal-close-btn, .modal-overlay").forEach(m=>{m.addEventListener("click",()=>a.classList.remove("open"))}),n&&n.addEventListener("click",async()=>{const m=s.querySelector("#add-volume-name-input").value.trim();if(!m)return d("Please enter a volume name","error");try{n.disabled=!0,n.textContent="Creating...",await v.createVolume(e.id,m),d("Volume created successfully!","success"),a.classList.remove("open"),s.querySelector("#add-volume-name-input").value="",await z(e.id),N([e.id])}catch(x){d("Failed to create volume: "+x.message,"error")}finally{n.disabled=!1,n.textContent="Create Volume"}});const o=s.querySelector("#manage-chapters-btn");o&&o.addEventListener("click",()=>{f.manageChapters=!f.manageChapters,N([e.id,"volume",f.activeVolumeId])}),s.querySelectorAll(".add-to-vol-btn").forEach(m=>{m.addEventListener("click",async()=>{const x=parseFloat(m.dataset.num),_=f.activeVolume;if(_)try{m.disabled=!0,m.textContent="...";const L=_.chapters||[];if(L.includes(x))return;const T=[...L,x].sort((B,w)=>B-w);await v.updateVolumeChapters(e.id,_.id,T),d(`Chapter ${x} added to volume`,"success"),await z(e.id),N([e.id,"volume",_.id])}catch(L){d("Failed to add chapter: "+L.message,"error"),m.disabled=!1,m.textContent="Add"}})}),s.querySelectorAll(".remove-from-vol-btn").forEach(m=>{m.addEventListener("click",async x=>{x.stopPropagation();const _=parseFloat(m.dataset.num),L=f.activeVolume;if(L)try{m.disabled=!0,m.textContent="...";const B=(L.chapters||[]).filter(w=>w!==_);await v.updateVolumeChapters(e.id,L.id,B),d(`Chapter ${_} removed from volume`,"success"),await z(e.id),N([e.id,"volume",L.id])}catch(T){d("Failed to remove chapter: "+T.message,"error"),m.disabled=!1,m.textContent="×"}})});const r=s.querySelector("#edit-vol-btn"),u=s.querySelector("#edit-volume-modal");r&&u&&r.addEventListener("click",()=>{const m=r.dataset.volId,x=e.volumes.find(_=>_.id===m);x&&(s.querySelector("#volume-name-input").value=x.name,u.dataset.editingVolId=m,u.classList.add("open"))});const c=s.querySelector("#save-volume-btn");c&&c.addEventListener("click",async()=>{const m=u.dataset.editingVolId,x=s.querySelector("#volume-name-input").value.trim();if(!x)return d("Volume name cannot be empty","error");try{await v.renameVolume(e.id,m,x),d("Volume renamed","success"),u.classList.remove("open"),await z(e.id),N([e.id,"volume",m])}catch(_){d(_.message,"error")}});const p=s.querySelector("#delete-volume-btn");p&&p.addEventListener("click",async()=>{if(!confirm("Are you sure you want to delete this volume? Chapters will remain in the library."))return;const m=u.dataset.editingVolId;try{await v.deleteVolume(e.id,m),d("Volume deleted","success"),u.classList.remove("open"),window.location.hash=`#/manga/${e.id}`}catch(x){d(x.message,"error")}});const y=s.querySelector("#vol-cover-upload-btn");if(y){let m=document.getElementById("vol-cover-input-hidden");m||(m=document.createElement("input"),m.type="file",m.id="vol-cover-input-hidden",m.accept="image/*",m.style.display="none",document.body.appendChild(m),m.addEventListener("change",async x=>{const _=x.target.files[0];if(!_)return;const L=u.dataset.editingVolId;if(L)try{m.value="",y.disabled=!0,y.textContent="Uploading...",await v.uploadVolumeCover(e.id,L,_),d("Cover uploaded","success"),await z(e.id),N([e.id,"volume",L])}catch(T){d("Upload failed: "+T.message,"error")}finally{y.disabled=!1,y.innerHTML="📤 Upload Image"}})),y.addEventListener("click",()=>m.click())}const C=s.querySelector("#vol-cover-selector-btn"),b=s.querySelector("#cover-selector-modal");C&&b&&C.addEventListener("click",async()=>{const m=b.querySelector("#cover-chapter-select");m.innerHTML='<option value="">Select a chapter...</option>';const x=s.querySelector("#edit-volume-modal"),_=x?x.dataset.editingVolId:null;let L=[...e.chapters||[]];if(_){const B=e.volumes.find(w=>w.id===_);if(B&&B.chapters){const w=new Set(B.chapters);L=L.filter(E=>w.has(E.number))}}L.sort((B,w)=>B.number-w.number);const T=new Set;L.forEach(B=>{if(!T.has(B.number)){T.add(B.number);const w=document.createElement("option");w.value=B.number,w.textContent=`Chapter ${B.number}`,m.appendChild(w)}}),L.length>0&&(m.value=L[0].number,Bt(e.id,L[0].number)),b.classList.add("open")});const g=s.querySelector("#cover-chapter-select");g&&g.addEventListener("change",m=>{m.target.value&&Bt(e.id,m.target.value)}),s.querySelectorAll(".modal-close, .modal-close-btn").forEach(m=>{m.addEventListener("click",()=>{m.closest(".modal").classList.remove("open")})}),s.querySelectorAll(".modal-overlay").forEach(m=>{m.addEventListener("click",()=>{m.closest(".modal").classList.remove("open")})})}async function Bt(s,e){const t=document.getElementById("cover-images-grid");if(t){t.innerHTML='<div class="loading-center"><div class="loading-spinner"></div></div>';try{const n=(await v.getChapterImages(s,e)).images||[];if(t.innerHTML="",n.length===0){t.innerHTML='<div style="grid-column:1/-1; text-align:center; padding:20px;">No images found.</div>';return}n.forEach(o=>{const r=document.createElement("div");r.className="cover-grid-item",r.style.cssText="cursor:pointer; width:100%; padding-bottom:150%; height:0; border-radius:4px; overflow:hidden; position:relative; background: #222;",r.innerHTML=`<img src="${o}" style="position:absolute; top:0; left:0; width:100%; height:100%; object-fit:cover; object-position:top;" loading="lazy">`,r.addEventListener("click",()=>{const u=document.querySelector('input[name="cover-target"]:checked').value,c=o.split("/").pop();Ka(c,e,u)}),t.appendChild(r)})}catch(a){t.innerHTML=`<div style="color:var(--danger); padding:20px;">Error: ${a.message}</div>`}}}async function Ka(s,e,t){const a=f.manga,n=document.getElementById("edit-volume-modal"),o=document.getElementById("cover-selector-modal");if(confirm(`Set this image as ${t} cover?`))try{if(t==="volume"){const r=n.dataset.editingVolId;if(!r)throw new Error("No volume selected");await v.setVolumeCoverFromChapter(a.id,r,e,s),d("Volume cover updated","success"),o.classList.remove("open"),n.classList.remove("open"),await z(a.id),N([a.id,"volume",r])}else{await v.setMangaCoverFromChapter(a.id,e,s),d("Series cover updated","success"),o.classList.remove("open"),await z(a.id);const r=window.location.hash.replace("#","");f.activeVolumeId?N([a.id,"volume",f.activeVolumeId]):N([a.id])}}catch(r){d("Failed to set cover: "+r.message,"error")}}let ee={series:null,loading:!0};function ye(){if(ee.loading)return`
      ${Z("series")}
      <div class="container">
        <div class="loading-center"><div class="loading-spinner"></div></div>
      </div>
  ...
  `}function Qe(){var c,p,y;const s=document.getElementById("app"),e=ee.series;(c=document.getElementById("back-btn"))==null||c.addEventListener("click",()=>P.go("/")),(p=document.getElementById("back-library-btn"))==null||p.addEventListener("click",()=>P.go("/")),s.querySelectorAll(".series-entry-card").forEach(C=>{C.addEventListener("click",b=>{if(b.target.closest("[data-action]"))return;const g=C.dataset.id;P.go(`/manga/${g}`)})}),s.querySelectorAll("[data-action]").forEach(C=>{C.addEventListener("click",async b=>{b.stopPropagation();const g=C.dataset.action,m=C.dataset.id;switch(g){case"move-up":await At(m,-1);break;case"move-down":await At(m,1);break;case"set-cover":const x=C.dataset.entryid;await Ja(x);break}})});const t=document.getElementById("add-entry-btn"),a=document.getElementById("add-entry-modal"),n=document.getElementById("available-bookmarks-input"),o=document.getElementById("available-bookmarks-list"),r=document.getElementById("confirm-add-entry-btn");let u=[];t&&a&&(t.addEventListener("click",async()=>{try{t.disabled=!0,n&&(n.value="",n.placeholder="Loading...",n.disabled=!0),o&&(o.innerHTML=""),a.classList.add("open");const C=await v.getAvailableBookmarksForSeries();u=C,C.length===0?(n&&(n.placeholder="No available manga found"),r.disabled=!0):(n&&(n.placeholder="Select or type a manga...",n.disabled=!1),o&&(o.innerHTML=C.map(b=>`<option value="${(b.alias||b.title||"").replace(/"/g,"&quot;")}"></option>`).join("")),r.disabled=!1)}catch{d("Failed to load available manga","error"),a.classList.remove("open")}finally{t.disabled=!1}}),r.addEventListener("click",async()=>{const C=n?n.value:"",b=u.find(m=>(m.alias||m.title||"")===C);if(!b){d("Please select a valid manga from the list","warning");return}const g=b.id;try{r.disabled=!0,r.textContent="Adding...",await v.addSeriesEntry(e.id,g),d("Manga added to series","success"),a.classList.remove("open"),await We(e.id),s.innerHTML=ye(),Qe()}catch(m){d("Failed to add manga: "+m.message,"error")}finally{r.disabled=!1,r.textContent="Add to Series"}})),(y=document.getElementById("edit-series-btn"))==null||y.addEventListener("click",()=>{d("Edit series coming soon","info")})}async function At(s,e){const t=ee.series;if(!t)return;const a=t.entries||[],n=a.findIndex(u=>u.bookmark_id===s);if(n===-1)return;const o=n+e;if(o<0||o>=a.length)return;const r=a.map(u=>u.bookmark_id);[r[n],r[o]]=[r[o],r[n]];try{await v.post(`/series/${t.id}/reorder`,{order:r}),d("Order updated","success"),await We(t.id);const u=document.getElementById("app");u.innerHTML=ye(),Qe()}catch(u){d("Failed to reorder: "+u.message,"error")}}async function Ja(s){const e=ee.series;if(e)try{await v.setSeriesCover(e.id,s),d("Series cover updated","success"),await We(e.id);const t=document.getElementById("app");t.innerHTML=ye(),Qe()}catch(t){d("Failed to set cover: "+t.message,"error")}}async function We(s){try{const e=await v.get(`/series/${s}`);ee.series=e,ee.loading=!1}catch{d("Failed to load series","error"),ee.loading=!1}}async function Xa(s=[]){const[e]=s;if(!e){P.go("/");return}const t=document.getElementById("app");ee.loading=!0,ee.series=null,t.innerHTML=ye(),await We(e),t.innerHTML=ye(),Qe()}function Za(){ee.series=null,ee.loading=!0}const en={mount:Xa,unmount:Za,render:ye},tn={mount:async s=>{const e=document.getElementById("app");e.innerHTML=`
            ...
            <div class="table-responsive">
                <table class="data-table">
                    ...
                    <tbody>
                        ${r.rows.map(c=>`
                            <tr>
                                ${u.map(p=>{const y=c[p];let C=y;return y===null?C='<span class="null">NULL</span>':typeof y=="object"?C=JSON.stringify(y):String(y).length>100&&(C=String(y).substring(0,100)+"..."),`<td>${C}</td>`}).join("")}
                            </tr>
                        `).join("")}
                    </tbody>
                </table>
