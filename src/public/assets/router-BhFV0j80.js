import{a as m}from"./api-CQSJjZle.js";const Ce=Object.create(null);Ce.open="0";Ce.close="1";Ce.ping="2";Ce.pong="3";Ce.message="4";Ce.upgrade="5";Ce.noop="6";const at=Object.create(null);Object.keys(Ce).forEach(t=>{at[Ce[t]]=t});const Pt={type:"error",data:"parser error"},Os=typeof Blob=="function"||typeof Blob<"u"&&Object.prototype.toString.call(Blob)==="[object BlobConstructor]",Us=typeof ArrayBuffer=="function",Hs=t=>typeof ArrayBuffer.isView=="function"?ArrayBuffer.isView(t):t&&t.buffer instanceof ArrayBuffer,es=({type:t,data:e},s,a)=>Os&&e instanceof Blob?s?a(e):ks(e,a):Us&&(e instanceof ArrayBuffer||Hs(e))?s?a(e):ks(new Blob([e]),a):a(Ce[t]+(e||"")),ks=(t,e)=>{const s=new FileReader;return s.onload=function(){const a=s.result.split(",")[1];e("b"+(a||""))},s.readAsDataURL(t)};function $s(t){return t instanceof Uint8Array?t:t instanceof ArrayBuffer?new Uint8Array(t):new Uint8Array(t.buffer,t.byteOffset,t.byteLength)}let Lt;function xa(t,e){if(Os&&t.data instanceof Blob)return t.data.arrayBuffer().then($s).then(e);if(Us&&(t.data instanceof ArrayBuffer||Hs(t.data)))return e($s(t.data));es(t,!1,s=>{Lt||(Lt=new TextEncoder),e(Lt.encode(s))})}const Es="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/",je=typeof Uint8Array>"u"?[]:new Uint8Array(256);for(let t=0;t<Es.length;t++)je[Es.charCodeAt(t)]=t;const La=t=>{let e=t.length*.75,s=t.length,a,n=0,r,o,c,l;t[t.length-1]==="="&&(e--,t[t.length-2]==="="&&e--);const h=new ArrayBuffer(e),u=new Uint8Array(h);for(a=0;a<s;a+=4)r=je[t.charCodeAt(a)],o=je[t.charCodeAt(a+1)],c=je[t.charCodeAt(a+2)],l=je[t.charCodeAt(a+3)],u[n++]=r<<2|o>>4,u[n++]=(o&15)<<4|c>>2,u[n++]=(c&3)<<6|l&63;return h},Ia=typeof ArrayBuffer=="function",ts=(t,e)=>{if(typeof t!="string")return{type:"message",data:Vs(t,e)};const s=t.charAt(0);return s==="b"?{type:"message",data:Ba(t.substring(1),e)}:at[s]?t.length>1?{type:at[s],data:t.substring(1)}:{type:at[s]}:Pt},Ba=(t,e)=>{if(Ia){const s=La(t);return Vs(s,e)}else return{base64:!0,data:t}},Vs=(t,e)=>{switch(e){case"blob":return t instanceof Blob?t:new Blob([t]);case"arraybuffer":default:return t instanceof ArrayBuffer?t:t.buffer}},zs="",Aa=(t,e)=>{const s=t.length,a=new Array(s);let n=0;t.forEach((r,o)=>{es(r,!1,c=>{a[o]=c,++n===s&&e(a.join(zs))})})},_a=(t,e)=>{const s=t.split(zs),a=[];for(let n=0;n<s.length;n++){const r=ts(s[n],e);if(a.push(r),r.type==="error")break}return a};function Ma(){return new TransformStream({transform(t,e){xa(t,s=>{const a=s.length;let n;if(a<126)n=new Uint8Array(1),new DataView(n.buffer).setUint8(0,a);else if(a<65536){n=new Uint8Array(3);const r=new DataView(n.buffer);r.setUint8(0,126),r.setUint16(1,a)}else{n=new Uint8Array(9);const r=new DataView(n.buffer);r.setUint8(0,127),r.setBigUint64(1,BigInt(a))}t.data&&typeof t.data!="string"&&(n[0]|=128),e.enqueue(n),e.enqueue(s)})}})}let It;function et(t){return t.reduce((e,s)=>e+s.length,0)}function tt(t,e){if(t[0].length===e)return t.shift();const s=new Uint8Array(e);let a=0;for(let n=0;n<e;n++)s[n]=t[0][a++],a===t[0].length&&(t.shift(),a=0);return t.length&&a<t[0].length&&(t[0]=t[0].slice(a)),s}function Ta(t,e){It||(It=new TextDecoder);const s=[];let a=0,n=-1,r=!1;return new TransformStream({transform(o,c){for(s.push(o);;){if(a===0){if(et(s)<1)break;const l=tt(s,1);r=(l[0]&128)===128,n=l[0]&127,n<126?a=3:n===126?a=1:a=2}else if(a===1){if(et(s)<2)break;const l=tt(s,2);n=new DataView(l.buffer,l.byteOffset,l.length).getUint16(0),a=3}else if(a===2){if(et(s)<8)break;const l=tt(s,8),h=new DataView(l.buffer,l.byteOffset,l.length),u=h.getUint32(0);if(u>Math.pow(2,21)-1){c.enqueue(Pt);break}n=u*Math.pow(2,32)+h.getUint32(4),a=3}else{if(et(s)<n)break;const l=tt(s,n);c.enqueue(ts(r?l:It.decode(l),e)),a=0}if(n===0||n>t){c.enqueue(Pt);break}}}})}const js=4;function te(t){if(t)return Pa(t)}function Pa(t){for(var e in te.prototype)t[e]=te.prototype[e];return t}te.prototype.on=te.prototype.addEventListener=function(t,e){return this._callbacks=this._callbacks||{},(this._callbacks["$"+t]=this._callbacks["$"+t]||[]).push(e),this};te.prototype.once=function(t,e){function s(){this.off(t,s),e.apply(this,arguments)}return s.fn=e,this.on(t,s),this};te.prototype.off=te.prototype.removeListener=te.prototype.removeAllListeners=te.prototype.removeEventListener=function(t,e){if(this._callbacks=this._callbacks||{},arguments.length==0)return this._callbacks={},this;var s=this._callbacks["$"+t];if(!s)return this;if(arguments.length==1)return delete this._callbacks["$"+t],this;for(var a,n=0;n<s.length;n++)if(a=s[n],a===e||a.fn===e){s.splice(n,1);break}return s.length===0&&delete this._callbacks["$"+t],this};te.prototype.emit=function(t){this._callbacks=this._callbacks||{};for(var e=new Array(arguments.length-1),s=this._callbacks["$"+t],a=1;a<arguments.length;a++)e[a-1]=arguments[a];if(s){s=s.slice(0);for(var a=0,n=s.length;a<n;++a)s[a].apply(this,e)}return this};te.prototype.emitReserved=te.prototype.emit;te.prototype.listeners=function(t){return this._callbacks=this._callbacks||{},this._callbacks["$"+t]||[]};te.prototype.hasListeners=function(t){return!!this.listeners(t).length};const wt=typeof Promise=="function"&&typeof Promise.resolve=="function"?e=>Promise.resolve().then(e):(e,s)=>s(e,0),ge=typeof self<"u"?self:typeof window<"u"?window:Function("return this")(),Ra="arraybuffer";function Qs(t,...e){return e.reduce((s,a)=>(t.hasOwnProperty(a)&&(s[a]=t[a]),s),{})}const qa=ge.setTimeout,Da=ge.clearTimeout;function kt(t,e){e.useNativeTimers?(t.setTimeoutFn=qa.bind(ge),t.clearTimeoutFn=Da.bind(ge)):(t.setTimeoutFn=ge.setTimeout.bind(ge),t.clearTimeoutFn=ge.clearTimeout.bind(ge))}const Fa=1.33;function Na(t){return typeof t=="string"?Oa(t):Math.ceil((t.byteLength||t.size)*Fa)}function Oa(t){let e=0,s=0;for(let a=0,n=t.length;a<n;a++)e=t.charCodeAt(a),e<128?s+=1:e<2048?s+=2:e<55296||e>=57344?s+=3:(a++,s+=4);return s}function Ws(){return Date.now().toString(36).substring(3)+Math.random().toString(36).substring(2,5)}function Ua(t){let e="";for(let s in t)t.hasOwnProperty(s)&&(e.length&&(e+="&"),e+=encodeURIComponent(s)+"="+encodeURIComponent(t[s]));return e}function Ha(t){let e={},s=t.split("&");for(let a=0,n=s.length;a<n;a++){let r=s[a].split("=");e[decodeURIComponent(r[0])]=decodeURIComponent(r[1])}return e}class Va extends Error{constructor(e,s,a){super(e),this.description=s,this.context=a,this.type="TransportError"}}class ss extends te{constructor(e){super(),this.writable=!1,kt(this,e),this.opts=e,this.query=e.query,this.socket=e.socket,this.supportsBinary=!e.forceBase64}onError(e,s,a){return super.emitReserved("error",new Va(e,s,a)),this}open(){return this.readyState="opening",this.doOpen(),this}close(){return(this.readyState==="opening"||this.readyState==="open")&&(this.doClose(),this.onClose()),this}send(e){this.readyState==="open"&&this.write(e)}onOpen(){this.readyState="open",this.writable=!0,super.emitReserved("open")}onData(e){const s=ts(e,this.socket.binaryType);this.onPacket(s)}onPacket(e){super.emitReserved("packet",e)}onClose(e){this.readyState="closed",super.emitReserved("close",e)}pause(e){}createUri(e,s={}){return e+"://"+this._hostname()+this._port()+this.opts.path+this._query(s)}_hostname(){const e=this.opts.hostname;return e.indexOf(":")===-1?e:"["+e+"]"}_port(){return this.opts.port&&(this.opts.secure&&Number(this.opts.port)!==443||!this.opts.secure&&Number(this.opts.port)!==80)?":"+this.opts.port:""}_query(e){const s=Ua(e);return s.length?"?"+s:""}}class za extends ss{constructor(){super(...arguments),this._polling=!1}get name(){return"polling"}doOpen(){this._poll()}pause(e){this.readyState="pausing";const s=()=>{this.readyState="paused",e()};if(this._polling||!this.writable){let a=0;this._polling&&(a++,this.once("pollComplete",function(){--a||s()})),this.writable||(a++,this.once("drain",function(){--a||s()}))}else s()}_poll(){this._polling=!0,this.doPoll(),this.emitReserved("poll")}onData(e){const s=a=>{if(this.readyState==="opening"&&a.type==="open"&&this.onOpen(),a.type==="close")return this.onClose({description:"transport closed by the server"}),!1;this.onPacket(a)};_a(e,this.socket.binaryType).forEach(s),this.readyState!=="closed"&&(this._polling=!1,this.emitReserved("pollComplete"),this.readyState==="open"&&this._poll())}doClose(){const e=()=>{this.write([{type:"close"}])};this.readyState==="open"?e():this.once("open",e)}write(e){this.writable=!1,Aa(e,s=>{this.doWrite(s,()=>{this.writable=!0,this.emitReserved("drain")})})}uri(){const e=this.opts.secure?"https":"http",s=this.query||{};return this.opts.timestampRequests!==!1&&(s[this.opts.timestampParam]=Ws()),!this.supportsBinary&&!s.sid&&(s.b64=1),this.createUri(e,s)}}let Gs=!1;try{Gs=typeof XMLHttpRequest<"u"&&"withCredentials"in new XMLHttpRequest}catch{}const ja=Gs;function Qa(){}class Wa extends za{constructor(e){if(super(e),typeof location<"u"){const s=location.protocol==="https:";let a=location.port;a||(a=s?"443":"80"),this.xd=typeof location<"u"&&e.hostname!==location.hostname||a!==e.port}}doWrite(e,s){const a=this.request({method:"POST",data:e});a.on("success",s),a.on("error",(n,r)=>{this.onError("xhr post error",n,r)})}doPoll(){const e=this.request();e.on("data",this.onData.bind(this)),e.on("error",(s,a)=>{this.onError("xhr poll error",s,a)}),this.pollXhr=e}}class Ee extends te{constructor(e,s,a){super(),this.createRequest=e,kt(this,a),this._opts=a,this._method=a.method||"GET",this._uri=s,this._data=a.data!==void 0?a.data:null,this._create()}_create(){var e;const s=Qs(this._opts,"agent","pfx","key","passphrase","cert","ca","ciphers","rejectUnauthorized","autoUnref");s.xdomain=!!this._opts.xd;const a=this._xhr=this.createRequest(s);try{a.open(this._method,this._uri,!0);try{if(this._opts.extraHeaders){a.setDisableHeaderCheck&&a.setDisableHeaderCheck(!0);for(let n in this._opts.extraHeaders)this._opts.extraHeaders.hasOwnProperty(n)&&a.setRequestHeader(n,this._opts.extraHeaders[n])}}catch{}if(this._method==="POST")try{a.setRequestHeader("Content-type","text/plain;charset=UTF-8")}catch{}try{a.setRequestHeader("Accept","*/*")}catch{}(e=this._opts.cookieJar)===null||e===void 0||e.addCookies(a),"withCredentials"in a&&(a.withCredentials=this._opts.withCredentials),this._opts.requestTimeout&&(a.timeout=this._opts.requestTimeout),a.onreadystatechange=()=>{var n;a.readyState===3&&((n=this._opts.cookieJar)===null||n===void 0||n.parseCookies(a.getResponseHeader("set-cookie"))),a.readyState===4&&(a.status===200||a.status===1223?this._onLoad():this.setTimeoutFn(()=>{this._onError(typeof a.status=="number"?a.status:0)},0))},a.send(this._data)}catch(n){this.setTimeoutFn(()=>{this._onError(n)},0);return}typeof document<"u"&&(this._index=Ee.requestsCount++,Ee.requests[this._index]=this)}_onError(e){this.emitReserved("error",e,this._xhr),this._cleanup(!0)}_cleanup(e){if(!(typeof this._xhr>"u"||this._xhr===null)){if(this._xhr.onreadystatechange=Qa,e)try{this._xhr.abort()}catch{}typeof document<"u"&&delete Ee.requests[this._index],this._xhr=null}}_onLoad(){const e=this._xhr.responseText;e!==null&&(this.emitReserved("data",e),this.emitReserved("success"),this._cleanup())}abort(){this._cleanup()}}Ee.requestsCount=0;Ee.requests={};if(typeof document<"u"){if(typeof attachEvent=="function")attachEvent("onunload",Cs);else if(typeof addEventListener=="function"){const t="onpagehide"in ge?"pagehide":"unload";addEventListener(t,Cs,!1)}}function Cs(){for(let t in Ee.requests)Ee.requests.hasOwnProperty(t)&&Ee.requests[t].abort()}const Ga=function(){const t=Ks({xdomain:!1});return t&&t.responseType!==null}();class Ka extends Wa{constructor(e){super(e);const s=e&&e.forceBase64;this.supportsBinary=Ga&&!s}request(e={}){return Object.assign(e,{xd:this.xd},this.opts),new Ee(Ks,this.uri(),e)}}function Ks(t){const e=t.xdomain;try{if(typeof XMLHttpRequest<"u"&&(!e||ja))return new XMLHttpRequest}catch{}if(!e)try{return new ge[["Active"].concat("Object").join("X")]("Microsoft.XMLHTTP")}catch{}}const Js=typeof navigator<"u"&&typeof navigator.product=="string"&&navigator.product.toLowerCase()==="reactnative";class Ja extends ss{get name(){return"websocket"}doOpen(){const e=this.uri(),s=this.opts.protocols,a=Js?{}:Qs(this.opts,"agent","perMessageDeflate","pfx","key","passphrase","cert","ca","ciphers","rejectUnauthorized","localAddress","protocolVersion","origin","maxPayload","family","checkServerIdentity");this.opts.extraHeaders&&(a.headers=this.opts.extraHeaders);try{this.ws=this.createSocket(e,s,a)}catch(n){return this.emitReserved("error",n)}this.ws.binaryType=this.socket.binaryType,this.addEventListeners()}addEventListeners(){this.ws.onopen=()=>{this.opts.autoUnref&&this.ws._socket.unref(),this.onOpen()},this.ws.onclose=e=>this.onClose({description:"websocket connection closed",context:e}),this.ws.onmessage=e=>this.onData(e.data),this.ws.onerror=e=>this.onError("websocket error",e)}write(e){this.writable=!1;for(let s=0;s<e.length;s++){const a=e[s],n=s===e.length-1;es(a,this.supportsBinary,r=>{try{this.doWrite(a,r)}catch{}n&&wt(()=>{this.writable=!0,this.emitReserved("drain")},this.setTimeoutFn)})}}doClose(){typeof this.ws<"u"&&(this.ws.onerror=()=>{},this.ws.close(),this.ws=null)}uri(){const e=this.opts.secure?"wss":"ws",s=this.query||{};return this.opts.timestampRequests&&(s[this.opts.timestampParam]=Ws()),this.supportsBinary||(s.b64=1),this.createUri(e,s)}}const Bt=ge.WebSocket||ge.MozWebSocket;class Ya extends Ja{createSocket(e,s,a){return Js?new Bt(e,s,a):s?new Bt(e,s):new Bt(e)}doWrite(e,s){this.ws.send(s)}}class Xa extends ss{get name(){return"webtransport"}doOpen(){try{this._transport=new WebTransport(this.createUri("https"),this.opts.transportOptions[this.name])}catch(e){return this.emitReserved("error",e)}this._transport.closed.then(()=>{this.onClose()}).catch(e=>{this.onError("webtransport error",e)}),this._transport.ready.then(()=>{this._transport.createBidirectionalStream().then(e=>{const s=Ta(Number.MAX_SAFE_INTEGER,this.socket.binaryType),a=e.readable.pipeThrough(s).getReader(),n=Ma();n.readable.pipeTo(e.writable),this._writer=n.writable.getWriter();const r=()=>{a.read().then(({done:c,value:l})=>{c||(this.onPacket(l),r())}).catch(c=>{})};r();const o={type:"open"};this.query.sid&&(o.data=`{"sid":"${this.query.sid}"}`),this._writer.write(o).then(()=>this.onOpen())})})}write(e){this.writable=!1;for(let s=0;s<e.length;s++){const a=e[s],n=s===e.length-1;this._writer.write(a).then(()=>{n&&wt(()=>{this.writable=!0,this.emitReserved("drain")},this.setTimeoutFn)})}}doClose(){var e;(e=this._transport)===null||e===void 0||e.close()}}const Za={websocket:Ya,webtransport:Xa,polling:Ka},en=/^(?:(?![^:@\/?#]+:[^:@\/]*@)(http|https|ws|wss):\/\/)?((?:(([^:@\/?#]*)(?::([^:@\/?#]*))?)?@)?((?:[a-f0-9]{0,4}:){2,7}[a-f0-9]{0,4}|[^:\/?#]*)(?::(\d*))?)(((\/(?:[^?#](?![^?#\/]*\.[^?#\/.]+(?:[?#]|$)))*\/?)?([^?#\/]*))(?:\?([^#]*))?(?:#(.*))?)/,tn=["source","protocol","authority","userInfo","user","password","host","port","relative","path","directory","file","query","anchor"];function Rt(t){if(t.length>8e3)throw"URI too long";const e=t,s=t.indexOf("["),a=t.indexOf("]");s!=-1&&a!=-1&&(t=t.substring(0,s)+t.substring(s,a).replace(/:/g,";")+t.substring(a,t.length));let n=en.exec(t||""),r={},o=14;for(;o--;)r[tn[o]]=n[o]||"";return s!=-1&&a!=-1&&(r.source=e,r.host=r.host.substring(1,r.host.length-1).replace(/;/g,":"),r.authority=r.authority.replace("[","").replace("]","").replace(/;/g,":"),r.ipv6uri=!0),r.pathNames=sn(r,r.path),r.queryKey=an(r,r.query),r}function sn(t,e){const s=/\/{2,9}/g,a=e.replace(s,"/").split("/");return(e.slice(0,1)=="/"||e.length===0)&&a.splice(0,1),e.slice(-1)=="/"&&a.splice(a.length-1,1),a}function an(t,e){const s={};return e.replace(/(?:^|&)([^&=]*)=?([^&]*)/g,function(a,n,r){n&&(s[n]=r)}),s}const qt=typeof addEventListener=="function"&&typeof removeEventListener=="function",nt=[];qt&&addEventListener("offline",()=>{nt.forEach(t=>t())},!1);class Be extends te{constructor(e,s){if(super(),this.binaryType=Ra,this.writeBuffer=[],this._prevBufferLen=0,this._pingInterval=-1,this._pingTimeout=-1,this._maxPayload=-1,this._pingTimeoutTime=1/0,e&&typeof e=="object"&&(s=e,e=null),e){const a=Rt(e);s.hostname=a.host,s.secure=a.protocol==="https"||a.protocol==="wss",s.port=a.port,a.query&&(s.query=a.query)}else s.host&&(s.hostname=Rt(s.host).host);kt(this,s),this.secure=s.secure!=null?s.secure:typeof location<"u"&&location.protocol==="https:",s.hostname&&!s.port&&(s.port=this.secure?"443":"80"),this.hostname=s.hostname||(typeof location<"u"?location.hostname:"localhost"),this.port=s.port||(typeof location<"u"&&location.port?location.port:this.secure?"443":"80"),this.transports=[],this._transportsByName={},s.transports.forEach(a=>{const n=a.prototype.name;this.transports.push(n),this._transportsByName[n]=a}),this.opts=Object.assign({path:"/engine.io",agent:!1,withCredentials:!1,upgrade:!0,timestampParam:"t",rememberUpgrade:!1,addTrailingSlash:!0,rejectUnauthorized:!0,perMessageDeflate:{threshold:1024},transportOptions:{},closeOnBeforeunload:!1},s),this.opts.path=this.opts.path.replace(/\/$/,"")+(this.opts.addTrailingSlash?"/":""),typeof this.opts.query=="string"&&(this.opts.query=Ha(this.opts.query)),qt&&(this.opts.closeOnBeforeunload&&(this._beforeunloadEventListener=()=>{this.transport&&(this.transport.removeAllListeners(),this.transport.close())},addEventListener("beforeunload",this._beforeunloadEventListener,!1)),this.hostname!=="localhost"&&(this._offlineEventListener=()=>{this._onClose("transport close",{description:"network connection lost"})},nt.push(this._offlineEventListener))),this.opts.withCredentials&&(this._cookieJar=void 0),this._open()}createTransport(e){const s=Object.assign({},this.opts.query);s.EIO=js,s.transport=e,this.id&&(s.sid=this.id);const a=Object.assign({},this.opts,{query:s,socket:this,hostname:this.hostname,secure:this.secure,port:this.port},this.opts.transportOptions[e]);return new this._transportsByName[e](a)}_open(){if(this.transports.length===0){this.setTimeoutFn(()=>{this.emitReserved("error","No transports available")},0);return}const e=this.opts.rememberUpgrade&&Be.priorWebsocketSuccess&&this.transports.indexOf("websocket")!==-1?"websocket":this.transports[0];this.readyState="opening";const s=this.createTransport(e);s.open(),this.setTransport(s)}setTransport(e){this.transport&&this.transport.removeAllListeners(),this.transport=e,e.on("drain",this._onDrain.bind(this)).on("packet",this._onPacket.bind(this)).on("error",this._onError.bind(this)).on("close",s=>this._onClose("transport close",s))}onOpen(){this.readyState="open",Be.priorWebsocketSuccess=this.transport.name==="websocket",this.emitReserved("open"),this.flush()}_onPacket(e){if(this.readyState==="opening"||this.readyState==="open"||this.readyState==="closing")switch(this.emitReserved("packet",e),this.emitReserved("heartbeat"),e.type){case"open":this.onHandshake(JSON.parse(e.data));break;case"ping":this._sendPacket("pong"),this.emitReserved("ping"),this.emitReserved("pong"),this._resetPingTimeout();break;case"error":const s=new Error("server error");s.code=e.data,this._onError(s);break;case"message":this.emitReserved("data",e.data),this.emitReserved("message",e.data);break}}onHandshake(e){this.emitReserved("handshake",e),this.id=e.sid,this.transport.query.sid=e.sid,this._pingInterval=e.pingInterval,this._pingTimeout=e.pingTimeout,this._maxPayload=e.maxPayload,this.onOpen(),this.readyState!=="closed"&&this._resetPingTimeout()}_resetPingTimeout(){this.clearTimeoutFn(this._pingTimeoutTimer);const e=this._pingInterval+this._pingTimeout;this._pingTimeoutTime=Date.now()+e,this._pingTimeoutTimer=this.setTimeoutFn(()=>{this._onClose("ping timeout")},e),this.opts.autoUnref&&this._pingTimeoutTimer.unref()}_onDrain(){this.writeBuffer.splice(0,this._prevBufferLen),this._prevBufferLen=0,this.writeBuffer.length===0?this.emitReserved("drain"):this.flush()}flush(){if(this.readyState!=="closed"&&this.transport.writable&&!this.upgrading&&this.writeBuffer.length){const e=this._getWritablePackets();this.transport.send(e),this._prevBufferLen=e.length,this.emitReserved("flush")}}_getWritablePackets(){if(!(this._maxPayload&&this.transport.name==="polling"&&this.writeBuffer.length>1))return this.writeBuffer;let s=1;for(let a=0;a<this.writeBuffer.length;a++){const n=this.writeBuffer[a].data;if(n&&(s+=Na(n)),a>0&&s>this._maxPayload)return this.writeBuffer.slice(0,a);s+=2}return this.writeBuffer}_hasPingExpired(){if(!this._pingTimeoutTime)return!0;const e=Date.now()>this._pingTimeoutTime;return e&&(this._pingTimeoutTime=0,wt(()=>{this._onClose("ping timeout")},this.setTimeoutFn)),e}write(e,s,a){return this._sendPacket("message",e,s,a),this}send(e,s,a){return this._sendPacket("message",e,s,a),this}_sendPacket(e,s,a,n){if(typeof s=="function"&&(n=s,s=void 0),typeof a=="function"&&(n=a,a=null),this.readyState==="closing"||this.readyState==="closed")return;a=a||{},a.compress=a.compress!==!1;const r={type:e,data:s,options:a};this.emitReserved("packetCreate",r),this.writeBuffer.push(r),n&&this.once("flush",n),this.flush()}close(){const e=()=>{this._onClose("forced close"),this.transport.close()},s=()=>{this.off("upgrade",s),this.off("upgradeError",s),e()},a=()=>{this.once("upgrade",s),this.once("upgradeError",s)};return(this.readyState==="opening"||this.readyState==="open")&&(this.readyState="closing",this.writeBuffer.length?this.once("drain",()=>{this.upgrading?a():e()}):this.upgrading?a():e()),this}_onError(e){if(Be.priorWebsocketSuccess=!1,this.opts.tryAllTransports&&this.transports.length>1&&this.readyState==="opening")return this.transports.shift(),this._open();this.emitReserved("error",e),this._onClose("transport error",e)}_onClose(e,s){if(this.readyState==="opening"||this.readyState==="open"||this.readyState==="closing"){if(this.clearTimeoutFn(this._pingTimeoutTimer),this.transport.removeAllListeners("close"),this.transport.close(),this.transport.removeAllListeners(),qt&&(this._beforeunloadEventListener&&removeEventListener("beforeunload",this._beforeunloadEventListener,!1),this._offlineEventListener)){const a=nt.indexOf(this._offlineEventListener);a!==-1&&nt.splice(a,1)}this.readyState="closed",this.id=null,this.emitReserved("close",e,s),this.writeBuffer=[],this._prevBufferLen=0}}}Be.protocol=js;class nn extends Be{constructor(){super(...arguments),this._upgrades=[]}onOpen(){if(super.onOpen(),this.readyState==="open"&&this.opts.upgrade)for(let e=0;e<this._upgrades.length;e++)this._probe(this._upgrades[e])}_probe(e){let s=this.createTransport(e),a=!1;Be.priorWebsocketSuccess=!1;const n=()=>{a||(s.send([{type:"ping",data:"probe"}]),s.once("packet",g=>{if(!a)if(g.type==="pong"&&g.data==="probe"){if(this.upgrading=!0,this.emitReserved("upgrading",s),!s)return;Be.priorWebsocketSuccess=s.name==="websocket",this.transport.pause(()=>{a||this.readyState!=="closed"&&(u(),this.setTransport(s),s.send([{type:"upgrade"}]),this.emitReserved("upgrade",s),s=null,this.upgrading=!1,this.flush())})}else{const v=new Error("probe error");v.transport=s.name,this.emitReserved("upgradeError",v)}}))};function r(){a||(a=!0,u(),s.close(),s=null)}const o=g=>{const v=new Error("probe error: "+g);v.transport=s.name,r(),this.emitReserved("upgradeError",v)};function c(){o("transport closed")}function l(){o("socket closed")}function h(g){s&&g.name!==s.name&&r()}const u=()=>{s.removeListener("open",n),s.removeListener("error",o),s.removeListener("close",c),this.off("close",l),this.off("upgrading",h)};s.once("open",n),s.once("error",o),s.once("close",c),this.once("close",l),this.once("upgrading",h),this._upgrades.indexOf("webtransport")!==-1&&e!=="webtransport"?this.setTimeoutFn(()=>{a||s.open()},200):s.open()}onHandshake(e){this._upgrades=this._filterUpgrades(e.upgrades),super.onHandshake(e)}_filterUpgrades(e){const s=[];for(let a=0;a<e.length;a++)~this.transports.indexOf(e[a])&&s.push(e[a]);return s}}let rn=class extends nn{constructor(e,s={}){const a=typeof e=="object"?e:s;(!a.transports||a.transports&&typeof a.transports[0]=="string")&&(a.transports=(a.transports||["polling","websocket","webtransport"]).map(n=>Za[n]).filter(n=>!!n)),super(e,a)}};function on(t,e="",s){let a=t;s=s||typeof location<"u"&&location,t==null&&(t=s.protocol+"//"+s.host),typeof t=="string"&&(t.charAt(0)==="/"&&(t.charAt(1)==="/"?t=s.protocol+t:t=s.host+t),/^(https?|wss?):\/\//.test(t)||(typeof s<"u"?t=s.protocol+"//"+t:t="https://"+t),a=Rt(t)),a.port||(/^(http|ws)$/.test(a.protocol)?a.port="80":/^(http|ws)s$/.test(a.protocol)&&(a.port="443")),a.path=a.path||"/";const r=a.host.indexOf(":")!==-1?"["+a.host+"]":a.host;return a.id=a.protocol+"://"+r+":"+a.port+e,a.href=a.protocol+"://"+r+(s&&s.port===a.port?"":":"+a.port),a}const ln=typeof ArrayBuffer=="function",cn=t=>typeof ArrayBuffer.isView=="function"?ArrayBuffer.isView(t):t.buffer instanceof ArrayBuffer,Ys=Object.prototype.toString,dn=typeof Blob=="function"||typeof Blob<"u"&&Ys.call(Blob)==="[object BlobConstructor]",un=typeof File=="function"||typeof File<"u"&&Ys.call(File)==="[object FileConstructor]";function as(t){return ln&&(t instanceof ArrayBuffer||cn(t))||dn&&t instanceof Blob||un&&t instanceof File}function rt(t,e){if(!t||typeof t!="object")return!1;if(Array.isArray(t)){for(let s=0,a=t.length;s<a;s++)if(rt(t[s]))return!0;return!1}if(as(t))return!0;if(t.toJSON&&typeof t.toJSON=="function"&&arguments.length===1)return rt(t.toJSON(),!0);for(const s in t)if(Object.prototype.hasOwnProperty.call(t,s)&&rt(t[s]))return!0;return!1}function hn(t){const e=[],s=t.data,a=t;return a.data=Dt(s,e),a.attachments=e.length,{packet:a,buffers:e}}function Dt(t,e){if(!t)return t;if(as(t)){const s={_placeholder:!0,num:e.length};return e.push(t),s}else if(Array.isArray(t)){const s=new Array(t.length);for(let a=0;a<t.length;a++)s[a]=Dt(t[a],e);return s}else if(typeof t=="object"&&!(t instanceof Date)){const s={};for(const a in t)Object.prototype.hasOwnProperty.call(t,a)&&(s[a]=Dt(t[a],e));return s}return t}function pn(t,e){return t.data=Ft(t.data,e),delete t.attachments,t}function Ft(t,e){if(!t)return t;if(t&&t._placeholder===!0){if(typeof t.num=="number"&&t.num>=0&&t.num<e.length)return e[t.num];throw new Error("illegal attachments")}else if(Array.isArray(t))for(let s=0;s<t.length;s++)t[s]=Ft(t[s],e);else if(typeof t=="object")for(const s in t)Object.prototype.hasOwnProperty.call(t,s)&&(t[s]=Ft(t[s],e));return t}const mn=["connect","connect_error","disconnect","disconnecting","newListener","removeListener"];var H;(function(t){t[t.CONNECT=0]="CONNECT",t[t.DISCONNECT=1]="DISCONNECT",t[t.EVENT=2]="EVENT",t[t.ACK=3]="ACK",t[t.CONNECT_ERROR=4]="CONNECT_ERROR",t[t.BINARY_EVENT=5]="BINARY_EVENT",t[t.BINARY_ACK=6]="BINARY_ACK"})(H||(H={}));class gn{constructor(e){this.replacer=e}encode(e){return(e.type===H.EVENT||e.type===H.ACK)&&rt(e)?this.encodeAsBinary({type:e.type===H.EVENT?H.BINARY_EVENT:H.BINARY_ACK,nsp:e.nsp,data:e.data,id:e.id}):[this.encodeAsString(e)]}encodeAsString(e){let s=""+e.type;return(e.type===H.BINARY_EVENT||e.type===H.BINARY_ACK)&&(s+=e.attachments+"-"),e.nsp&&e.nsp!=="/"&&(s+=e.nsp+","),e.id!=null&&(s+=e.id),e.data!=null&&(s+=JSON.stringify(e.data,this.replacer)),s}encodeAsBinary(e){const s=hn(e),a=this.encodeAsString(s.packet),n=s.buffers;return n.unshift(a),n}}class ns extends te{constructor(e){super(),this.reviver=e}add(e){let s;if(typeof e=="string"){if(this.reconstructor)throw new Error("got plaintext data when reconstructing a packet");s=this.decodeString(e);const a=s.type===H.BINARY_EVENT;a||s.type===H.BINARY_ACK?(s.type=a?H.EVENT:H.ACK,this.reconstructor=new fn(s),s.attachments===0&&super.emitReserved("decoded",s)):super.emitReserved("decoded",s)}else if(as(e)||e.base64)if(this.reconstructor)s=this.reconstructor.takeBinaryData(e),s&&(this.reconstructor=null,super.emitReserved("decoded",s));else throw new Error("got binary data when not reconstructing a packet");else throw new Error("Unknown type: "+e)}decodeString(e){let s=0;const a={type:Number(e.charAt(0))};if(H[a.type]===void 0)throw new Error("unknown packet type "+a.type);if(a.type===H.BINARY_EVENT||a.type===H.BINARY_ACK){const r=s+1;for(;e.charAt(++s)!=="-"&&s!=e.length;);const o=e.substring(r,s);if(o!=Number(o)||e.charAt(s)!=="-")throw new Error("Illegal attachments");a.attachments=Number(o)}if(e.charAt(s+1)==="/"){const r=s+1;for(;++s&&!(e.charAt(s)===","||s===e.length););a.nsp=e.substring(r,s)}else a.nsp="/";const n=e.charAt(s+1);if(n!==""&&Number(n)==n){const r=s+1;for(;++s;){const o=e.charAt(s);if(o==null||Number(o)!=o){--s;break}if(s===e.length)break}a.id=Number(e.substring(r,s+1))}if(e.charAt(++s)){const r=this.tryParse(e.substr(s));if(ns.isPayloadValid(a.type,r))a.data=r;else throw new Error("invalid payload")}return a}tryParse(e){try{return JSON.parse(e,this.reviver)}catch{return!1}}static isPayloadValid(e,s){switch(e){case H.CONNECT:return Ss(s);case H.DISCONNECT:return s===void 0;case H.CONNECT_ERROR:return typeof s=="string"||Ss(s);case H.EVENT:case H.BINARY_EVENT:return Array.isArray(s)&&(typeof s[0]=="number"||typeof s[0]=="string"&&mn.indexOf(s[0])===-1);case H.ACK:case H.BINARY_ACK:return Array.isArray(s)}}destroy(){this.reconstructor&&(this.reconstructor.finishedReconstruction(),this.reconstructor=null)}}class fn{constructor(e){this.packet=e,this.buffers=[],this.reconPack=e}takeBinaryData(e){if(this.buffers.push(e),this.buffers.length===this.reconPack.attachments){const s=pn(this.reconPack,this.buffers);return this.finishedReconstruction(),s}return null}finishedReconstruction(){this.reconPack=null,this.buffers=[]}}function Ss(t){return Object.prototype.toString.call(t)==="[object Object]"}const vn=Object.freeze(Object.defineProperty({__proto__:null,Decoder:ns,Encoder:gn,get PacketType(){return H}},Symbol.toStringTag,{value:"Module"}));function ye(t,e,s){return t.on(e,s),function(){t.off(e,s)}}const yn=Object.freeze({connect:1,connect_error:1,disconnect:1,disconnecting:1,newListener:1,removeListener:1});class Xs extends te{constructor(e,s,a){super(),this.connected=!1,this.recovered=!1,this.receiveBuffer=[],this.sendBuffer=[],this._queue=[],this._queueSeq=0,this.ids=0,this.acks={},this.flags={},this.io=e,this.nsp=s,a&&a.auth&&(this.auth=a.auth),this._opts=Object.assign({},a),this.io._autoConnect&&this.open()}get disconnected(){return!this.connected}subEvents(){if(this.subs)return;const e=this.io;this.subs=[ye(e,"open",this.onopen.bind(this)),ye(e,"packet",this.onpacket.bind(this)),ye(e,"error",this.onerror.bind(this)),ye(e,"close",this.onclose.bind(this))]}get active(){return!!this.subs}connect(){return this.connected?this:(this.subEvents(),this.io._reconnecting||this.io.open(),this.io._readyState==="open"&&this.onopen(),this)}open(){return this.connect()}send(...e){return e.unshift("message"),this.emit.apply(this,e),this}emit(e,...s){var a,n,r;if(yn.hasOwnProperty(e))throw new Error('"'+e.toString()+'" is a reserved event name');if(s.unshift(e),this._opts.retries&&!this.flags.fromQueue&&!this.flags.volatile)return this._addToQueue(s),this;const o={type:H.EVENT,data:s};if(o.options={},o.options.compress=this.flags.compress!==!1,typeof s[s.length-1]=="function"){const u=this.ids++,g=s.pop();this._registerAckCallback(u,g),o.id=u}const c=(n=(a=this.io.engine)===null||a===void 0?void 0:a.transport)===null||n===void 0?void 0:n.writable,l=this.connected&&!(!((r=this.io.engine)===null||r===void 0)&&r._hasPingExpired());return this.flags.volatile&&!c||(l?(this.notifyOutgoingListeners(o),this.packet(o)):this.sendBuffer.push(o)),this.flags={},this}_registerAckCallback(e,s){var a;const n=(a=this.flags.timeout)!==null&&a!==void 0?a:this._opts.ackTimeout;if(n===void 0){this.acks[e]=s;return}const r=this.io.setTimeoutFn(()=>{delete this.acks[e];for(let c=0;c<this.sendBuffer.length;c++)this.sendBuffer[c].id===e&&this.sendBuffer.splice(c,1);s.call(this,new Error("operation has timed out"))},n),o=(...c)=>{this.io.clearTimeoutFn(r),s.apply(this,c)};o.withError=!0,this.acks[e]=o}emitWithAck(e,...s){return new Promise((a,n)=>{const r=(o,c)=>o?n(o):a(c);r.withError=!0,s.push(r),this.emit(e,...s)})}_addToQueue(e){let s;typeof e[e.length-1]=="function"&&(s=e.pop());const a={id:this._queueSeq++,tryCount:0,pending:!1,args:e,flags:Object.assign({fromQueue:!0},this.flags)};e.push((n,...r)=>(this._queue[0],n!==null?a.tryCount>this._opts.retries&&(this._queue.shift(),s&&s(n)):(this._queue.shift(),s&&s(null,...r)),a.pending=!1,this._drainQueue())),this._queue.push(a),this._drainQueue()}_drainQueue(e=!1){if(!this.connected||this._queue.length===0)return;const s=this._queue[0];s.pending&&!e||(s.pending=!0,s.tryCount++,this.flags=s.flags,this.emit.apply(this,s.args))}packet(e){e.nsp=this.nsp,this.io._packet(e)}onopen(){typeof this.auth=="function"?this.auth(e=>{this._sendConnectPacket(e)}):this._sendConnectPacket(this.auth)}_sendConnectPacket(e){this.packet({type:H.CONNECT,data:this._pid?Object.assign({pid:this._pid,offset:this._lastOffset},e):e})}onerror(e){this.connected||this.emitReserved("connect_error",e)}onclose(e,s){this.connected=!1,delete this.id,this.emitReserved("disconnect",e,s),this._clearAcks()}_clearAcks(){Object.keys(this.acks).forEach(e=>{if(!this.sendBuffer.some(a=>String(a.id)===e)){const a=this.acks[e];delete this.acks[e],a.withError&&a.call(this,new Error("socket has been disconnected"))}})}onpacket(e){if(e.nsp===this.nsp)switch(e.type){case H.CONNECT:e.data&&e.data.sid?this.onconnect(e.data.sid,e.data.pid):this.emitReserved("connect_error",new Error("It seems you are trying to reach a Socket.IO server in v2.x with a v3.x client, but they are not compatible (more information here: https://socket.io/docs/v3/migrating-from-2-x-to-3-0/)"));break;case H.EVENT:case H.BINARY_EVENT:this.onevent(e);break;case H.ACK:case H.BINARY_ACK:this.onack(e);break;case H.DISCONNECT:this.ondisconnect();break;case H.CONNECT_ERROR:this.destroy();const a=new Error(e.data.message);a.data=e.data.data,this.emitReserved("connect_error",a);break}}onevent(e){const s=e.data||[];e.id!=null&&s.push(this.ack(e.id)),this.connected?this.emitEvent(s):this.receiveBuffer.push(Object.freeze(s))}emitEvent(e){if(this._anyListeners&&this._anyListeners.length){const s=this._anyListeners.slice();for(const a of s)a.apply(this,e)}super.emit.apply(this,e),this._pid&&e.length&&typeof e[e.length-1]=="string"&&(this._lastOffset=e[e.length-1])}ack(e){const s=this;let a=!1;return function(...n){a||(a=!0,s.packet({type:H.ACK,id:e,data:n}))}}onack(e){const s=this.acks[e.id];typeof s=="function"&&(delete this.acks[e.id],s.withError&&e.data.unshift(null),s.apply(this,e.data))}onconnect(e,s){this.id=e,this.recovered=s&&this._pid===s,this._pid=s,this.connected=!0,this.emitBuffered(),this._drainQueue(!0),this.emitReserved("connect")}emitBuffered(){this.receiveBuffer.forEach(e=>this.emitEvent(e)),this.receiveBuffer=[],this.sendBuffer.forEach(e=>{this.notifyOutgoingListeners(e),this.packet(e)}),this.sendBuffer=[]}ondisconnect(){this.destroy(),this.onclose("io server disconnect")}destroy(){this.subs&&(this.subs.forEach(e=>e()),this.subs=void 0),this.io._destroy(this)}disconnect(){return this.connected&&this.packet({type:H.DISCONNECT}),this.destroy(),this.connected&&this.onclose("io client disconnect"),this}close(){return this.disconnect()}compress(e){return this.flags.compress=e,this}get volatile(){return this.flags.volatile=!0,this}timeout(e){return this.flags.timeout=e,this}onAny(e){return this._anyListeners=this._anyListeners||[],this._anyListeners.push(e),this}prependAny(e){return this._anyListeners=this._anyListeners||[],this._anyListeners.unshift(e),this}offAny(e){if(!this._anyListeners)return this;if(e){const s=this._anyListeners;for(let a=0;a<s.length;a++)if(e===s[a])return s.splice(a,1),this}else this._anyListeners=[];return this}listenersAny(){return this._anyListeners||[]}onAnyOutgoing(e){return this._anyOutgoingListeners=this._anyOutgoingListeners||[],this._anyOutgoingListeners.push(e),this}prependAnyOutgoing(e){return this._anyOutgoingListeners=this._anyOutgoingListeners||[],this._anyOutgoingListeners.unshift(e),this}offAnyOutgoing(e){if(!this._anyOutgoingListeners)return this;if(e){const s=this._anyOutgoingListeners;for(let a=0;a<s.length;a++)if(e===s[a])return s.splice(a,1),this}else this._anyOutgoingListeners=[];return this}listenersAnyOutgoing(){return this._anyOutgoingListeners||[]}notifyOutgoingListeners(e){if(this._anyOutgoingListeners&&this._anyOutgoingListeners.length){const s=this._anyOutgoingListeners.slice();for(const a of s)a.apply(this,e.data)}}}function Ve(t){t=t||{},this.ms=t.min||100,this.max=t.max||1e4,this.factor=t.factor||2,this.jitter=t.jitter>0&&t.jitter<=1?t.jitter:0,this.attempts=0}Ve.prototype.duration=function(){var t=this.ms*Math.pow(this.factor,this.attempts++);if(this.jitter){var e=Math.random(),s=Math.floor(e*this.jitter*t);t=Math.floor(e*10)&1?t+s:t-s}return Math.min(t,this.max)|0};Ve.prototype.reset=function(){this.attempts=0};Ve.prototype.setMin=function(t){this.ms=t};Ve.prototype.setMax=function(t){this.max=t};Ve.prototype.setJitter=function(t){this.jitter=t};class Nt extends te{constructor(e,s){var a;super(),this.nsps={},this.subs=[],e&&typeof e=="object"&&(s=e,e=void 0),s=s||{},s.path=s.path||"/socket.io",this.opts=s,kt(this,s),this.reconnection(s.reconnection!==!1),this.reconnectionAttempts(s.reconnectionAttempts||1/0),this.reconnectionDelay(s.reconnectionDelay||1e3),this.reconnectionDelayMax(s.reconnectionDelayMax||5e3),this.randomizationFactor((a=s.randomizationFactor)!==null&&a!==void 0?a:.5),this.backoff=new Ve({min:this.reconnectionDelay(),max:this.reconnectionDelayMax(),jitter:this.randomizationFactor()}),this.timeout(s.timeout==null?2e4:s.timeout),this._readyState="closed",this.uri=e;const n=s.parser||vn;this.encoder=new n.Encoder,this.decoder=new n.Decoder,this._autoConnect=s.autoConnect!==!1,this._autoConnect&&this.open()}reconnection(e){return arguments.length?(this._reconnection=!!e,e||(this.skipReconnect=!0),this):this._reconnection}reconnectionAttempts(e){return e===void 0?this._reconnectionAttempts:(this._reconnectionAttempts=e,this)}reconnectionDelay(e){var s;return e===void 0?this._reconnectionDelay:(this._reconnectionDelay=e,(s=this.backoff)===null||s===void 0||s.setMin(e),this)}randomizationFactor(e){var s;return e===void 0?this._randomizationFactor:(this._randomizationFactor=e,(s=this.backoff)===null||s===void 0||s.setJitter(e),this)}reconnectionDelayMax(e){var s;return e===void 0?this._reconnectionDelayMax:(this._reconnectionDelayMax=e,(s=this.backoff)===null||s===void 0||s.setMax(e),this)}timeout(e){return arguments.length?(this._timeout=e,this):this._timeout}maybeReconnectOnOpen(){!this._reconnecting&&this._reconnection&&this.backoff.attempts===0&&this.reconnect()}open(e){if(~this._readyState.indexOf("open"))return this;this.engine=new rn(this.uri,this.opts);const s=this.engine,a=this;this._readyState="opening",this.skipReconnect=!1;const n=ye(s,"open",function(){a.onopen(),e&&e()}),r=c=>{this.cleanup(),this._readyState="closed",this.emitReserved("error",c),e?e(c):this.maybeReconnectOnOpen()},o=ye(s,"error",r);if(this._timeout!==!1){const c=this._timeout,l=this.setTimeoutFn(()=>{n(),r(new Error("timeout")),s.close()},c);this.opts.autoUnref&&l.unref(),this.subs.push(()=>{this.clearTimeoutFn(l)})}return this.subs.push(n),this.subs.push(o),this}connect(e){return this.open(e)}onopen(){this.cleanup(),this._readyState="open",this.emitReserved("open");const e=this.engine;this.subs.push(ye(e,"ping",this.onping.bind(this)),ye(e,"data",this.ondata.bind(this)),ye(e,"error",this.onerror.bind(this)),ye(e,"close",this.onclose.bind(this)),ye(this.decoder,"decoded",this.ondecoded.bind(this)))}onping(){this.emitReserved("ping")}ondata(e){try{this.decoder.add(e)}catch(s){this.onclose("parse error",s)}}ondecoded(e){wt(()=>{this.emitReserved("packet",e)},this.setTimeoutFn)}onerror(e){this.emitReserved("error",e)}socket(e,s){let a=this.nsps[e];return a?this._autoConnect&&!a.active&&a.connect():(a=new Xs(this,e,s),this.nsps[e]=a),a}_destroy(e){const s=Object.keys(this.nsps);for(const a of s)if(this.nsps[a].active)return;this._close()}_packet(e){const s=this.encoder.encode(e);for(let a=0;a<s.length;a++)this.engine.write(s[a],e.options)}cleanup(){this.subs.forEach(e=>e()),this.subs.length=0,this.decoder.destroy()}_close(){this.skipReconnect=!0,this._reconnecting=!1,this.onclose("forced close")}disconnect(){return this._close()}onclose(e,s){var a;this.cleanup(),(a=this.engine)===null||a===void 0||a.close(),this.backoff.reset(),this._readyState="closed",this.emitReserved("close",e,s),this._reconnection&&!this.skipReconnect&&this.reconnect()}reconnect(){if(this._reconnecting||this.skipReconnect)return this;const e=this;if(this.backoff.attempts>=this._reconnectionAttempts)this.backoff.reset(),this.emitReserved("reconnect_failed"),this._reconnecting=!1;else{const s=this.backoff.duration();this._reconnecting=!0;const a=this.setTimeoutFn(()=>{e.skipReconnect||(this.emitReserved("reconnect_attempt",e.backoff.attempts),!e.skipReconnect&&e.open(n=>{n?(e._reconnecting=!1,e.reconnect(),this.emitReserved("reconnect_error",n)):e.onreconnect()}))},s);this.opts.autoUnref&&a.unref(),this.subs.push(()=>{this.clearTimeoutFn(a)})}}onreconnect(){const e=this.backoff.attempts;this._reconnecting=!1,this.backoff.reset(),this.emitReserved("reconnect",e)}}const ze={};function it(t,e){typeof t=="object"&&(e=t,t=void 0),e=e||{};const s=on(t,e.path||"/socket.io"),a=s.source,n=s.id,r=s.path,o=ze[n]&&r in ze[n].nsps,c=e.forceNew||e["force new connection"]||e.multiplex===!1||o;let l;return c?l=new Nt(a,e):(ze[n]||(ze[n]=new Nt(a,e)),l=ze[n]),s.query&&!e.query&&(e.query=s.queryKey),l.socket(s.path,e)}Object.assign(it,{Manager:Nt,Socket:Xs,io:it,connect:it});class bn{constructor(){this.socket=null,this.listeners=new Map,this.subscribedMangas=new Set}connect(){var e;(e=this.socket)!=null&&e.connected||(this.socket=it({autoConnect:!0,reconnection:!0,reconnectionDelay:1e3,reconnectionAttempts:10}),this.socket.on("connect",()=>{console.log("[Socket] Connected:",this.socket.id),this.subscribedMangas.forEach(s=>{this.socket.emit("subscribe:manga",s)}),this.socket.emit("subscribe:global")}),this.socket.on("disconnect",s=>{console.log("[Socket] Disconnected:",s)}),this.socket.on("connect_error",s=>{console.error("[Socket] Connection error:",s.message)}))}disconnect(){this.socket&&(this.socket.disconnect(),this.socket=null)}subscribeToManga(e){var s;this.subscribedMangas.add(e),(s=this.socket)!=null&&s.connected&&this.socket.emit("subscribe:manga",e)}unsubscribeFromManga(e){var s;this.subscribedMangas.delete(e),(s=this.socket)!=null&&s.connected&&this.socket.emit("unsubscribe:manga",e)}on(e,s){this.listeners.has(e)||this.listeners.set(e,new Set),this.listeners.get(e).add(s),this.socket&&this.socket.on(e,s)}off(e,s){this.listeners.has(e)&&this.listeners.get(e).delete(s),this.socket&&this.socket.off(e,s)}emit(e,s){var a;(a=this.socket)!=null&&a.connected&&this.socket.emit(e,s)}}const oe={CHAPTER_DOWNLOADED:"chapter:downloaded",CHAPTER_HIDDEN:"chapter:hidden",CHAPTER_UNHIDDEN:"chapter:unhidden",MANGA_UPDATED:"manga:updated",MANGA_ADDED:"manga:added",MANGA_DELETED:"manga:deleted",DOWNLOAD_PROGRESS:"download:progress",DOWNLOAD_COMPLETED:"download:completed",QUEUE_UPDATED:"queue:updated",ACTION_RECORDED:"action:recorded",ACTION_UNDONE:"action:undone",SITE_CHALLENGE:"site:challenge",SITE_CHALLENGE_CLEARED:"site:challenge-cleared",SITE_SESSION:"site:session"},ee=new bn,de={bookmarks:[],series:[],categories:[],favorites:{favorites:{},listOrder:[]}},be=new Set,X=new Map,Qe=new Map;function wn(t){return de[t]}function kn(t,e){de[t]=e,be.add(t),Xe(t)}function $n(t,e){return Qe.has(t)||Qe.set(t,new Set),Qe.get(t).add(e),()=>{var s;return(s=Qe.get(t))==null?void 0:s.delete(e)}}function Xe(t){const e=Qe.get(t);e&&e.forEach(s=>s(de[t]))}function We(t){be.delete(t),X.delete(t)}function En(t){return be.has(t)}async function Ge(t=!1){if(!t&&be.has("bookmarks"))return de.bookmarks;if(X.has("bookmarks"))return X.get("bookmarks");const e=m.getBookmarks().then(s=>(de.bookmarks=s||[],be.add("bookmarks"),X.delete("bookmarks"),Xe("bookmarks"),de.bookmarks)).catch(s=>{throw X.delete("bookmarks"),s});return X.set("bookmarks",e),e}async function Cn(t=!1){if(!t&&be.has("series"))return de.series;if(X.has("series"))return X.get("series");const e=m.get("/series").then(s=>(de.series=s||[],be.add("series"),X.delete("series"),Xe("series"),de.series)).catch(s=>{throw X.delete("series"),s});return X.set("series",e),e}async function Sn(t=!1){if(!t&&be.has("categories"))return de.categories;if(X.has("categories"))return X.get("categories");const e=m.get("/categories").then(s=>(de.categories=s.categories||[],be.add("categories"),X.delete("categories"),Xe("categories"),de.categories)).catch(s=>{throw X.delete("categories"),s});return X.set("categories",e),e}async function xn(t=!1){if(!t&&be.has("favorites"))return de.favorites;if(X.has("favorites"))return X.get("favorites");const e=m.getFavorites().then(s=>(de.favorites=s||{favorites:{},listOrder:[]},be.add("favorites"),X.delete("favorites"),Xe("favorites"),de.favorites)).catch(s=>{throw X.delete("favorites"),s});return X.set("favorites",e),e}function Ln(){ee.on(oe.MANGA_UPDATED,()=>{We("bookmarks"),Ge(!0)}),ee.on(oe.MANGA_ADDED,()=>{We("bookmarks"),Ge(!0)}),ee.on(oe.MANGA_DELETED,()=>{We("bookmarks"),Ge(!0)}),ee.on(oe.DOWNLOAD_COMPLETED,()=>{We("bookmarks"),Ge(!0)})}Ln();const ue={get:wn,set:kn,subscribe:$n,invalidate:We,isLoaded:En,loadBookmarks:Ge,loadSeries:Cn,loadCategories:Sn,loadFavorites:xn};function d(t,e="info"){document.querySelectorAll(".toast").forEach(n=>{n.classList.contains("show")&&n.classList.remove("show")});const a=document.createElement("div");a.className=`toast toast-${e}`,a.textContent=t,document.body.appendChild(a),requestAnimationFrame(()=>a.classList.add("show")),setTimeout(()=>{a.classList.remove("show"),setTimeout(()=>a.remove(),300)},3e3)}const In={library:'<path d="m16 6 4 14"/><path d="M12 6v14"/><path d="M8 8v12"/><path d="M4 4v16"/>',"book-open":'<path d="M12 7v14"/><path d="M3 18a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1h5a4 4 0 0 1 4 4 4 4 0 0 1 4-4h5a1 1 0 0 1 1 1v13a1 1 0 0 1-1 1h-6a3 3 0 0 0-3 3 3 3 0 0 0-3-3z"/>',"book-marked":'<path d="M10 2v8l3-3 3 3V2"/><path d="M4 19.5v-15A2.5 2.5 0 0 1 6.5 2H19a1 1 0 0 1 1 1v18a1 1 0 0 1-1 1H6.5a1 1 0 0 1 0-5H20"/>',"layout-grid":'<rect width="7" height="7" x="3" y="3" rx="1"/><rect width="7" height="7" x="14" y="3" rx="1"/><rect width="7" height="7" x="14" y="14" rx="1"/><rect width="7" height="7" x="3" y="14" rx="1"/>',star:'<polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/>',trophy:'<path d="M6 9H4.5a2.5 2.5 0 0 1 0-5H6"/><path d="M18 9h1.5a2.5 2.5 0 0 0 0-5H18"/><path d="M4 22h16"/><path d="M10 14.66V17c0 .55-.47.98-.97 1.21C7.85 18.75 7 20.24 7 22"/><path d="M14 14.66V17c0 .55.47.98.97 1.21C16.15 18.75 17 20.24 17 22"/><path d="M18 2H6v7a6 6 0 0 0 12 0V2Z"/>',plus:'<path d="M5 12h14"/><path d="M12 5v14"/>',check:'<path d="M20 6 9 17l-5-5"/>',pencil:'<path d="M21.174 6.812a1 1 0 0 0-3.986-3.987L3.842 16.174a2 2 0 0 0-.5.83l-1.321 4.352a.5.5 0 0 0 .623.622l4.353-1.32a2 2 0 0 0 .83-.497z"/>',"trash-2":'<path d="M3 6h18"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6"/><path d="M8 6V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/><line x1="10" x2="10" y1="11" y2="17"/><line x1="14" x2="14" y1="11" y2="17"/>',"undo-2":'<path d="M9 14 4 9l5-5"/><path d="M4 9h10.5a5.5 5.5 0 0 1 5.5 5.5a5.5 5.5 0 0 1-5.5 5.5H11"/>',scissors:'<circle cx="6" cy="6" r="3"/><path d="M8.12 8.12 12 12"/><path d="M20 4 8.12 15.88"/><circle cx="6" cy="18" r="3"/><path d="M14.8 14.8 20 20"/>',image:'<rect width="18" height="18" x="3" y="3" rx="2" ry="2"/><circle cx="9" cy="9" r="2"/><path d="m21 15-3.086-3.086a2 2 0 0 0-2.828 0L6 21"/>',palette:'<path d="M12 22a1 1 0 0 1 0-20 10 9 0 0 1 10 9 5 5 0 0 1-5 5h-2.25a1.75 1.75 0 0 0-1.4 2.8l.3.4a1.75 1.75 0 0 1-1.4 2.8z"/><circle cx="13.5" cy="6.5" r=".5" fill="currentColor"/><circle cx="17.5" cy="10.5" r=".5" fill="currentColor"/><circle cx="6.5" cy="12.5" r=".5" fill="currentColor"/><circle cx="8.5" cy="7.5" r=".5" fill="currentColor"/>',tag:'<path d="M12.586 2.586A2 2 0 0 0 11.172 2H4a2 2 0 0 0-2 2v7.172a2 2 0 0 0 .586 1.414l8.704 8.704a2.426 2.426 0 0 0 3.42 0l6.58-6.58a2.426 2.426 0 0 0 0-3.42z"/><circle cx="7.5" cy="7.5" r=".5" fill="currentColor"/>',play:'<polygon points="6 3 20 12 6 21 6 3"/>',pause:'<rect x="14" y="4" width="4" height="16" rx="1"/><rect x="6" y="4" width="4" height="16" rx="1"/>',download:'<path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" x2="12" y1="15" y2="3"/>',upload:'<path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="17 8 12 3 7 8"/><line x1="12" x2="12" y1="3" y2="15"/>',"hard-drive":'<line x1="22" x2="2" y1="12" y2="12"/><path d="M5.45 5.11 2 12v6a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-6l-3.45-6.89A2 2 0 0 0 16.76 4H7.24a2 2 0 0 0-1.79 1.11z"/><line x1="6" x2="6.01" y1="16" y2="16"/><line x1="10" x2="10.01" y1="16" y2="16"/>',save:'<path d="M15.2 3a2 2 0 0 1 1.4.6l3.8 3.8a2 2 0 0 1 .6 1.4V19a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2z"/><path d="M17 21v-7a1 1 0 0 0-1-1H8a1 1 0 0 0-1 1v7"/><path d="M7 3v4a1 1 0 0 0 1 1h7"/>',package:'<path d="M11 21.73a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73z"/><path d="M12 22V12"/><path d="m3.3 7 7.703 4.734a2 2 0 0 0 1.994 0L20.7 7"/>',folder:'<path d="M20 20a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2h-7.9a2 2 0 0 1-1.69-.9L9.6 3.9A2 2 0 0 0 7.93 3H4a2 2 0 0 0-2 2v13a2 2 0 0 0 2 2Z"/>',eye:'<path d="M2 12s3-7 10-7 10 7 10 7-3 7-10 7-10-7-10-7Z"/><circle cx="12" cy="12" r="3"/>',"eye-off":'<path d="M10.733 5.076a10.744 10.744 0 0 1 11.205 6.575 1 1 0 0 1 0 .696 10.747 10.747 0 0 1-1.444 2.49"/><path d="M14.084 14.158a3 3 0 0 1-4.242-4.242"/><path d="M17.479 17.499a10.75 10.75 0 0 1-15.417-5.151 1 1 0 0 1 0-.696 10.75 10.75 0 0 1 4.446-5.143"/><path d="m2 2 20 20"/>',circle:'<circle cx="12" cy="12" r="10"/>',lock:'<rect width="18" height="11" x="3" y="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/>',"lock-open":'<rect width="18" height="11" x="3" y="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 9.9-1"/>',"triangle-alert":'<path d="m21.73 18-8-14a2 2 0 0 0-3.48 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3"/><path d="M12 9v4"/><path d="M12 17h.01"/>',"shield-alert":'<path d="M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z"/><path d="M12 8v4"/><path d="M12 16h.01"/>',"circle-help":'<circle cx="12" cy="12" r="10"/><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"/><path d="M12 17h.01"/>',"traffic-cone":'<path d="M9.3 6.2a4.55 4.55 0 0 0 5.4 0"/><path d="M7.9 10.7c.9.8 2.4 1.3 4.1 1.3s3.2-.5 4.1-1.3"/><path d="M13.9 3.5a1.93 1.93 0 0 0-3.8 0L6.1 19.5a1.93 1.93 0 0 0 1.9 2.5h8a1.93 1.93 0 0 0 1.9-2.5z"/><path d="M2 21h20"/>',sparkles:'<path d="M9.937 15.5A2 2 0 0 0 8.5 14.063l-6.135-1.582a.5.5 0 0 1 0-.962L8.5 9.936A2 2 0 0 0 9.937 8.5l1.582-6.135a.5.5 0 0 1 .963 0L14.063 8.5A2 2 0 0 0 15.5 9.937l6.135 1.581a.5.5 0 0 1 0 .964L15.5 14.063a2 2 0 0 0-1.437 1.437l-1.582 6.135a.5.5 0 0 1-.963 0z"/><path d="M20 3v4"/><path d="M22 5h-4"/>',zap:'<path d="M4 14a1 1 0 0 1-.78-1.63l9.9-10.2a.5.5 0 0 1 .86.46l-1.92 6.02A1 1 0 0 0 13 10h7a1 1 0 0 1 .78 1.63l-9.9 10.2a.5.5 0 0 1-.86-.46l1.92-6.02A1 1 0 0 0 11 14z"/>',clock:'<circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/>',"alarm-clock":'<circle cx="12" cy="13" r="8"/><path d="M12 9v4l2 2"/><path d="M5 3 2 6"/><path d="m22 6-3-3"/><path d="M6.38 18.7 4 21"/><path d="M17.64 18.67 20 21"/>',loader:'<path d="M12 2v4"/><path d="m16.2 7.8 2.9-2.9"/><path d="M18 12h4"/><path d="m16.2 16.2 2.9 2.9"/><path d="M12 18v4"/><path d="m4.9 19.1 2.9-2.9"/><path d="M2 12h4"/><path d="m4.9 4.9 2.9 2.9"/>',search:'<circle cx="11" cy="11" r="8"/><path d="m21 21-4.3-4.3"/>',"search-x":'<path d="m13.5 8.5-5 5"/><path d="m8.5 8.5 5 5"/><circle cx="11" cy="11" r="8"/><path d="m21 21-4.3-4.3"/>',list:'<path d="M8 6h13"/><path d="M8 12h13"/><path d="M8 18h13"/><path d="M3 6h.01"/><path d="M3 12h.01"/><path d="M3 18h.01"/>',"list-checks":'<path d="m3 17 2 2 4-4"/><path d="m3 7 2 2 4-4"/><path d="M13 6h8"/><path d="M13 12h8"/><path d="M13 18h8"/>',"log-out":'<path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"/><polyline points="16 17 21 12 16 7"/><line x1="21" x2="9" y1="12" y2="12"/>',settings:'<path d="M12.22 2h-.44a2 2 0 0 0-2 2v.18a2 2 0 0 1-1 1.73l-.43.25a2 2 0 0 1-2 0l-.15-.08a2 2 0 0 0-2.73.73l-.22.38a2 2 0 0 0 .73 2.73l.15.1a2 2 0 0 1 1 1.72v.51a2 2 0 0 1-1 1.74l-.15.09a2 2 0 0 0-.73 2.73l.22.38a2 2 0 0 0 2.73.73l.15-.08a2 2 0 0 1 2 0l.43.25a2 2 0 0 1 1 1.73V20a2 2 0 0 0 2 2h.44a2 2 0 0 0 2-2v-.18a2 2 0 0 1 1-1.73l.43-.25a2 2 0 0 1 2 0l.15.08a2 2 0 0 0 2.73-.73l.22-.39a2 2 0 0 0-.73-2.73l-.15-.08a2 2 0 0 1-1-1.74v-.5a2 2 0 0 1 1-1.74l.15-.09a2 2 0 0 0 .73-2.73l-.22-.38a2 2 0 0 0-2.73-.73l-.15.08a2 2 0 0 1-2 0l-.43-.25a2 2 0 0 1-1-1.73V4a2 2 0 0 0-2-2z"/><circle cx="12" cy="12" r="3"/>',sliders:'<path d="M20 7h-9"/><path d="M14 17H5"/><circle cx="17" cy="17" r="3"/><circle cx="7" cy="7" r="3"/>',wrench:'<path d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94z"/>',"chevron-up":'<path d="m18 15-6-6-6 6"/>',"chevron-down":'<path d="m6 9 6 6 6-6"/>',"chevron-left":'<path d="m15 18-6-6 6-6"/>',"chevron-right":'<path d="m9 18 6-6-6-6"/>',x:'<path d="M18 6 6 18"/><path d="m6 6 12 12"/>',images:'<path d="M18 22H4a2 2 0 0 1-2-2V6"/><path d="m22 13-1.296-1.296a2.41 2.41 0 0 0-3.408 0L11 18"/><circle cx="12" cy="8" r="2"/><rect width="16" height="16" x="6" y="2" rx="2"/>',"columns-2":'<rect width="18" height="18" x="3" y="3" rx="2"/><path d="M12 3v18"/>',"rectangle-vertical":'<rect width="12" height="20" x="6" y="2" rx="2"/>',maximize:'<path d="M8 3H5a2 2 0 0 0-2 2v3"/><path d="M21 8V5a2 2 0 0 0-2-2h-3"/><path d="M3 16v3a2 2 0 0 0 2 2h3"/><path d="M16 21h3a2 2 0 0 0 2-2v-3"/>',"arrow-left-right":'<path d="M8 3 4 7l4 4"/><path d="M4 7h16"/><path d="m16 21 4-4-4-4"/><path d="M20 17H4"/>',"refresh-cw":'<path d="M3 12a9 9 0 0 1 9-9 9.75 9.75 0 0 1 6.74 2.74L21 8"/><path d="M21 3v5h-5"/><path d="M3 21v-5h5"/><path d="M21 12a9 9 0 0 1-9 9 9.75 9.75 0 0 1-6.74-2.74L3 16"/>',"rotate-cw":'<path d="M21 12a9 9 0 1 1-9-9c2.52 0 4.93 1 6.74 2.74L21 8"/><path d="M21 3v5h-5"/>',"wifi-off":'<path d="M12 20h.01"/><path d="M8.5 16.429a5 5 0 0 1 7 0"/><path d="M5 12.859a10 10 0 0 1 5.17-2.69"/><path d="M19 12.859a10 10 0 0 0-2.007-1.523"/><path d="M2 8.82a15 15 0 0 1 4.177-2.643"/><path d="M22 8.82a15 15 0 0 0-11.288-3.764"/><path d="m2 2 20 20"/>',globe:'<circle cx="12" cy="12" r="10"/><path d="M12 2a14.5 14.5 0 0 0 0 20 14.5 14.5 0 0 0 0-20"/><path d="M2 12h20"/>',plug:'<path d="M12 22v-5"/><path d="M9 8V2"/><path d="M15 8V2"/><path d="M18 8v5a4 4 0 0 1-4 4h-4a4 4 0 0 1-4-4V8Z"/>',link:'<path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"/><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"/>',"message-circle":'<path d="M7.9 20A9 9 0 1 0 4 16.1L2 22Z"/>'};function p(t,e={}){const s=In[t];if(!s)return console.warn("[icons] unknown icon:",t),"";const{size:a,cls:n="",title:r,spin:o=!1}=e,c=["icon",o?"icon-spin":"",n].filter(Boolean).join(" "),l=a?` width="${a}" height="${a}"`:"",h=r?` role="img" aria-label="${String(r).replace(/"/g,"&quot;")}"`:' aria-hidden="true"';return`<svg class="${c}"${l} viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"${h}>${s}</svg>`}function pe(t="book"){return`<div class="placeholder" data-icon="${t}"></div>`}function xe(t,e,s={}){const{kind:a="book",self:n=!1,attrs:r=""}=s,o=String(e??"").replace(/"/g,"&quot;"),c=`<div class=&quot;placeholder&quot; data-icon=&quot;${a}&quot;></div>`,l=n?"this.outerHTML":"this.parentElement.innerHTML";return`<img src="${t}" alt="${o}" loading="lazy"${r?" "+r:""} onerror="${l}='${c}'">`}const xs=`${p("folder")} Scan Folder`,Ls=`${p("loader",{spin:!0})} Scanning...`;async function Bn(t,e,s){try{t&&(t.disabled=!0,t.innerHTML=Ls),e&&(e.innerHTML=Ls),d("Scanning downloads folder...","info");const n=(await m.scanLibrary()).found||[];if(n.length===0){d("Scan complete: No new manga found","info"),s&&s();return}An(n,s)}catch(a){d("Scan failed: "+a.message,"error")}finally{t&&(t.disabled=!1,t.innerHTML=xs),e&&(e.innerHTML=xs)}}async function An(t,e){const s=document.createElement("div");s.id="import-modal-overlay",s.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.7);z-index:9999;display:flex;align-items:center;justify-content:center;";const a=document.createElement("div");a.style.cssText="background:var(--bg-primary);border-radius:8px;padding:24px;max-width:500px;width:90%;max-height:80vh;overflow-y:auto;",a.innerHTML=`
  ...
  `}function Le(){const t=document.querySelector("header");if(t&&t.dataset.listenersBound)return;t&&(t.dataset.listenersBound="true");const e=document.getElementById("hamburger-btn"),s=document.getElementById("mobile-menu");e&&s&&e.addEventListener("click",()=>{s.classList.toggle("hidden")});const a=document.getElementById("logout-btn"),n=document.getElementById("mobile-logout-btn"),r=()=>{localStorage.removeItem("manga_auth_token"),window.location.href="/login.html"};a&&a.addEventListener("click",r),n&&n.addEventListener("click",r);const o=document.getElementById("demo-exit-btn");o&&o.addEventListener("click",$=>{$.preventDefault(),localStorage.removeItem("manga_auth_token"),window.location.href="/login.html"}),document.querySelectorAll("[data-view]").forEach($=>{$.addEventListener("click",()=>{const A=$.dataset.view;localStorage.setItem("library_view_mode",A),document.querySelectorAll("[data-view]").forEach(D=>{D.classList.toggle("active",D.dataset.view===A)}),window.dispatchEvent(new CustomEvent("viewModeChange",{detail:{mode:A}}))})});const c=document.querySelector(".logo");c&&c.addEventListener("click",$=>{localStorage.removeItem("library_active_category"),localStorage.removeItem("library_artist_filter"),localStorage.removeItem("library_search"),ue.loadBookmarks(!0).catch(()=>{}),window.dispatchEvent(new CustomEvent("clearFilters"))});const l=document.getElementById("favorites-btn"),h=document.getElementById("mobile-favorites-btn"),u=$=>{$.preventDefault(),q.go("/favorites")};l&&l.addEventListener("click",u),h&&h.addEventListener("click",u);const g=document.getElementById("queue-nav-btn");g&&g.addEventListener("click",$=>{$.preventDefault(),q.go("/queue")});const v=document.getElementById("add-manga-btn"),S=document.getElementById("mobile-add-btn"),x=()=>{document.getElementById("add-modal")||(sessionStorage.setItem("open_add_modal","1"),q.go("/"))};v&&v.addEventListener("click",x),S&&S.addEventListener("click",x);const f=document.getElementById("scan-btn"),I=document.getElementById("mobile-scan-btn");if(f||I){const $=()=>{Bn(f,I,async()=>{await ue.loadBookmarks(!0),q.reload()})};f&&f.addEventListener("click",$),I&&I.addEventListener("click",$)}}const ut={series:"any",downloads:"any",reading:"any",source:"any",monitor:"any"};function Mn(){try{const t=JSON.parse(localStorage.getItem("library_filters")||"{}");return{...ut,...t&&typeof t=="object"?t:{}}}catch{return{...ut}}}let C={bookmarks:[],series:[],favorites:{favorites:{},listOrder:[]},activeCategory:localStorage.getItem("library_active_category")||null,artistFilter:null,searchQuery:localStorage.getItem("library_search")||"",searchAuthor:localStorage.getItem("library_search_author")||null,searchAuthorSource:localStorage.getItem("library_search_author_source")||null,sortBy:localStorage.getItem("library_sort")||"updated",filters:Mn(),viewMode:"manga",loading:!0},ht=[],_e=null;function Tn(){localStorage.setItem("library_filters",JSON.stringify(C.filters))}function Pn(t){var o,c,l;const e=new Set(t.excludedChapters||[]),s=new Set((t.chapters||[]).filter(h=>!e.has(h.number)).map(h=>h.number)).size||t.uniqueChapters||0,a=t.downloadedCount??((o=t.downloadedChapters)==null?void 0:o.length)??0,n=t.readCount??((c=t.readChapters)==null?void 0:c.length)??0,r=(t.updatedCount??((l=t.updatedChapters)==null?void 0:l.length)??0)>0;return{total:s,downloaded:a,read:n,updates:r}}const Rn=[{key:"series",label:"Series",options:[{value:"none",label:"Not in a series",test:t=>!t.series},{value:"in",label:"In a series",test:t=>!!t.series}]},{key:"downloads",label:"Downloads",options:[{value:"none",label:"Nothing downloaded",test:(t,e)=>e.downloaded===0},{value:"partial",label:"Partly downloaded",test:(t,e)=>e.downloaded>0&&e.downloaded<e.total},{value:"complete",label:"Fully downloaded",test:(t,e)=>e.total>0&&e.downloaded>=e.total}]},{key:"reading",label:"Reading",options:[{value:"unread",label:"Not started",test:(t,e)=>e.read===0},{value:"progress",label:"In progress",test:(t,e)=>e.read>0&&e.read<e.total},{value:"finished",label:"Finished",test:(t,e)=>e.total>0&&e.read>=e.total},{value:"updates",label:"New chapters",test:(t,e)=>e.updates}]},{key:"source",label:"Source",options:[]},{key:"monitor",label:"Auto-check",options:[{value:"on",label:"On",test:t=>!!t.autoCheck},{value:"off",label:"Off",test:t=>!t.autoCheck}]}];function qn(){const e=[...new Set(C.bookmarks.filter(s=>s.source!=="local"&&s.website).map(s=>s.website))].sort().map(s=>({value:`site:${s}`,label:s,test:a=>a.source!=="local"&&a.website===s}));return C.bookmarks.some(s=>s.source==="local")&&e.unshift({value:"local",label:"Local files",test:s=>s.source==="local"}),e}function Zs(){return Rn.map(t=>t.key==="source"?{...t,options:qn()}:t)}function ea(){return Object.values(C.filters).filter(t=>t&&t!=="any").length}function Dn(t){const s=Zs().map(a=>({g:a,option:a.options.find(n=>n.value===C.filters[a.key])})).filter(a=>a.option);return s.length===0?t:t.filter(a=>{const n=Pn(a);return s.every(({option:r})=>r.test(a,n))})}function pt(t){return String(t).replace(/[&<>"]/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;"})[e])}function Fn(t){return[...t].sort((e,s)=>{var a,n;switch(C.sortBy){case"az":return(e.alias||e.title).localeCompare(s.alias||s.title);case"za":return(s.alias||s.title).localeCompare(e.alias||e.title);case"lastread":return(s.lastReadAt||"").localeCompare(e.lastReadAt||"");case"chapters":{const r=((a=e.chapters)==null?void 0:a.length)||e.uniqueChapters||0;return(((n=s.chapters)==null?void 0:n.length)||s.uniqueChapters||0)-r}case"updated":default:return(s.updatedAt||"").localeCompare(e.updatedAt||"")}})}function $t(){let t=C.bookmarks;const e=(Array.isArray(C.categories)?C.categories:[]).filter(s=>typeof s=="object"?s.isNsfw:!1).map(s=>s.name);if(C.activeCategory==="__nsfw__"?t=t.filter(s=>(s.categories||[]).some(a=>e.includes(a))):C.activeCategory?t=t.filter(s=>(s.categories||[]).includes(C.activeCategory)):e.length>0&&(t=t.filter(s=>!(s.categories||[]).some(a=>e.includes(a)))),C.artistFilter&&(t=t.filter(s=>(s.artists||[]).includes(C.artistFilter))),C.searchQuery){const s=C.searchQuery.toLowerCase();t=t.filter(a=>(a.title||"").toLowerCase().includes(s)||(a.alias||"").toLowerCase().includes(s)||(a.artists||[]).some(n=>n.toLowerCase().includes(s)))}return t=Dn(t),Fn(t)}function Nn(t){const e=ea(),s=Zs().filter(a=>a.options.length>0);return`
    <div class="library-filter" id="library-filter">
      <button type="button" class="filter-btn ${e?"has-filter":""}" id="library-filter-btn" aria-haspopup="true" aria-expanded="false">
        ...
        ${s.map(a=>`
          <div class="library-filter-group">
            ...
            <div class="library-filter-options">
              ...
              ${a.options.map(n=>`<button type="button" class="filter-chip ${C.filters[a.key]===n.value?"active":""}" data-group="${a.key}" data-value="${pt(n.value)}">${pt(n.label)}</button>`).join("")}
            </div>
          </div>
        `).join("")}
      </div>
  ...
  `}function Bs(){const t=document.getElementById("library-grid");if(!t)return;const e=$t();t.innerHTML=e.map(Et).join("")||Ct();const s=document.getElementById("library-count");s&&(s.textContent=`${e.length} / ${C.bookmarks.length}`);const a=ea(),n=document.getElementById("library-filter-btn");n&&(n.classList.toggle("has-filter",a>0),n.innerHTML=`${p("sliders")} Filter${a?` · ${a}`:""}`);const r=document.getElementById("library-filter-reset");r&&(r.hidden=a===0),document.querySelectorAll("#library-filter-menu .filter-chip").forEach(o=>{const c=C.filters[o.dataset.group]||"any";o.classList.toggle("active",o.dataset.value===c)})}function Et(t){var u,g,v;const e=t.alias||t.title,s=t.downloadedCount??((u=t.downloadedChapters)==null?void 0:u.length)??0,a=new Set(t.excludedChapters||[]),n=(t.chapters||[]).filter(S=>!a.has(S.number)),r=new Set(n.map(S=>S.number)).size||t.uniqueChapters||0,o=t.readCount??((g=t.readChapters)==null?void 0:g.length)??0,c=(t.updatedCount??((v=t.updatedChapters)==null?void 0:v.length)??0)>0,l=t.localCover?`/api/public/covers/${t.id}/${encodeURIComponent(t.localCover.split(/[/\\]/).pop())}`:t.cover,h=t.source==="local";return`
  ...
  `}function On(t){var n;const e=t.alias||t.title,s=((n=t.entries)==null?void 0:n.length)||t.entry_count||0;let a=null;return t.localCover&&t.coverBookmarkId?a=`/api/public/covers/${t.coverBookmarkId}/${encodeURIComponent(t.localCover.split(/[/\\]/).pop())}`:t.cover&&(a=t.cover),`
  ...
  `}function mt(){const t=localStorage.getItem("library_view_mode");if(t&&t!==C.viewMode&&(C.viewMode=t),C.activeCategory==="Favorites")return q.go("/favorites"),"";let e="";if(C.viewMode==="series"){const s=C.series.map(On).join("");e=`
    ...
    `}else{const s=$t(),n=C.searchAuthor&&C.searchQuery===C.searchAuthor?`
      <div class="manga-card search-sources-card" id="search-sources-card" title="Search online sources for ${pt(C.searchAuthor)}"
        ...
        <div style="padding:1rem;color:var(--text-muted, #9aa);">
          ...
          <div style="font-size:.85rem;">Search sources for<br><strong style="color:var(--text-color, #fff);">${pt(C.searchAuthor)}</strong></div>
        </div>
      </div>`:"",r=s.map(Et).join("")+n;e=`
      ...
      `:""}
      <div class="library-grid" id="library-grid">
        ${C.loading?'<div class="loading-spinner"></div>':r||Ct()}
      </div>
    `}return`
    ${ce(C.viewMode)}
    <div class="container">
    ...
    ${Vn()}
    ${zn()}
  `}function Un(){const{activeCategory:t}=C,s=(Array.isArray(C.categories)?C.categories:[]).map(n=>typeof n=="object"?n:{name:n,isNsfw:!1}),a=s.some(n=>n.isNsfw);return`
    ...
    ${Hn()}
      `}function Hn(){const e=(Array.isArray(C.categories)?C.categories:[]).map(s=>typeof s=="object"?s:{name:s,isNsfw:!1});return`
  ...
  `}function Vn(){return`
      ...
      `}function Ot(){C.activeCategory=null,C.artistFilter=null,C.searchQuery="",C.searchAuthor=null,C.searchAuthorSource=null,C.filters={...ut},localStorage.removeItem("library_active_category"),localStorage.removeItem("library_artist_filter"),localStorage.removeItem("library_search"),localStorage.removeItem("library_search_author"),localStorage.removeItem("library_search_author_source"),localStorage.removeItem("library_filters"),me()}function jn(){const t=document.getElementById("library-filter-btn"),e=document.getElementById("library-filter-menu");!t||!e||(t.addEventListener("click",s=>{s.stopPropagation();const a=e.classList.toggle("hidden")===!1;t.setAttribute("aria-expanded",String(a))}),e.addEventListener("click",s=>{s.stopPropagation();const a=s.target.closest(".filter-chip");if(a){C.filters[a.dataset.group]=a.dataset.value,Tn(),Bs();return}s.target.closest("#library-filter-reset")&&(C.filters={...ut},localStorage.removeItem("library_filters"),Bs())}),_e&&document.removeEventListener("click",_e),_e=s=>{!e.classList.contains("hidden")&&!s.target.closest("#library-filter")&&(e.classList.add("hidden"),t.setAttribute("aria-expanded","false"))},document.addEventListener("click",_e))}async function Ut(t){const e=t.target.closest(".manga-card");if(e){if(e.classList.contains("gallery-card")){const n=e.dataset.gallery;q.go(`/read/gallery/${encodeURIComponent(n)}`);return}const s=e.dataset.id,a=e.dataset.seriesId;if(a){q.go(`/series/${a}`);return}if(s){if(C.activeCategory==="Favorites"){const n=C.bookmarks.find(r=>r.id===s);if(n){let r=n.last_read_chapter;if(!r&&n.chapters&&n.chapters.length>0&&(r=[...n.chapters].sort((c,l)=>c.number-l.number)[0].number),r){q.go(`/read/${s}/${r}`);return}else d("No chapters available to read","warning")}}q.go(`/manga/${s}`)}}}function ta(){var G,Z,w,B,M;const t=document.getElementById("app");t.removeEventListener("click",Ut),t.addEventListener("click",Ut),window._libraryViewModeListenerSet||(window._libraryViewModeListenerSet=!0,window.addEventListener("viewModeChange",E=>{C.viewMode=E.detail.mode;const y=document.getElementById("app");y.innerHTML=mt(),ta(),Le()}));const e=document.getElementById("category-fab-btn"),s=document.getElementById("category-fab-menu");e&&s&&(e.addEventListener("click",()=>{s.classList.toggle("hidden")}),s.addEventListener("click",E=>{const y=E.target.closest(".category-menu-item");if(y){const T=y.dataset.category||null;Qn(T),s.classList.add("hidden")}})),(G=document.getElementById("manage-categories-btn"))==null||G.addEventListener("click",E=>{E.stopPropagation();const y=document.getElementById("manage-categories-modal");y&&y.classList.add("open")}),(Z=document.getElementById("close-manage-categories-btn"))==null||Z.addEventListener("click",()=>{var E;(E=document.getElementById("manage-categories-modal"))==null||E.classList.remove("open")}),(w=document.querySelector("#manage-categories-modal .modal-overlay"))==null||w.addEventListener("click",()=>{var E;(E=document.getElementById("manage-categories-modal"))==null||E.classList.remove("open")}),(B=document.querySelector("#manage-categories-modal .modal-close"))==null||B.addEventListener("click",()=>{var E;(E=document.getElementById("manage-categories-modal"))==null||E.classList.remove("open")}),(M=document.getElementById("add-category-btn"))==null||M.addEventListener("click",async()=>{var T;const E=document.getElementById("new-category-input"),y=(T=E==null?void 0:E.value)==null?void 0:T.trim();if(y)try{await m.post("/categories",{name:y}),E.value="",d("Category added","success"),await Ne(!0),me()}catch(N){d("Failed: "+N.message,"error")}}),document.querySelectorAll(".nsfw-toggle").forEach(E=>{E.addEventListener("change",async y=>{const T=E.dataset.category;try{await m.put(`/categories/${encodeURIComponent(T)}/nsfw`,{isNsfw:E.checked}),d(`${T} ${E.checked?"marked as 18+":"unmarked"}`,"success"),await Ne(!0),me()}catch(N){d("Failed: "+N.message,"error"),E.checked=!E.checked}})}),document.querySelectorAll(".delete-category-btn").forEach(E=>{E.addEventListener("click",async()=>{const y=E.dataset.category;if(confirm(`Delete category "${y}"?`))try{await m.delete(`/categories/${encodeURIComponent(y)}`),d("Category deleted","success"),C.activeCategory===y&&(C.activeCategory=null,localStorage.removeItem("library_active_category")),await Ne(!0),me()}catch(T){d("Failed: "+T.message,"error")}})});const a=document.getElementById("artist-filter-badge");a&&a.addEventListener("click",()=>{C.artistFilter=null,localStorage.removeItem("library_artist_filter"),me()});const n=document.getElementById("library-search");n&&(n.addEventListener("input",E=>{var T;C.searchQuery=E.target.value,localStorage.setItem("library_search",E.target.value),C.searchAuthor=null,C.searchAuthorSource=null,localStorage.removeItem("library_search_author"),localStorage.removeItem("library_search_author_source");const y=document.getElementById("library-grid");if(y){const N=$t();y.innerHTML=N.map(Et).join("")||Ct();const W=document.getElementById("search-clear");!W&&C.searchQuery?(n.parentElement.insertAdjacentHTML("beforeend",'<button class="search-clear" id="search-clear">×</button>'),(T=document.getElementById("search-clear"))==null||T.addEventListener("click",()=>{C.searchQuery="",C.searchAuthor=null,C.searchAuthorSource=null,localStorage.removeItem("library_search"),localStorage.removeItem("library_search_author"),localStorage.removeItem("library_search_author_source"),n.value="",me()})):W&&!C.searchQuery&&W.remove()}}),C.searchQuery&&n.focus());const r=document.getElementById("search-clear");r&&r.addEventListener("click",()=>{C.searchQuery="",C.searchAuthor=null,C.searchAuthorSource=null,localStorage.removeItem("library_search"),localStorage.removeItem("library_search_author"),localStorage.removeItem("library_search_author_source"),me()});const o=document.getElementById("search-sources-card");o&&o.addEventListener("click",()=>{const E=C.searchAuthor||C.searchQuery,y=C.searchAuthorSource||"nhentai.net";E&&(window.location.hash=`#/scrapers?browse=${encodeURIComponent(y)}&q=${encodeURIComponent(E)}`)});const c=document.getElementById("library-sort");c&&c.addEventListener("change",E=>{C.sortBy=E.target.value,localStorage.setItem("library_sort",C.sortBy),me()}),jn(),window.removeEventListener("clearFilters",Ot),window.addEventListener("clearFilters",Ot);const l=document.getElementById("add-manga-btn"),h=document.getElementById("mobile-add-btn"),u=document.getElementById("add-modal"),g=document.getElementById("add-modal-close"),v=document.getElementById("add-modal-cancel"),S=document.getElementById("add-modal-submit"),x=document.getElementById("mobile-menu"),f=()=>{x&&x.classList.add("hidden"),u&&u.classList.add("open")};l&&l.addEventListener("click",f),h&&h.addEventListener("click",f),g&&g.addEventListener("click",()=>u.classList.remove("open")),v&&v.addEventListener("click",()=>u.classList.remove("open")),S&&S.addEventListener("click",async()=>{const E=document.getElementById("manga-url"),y=E.value.trim();if(!y){d("Please enter a URL","error");return}try{S.disabled=!0,S.textContent="Adding...",await m.addBookmark(y),d("Manga added successfully!","success"),u.classList.remove("open"),E.value="",await Ne(),me()}catch(T){d("Failed to add manga: "+T.message,"error")}finally{S.disabled=!1,S.textContent="Add"}});const I=document.getElementById("add-series-btn"),$=document.getElementById("mobile-add-series-btn"),A=document.getElementById("add-series-modal"),D=document.getElementById("add-series-modal-close"),R=document.getElementById("add-series-modal-cancel"),F=document.getElementById("add-series-modal-submit"),O=document.getElementById("mobile-menu");if((I||$)&&A){const E=()=>{O&&O.classList.add("hidden"),A.classList.add("open")};I&&I.addEventListener("click",E),$&&$.addEventListener("click",E)}D&&D.addEventListener("click",()=>A.classList.remove("open")),R&&R.addEventListener("click",()=>A.classList.remove("open")),F&&F.addEventListener("click",async()=>{const E=document.getElementById("series-title"),y=document.getElementById("series-alias"),T=E.value.trim(),N=y.value.trim();if(!T){d("Please enter a title","error");return}try{F.disabled=!0,F.textContent="Creating...",await m.createSeries(T,N),d("Series created successfully!","success"),A.classList.remove("open"),E.value="",y.value="",await Ne(!0),me()}catch(W){d("Failed to create series: "+W.message,"error")}finally{F.disabled=!1,F.textContent="Create"}});const k=A==null?void 0:A.querySelector(".modal-overlay");k&&k.addEventListener("click",()=>A.classList.remove("open"));const L=document.getElementById("empty-add-btn");L&&u&&L.addEventListener("click",()=>u.classList.add("open"));const P=document.getElementById("empty-add-series-btn");P&&A&&P.addEventListener("click",()=>A.classList.add("open"));const Q=u==null?void 0:u.querySelector(".modal-overlay");Q&&Q.addEventListener("click",()=>u.classList.remove("open")),Le()}function Qn(t){C.activeCategory=t,t?localStorage.setItem("library_active_category",t):localStorage.removeItem("library_active_category"),me()}async function Ne(t=!1){try{if(Y.isDemo){const[r,o]=await Promise.all([ue.loadBookmarks(t),ue.loadSeries(t)]);C.bookmarks=r,C.categories=[],C.series=o,C.favorites={favorites:{},listOrder:[]},C.loading=!1;return}const[e,s,a,n]=await Promise.all([ue.loadBookmarks(t),ue.loadCategories(t),ue.loadSeries(t),ue.loadFavorites(t)]);C.bookmarks=e,C.categories=s,C.series=a,C.favorites=n,C.loading=!1}catch{d("Failed to load library","error"),C.loading=!1}}async function me(){var e;const t=document.getElementById("app");if(Y.isDemo)C.activeCategory=null,C.artistFilter=null,C.searchQuery="",C.searchAuthor=null,C.searchAuthorSource=null;else{const s=localStorage.getItem("library_active_category");C.activeCategory!==s&&(C.activeCategory=s);const a=localStorage.getItem("library_artist_filter")||null;C.artistFilter!==a&&(C.artistFilter=a);const n=localStorage.getItem("library_search")||"";C.searchQuery!==n&&(C.searchQuery=n),C.searchAuthor=localStorage.getItem("library_search_author")||null,C.searchAuthorSource=localStorage.getItem("library_search_author_source")||null}C.loading&&(t.innerHTML=mt()),C.bookmarks.length===0&&C.loading&&await Ne(),t.innerHTML=mt(),ta(),sessionStorage.getItem("open_add_modal")&&(sessionStorage.removeItem("open_add_modal"),(e=document.getElementById("add-modal"))==null||e.classList.add("open")),ht.forEach(s=>s()),ht=[ue.subscribe("bookmarks",s=>{C.bookmarks=s;const a=document.getElementById("library-grid");if(a){const n=$t();a.innerHTML=n.map(Et).join("")||Ct()}})]}function Wn(){const t=document.getElementById("app");t&&t.removeEventListener("click",Ut),window.removeEventListener("clearFilters",Ot),_e&&(document.removeEventListener("click",_e),_e=null),ht.forEach(e=>e()),ht=[]}const Gn={mount:me,unmount:Wn,render:mt},Kn="manga-offline",Jn=1,Re="images",re="chapters";let st=null;function Ze(){return new Promise((t,e)=>{if(st)return t(st);const s=indexedDB.open(Kn,Jn);s.onupgradeneeded=a=>{const n=a.target.result;n.objectStoreNames.contains(Re)||n.createObjectStore(Re),n.objectStoreNames.contains(re)||n.createObjectStore(re)},s.onsuccess=()=>{st=s.result,t(st)},s.onerror=()=>e(s.error)})}function qe(t,e){return Ze().then(s=>new Promise((a,n)=>{const c=s.transaction(t,"readonly").objectStore(t).get(e);c.onsuccess=()=>a(c.result),c.onerror=()=>n(c.error)}))}function Ht(t,e,s){return Ze().then(a=>new Promise((n,r)=>{const l=a.transaction(t,"readwrite").objectStore(t).put(s,e);l.onsuccess=()=>n(),l.onerror=()=>r(l.error)}))}function Vt(t,e){return Ze().then(s=>new Promise((a,n)=>{const c=s.transaction(t,"readwrite").objectStore(t).delete(e);c.onsuccess=()=>a(),c.onerror=()=>n(c.error)}))}function rs(t){return Ze().then(e=>new Promise((s,a)=>{const o=e.transaction(t,"readonly").objectStore(t).getAllKeys();o.onsuccess=()=>s(o.result),o.onerror=()=>a(o.error)}))}function Ue(t,e){return`${t}:${e}`}function is(t,e,s){return`${t}:${e}:${s}`}function Yn(t){const e=t.split(":");return{mangaId:e[0],chapterNum:parseFloat(e[1])}}async function os(t,e,s=null){const a=await m.get(`/bookmarks/${t}/chapters/${e}/reader-images`);if(!a||!a.images||a.images.length===0)throw new Error("No images found for this chapter");const n=a.images,r=n.length;let o=0;const c=m.getToken();for(let h=0;h<n.length;h++){const u=typeof n[h]=="string"?n[h]:n[h].url,g=u.startsWith("http")?u:`${window.location.origin}${u}`;try{const v=await fetch(g,{headers:c?{Authorization:`Bearer ${c}`}:{}});if(!v.ok)throw new Error(`HTTP ${v.status}`);const S=await v.blob();await Ht(Re,is(t,e,u),S),o++,s&&s(o,r)}catch(v){console.error(`[Offline] Failed to cache image ${h+1}/${r}:`,v)}}const l={mangaId:t,chapterNum:e,imageUrls:n.map(h=>typeof h=="string"?h:h.url),savedAt:Date.now(),imageCount:o};return await Ht(re,Ue(t,e),l),{success:!0,imageCount:o}}async function Xn(t,e){const s=await qe(re,Ue(t,e));if(!s)return null;const a=[];for(const n of s.imageUrls){const r=await qe(Re,is(t,e,n));if(r)a.push(URL.createObjectURL(r));else return a.forEach(o=>URL.revokeObjectURL(o)),null}return a}async function sa(t,e){const s=await qe(re,Ue(t,e));if(s&&s.imageUrls)for(const a of s.imageUrls)await Vt(Re,is(t,e,a));await Vt(re,Ue(t,e))}async function Zn(t,e){if(!await qe(re,Ue(t,e)))return!1;await sa(t,e);try{return await os(t,e),!0}catch(a){return console.warn("[Offline] Could not re-save chapter after edit:",a),!1}}async function er(t,e){return!!await qe(re,Ue(t,e))}async function tr(){const t=await rs(re),e=[];for(const s of t){if(s.startsWith("auto-offline-"))continue;const a=await qe(re,s);a&&e.push(a)}return e}async function aa(t){const e=await rs(re),s=[];for(const a of e)if(!a.startsWith("auto-offline-")&&a.startsWith(`${t}:`)){const{chapterNum:n}=Yn(a);s.push(n)}return s}async function sr(){if(navigator.storage&&navigator.storage.estimate){const t=await navigator.storage.estimate();return{used:t.usage||0,quota:t.quota||0,usedMB:((t.usage||0)/(1024*1024)).toFixed(1),quotaMB:((t.quota||0)/(1024*1024)).toFixed(0)}}return{used:0,quota:0,usedMB:"0",quotaMB:"Unknown"}}async function ar(){const t=await Ze();await new Promise((e,s)=>{const r=t.transaction(Re,"readwrite").objectStore(Re).clear();r.onsuccess=e,r.onerror=s}),await new Promise((e,s)=>{const r=t.transaction(re,"readwrite").objectStore(re).clear();r.onsuccess=e,r.onerror=s})}async function nr(t,e){e?await Ht(re,`auto-offline-${t}`,{enabled:!0,mangaId:t}):await Vt(re,`auto-offline-${t}`)}async function rr(t){const e=await qe(re,`auto-offline-${t}`);return!!(e!=null&&e.enabled)}async function ir(){return(await rs(re)).filter(e=>e.startsWith("auto-offline-")).map(e=>e.replace("auto-offline-",""))}"serviceWorker"in navigator&&navigator.serviceWorker.addEventListener("message",async t=>{var e;if(((e=t.data)==null?void 0:e.type)==="sync-offline"){const s=t.data.mangaId;console.log(`[Offline] Auto-sync triggered for manga ${s}`);try{await na(s)}catch(a){console.error("[Offline] Auto-sync failed:",a)}}});async function na(t){try{const e=await m.getBookmark(t);if(!e)return;const s=e.downloadedChapters||[],a=await aa(t),n=s.filter(r=>!a.includes(r));console.log(`[Offline] ${n.length} new chapters to sync for ${e.alias||e.title}`);for(const r of n)await os(t,r),console.log(`[Offline] Auto-synced chapter ${r}`)}catch(e){console.error("[Offline] Sync error:",e)}}const or={saveChapterOffline:os,getOfflineChapter:Xn,deleteOfflineChapter:sa,refreshOfflineChapter:Zn,isChapterOffline:er,getOfflineChapters:tr,getOfflineChaptersForManga:aa,getStorageUsage:sr,clearAllOfflineData:ar,setAutoOffline:nr,isAutoOffline:rr,getAutoOfflineManga:ir,syncNewChaptersForManga:na};let i={manga:null,chapter:null,versionUrl:null,images:[],trophyPages:{},mode:"manga",direction:"rtl",firstPageSingle:!0,lastPageSingle:!1,singlePageMode:!0,currentPage:0,zoom:100,loading:!0,showControls:!0,isGalleryMode:!1,isCollectionMode:!1,favoriteLists:[],allFavorites:null,navigationDirection:null,nextChapterImage:null,nextChapterNum:null,_preloadCache:null,isStreamingMode:!1,_streamAbortController:null};function ls(t,e=i.manga){if(!t||!e)return"";const s=(e.chapters||[]).find(n=>n.url===t),a=[];return s&&(s.releaseGroup?a.push(s.releaseGroup):s.title&&s.title!==`Chapter ${s.number}`&&a.push(s.title)),t.startsWith("local://")&&a.push("Local"),a.join(" · ")}function cs(t){var s,a;const e=(a=(s=i.manga)==null?void 0:s.downloadedVersions)==null?void 0:a[t];return Array.isArray(e)?e:e?[e]:[]}function lr(){var e;const t=cs((e=i.chapter)==null?void 0:e.number);return t.length<2||!i.versionUrl?"":ls(i.versionUrl)||`Version ${t.indexOf(i.versionUrl)+1}`}function ra(){if(!i.manga||!i.chapter||!i.allFavorites||!i.allFavorites.favorites)return!1;if(i.isCollectionMode)return!0;let e=[jt()];if(i.mode==="manga"&&!i.singlePageMode){const n=ae()[i.currentPage];n&&Array.isArray(n)?e=n:n&&n.pages&&(e=n.pages)}const s=e.map(a=>{const n=Ye(i.images[a]);return n?{filename:n}:null}).filter(Boolean);for(const a in i.allFavorites.favorites){const n=i.allFavorites.favorites[a];if(Array.isArray(n)){for(const r of n)if(r.mangaId===i.manga.id&&r.chapterNum===i.chapter.number&&r.imagePaths)for(const o of r.imagePaths){const c=typeof o=="string"?o:(o==null?void 0:o.filename)||(o==null?void 0:o.path);for(const l of s)if(l&&l.filename===c)return!0}}}return!1}function zt(){const t=document.getElementById("favorites-btn");t&&(ra()?t.classList.add("active"):t.classList.remove("active"))}function Pe(){var g;if(i.loading)return`
    ...
    `;const t=i.manga.alias||i.manga.title,e=(g=i.chapter)==null?void 0:g.number,s=i.isCollectionMode||i.isStreamingMode?"":lr(),a=!i.isCollectionMode&&!i.isStreamingMode&&cs(e).length>1,r=ae().length,o=i.images.length;let c,l;i.mode==="webtoon"?(c=o-1,l=`${o} pages`):i.singlePageMode?(c=o-1,l=`${i.currentPage+1} / ${o}`):(c=r-1,l=`${i.currentPage+1} / ${r}`);const h=ra(),u=ca();return`
  ...
  `}function la(){if(i.singlePageMode)return cr();const e=ae()[i.currentPage];if(!e)return"";if(e.type==="link"){const s=e.pages[0],a=i.images[s],n=typeof a=="string"?a:a.url,r=i.trophyPages[s];return`
  ...
  `}function cr(){const t=i.currentPage,e=i.trophyPages[t];if(e&&!e.isSingle&&e.pages&&e.pages.length===2){const[r,o]=e.pages,c=i.images[r],l=i.images[o],h=typeof c=="string"?c:c==null?void 0:c.url,u=typeof l=="string"?l:l==null?void 0:l.url;if(h&&u)return`
            <div class="manga-spread ${i.direction}">
  ...
  `}function ae(){const t=[],e=i.images.length;let s=0;if(i.isCollectionMode){for(let n=0;n<e;n++)t.push([n]);return t}let a=!i.firstPageSingle;for(;s<e;){const n=i.trophyPages[s];if(n){if(!n.isSingle&&n.pages&&n.pages.length===2){const[r,o]=n.pages;t.push([r,o]),s=Math.max(r,o)+1}else t.push([s]),s++;continue}if(!a){a=!0,t.push([s]),s++;continue}if(i.lastPageSingle&&s===e-1){i.nextChapterImage?t.push({type:"link",pages:[s],nextImage:i.nextChapterImage,nextChapter:i.nextChapterNum}):t.push([s]),s++;break}s+1<e?i.trophyPages[s+1]?(t.push([s]),s++):i.lastPageSingle&&s+1===e-1?(t.push([s]),i.nextChapterImage?t.push({type:"link",pages:[s+1],nextImage:i.nextChapterImage,nextChapter:i.nextChapterNum}):t.push([s+1]),s+=2):(t.push([s,s+1]),s+=2):(t.push([s]),s++)}return t}function ca(){if(i.singlePageMode)return!!i.trophyPages[i.currentPage];const e=ae()[i.currentPage];return e?(Array.isArray(e)?e:e.pages||[]).some(a=>!!i.trophyPages[a]):!1}function ds(){if(i.singlePageMode)return[i.currentPage];const e=ae()[i.currentPage];return e?Array.isArray(e)?e:e.pages||[]:[]}async function dr(){if(!i.manga||!i.chapter||i.isCollectionMode)return;const t=ds();if(t.length===0)return;if(t.some(s=>!!i.trophyPages[s])){const s=[...t];if(i.singlePageMode){const a=i.trophyPages[i.currentPage];a&&!a.isSingle&&a.pages&&a.pages.length>1&&(s.length=0,s.push(...a.pages))}s.forEach(a=>delete i.trophyPages[a]),d(`Page${s.length>1?"s":""} unmarked as trophy`,"info")}else{let s=t,a=i.singlePageMode||t.length===1;if(!i.singlePageMode&&t.length===2){const r=await ga(t,"Mark as trophy");if(!r)return;s=r.pages,a=r.pages.length===1}s.forEach(r=>{i.trophyPages[r]={isSingle:a,pages:[...s]}});const n=a?"single":"double";d(`Page${s.length>1?"s":""} marked as trophy (${n})`,"success")}try{await m.saveTrophyPages(i.manga.id,i.chapter.number,i.trophyPages)}catch(s){console.error("Failed to save trophy pages:",s)}Se(),da()}function da(){const t=document.getElementById("trophy-btn");if(t){const e=ca();t.classList.toggle("active",e),t.title=e?"Unmark trophy":"Mark as trophy"}}function ua(){if(!i.manga||!i.chapter||i.isCollectionMode||i.isStreamingMode||!i.images.length)return null;const t=i.images.length;let e=1,s=!1;if(i.mode==="manga"){const a=ds();a.length>0&&(e=Math.min(...a)+1),s=a.includes(t-1)}else{const a=document.getElementById("reader-content");if(a){const n=[...a.querySelectorAll("img")],r=a.scrollTop;let o=0;n.forEach((h,u)=>{r>=o&&(e=u+1),o+=h.offsetHeight});const c=a.scrollHeight>a.clientHeight+10,l=n.length>0&&n.every(h=>h.complete&&h.naturalHeight>0);s=c?r+a.clientHeight>=a.scrollHeight-4:l}}return s&&(e=t),{mangaId:i.manga.id,chapterNumber:i.chapter.number,currentPage:e,totalPages:t}}async function De(t=ua()){var e;if(!(!t||Y.isDemo))try{if(await m.updateReadingProgress(t.mangaId,t.chapterNumber,t.currentPage,t.totalPages),t.currentPage>=t.totalPages&&((e=i.manga)==null?void 0:e.id)===t.mangaId){const s=new Set(i.manga.readChapters||[]);s.add(t.chapterNumber),i.manga.readChapters=[...s]}}catch(s){console.error("Failed to save progress:",s)}}let Me=null;function ha(){Me&&clearTimeout(Me),Me=setTimeout(()=>{Me=null,De()},1500)}function gt(){var s,a,n,r,o,c,l,h,u,g,v,S,x,f,I,$,A,D,R,F,O;const t=document.getElementById("app");(s=document.getElementById("reader-close-btn"))==null||s.addEventListener("click",async()=>{i.isStreamingMode||(await De(),await Ie()),i.isStreamingMode?q.go("/scrapers"):i.manga&&i.manga.id!=="gallery"?q.go(`/manga/${i.manga.id}`):q.go("/")}),(a=document.getElementById("reader-back-btn"))==null||a.addEventListener("click",()=>{q.go(i.isStreamingMode?"/scrapers":"/")}),(n=document.getElementById("reader-settings-btn"))==null||n.addEventListener("click",()=>{var k;(k=document.getElementById("reader-settings"))==null||k.classList.toggle("hidden")}),(r=document.getElementById("close-settings-btn"))==null||r.addEventListener("click",()=>{var k;(k=document.getElementById("reader-settings"))==null||k.classList.add("hidden")}),(o=document.getElementById("single-page-btn"))==null||o.addEventListener("click",()=>{if(i.singlePageMode){const k=ae();let L=0;for(let P=0;P<k.length;P++)if(k[P].includes(i.currentPage)){L=P;break}i.singlePageMode=!1,i.currentPage=L}else{const L=ae()[i.currentPage];i.singlePageMode=!0,i.currentPage=L?L[0]:0}localStorage.setItem("reader_single_page",i.singlePageMode?"1":"0"),Oe()}),(c=document.getElementById("trophy-btn"))==null||c.addEventListener("click",()=>{dr()}),t.querySelectorAll("[data-mode]").forEach(k=>{k.addEventListener("click",()=>{var Q,G;const L=k.dataset.mode;let P=jt();if(i.mode=L,localStorage.setItem("reader_mode",i.mode),L==="webtoon")i.currentPage=P;else if(i.singlePageMode)i.currentPage=P;else{const Z=ae();let w=0;for(let B=0;B<Z.length;B++)if(Z[B].includes(P)){w=B;break}i.currentPage=w}(Q=i.manga)!=null&&Q.id&&((G=i.chapter)!=null&&G.number)&&Ie(),Oe(),L==="webtoon"&&setTimeout(()=>{const Z=document.getElementById("reader-content");if(Z){const w=Z.querySelectorAll("img");w[P]&&w[P].scrollIntoView({behavior:"auto",block:"start"})}},100)})}),t.querySelectorAll("[data-direction]").forEach(k=>{k.addEventListener("click",async()=>{var L,P;i.direction=k.dataset.direction,localStorage.setItem("reader_direction",i.direction),(L=i.manga)!=null&&L.id&&((P=i.chapter)!=null&&P.number)&&await Ie(),Oe()})}),(l=document.getElementById("first-page-single"))==null||l.addEventListener("change",async k=>{i.firstPageSingle=k.target.checked,await Ie(),Se()}),(h=document.getElementById("last-page-single"))==null||h.addEventListener("change",async k=>{var L,P;i.lastPageSingle=k.target.checked,await Ie(),i.lastPageSingle&&((L=i.manga)!=null&&L.id)&&((P=i.chapter)!=null&&P.number)?await pa():(i.nextChapterImage=null,i.nextChapterNum=null),Se()}),(u=document.getElementById("zoom-slider"))==null||u.addEventListener("input",k=>{i.zoom=parseInt(k.target.value);const L=document.getElementById("reader-content");L&&(L.style.zoom=`${i.zoom}%`)});const e=document.getElementById("page-slider");if(e&&(e.addEventListener("input",k=>{const L=parseInt(k.target.value),P=document.getElementById("page-indicator");P&&(i.singlePageMode?P.textContent=`${L+1} / ${i.images.length}`:P.textContent=`${L+1} / ${ae().length}`)}),e.addEventListener("change",k=>{i.currentPage=parseInt(k.target.value),Se()})),i.mode==="manga"){const k=document.getElementById("reader-content");k==null||k.addEventListener("click",L=>{var Z;if(L.target.closest("button, a, .link-overlay"))return;const P=k.getBoundingClientRect(),G=(L.clientX-P.left)/P.width;G<.3?Qt():G>.7?ot():(i.showControls=!i.showControls,(Z=document.querySelector(".reader"))==null||Z.classList.toggle("controls-hidden",!i.showControls))})}document.addEventListener("keydown",fa),(g=document.getElementById("prev-chapter-btn"))==null||g.addEventListener("click",()=>ft(-1)),(v=document.getElementById("next-chapter-btn"))==null||v.addEventListener("click",()=>ft(1)),i.mode==="webtoon"&&((S=document.getElementById("reader-content"))==null||S.addEventListener("click",()=>{var k;i.showControls=!i.showControls,(k=document.querySelector(".reader"))==null||k.classList.toggle("controls-hidden",!i.showControls)}),(x=document.getElementById("reader-content"))==null||x.addEventListener("scroll",ha,{passive:!0})),(f=document.getElementById("rotate-btn"))==null||f.addEventListener("click",async()=>{const k=At();if(!(!k||!i.manga||!i.chapter))try{d("Rotating...","info");const L=await m.rotatePage(i.manga.id,i.chapter.number,k,90,i.versionUrl);L.images&&(await _t(L.images),d("Page rotated","success"))}catch(L){d("Rotate failed: "+L.message,"error")}}),(I=document.getElementById("swap-btn"))==null||I.addEventListener("click",async()=>{const L=ae()[i.currentPage];if(!L||L.length!==2||!i.manga||!i.chapter){d("Select a spread with 2 pages to swap","info");return}const P=Ye(i.images[L[0]]),Q=Ye(i.images[L[1]]);if(!(!P||!Q))try{d("Swapping...","info");const G=await m.swapPages(i.manga.id,i.chapter.number,P,Q,i.versionUrl);G.images&&(await _t(G.images),d("Pages swapped","success"))}catch(G){d("Swap failed: "+G.message,"error")}}),($=document.getElementById("split-btn"))==null||$.addEventListener("click",async()=>{const k=At();if(!k||!i.manga||!i.chapter||!confirm("Split this page into halves? This is permanent."))return;const L=document.getElementById("split-btn");try{d("Preparing to split...","info"),L&&(L.disabled=!0),i.images=[],i.loading=!0,t.innerHTML=Pe(),await new Promise(Q=>setTimeout(Q,2e3)),d("Splitting page...","info");const P=await m.splitPage(i.manga.id,i.chapter.number,k,i.versionUrl);L&&(L.disabled=!1),await Ae(i.manga.id,i.chapter.number,i.versionUrl),t.innerHTML=Pe(),gt(),Se(),P.warning?d(P.warning,"warning"):d("Page split into halves","success")}catch(P){L&&(L.disabled=!1),d("Split failed: "+P.message,"error"),await Ae(i.manga.id,i.chapter.number,i.versionUrl),t.innerHTML=Pe(),gt()}}),(A=document.getElementById("delete-page-btn"))==null||A.addEventListener("click",async()=>{const k=At();if(!(!k||!i.manga||!i.chapter)&&confirm(`Delete page "${k}" permanently? This cannot be undone.`))try{d("Deleting...","info");const L=await m.deletePage(i.manga.id,i.chapter.number,k,i.versionUrl);L.images&&(await _t(L.images),d("Page deleted","success"))}catch(L){d("Delete failed: "+L.message,"error")}}),(D=document.getElementById("favorites-btn"))==null||D.addEventListener("click",async()=>{try{const P=await m.getFavorites();i.allFavorites=P,i.favoriteLists=Object.keys(P.favorites||P||{})}catch(P){console.error("Failed to load favorites",P),d("Failed to load favorites","error");return}let L=[jt()];if(i.mode==="manga"&&!i.singlePageMode){const Q=ae()[i.currentPage];Q&&Array.isArray(Q)?L=Q:Q&&Q.pages&&(L=Q.pages)}if(L.length>1){const P=await ga(L,"Select Page for Favorites");if(!P)return;L=P.pages}mr(L)}),(R=document.getElementById("version-btn"))==null||R.addEventListener("click",()=>{hr()}),(F=document.getElementById("fullscreen-btn"))==null||F.addEventListener("click",()=>{document.fullscreenElement?document.exitFullscreen():document.documentElement.requestFullscreen().catch(()=>{d("Fullscreen not supported","info")})}),(O=document.getElementById("stream-add-lib-btn"))==null||O.addEventListener("click",async()=>{var P;const k=document.getElementById("stream-add-lib-btn");if(!((P=i.manga)!=null&&P._streamUrl)){d("No URL to add","error");return}const L=k.innerHTML;k.innerHTML=p("loader",{spin:!0}),k.disabled=!0;try{const Q=await m.addBookmark(i.manga._streamUrl);if(!Q.jobId)throw new Error("No job ID returned");d("Adding to library...","info");const G=setInterval(async()=>{var Z;try{const B=(await m.getQueueHistory(20)).find(M=>M.id===Q.jobId);B&&(B.status==="completed"?(clearInterval(G),(Z=B.result)!=null&&Z.bookmark&&(d("Added to library!","success"),k.innerHTML=p("check"),k.title="Added! Click to view",k.disabled=!1,k.onclick=()=>{q.go(`/manga/${B.result.bookmark.id}`)})):B.status==="failed"&&(clearInterval(G),d("Failed to add: "+(B.error||"Unknown error"),"error"),k.innerHTML=L,k.disabled=!1))}catch{}},1500)}catch(Q){d("Failed to add: "+Q.message,"error"),k.innerHTML=L,k.disabled=!1}}),document.body.classList.add("reader-active")}function Ye(t){var n;const e=typeof t=="string"?t:(t==null?void 0:t.url)||((n=t==null?void 0:t.urls)==null?void 0:n[0]);if(!e)return null;const a=e.split("?")[0].split("/");return decodeURIComponent(a[a.length-1])}function At(){const t=ds();return t.length===0?null:Ye(i.images[t[0]])}async function _t(t){var s,a;(s=i.manga)!=null&&s.id&&((a=i.chapter)!=null&&a.number)&&!i.isStreamingMode&&or.refreshOfflineChapter(i.manga.id,i.chapter.number).then(n=>{n&&console.log("[Reader] Refreshed offline copy after page edit")}).catch(n=>console.warn("[Reader] Offline refresh failed:",n));const e=Date.now();if(i.images=t.map(n=>{const r=typeof n=="string"?n:n==null?void 0:n.url;if(!r)return n;const o=r+(r.includes("?")?"&":"?")+`_t=${e}`;return typeof n=="string"?o:{...n,url:o}}),i.mode==="manga")if(i.singlePageMode)i.currentPage=Math.min(i.currentPage,i.images.length-1);else{const n=ae();i.currentPage=Math.min(i.currentPage,n.length-1)}i.currentPage=Math.max(0,i.currentPage),Se()}async function pa(){var t,e;if(!(!((t=i.manga)!=null&&t.id)||!((e=i.chapter)!=null&&e.number)))try{const s=await m.getNextChapterPreview(i.manga.id,i.chapter.number);i.nextChapterImage=s.firstImage||null,i.nextChapterNum=s.nextChapter||null}catch{i.nextChapterImage=null,i.nextChapterNum=null}}async function ur(){var r,o;if(!((r=i.manga)!=null&&r.id)||!((o=i.chapter)!=null&&o.number)||i.isCollectionMode)return;const e=[...i.manga.downloadedChapters||[]].sort((c,l)=>c-l),s=e.indexOf(i.chapter.number);if(s<0||s>=e.length-1)return;const a=e[s+1],n=i.manga.id;if(!(i._preloadCache&&i._preloadCache.chapterNum===a&&i._preloadCache.mangaId===n))try{const l=(i.manga.downloadedVersions||{})[a]||[],h=Array.isArray(l)?l[0]:l,u=h?`/bookmarks/${n}/chapters/${a}/reader-images?version=${encodeURIComponent(h)}`:`/bookmarks/${n}/chapters/${a}/reader-images`,v=(await m.get(u)).images||[];if(v.length===0)return;const S=v.map(x=>{const f=new Image,I=typeof x=="string"?x:x.url;return I&&(f.src=I),f});i._preloadCache={chapterNum:a,mangaId:n,images:v,imageObjects:S,versionUrl:h},console.log(`[Reader] Preloaded ${v.length} images for chapter ${a}`)}catch(c){console.warn("[Reader] Failed to preload next chapter:",c)}}function ma(t,e,s=i.manga,a=[],n={}){return new Promise(r=>{const o=document.createElement("div");o.className="version-modal-overlay",o.innerHTML=`
        ...
        `;const c=o.querySelector(".version-list");t.forEach((l,h)=>{const u=document.createElement("button");u.className="version-item";const g=n.current&&n.current===l;g&&u.classList.add("current");const v=(ls(l,s)||`Version ${h+1}`)+(g?" (reading)":""),S=a.find($=>$.url===l),x=[];if(S!=null&&S.imageCount&&x.push(`${S.imageCount} pages`),S!=null&&S.folder&&x.push(S.folder),u.innerHTML=`<span class="version-item-title"></span>${x.length?'<span class="version-item-meta"></span>':""}`,u.querySelector(".version-item-title").textContent=v,x.length&&(u.querySelector(".version-item-meta").textContent=x.join(" · ")),u.title=l,u.addEventListener("click",()=>{o.remove(),r(l)}),!n.allowKeep){c.appendChild(u);return}const f=document.createElement("div");f.className="version-item-row",f.appendChild(u);const I=document.createElement("button");I.className="version-item-keep",I.textContent="Keep only",I.title="Delete every other downloaded version of this chapter",I.addEventListener("click",()=>{o.remove(),r({keep:l})}),f.appendChild(I),c.appendChild(f)}),o.querySelector(".version-cancel").addEventListener("click",()=>{o.remove(),r(null)}),o.addEventListener("click",l=>{l.target===o&&(o.remove(),r(null))}),document.body.appendChild(o)})}async function hr(){if(!i.manga||!i.chapter||i.isCollectionMode||i.isStreamingMode)return;const t=i.chapter.number,e=cs(t);if(e.length<2)return;let s=[];try{s=(await m.getChapterVersions(i.manga.id,t)).versions||[]}catch{}const a=await ma(e,t,i.manga,s,{current:i.versionUrl,allowKeep:!0});if(a){if(typeof a=="string"){a!==i.versionUrl&&(await De(),q.go(`/read/${i.manga.id}/${t}?version=${encodeURIComponent(a)}`));return}a.keep&&await pr(t,a.keep,e)}}async function pr(t,e,s){var c;const a=s.filter(l=>l!==e),n=ls(e)||"this version";if(!confirm(`Keep only "${n}" and delete the other ${a.length} downloaded version${a.length>1?"s":""} of chapter ${t}?`))return;const r=i.manga.id;let o=0;for(const l of a)try{await m.deleteChapterVersion(r,t,l)}catch(h){o++,d("Failed to delete a version: "+h.message,"error")}o===0&&d("Other versions deleted","success");try{const l=await m.getBookmark(r);((c=i.manga)==null?void 0:c.id)===r&&(i.manga=l)}catch{}e!==i.versionUrl?q.go(`/read/${r}/${t}?version=${encodeURIComponent(e)}`):Oe()}function mr(t){if(!i.manga||!i.chapter)return;const e=t.map(l=>{const h=Ye(i.images[l]);return h?{filename:h}:null}).filter(Boolean),s=l=>{if(!i.allFavorites||!i.allFavorites.favorites)return-1;const h=i.allFavorites.favorites[l];if(!Array.isArray(h))return-1;for(let u=0;u<h.length;u++){const g=h[u];if(g.mangaId===i.manga.id&&g.chapterNum===i.chapter.number&&g.imagePaths)for(const v of g.imagePaths){const S=typeof v=="string"?v:(v==null?void 0:v.filename)||(v==null?void 0:v.path);for(const x of e)if(x&&x.filename===S)return u}}return-1},a=document.createElement("div");a.className="page-picker-overlay";let n="";i.favoriteLists.length===0?n='<div style="margin: 20px 0; color: #888;">No favorite lists available.</div>':(n='<div class="favorite-list-selection" style="display: flex; flex-direction: column; gap: 10px; margin-bottom: 20px; max-height: 400px; overflow-y: auto;">',i.favoriteLists.forEach(l=>{const u=s(l)!==-1;n+=`
    ...
    `,a.appendChild(r),a.querySelector(".page-picker-cancel").addEventListener("click",()=>{a.remove(),zt()}),a.addEventListener("click",l=>{l.target===a&&(a.remove(),zt())}),a.querySelectorAll(".list-option").forEach(l=>{l.addEventListener("click",async()=>{const h=l.dataset.list,u=s(h),g=u!==-1;l.style.opacity="0.5",l.style.pointerEvents="none";try{if(g){await m.removeFavoriteItem(h,u);const v=await m.getFavorites();i.allFavorites=v,l.classList.remove("active-list"),l.querySelector("span:last-child").innerHTML=p("plus")}else{const v=t.length>1?"double":"single",S={mangaId:i.manga.id,chapterNum:i.chapter.number,title:`${i.manga.alias||i.manga.title} Ch.${i.chapter.number} p${t[0]+1}`,imagePaths:e,displayMode:v,displaySide:i.direction==="rtl"?"right":"left"};await m.addFavoriteItem(h,S);const x=await m.getFavorites();i.allFavorites=x,l.classList.add("active-list"),l.querySelector("span:last-child").innerHTML=p("check")}}catch(v){console.error(v)}finally{l.style.opacity="1",l.style.pointerEvents="auto"}})}),document.body.appendChild(a)}function ga(t,e){return new Promise(s=>{const[a,n]=t,r=i.images[a],o=i.images[n],c=typeof r=="string"?r:r==null?void 0:r.url,l=typeof o=="string"?o:o==null?void 0:o.url,h=i.direction==="rtl",u=h?n:a,g=h?a:n,v=h?l:c,S=h?c:l,x=document.createElement("div");x.className="page-picker-overlay",x.innerHTML=`
        ...
        `;const f=I=>{x.remove(),s(I)};x.querySelectorAll(".page-picker-option").forEach(I=>{I.addEventListener("click",()=>{const $=I.dataset.choice;$==="left"?f({pages:[u]}):$==="right"?f({pages:[g]}):$==="both"&&f({pages:t})})}),x.querySelector(".page-picker-cancel").addEventListener("click",()=>f(null)),x.addEventListener("click",I=>{I.target===x&&f(null)}),document.body.appendChild(x)})}function jt(){if(i.mode==="webtoon"){const t=document.getElementById("reader-content");if(t){const e=t.querySelectorAll("img");if(e.length>0){const s=t.scrollTop;if(s>10){let a=0;for(let n=0;n<e.length;n++){const r=e[n].offsetHeight;if(a+r>s)return n;a+=r}}}}return 0}else{if(i.singlePageMode)return i.currentPage;{const e=ae()[i.currentPage];return e&&e.length>0?e[0]:0}}}function fa(t){var e;if(!(t.target.tagName==="INPUT"||t.target.tagName==="TEXTAREA")){if(t.key==="Escape"){const s=(e=i.manga)==null?void 0:e.id;Promise.all([De(),Ie()]).finally(()=>{s&&q.go(`/manga/${s}`)});return}if(i.mode==="manga")t.key==="ArrowLeft"?i.direction==="rtl"?ot():Qt():t.key==="ArrowRight"?i.direction==="rtl"?Qt():ot():t.key===" "&&(t.preventDefault(),ot());else if(i.mode==="webtoon"&&t.key===" "){t.preventDefault();const s=document.getElementById("reader-content");if(s){const a=s.clientHeight*.8;s.scrollBy({top:t.shiftKey?-a:a,behavior:"smooth"})}}}}function ot(){const t=ae(),e=i.singlePageMode?i.images.length-1:t.length-1;if(i.currentPage<e)i.currentPage++,Se();else{const s=t[i.currentPage],a=s&&s.type==="link";De(),a&&(i.navigationDirection="next-linked"),ft(1)}}function Qt(){i.currentPage>0?(i.currentPage--,Se()):ft(-1)}function Se(){const t=document.getElementById("reader-content");if(t){t.innerHTML=i.isCollectionMode?ia():i.mode==="webtoon"?oa():la();const e=document.getElementById("page-indicator");e&&(i.singlePageMode?e.textContent=`${i.currentPage+1} / ${i.images.length}`:e.textContent=`${i.currentPage+1} / ${ae().length}`);const s=document.getElementById("page-slider");s&&(s.value=i.currentPage,s.max=i.singlePageMode?i.images.length-1:ae().length-1),da(),zt(),i.mode==="manga"&&ha()}}function Oe(){const t=document.getElementById("app");t&&(t.innerHTML=Pe(),gt())}async function ft(t){if(console.log("[Nav] navigateChapter called with delta:",t),i.isStreamingMode)return;if(!i.manga||!i.chapter){console.log("[Nav] early return - no manga or chapter");return}await De(),await Ie();const s=[...i.manga.downloadedChapters||[]].sort((r,o)=>r-o),a=s.indexOf(i.chapter.number),n=a+t;if(console.log("[Nav]",{delta:t,chapterNumber:i.chapter.number,sorted:s,currentIdx:a,newIdx:n}),n>=0&&n<s.length){i.navigationDirection||(i.navigationDirection=t<0?"prev":null);const r=s[n],c=(i.manga.downloadedVersions||{})[r]||[],l=Array.isArray(c)?c[0]:c,h=l?`?version=${encodeURIComponent(l)}`:"";console.log("[Nav] Calling router.go with:",`/read/${i.manga.id}/${r}${h}`),q.go(`/read/${i.manga.id}/${r}${h}`)}else d(t>0?"Last chapter":"First chapter","info")}async function Ae(t,e,s){var a,n,r,o,c;console.log("[Reader] loadData called:",{mangaId:t,chapterNum:e,versionUrl:s});try{if(i.mode=localStorage.getItem("reader_mode")||"manga",i.direction=localStorage.getItem("reader_direction")||"rtl",i.singlePageMode=localStorage.getItem("reader_single_page")!=="0",i.firstPageSingle=!0,i.lastPageSingle=!1,i.versionUrl=null,t==="gallery"){const l=decodeURIComponent(e),u=((a=(await m.getFavorites()).favorites)==null?void 0:a[l])||[];i.images=[];for(const g of u){const v=g.imagePaths||[],S=[];for(const x of v){let f;typeof x=="string"?f=x:x&&typeof x=="object"&&(f=x.filename||x.path||x.name||x.url,f&&f.includes("/")&&(f=f.split("/").pop()),f&&f.includes("\\")&&(f=f.split("\\").pop())),f&&S.push(`/api/public/chapter-images/${g.mangaId}/${g.chapterNum}/${encodeURIComponent(f)}`)}S.length>0&&i.images.push({urls:S,displayMode:g.displayMode||"single",displaySide:g.displaySide||"left"})}i.manga={id:"gallery",title:l,alias:l},i.chapter={number:"Gallery"},i.isGalleryMode=!0,i.isCollectionMode=!0,i.images.length===0&&d("Gallery is empty","warning")}else if(t==="trophies"){const l=e;let h=[],u="Trophies";if(l.startsWith("series-")){const g=l.replace("series-",""),S=(await store.loadSeries()).find(I=>I.id===g);u=S?S.alias||S.title:"Series Trophies";const f=(await store.loadBookmarks()).filter(I=>I.seriesId===g);for(const I of f){const $=await m.getTrophyPagesAll(I.id);for(const A in $)for(const D in $[A]){const R=$[A][D],O=(await m.getChapterImages(I.id,A)).images[D],k=typeof O=="string"?O.split("/").pop():(O==null?void 0:O.filename)||(O==null?void 0:O.path);h.push({mangaId:I.id,chapterNum:A,imagePaths:[{filename:k}],displayMode:R.isSingle?"single":"double",displaySide:"left"})}}}else{const g=await m.getBookmark(l);u=g?g.alias||g.title:"Manga Trophies";const v=await m.getTrophyPagesAll(l);for(const S in v)for(const x in v[S]){const f=v[S][x],$=(await m.getChapterImages(l,S)).images[x],A=typeof $=="string"?$.split("/").pop():($==null?void 0:$.filename)||($==null?void 0:$.path);h.push({mangaId:l,chapterNum:S,imagePaths:[{filename:decodeURIComponent(A)}],displayMode:f.isSingle?"single":"double",displaySide:"left"})}}i.images=h.map(g=>{const v=g.imagePaths[0].filename;return{urls:[`/api/public/chapter-images/${g.mangaId}/${g.chapterNum}/${encodeURIComponent(v)}`],displayMode:g.displayMode,displaySide:g.displaySide}}),i.manga={id:"trophies",title:u,alias:u},i.chapter={number:"🏆"},i.isCollectionMode=!0,i.isGalleryMode=!1}else if(t==="stream"){i.isStreamingMode=!0,i.isCollectionMode=!1,i.isGalleryMode=!1,i.singlePageMode=!0;const l=sessionStorage.getItem("streamPreviewUrl"),h=sessionStorage.getItem("streamPreviewScraper"),u=sessionStorage.getItem("streamPreviewTitle")||"Preview";i.manga={id:"stream",title:u,alias:u,_streamUrl:l},i.chapter={number:1},i.images=[],l?gr(l,h):d("No stream URL found","error")}else{i.isGalleryMode=!1;const l=await m.getBookmark(t);i.manga=l,console.log("[Reader] manga loaded, finding chapter..."),i.chapter=((n=l.chapters)==null?void 0:n.find(u=>u.number===parseFloat(e)))||{number:parseFloat(e)};const h=parseFloat(e);if(i._preloadCache&&i._preloadCache.mangaId===t&&i._preloadCache.chapterNum===h)console.log("[Reader] Using preloaded images for chapter",e),i.images=i._preloadCache.images||[],i.versionUrl=s||i._preloadCache.versionUrl||null,i._preloadCache=null;else{i.versionUrl=s||null;const u=s?`/bookmarks/${t}/chapters/${e}/reader-images?version=${encodeURIComponent(s)}`:`/bookmarks/${t}/chapters/${e}/reader-images`,g=await m.get(u);console.log("[Reader] images loaded, count:",(r=g.images)==null?void 0:r.length),i.images=g.images||[]}try{const u=await m.getChapterSettings(t,e);if(As(u))_s(u);else try{const v=[...i.manga.downloadedChapters||[]].sort(($,A)=>$-A),S=parseFloat(e),x=v.indexOf(S),f=[];if(x!==-1){for(let $=x-1;$>=0;$--)f.push(v[$]);for(let $=x+1;$<v.length;$++)f.push(v[$])}const I=12;for(const $ of f.slice(0,I)){const A=await m.getChapterSettings(t,$);if(As(A)){_s(A),console.log("[Reader] Inherited settings from chapter",$);break}}}catch(g){console.warn("Failed to inherit chapter settings",g)}}catch(u){console.warn("Failed to load chapter settings",u)}try{const u=await m.getTrophyPages(t,e);i.trophyPages=u||{}}catch(u){console.warn("Failed to load trophy pages",u)}try{const u=await m.getFavorites();i.allFavorites=u,i.favoriteLists=Object.keys(u.favorites||u||{})}catch(u){console.warn("Failed to load favorites",u)}}if(i.isStreamingMode)i.currentPage=0;else{const l=parseFloat(e),h=(c=(o=i.manga)==null?void 0:o.readingProgress)==null?void 0:c[l];if(h&&h.page<h.totalPages)if(i.mode==="manga")if(i.singlePageMode)i.currentPage=Math.max(0,h.page-1);else{const u=Math.max(0,h.page-1),g=ae();let v=0;for(let S=0;S<g.length;S++){const x=g[S],f=Array.isArray(x)?x:x.pages||[];if(f.includes(u)||f[0]>=u){v=S;break}v=S}i.currentPage=v}else i.currentPage=0,i._resumeScrollToPage=h.page-1;else i.currentPage=0}}catch(l){console.error("Error loading chapter:",l),d("Failed to load chapter","error")}if(!i.isStreamingMode){if(i.navigationDirection==="prev"&&i.mode==="manga")if(i.singlePageMode)i.currentPage=Math.max(0,i.images.length-1);else{const l=ae();i.currentPage=Math.max(0,l.length-1)}else if(i.navigationDirection==="next-linked"&&i.mode==="manga"&&i.images.length>1)if(i.singlePageMode)i.currentPage=1;else{const l=ae();let h=0;for(let u=0;u<l.length;u++){const g=l[u];if((Array.isArray(g)?g:g.pages||[]).includes(1)){h=u;break}}i.currentPage=h}}i.navigationDirection=null,i.lastPageSingle&&!i.isStreamingMode&&await pa(),i.loading=!1,Oe(),i.isStreamingMode||ur(),i.mode==="webtoon"&&i._resumeScrollToPage&&setTimeout(()=>{const l=document.getElementById("reader-content");if(l){const h=l.querySelectorAll("img");h[i._resumeScrollToPage]&&h[i._resumeScrollToPage].scrollIntoView({behavior:"auto",block:"start"})}delete i._resumeScrollToPage},300)}async function gr(t,e){i._streamAbortController&&i._streamAbortController.abort(),i._streamAbortController=new AbortController;const{signal:s}=i._streamAbortController;try{let a="/api/scrapers/preview-images-stream?";e&&(a+=`scraper=${encodeURIComponent(e)}&`),a+=`url=${encodeURIComponent(t)}`;const n=localStorage.getItem("manga_auth_token"),r={};n&&(r.Authorization=`Bearer ${n}`),console.log("[Reader] Starting stream from:",a);const o=await fetch(a,{headers:r,signal:s});if(!o.ok)throw new Error(`Failed to start stream: ${o.statusText}`);const c=o.body.getReader(),l=new TextDecoder;let h="";for(;;){const{value:u,done:g}=await c.read();if(g||s.aborted)break;h+=l.decode(u,{stream:!0});const v=h.split(`

`);h=v.pop();let S=!1;for(const x of v)if(x.startsWith("data: ")){const f=x.substring(6);try{const I=JSON.parse(f);if(I.type==="metadata")i.manga.title=I.title,i.manga.alias=I.title,Oe();else if(I.type==="image"){const $=`/api/scrapers/proxy-cover?url=${encodeURIComponent(I.url)}`;i.images.push($),S=!0}else if(I.type==="error")d("Stream error: "+I.message,"error");else if(I.type==="done")break}catch(I){console.error("Parse error for SSE data:",I)}}S&&Se()}}catch(a){a.name!=="AbortError"&&(console.error("Preview stream error:",a),d("Stream failed: "+a.message,"error"))}finally{i._streamAbortController&&i._streamAbortController.signal===s&&(i._streamAbortController=null)}}async function fr(t=[]){console.log("[Reader] mount called with params:",t);let[e,s]=t,a=null;if(s&&s.includes("?")){const[r,o]=s.split("?");s=r,a=new URLSearchParams(o).get("version")}else{const r=window.location.hash.split("?")[1];r&&(a=new URLSearchParams(r).get("version"))}if(console.log("[Reader] mangaId:",e,"chapterNum:",s,"urlVersion:",a),!e||!s){q.go("/");return}const n=document.getElementById("app");if(i.loading=!0,console.log("[Reader] loading set to true, calling loadData..."),i.images=[],i.singlePageMode=!1,i._resumeScrollToPage=null,i.nextChapterImage=null,i.nextChapterNum=null,n.innerHTML=Pe(),a)await Ae(e,s,decodeURIComponent(a));else try{const r=await m.getBookmark(e),o=r.downloadedVersions||{},c=new Set(r.deletedChapterUrls||[]),l=o[parseFloat(s)];let h=[];if(Array.isArray(l)&&(h=l.filter(u=>!c.has(u))),h.length>1){let u=[];try{u=(await m.getChapterVersions(e,s)).versions||[]}catch{}const g=await ma(h,s,r,u);if(g===null){q.go(`/manga/${e}`);return}await Ae(e,s,g)}else h.length===1?await Ae(e,s,h[0]):await Ae(e,s)}catch(r){console.log("[Reader] Error in version check, falling back:",r),await Ae(e,s)}if(n.innerHTML=Pe(),console.log("[Reader] render called, loading:",i.loading,"manga:",!!i.manga,"images:",i.images.length),gt(),i.mode==="webtoon"&&i._resumeScrollToPage!=null){const r=i._resumeScrollToPage;i._resumeScrollToPage=null,setTimeout(()=>{const o=document.getElementById("reader-content");if(o){const c=o.querySelectorAll("img");c[r]&&c[r].scrollIntoView({behavior:"auto",block:"start"})}},300)}}async function vr(){console.log("[Reader] unmount called"),i._streamAbortController&&(i._streamAbortController.abort(),i._streamAbortController=null),Me&&(clearTimeout(Me),Me=null);const t=ua(),e=va();document.body.classList.remove("reader-active"),document.removeEventListener("keydown",fa),i.manga=null,i.chapter=null,i.versionUrl=null,i.images=[],i.loading=!0,i.singlePageMode=!1,i.isStreamingMode=!1,i._resumeScrollToPage=null,i._preloadCache=null,await De(t),await Ie(e)}function As(t){return!!t&&(t.mode!==void 0||t.direction!==void 0||t.firstPageSingle!==void 0||t.lastPageSingle!==void 0)}function _s(t){t&&(t.mode&&(i.mode=t.mode),t.direction&&(i.direction=t.direction),t.firstPageSingle!==void 0&&(i.firstPageSingle=t.firstPageSingle),t.lastPageSingle!==void 0&&(i.lastPageSingle=t.lastPageSingle))}function va(){return!i.manga||!i.chapter||i.isCollectionMode||i.isStreamingMode?null:{mangaId:i.manga.id,chapterNumber:i.chapter.number,settings:{mode:i.mode,direction:i.direction,firstPageSingle:i.firstPageSingle,lastPageSingle:i.lastPageSingle}}}async function Ie(t=va()){if(!(!t||Y.isDemo))try{await m.updateChapterSettings(t.mangaId,t.chapterNumber,t.settings)}catch(e){console.error("Failed to save settings:",e)}}async function ya(t){try{const e=await m.getBookmark(t),s=e.downloadedChapters||[],a=new Set(e.readChapters||[]),n=e.readingProgress||{},r=e.downloadedVersions||{},o=[...s].sort((l,h)=>l-h);let c=null;for(const l of o){const h=n[l];if(h&&h.page<h.totalPages&&!a.has(l)){c=l;break}}if(c===null){for(const l of o)if(!a.has(l)){c=l;break}}if(c===null&&o.length>0&&(c=o[0]),c!==null){const l=r[c]||[],h=Array.isArray(l)?l[0]:l,u=h?`?version=${encodeURIComponent(h)}`:"";q.go(`/read/${t}/${c}${u}`)}else d("No downloaded chapters to read","info")}catch(e){d("Failed to continue reading: "+e.message,"error")}}const yr={mount:fr,unmount:vr,render:Pe,continueReading:ya},Je=50;let b={manga:null,categories:[],currentPage:0,filter:"all",loading:!0,selectionMode:!1,selected:new Set,activeVolume:null,activeVolumeId:null,cbzFiles:[],manageChapters:!1,offlineChapters:new Set,isAutoOffline:!1,volumesCollapsed:!1};const ba=t=>`volumes_collapsed_${t}`;function br(t){var s;const e=localStorage.getItem(ba(t==null?void 0:t.id));return e!==null?e==="1":(((s=t==null?void 0:t.volumes)==null?void 0:s.length)||0)>8}function wr(t){if(!(t.autoCheck===!0))return`<button class="btn btn-secondary" id="schedule-btn">${p("alarm-clock")} Schedule</button>`;const s=t.checkSchedule==="weekly"?`${(t.checkDay||"monday").charAt(0).toUpperCase()+(t.checkDay||"monday").slice(1)} ${t.checkTime||"06:00"}`:t.checkSchedule==="daily"?`Daily ${t.checkTime||"06:00"}`:"Every 6h";return`<button class="btn btn-primary" id="schedule-btn">${p("alarm-clock")} ${s}</button>`}function kr(t){const e=t.autoCheck===!0,s=t.checkSchedule||"daily",a=t.checkDay||"monday",n=t.checkTime||"06:00",r=t.autoDownload||!1;return`
  ...
  `}function Wt(){var O;if(b.loading)return`
      ${ce()}
      <div class="container">
    ...
    `;const e=t.alias||t.title,s=t.chapters||[],a=new Set(t.downloadedChapters||[]),n=new Set(t.readChapters||[]),r=new Set(s.map(k=>k.number)).size,o=new Set(t.excludedChapters||[]),c=new Set(t.deletedChapterUrls||[]),l=t.volumes||[],h=new Set;l.forEach(k=>{(k.chapters||[]).forEach(L=>h.add(L))});let u;b.filter==="hidden"?u=s.filter(k=>o.has(k.number)||c.has(k.url)):u=s.filter(k=>!o.has(k.number)&&!c.has(k.url));const g=u.filter(k=>!h.has(k.number));let v=[];if(b.activeVolume){const k=new Set(b.activeVolume.chapters||[]);v=u.filter(L=>k.has(L.number))}else v=g;const S=new Map;v.forEach(k=>{S.has(k.number)||S.set(k.number,[]),S.get(k.number).push(k)});let x=Array.from(S.entries()).sort((k,L)=>k[0]-L[0]);b.filter==="downloaded"?x=x.filter(([k])=>a.has(k)):b.filter==="not-downloaded"?x=x.filter(([k])=>!a.has(k)):b.filter==="main"?x=x.filter(([k])=>Number.isInteger(k)):b.filter==="extra"&&(x=x.filter(([k])=>!Number.isInteger(k)));const f=Math.max(1,Math.ceil(x.length/Je));b.currentPage>=f&&(b.currentPage=Math.max(0,f-1));const I=b.currentPage*Je,A=[...x.slice(I,I+Je)].reverse(),D=S.size,R=[...S.keys()].filter(k=>a.has(k)).length;n.size;let F="";if(b.activeVolume){const k=b.activeVolume;let L=null;k.local_cover?L=`/api/public/covers/${t.id}/${encodeURIComponent(k.local_cover.split(/[/\\]/).pop())}`:k.cover&&(L=k.cover),F=`
      ${ce()}
      <div class="container">
        <div class="manga-detail">
          <div class="manga-detail-header">
            <div class="manga-detail-cover">
              ${L?`<img src="${L}" alt="${k.name}">`:pe("book")}
            </div>
      ...
      `}else{const k=t.localCover?`/api/public/covers/${t.id}/${encodeURIComponent(t.localCover.split(/[/\\]/).pop())}`:t.cover;F=`
        ${ce()}
        <div class="container">
          <div class="manga-detail">
            <div class="manga-detail-header">
    ...
    ${F}
        ...
        ${b.activeVolume?b.manageChapters?Br(t,g):"":Ar(t,a)}
  ...
  `}function $r(){const t=b.manga;if(!t)return"";const e=t.alias||t.title;return`
  ...
  `}function Er(){const t=b.manga;return t?`
  ...
  `:""}function Cr(){const t=b.manga;return t?`
  ...
  `}function Lr(t,e,s,a,n){var Z,w,B,M,E;const r=s.has(t),o=a.has(t),c=!Number.isInteger(t),l=((Z=n.downloadedVersions)==null?void 0:Z[t])||[],h=new Set(n.deletedChapterUrls||[]),u=e.filter(y=>b.filter==="hidden"?!0:!h.has(y.url)),g=!!b.activeVolume,v=n.chapterSettings||{},S=g?!0:!!((w=v[t])!=null&&w.locked);let x=u;if(g||S){const y=u.filter(T=>Array.isArray(l)?l.includes(T.url):l===T.url);x=y.length>0?y:u}x.sort((y,T)=>{const N=Array.isArray(l)?l.includes(y.url):l===y.url;return((Array.isArray(l)?l.includes(T.url):l===T.url)?1:0)-(N?1:0)});const f=((B=n.chapterFolders)==null?void 0:B[t])||[],I=f.filter(y=>!y.url),$=f.reduce((y,T)=>Math.max(y,T.imageCount),0),A=y=>y.imageCount<3||$>=6&&y.imageCount<$/2,D=y=>f.find(T=>T.url===y)||null,R=f.filter(y=>y.url&&A(y)),F=x.length>1||I.length>0,O=(M=x[0])!=null&&M.url?encodeURIComponent(x[0].url):null,k=["chapter-item",r?"downloaded":"",o?"read":"",c?"extra":""].filter(Boolean).join(" "),L=Array.isArray(l)?l:l?[l]:[],P=L.length,Q=F?`
    <div class="versions-dropdown hidden" id="versions-${t}">
      ${x.map(y=>{const T=encodeURIComponent(y.url),N=L.includes(y.url),W=y.url.startsWith("local://"),U=y.title&&y.title!==`Chapter ${t}`?y.title:"",se=U||y.releaseGroup||"Version",j=[U&&y.releaseGroup?y.releaseGroup:"",Ir(y.uploadedAt)].filter(Boolean).join(" · ");return`
          <div class="version-row ${N?"downloaded":""}"
               data-version-url="${T}" data-num="${t}">
            <span class="version-title" style="cursor: pointer; flex: 1;" title="${Mt(y.url)}">${lt(se)}${W?' <span class="badge badge-local" style="background: var(--color-info, #2196f3); color: white; font-size: 0.65em; padding: 1px 5px; border-radius: 3px; margin-left: 6px; vertical-align: middle;">Local</span>':""}${j?`<span class="version-meta">${lt(j)}</span>`:""}${(()=>{const K=N?D(y.url):null;if(!K)return"";const le=A(K);return`<span class="version-meta version-pages ${le?"warn":""}" title="${Mt(K.folder)}">${K.imageCount} pages${le?" - incomplete?":""}</span>`})()}</span>
            <div class="version-actions">
              ${N?`<button class="btn-icon small success" data-action="read-version" data-num="${t}" data-url="${T}">${p("play",{title:"Read"})}</button>
      ...
      ${I.map(y=>`
          <div class="version-row orphan" data-num="${t}">
            <span class="version-title" title="${Mt(y.folder)}">Leftover folder on disk<span class="version-meta">${lt(y.folder)} · ${y.imageCount} pages</span></span>
            <div class="version-actions">
  ...
  `}function Ir(t){if(!t)return"";const e=new Date(t);return isNaN(e.getTime())?String(t).slice(0,10):e.toISOString().slice(0,10)}function lt(t){return String(t).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function Mt(t){return lt(t).replace(/"/g,"&quot;")}function Ms(t){return`
  ...
  `}function Br(t,e){return e.length===0?`
  ...
  `}function Ar(t,e){var o;const s=t.volumes||[];if(s.length===0)return"";const a=s.map(c=>{const l=c.chapters||[],h=l.filter(u=>e.has(u)).length;return`
  ...
  `}function _r(){var n,r,o,c,l,h,u,g,v,S,x,f,I,$,A,D,R,F,O,k,L,P,Q,G,Z;const t=document.getElementById("app"),e=b.manga;if(!e)return;(n=document.getElementById("back-btn"))==null||n.addEventListener("click",()=>q.go("/")),(r=document.getElementById("back-library-btn"))==null||r.addEventListener("click",()=>q.go("/")),t.querySelectorAll(".artist-link").forEach(w=>{w.addEventListener("click",async B=>{B.preventDefault();const M=w.dataset.artist;if(!M)return;localStorage.setItem("library_search",M),localStorage.removeItem("library_artist_filter");let E=null;try{const y=e.website;if(y&&y!=="Local"){const N=(window._scrapersList||(window._scrapersList=(await m.get("/scrapers/list")).scrapers)||[]).find(W=>W.name===y);N&&N.supportsBrowse&&(E=y)}}catch{}E?(localStorage.setItem("library_search_author",M),localStorage.setItem("library_search_author_source",E)):(localStorage.removeItem("library_search_author"),localStorage.removeItem("library_search_author_source")),q.go("/")})}),(o=document.getElementById("continue-btn"))==null||o.addEventListener("click",()=>{ya(e.id)}),(c=document.getElementById("download-all-btn"))==null||c.addEventListener("click",()=>{const w=document.getElementById("download-all-modal");w&&w.classList.add("open")}),(l=document.getElementById("confirm-download-all-btn"))==null||l.addEventListener("click",async()=>{var w;try{d("Queueing downloads...","info");const B=document.getElementsByName("download-version-mode");let M="single";for(const y of B)y.checked&&(M=y.value);(w=document.getElementById("download-all-modal"))==null||w.classList.remove("open");const E=await m.post(`/bookmarks/${e.id}/download`,{all:!0,versionMode:M});E.chaptersCount>0?d(`Download queued: ${E.chaptersCount} versions`,"success"):d("Already have these chapters downloaded","info")}catch(B){d("Failed to download: "+B.message,"error")}}),(h=document.getElementById("check-updates-btn"))==null||h.addEventListener("click",async()=>{try{d("Checking for updates...","info"),await m.post(`/bookmarks/${e.id}/quick-check`),d("Check complete!","success")}catch(w){d("Check failed: "+w.message,"error")}}),(u=document.getElementById("schedule-btn"))==null||u.addEventListener("click",()=>{const w=document.getElementById("schedule-modal");w&&w.classList.add("open")}),(g=document.getElementById("schedule-type"))==null||g.addEventListener("change",w=>{const B=document.getElementById("schedule-day-group");B&&(B.style.display=w.target.value==="weekly"?"":"none")}),(v=document.getElementById("save-schedule-btn"))==null||v.addEventListener("click",async()=>{var w;try{const B=document.getElementById("schedule-type").value,M=document.getElementById("schedule-day").value,E=document.getElementById("schedule-time").value,y=document.getElementById("auto-download-toggle").checked;await m.updateAutoCheckSchedule(e.id,{enabled:!0,schedule:B,day:M,time:E,autoDownload:y}),b.manga.checkSchedule=B,b.manga.checkDay=M,b.manga.checkTime=E,b.manga.autoDownload=y,(w=document.getElementById("schedule-modal"))==null||w.classList.remove("open"),V([e.id]),d("Schedule updated","success")}catch(B){d("Failed to save schedule: "+B.message,"error")}}),(S=document.getElementById("disable-schedule-btn"))==null||S.addEventListener("click",async()=>{var w;try{await m.toggleAutoCheck(e.id,!1),b.manga.autoCheck=!1,b.manga.checkSchedule=null,b.manga.checkDay=null,b.manga.checkTime=null,b.manga.nextCheck=null,(w=document.getElementById("schedule-modal"))==null||w.classList.remove("open"),V([e.id]),d("Auto-check disabled","success")}catch(B){d("Failed to disable: "+B.message,"error")}}),(x=document.getElementById("refresh-btn"))==null||x.addEventListener("click",async()=>{const w=document.getElementById("refresh-btn");try{w.disabled=!0,w.innerHTML=`${p("loader",{spin:!0})} Checking...`,d("Checking for updates...","info"),await m.post(`/bookmarks/${e.id}/check`),await J(e.id),V([e.id]),d("Check complete!","success")}catch(B){d("Check failed: "+B.message,"error"),w&&(w.disabled=!1,w.innerHTML=`${p("refresh-cw")} Refresh`)}}),(f=document.getElementById("scan-folder-btn"))==null||f.addEventListener("click",async()=>{var B,M;const w=document.getElementById("scan-folder-btn");try{w.disabled=!0,w.innerHTML=`${p("loader",{spin:!0})} Scanning...`,d("Scanning folder...","info");const E=await m.scanBookmark(e.id);await J(e.id),V([e.id]);const y=((B=E.addedChapters)==null?void 0:B.length)||0,T=((M=E.removedChapters)==null?void 0:M.length)||0;y>0||T>0?d(`Scan complete: ${y} added, ${T} removed`,"success"):d("Scan complete: No changes","info")}catch(E){d("Scan failed: "+E.message,"error")}finally{w&&(w.disabled=!1,w.innerHTML=`${p("folder")} Scan Folder`)}}),document.querySelectorAll("[data-cbz-path]").forEach(w=>{w.addEventListener("click",async()=>{const B=decodeURIComponent(w.dataset.cbzPath),M=parseInt(w.dataset.cbzChapter)||1,E=w.dataset.cbzExtracted==="true",y=prompt("Enter chapter number for extraction:",String(M));if(!y)return;const T=parseFloat(y);if(isNaN(T)){d("Invalid chapter number","error");return}try{w.disabled=!0,w.textContent="Extracting...",d("Extracting CBZ...","info"),await m.extractCbz(e.id,B,T,{forceReExtract:E}),d("CBZ extracted successfully!","success"),await J(e.id),V([e.id])}catch(N){d("Extract failed: "+N.message,"error")}finally{w.disabled=!1,w.textContent=E?"Re-Extract":"Extract"}})}),(I=document.getElementById("edit-btn"))==null||I.addEventListener("click",async()=>{const w=document.getElementById("edit-manga-modal");if(w){document.getElementById("edit-alias-input").value=e.alias||"",window._selectedCoverPath=null;try{const[B,M]=await Promise.all([m.getAllArtists(),m.getAllCategories()]),E=document.getElementById("artist-list"),y=document.getElementById("category-list");window._allArtists=B,window._allCategories=M,E&&(E.innerHTML=B.map(W=>`<option value="${W}">`).join("")),y&&(y.innerHTML=M.map(W=>`<option value="${W}">`).join(""));const T=document.getElementById("edit-artist-input"),N=document.getElementById("edit-categories-input");T==null||T.addEventListener("input",()=>{const W=T.value.toLowerCase(),U=T.value.lastIndexOf(","),se=T.value.substring(U+1).trim().toLowerCase();if(se.length>0&&window._allArtists){const j=window._allArtists.filter(K=>K.toLowerCase().includes(se));if(E&&j.length>0){const K=U>=0?T.value.substring(0,U+1)+" ":"";E.innerHTML=j.map(le=>`<option value="${K}${le}">`).join("")}}}),N==null||N.addEventListener("input",()=>{const W=N.value.lastIndexOf(","),U=N.value.substring(W+1).trim().toLowerCase();if(U.length>0&&window._allCategories){const se=window._allCategories.filter(j=>j.toLowerCase().includes(U));if(y&&se.length>0){const j=W>=0?N.value.substring(0,W+1)+" ":"";y.innerHTML=se.map(K=>`<option value="${j}${K}">`).join("")}}})}catch(B){console.error("Failed to load artists/categories:",B)}w.classList.add("open")}}),($=document.getElementById("save-manga-btn"))==null||$.addEventListener("click",async()=>{var w;try{const B=document.getElementById("edit-alias-input").value.trim(),M=document.getElementById("edit-artist-input").value.trim(),E=document.getElementById("edit-categories-input").value.trim(),y=M?M.split(",").map(N=>N.trim()).filter(N=>N):[],T=E?E.split(",").map(N=>N.trim()).filter(N=>N):[];await m.updateBookmark(e.id,{alias:B||null}),await m.setBookmarkArtists(e.id,y),await m.setBookmarkCategories(e.id,T),window._selectedCoverPath&&await m.setBookmarkCoverFromImage(e.id,window._selectedCoverPath),b.manga.alias=B||null,b.manga.artists=y,b.manga.categories=T,(w=document.getElementById("edit-manga-modal"))==null||w.classList.remove("open"),V([e.id]),d("Manga updated","success")}catch(B){d("Failed to update: "+B.message,"error")}}),(A=document.getElementById("change-cover-btn"))==null||A.addEventListener("click",async()=>{try{d("Loading images...","info");const w=await m.getFolderImages(e.id);if(w.length===0){d("No images found in manga folder","warning");return}const B=document.createElement("div");B.id="cover-select-modal",B.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.8);z-index:10000;display:flex;align-items:center;justify-content:center;",B.innerHTML=`
      ...
      `,document.body.appendChild(B),document.getElementById("close-cover-modal").addEventListener("click",()=>B.remove()),B.addEventListener("click",M=>{M.target===B&&B.remove()}),B.querySelectorAll(".cover-option").forEach(M=>{M.addEventListener("click",()=>{window._selectedCoverPath=M.dataset.path;const E=document.getElementById("cover-preview");E&&(E.innerHTML=`<img src="/api/proxy-image?path=${encodeURIComponent(window._selectedCoverPath)}" style="width:100%;height:100%;object-fit:cover;">`),B.remove(),d("Cover selected","success")})})}catch(w){d("Failed to load images: "+w.message,"error")}}),(D=document.getElementById("delete-manga-btn"))==null||D.addEventListener("click",()=>{const w=document.getElementById("delete-manga-modal");w&&w.classList.add("open")}),(R=document.getElementById("confirm-delete-manga-btn"))==null||R.addEventListener("click",async()=>{var B,M;const w=((B=document.getElementById("delete-files-toggle"))==null?void 0:B.checked)||!1;try{await m.deleteBookmark(e.id,w),(M=document.getElementById("delete-manga-modal"))==null||M.classList.remove("open"),d("Manga deleted","success"),q.go("/")}catch(E){d("Failed to delete: "+E.message,"error")}}),(F=document.getElementById("quick-check-btn"))==null||F.addEventListener("click",async()=>{const w=document.getElementById("quick-check-btn");try{w.disabled=!0,w.innerHTML=`${p("loader",{spin:!0})} Checking...`,d("Quick checking for updates...","info");const B=await m.post(`/bookmarks/${e.id}/quick-check`);await J(e.id),V([e.id]),B.newChaptersCount>0?d(`Found ${B.newChaptersCount} new chapter(s)!`,"success"):d("No new chapters found","info")}catch(B){d("Quick check failed: "+B.message,"error")}finally{w&&(w.disabled=!1,w.innerHTML=`${p("zap")} Quick Check`)}}),(O=document.getElementById("source-label"))==null||O.addEventListener("click",async()=>{const w=document.getElementById("migrate-source-modal");if(w){w.classList.add("open");const B=document.getElementById("migrate-search-scraper");if(B&&B.options.length<=1)try{const M=await m.get("/scrapers/list");if(M.success){const E=M.scrapers.filter(y=>y.supportsSearch);B.innerHTML='<option value="all">All Sources</option>'+E.map(y=>`<option value="${y.name}">${y.name}</option>`).join(""),B.value="all"}}catch(M){console.warn("Failed to load scrapers:",M)}}});const s=async()=>{var T,N,W;const w=(N=(T=document.getElementById("migrate-search-input"))==null?void 0:T.value)==null?void 0:N.trim(),B=(W=document.getElementById("migrate-search-scraper"))==null?void 0:W.value;if(!w)return;const M=document.getElementById("migrate-search-loading"),E=document.getElementById("migrate-search-results"),y=document.getElementById("migrate-results-grid");M.style.display="block",E.style.display="none";try{const se=(await m.get(`/scrapers/search?q=${encodeURIComponent(w)}&scraper=${encodeURIComponent(B)}`)).results||[];se.length===0?y.innerHTML='<p class="text-muted" style="text-align: center; padding: 20px;">No results found</p>':(y.innerHTML=se.map(j=>{var le;const K=(le=j.cover)!=null&&le.startsWith("/covers/")?j.cover:j.cover?`/api/scrapers/proxy-cover?url=${encodeURIComponent(j.cover)}`:"";return`
          ...
          `}).join(""),y.querySelectorAll(".migrate-result-card").forEach(j=>{j.addEventListener("click",()=>{var le;const K=j.dataset.url;document.getElementById("migrate-url-input").value=K,y.querySelectorAll(".migrate-result-card").forEach(Fe=>Fe.style.outline=""),j.style.outline="2px solid var(--color-primary)",d(`Selected: ${(le=j.querySelector(".manga-card-title"))==null?void 0:le.textContent}`,"info")})})),M.style.display="none",E.style.display="block"}catch(U){M.style.display="none",d("Search failed: "+U.message,"error")}};(k=document.getElementById("migrate-search-btn"))==null||k.addEventListener("click",s),(L=document.getElementById("migrate-search-input"))==null||L.addEventListener("keydown",w=>{w.key==="Enter"&&s()}),(P=document.getElementById("confirm-migrate-btn"))==null||P.addEventListener("click",async()=>{var M,E,y;const w=(E=(M=document.getElementById("migrate-url-input"))==null?void 0:M.value)==null?void 0:E.trim();if(!w){d("Please enter a URL","warning");return}const B=document.getElementById("confirm-migrate-btn");try{B.disabled=!0,B.textContent="Migrating...",d("Migrating source...","info");const T=await m.migrateSource(e.id,w);d(`Migrated! ${T.migratedChapters} chapters preserved as local`,"success"),d("Running full check on new source...","info"),await m.post(`/bookmarks/${e.id}/check`),(y=document.getElementById("migrate-source-modal"))==null||y.classList.remove("open"),await J(e.id),V([e.id]),d("Source migration complete!","success")}catch(T){d("Migration failed: "+T.message,"error")}finally{B&&(B.disabled=!1,B.textContent="Migrate Source")}}),(Q=document.getElementById("anilist-track-btn"))==null||Q.addEventListener("click",()=>{var w;(w=document.getElementById("anilist-modal"))==null||w.classList.add("open"),vt()});const a=async()=>{var y,T;const w=(T=(y=document.getElementById("anilist-search-input"))==null?void 0:y.value)==null?void 0:T.trim();if(!w)return;const B=document.getElementById("anilist-search-loading"),M=document.getElementById("anilist-search-results"),E=document.getElementById("anilist-results-list");B.style.display="block",M.style.display="none";try{const W=(await m.anilistSearch(w)).results||[];W.length===0?E.innerHTML='<p class="text-muted" style="text-align: center; padding: 20px;">No results found</p>':(E.innerHTML=W.map(U=>{var K,le,Fe,vs,ys,bs,ws;const se=((K=U.title)==null?void 0:K.romaji)||((le=U.title)==null?void 0:le.english)||((Fe=U.title)==null?void 0:Fe.native)||"Unknown",j=(vs=U.title)!=null&&vs.english&&U.title.english!==se?U.title.english:(ys=U.title)!=null&&ys.native&&U.title.native!==se?U.title.native:"";return`
            <div style="display: flex; gap: 10px; align-items: center; padding: 8px; border: 1px solid var(--border-color); border-radius: 6px; margin-bottom: 8px;">
              ${(bs=U.coverImage)!=null&&bs.medium?`<img src="${U.coverImage.medium}" alt="" style="width: 48px; height: 68px; object-fit: cover; border-radius: 4px; flex-shrink: 0;">`:""}
              <div style="flex: 1; min-width: 0;">
                <div style="overflow: hidden; text-overflow: ellipsis; white-space: nowrap;" title="${se}"><strong>${se}</strong></div>
                <div class="text-muted" style="font-size: 0.8em;">
                  ${[j,U.format,(ws=U.startDate)==null?void 0:ws.year,`${U.chapters??"?"} ch`].filter(Boolean).join(" • ")}
                </div>
              </div>
              <button class="btn btn-small btn-primary anilist-link-result-btn" data-id="${U.id}" data-title="${se.replace(/"/g,"&quot;")}">Link</button>
            </div>
          `}).join(""),E.querySelectorAll(".anilist-link-result-btn").forEach(U=>{U.addEventListener("click",async()=>{var se,j;try{U.disabled=!0,U.textContent="Linking...";const K=await m.anilistMap(e.id,Number(U.dataset.id)),le=((se=K.mapping)==null?void 0:se.anilist_title)||U.dataset.title,Fe=(j=K.pull)!=null&&j.markedUpTo?` — pulled progress up to ch. ${K.pull.markedUpTo}`:"";d(`Linked to AniList: ${le}${Fe}`,"success"),vt()}catch(K){U.disabled=!1,U.textContent="Link",d("Failed to link: "+K.message,"error")}})})),B.style.display="none",M.style.display="block"}catch(N){B.style.display="none",d("AniList search failed: "+N.message,"error")}};(G=document.getElementById("anilist-search-btn"))==null||G.addEventListener("click",a),(Z=document.getElementById("anilist-search-input"))==null||Z.addEventListener("keydown",w=>{w.key==="Enter"&&a()}),t.querySelectorAll(".filter-btn").forEach(w=>{w.addEventListener("click",()=>{b.filter=w.dataset.filter,b.currentPage=0,V([e.id])})}),t.querySelectorAll("[data-page]").forEach(w=>{w.addEventListener("click",()=>{const B=w.dataset.page,M=Math.ceil(b.manga.chapters.length/Je);switch(B){case"first":b.currentPage=0;break;case"prev":b.currentPage=Math.max(0,b.currentPage-1);break;case"next":b.currentPage=Math.min(M-1,b.currentPage+1);break;case"last":b.currentPage=M-1;break}V([e.id])})}),t.querySelectorAll(".chapter-item").forEach(w=>{w.addEventListener("click",B=>{var y;if(B.target.closest(".chapter-actions"))return;const M=parseFloat(w.dataset.num);if((e.downloadedChapters||[]).includes(M)){const T=((y=e.downloadedVersions)==null?void 0:y[M])||[],N=Array.isArray(T)?T[0]:T;N?q.go(`/read/${e.id}/${M}?version=${encodeURIComponent(N)}`):q.go(`/read/${e.id}/${M}`)}else d("Chapter not downloaded","info")})}),t.querySelectorAll("[data-action]").forEach(w=>{w.addEventListener("click",async B=>{B.stopPropagation();const M=w.dataset.action,E=parseFloat(w.dataset.num),y=w.dataset.url?decodeURIComponent(w.dataset.url):null;switch(M){case"lock":await Mr(E);break;case"read":await Tr(E);break;case"download":await Pr(E);break;case"versions":Rr(E);break;case"read-version":q.go(`/read/${e.id}/${E}?version=${encodeURIComponent(y)}`);break;case"download-version":await Fr(E,y);break;case"delete-version":await Nr(E,y);break;case"keep-version":await Dr(E,y);break;case"delete-folder":await qr(E,decodeURIComponent(w.dataset.folder||""));break;case"hide-version":await Or(E,y);break;case"restore-version":await Ur(E,y);break;case"restore-chapter":await Hr(E);break;case"delete-chapter":await Vr(E,y);break;case"hide-chapter":await zr(E,y);break;case"unhide-chapter":await jr(E,y);break}})}),t.querySelectorAll(".version-row .version-title").forEach(w=>{w.addEventListener("click",B=>{B.stopPropagation();const M=w.closest(".version-row"),E=parseFloat(M.dataset.num),y=M.dataset.versionUrl?decodeURIComponent(M.dataset.versionUrl):null;M.classList.contains("downloaded")&&y?q.go(`/read/${e.id}/${E}?version=${encodeURIComponent(y)}`):d("Version not downloaded yet","info")})}),t.querySelectorAll(".volume-card").forEach(w=>{w.addEventListener("click",()=>{const B=w.dataset.volumeId;q.go(`/manga/${e.id}/volume/${B}`)})}),Kr(t),Le(),ee.subscribeToManga(e.id)}async function Mr(t){var n;const e=b.manga,s=((n=e.chapterSettings)==null?void 0:n[t])||{},a=!s.locked;try{a?await m.lockChapter(e.id,t):await m.unlockChapter(e.id,t),e.chapterSettings||(e.chapterSettings={}),e.chapterSettings[t]={...s,locked:a},d(a?"Chapter locked":"Chapter unlocked","success"),V([e.id])}catch(r){d("Failed: "+r.message,"error")}}async function Tr(t){const e=b.manga,s=new Set(e.readChapters||[]),a=s.has(t);try{await m.post(`/bookmarks/${e.id}/chapters/${t}/read`,{isRead:!a}),a?s.delete(t):s.add(t),e.readChapters=[...s],d(a?"Marked unread":"Marked read","success"),V([e.id])}catch(n){d("Failed: "+n.message,"error")}}async function Pr(t){const e=b.manga,s=new Set(e.deletedChapterUrls||[]),a=(e.chapters||[]).find(n=>n.number===t&&!s.has(n.url));try{d(`Downloading chapter ${t}...`,"info");let n;a?n=await m.post(`/bookmarks/${e.id}/download-version`,{chapterNumber:t,url:a.url}):n=await m.post(`/bookmarks/${e.id}/download`,{chapters:[t]}),d("Download queued!","success"),wa(n==null?void 0:n.taskId,`Chapter ${t}`)}catch(n){d("Failed: "+n.message,"error")}}function Rr(t){document.querySelectorAll(".versions-dropdown").forEach(s=>{s.id!==`versions-${t}`&&s.classList.add("hidden")});const e=document.getElementById(`versions-${t}`);e&&e.classList.toggle("hidden")}async function qr(t,e){const s=b.manga;if(e&&confirm(`Delete the folder "${e}" from disk?`))try{await m.deleteChapterFolder(s.id,t,e),d("Folder deleted","success"),await J(s.id),V([s.id])}catch(a){d("Failed: "+a.message,"error")}}function wa(t,e){var r;if(!t)return;const s=(r=b.manga)==null?void 0:r.id,a=Date.now(),n=async()=>{var u,g;if(Date.now()-a>30*60*1e3)return;let o;try{o=await m.getDownloadProgress(t)}catch{return}if(!o)return;if(!["complete","error","cancelled"].includes(o.status)){setTimeout(n,3e3);return}const l=o.errors||[],h=(o.completedChapters||[]).length>0&&o.status!=="error";o.status==="cancelled"?d(`${e}: download cancelled`,"info"):h?l.length?d(`${e} downloaded with problems: ${l[0].error}`,"warning"):d(`${e} downloaded${o.pages?` (${o.pages} pages)`:""}`,"success"):d(`${e} failed: ${((u=l[0])==null?void 0:u.error)||"unknown error"}`,"error"),((g=b.manga)==null?void 0:g.id)===s&&window.location.hash.startsWith(`#/manga/${s}`)&&(await J(s),V([s]))};setTimeout(n,3e3)}async function Dr(t,e){var c;const s=b.manga,a=((c=s.downloadedVersions)==null?void 0:c[t])||[],r=(Array.isArray(a)?a:[a]).filter(l=>l&&l!==e);if(r.length===0){d("This is the only downloaded version","info");return}if(!confirm(`Delete the other ${r.length} downloaded version${r.length>1?"s":""} of chapter ${t}?`))return;let o=0;for(const l of r)try{await m.request(`/bookmarks/${s.id}/chapters`,{method:"DELETE",body:JSON.stringify({chapterNumber:t,url:l})})}catch(h){o++,d("Failed to delete a version: "+h.message,"error")}o===0&&d("Other versions deleted","success"),await J(s.id),V([s.id])}async function Fr(t,e){const s=b.manga;try{d("Downloading version...","info");const a=await m.post(`/bookmarks/${s.id}/download-version`,{chapterNumber:t,url:e});d("Download queued!","success"),wa(a==null?void 0:a.taskId,`Chapter ${t}`)}catch(a){d("Failed: "+a.message,"error")}}async function Nr(t,e){const s=b.manga;try{await m.request(`/bookmarks/${s.id}/chapters`,{method:"DELETE",body:JSON.stringify({chapterNumber:t,url:e})}),d("Version deleted","success"),await J(s.id),V([s.id])}catch(a){d("Failed: "+a.message,"error")}}async function Or(t,e){const s=b.manga;try{await m.hideVersion(s.id,t,e),d("Version hidden","success"),await J(s.id),V([s.id])}catch(a){d("Failed: "+a.message,"error")}}async function Ur(t,e){const s=b.manga;try{await m.unhideVersion(s.id,t,e),d("Version restored","success"),await J(s.id),V([s.id])}catch(a){d("Failed to restore version: "+a.message,"error")}}async function Hr(t){const e=b.manga;try{await m.unexcludeChapter(e.id,t),d("Chapter restored","success"),await J(e.id),V([e.id])}catch(s){d("Failed to restore chapter: "+s.message,"error")}}async function Vr(t,e){const s=b.manga;if(confirm("Delete this chapter's files from disk?"))try{await m.request(`/bookmarks/${s.id}/chapters`,{method:"DELETE",body:JSON.stringify({chapterNumber:t,url:e})}),d("Chapter files deleted","success"),await J(s.id),V([s.id])}catch(a){d("Failed to delete: "+a.message,"error")}}async function zr(t,e){const s=b.manga;if(confirm("Hide this chapter? It will be moved to the Hidden filter."))try{await m.hideVersion(s.id,t,e),d("Chapter hidden","success"),await J(s.id),V([s.id])}catch(a){d("Failed to hide chapter: "+a.message,"error")}}async function jr(t,e){const s=b.manga;try{await m.unhideVersion(s.id,t,e),d("Chapter unhidden","success"),await J(s.id),V([s.id])}catch(a){d("Failed to unhide chapter: "+a.message,"error")}}async function J(t){try{const[e,s]=await Promise.all([m.getBookmark(t),Y.isDemo?Promise.resolve([]):ue.loadCategories()]);if(b.manga=e,b.categories=s,b.loading=!1,b.volumesCollapsed=br(e),e.website==="Local")try{const r=await m.getCbzFiles(t);b.cbzFiles=r||[]}catch(r){console.error("Failed to load CBZ files:",r),b.cbzFiles=[]}else b.cbzFiles=[];const a=new Set((e.chapters||[]).map(r=>r.number)).size,n=Math.ceil(a/Je);b.currentPage=Math.max(0,n-1),b.activeVolumeId?b.activeVolume=(e.volumes||[]).find(r=>r.id===b.activeVolumeId):b.activeVolume=null}catch{d("Failed to load manga","error"),b.loading=!1}}async function V(t=[]){const[e,s,a]=t;if(!e){q.go("/");return}b.activeVolumeId=s==="volume"?a:null;const n=document.getElementById("app");!b.manga||b.manga.id!==e?(b.loading=!0,b.manga=null,n.innerHTML=Wt(),await J(e)):b.activeVolumeId?b.activeVolume=(b.manga.volumes||[]).find(r=>r.id===b.activeVolumeId):b.activeVolume=null,n.innerHTML=Wt(),_r(),vt()}function Qr(){b.manga&&ee.unsubscribeFromManga(b.manga.id),b.manga=null,b.loading=!0}const Wr={mount:V,unmount:Qr,render:Wt};function Gr(){return`
  ...
  `}function Kr(t){const e=b.manga;if(!e)return;const s=t.querySelector("#volumes-toggle-btn");s&&s.addEventListener("click",()=>{b.volumesCollapsed=!b.volumesCollapsed,localStorage.setItem(ba(e.id),b.volumesCollapsed?"1":"0");const f=t.querySelector(".volumes-section");f==null||f.classList.toggle("collapsed",b.volumesCollapsed),s.setAttribute("aria-expanded",String(!b.volumesCollapsed)),s.title=b.volumesCollapsed?"Expand volumes":"Collapse volumes";const I=s.querySelector("svg");I&&(I.outerHTML=p(b.volumesCollapsed?"chevron-down":"chevron-up"))});const a=t.querySelector("#add-volume-btn"),n=t.querySelector("#add-volume-modal"),r=t.querySelector("#add-volume-submit-btn");a&&n&&a.addEventListener("click",()=>{n.classList.add("open"),t.querySelector("#add-volume-name-input").focus()}),n==null||n.querySelectorAll(".modal-close, .modal-close-btn, .modal-overlay").forEach(f=>{f.addEventListener("click",()=>n.classList.remove("open"))}),r&&r.addEventListener("click",async()=>{const f=t.querySelector("#add-volume-name-input").value.trim();if(!f)return d("Please enter a volume name","error");try{r.disabled=!0,r.textContent="Creating...",await m.createVolume(e.id,f),d("Volume created successfully!","success"),n.classList.remove("open"),t.querySelector("#add-volume-name-input").value="",await J(e.id),V([e.id])}catch(I){d("Failed to create volume: "+I.message,"error")}finally{r.disabled=!1,r.textContent="Create Volume"}});const o=t.querySelector("#manage-chapters-btn");o&&o.addEventListener("click",()=>{b.manageChapters=!b.manageChapters,V([e.id,"volume",b.activeVolumeId])}),t.querySelectorAll(".add-to-vol-btn").forEach(f=>{f.addEventListener("click",async()=>{const I=parseFloat(f.dataset.num),$=b.activeVolume;if($)try{f.disabled=!0,f.textContent="...";const A=$.chapters||[];if(A.includes(I))return;const D=[...A,I].sort((R,F)=>R-F);await m.updateVolumeChapters(e.id,$.id,D),d(`Chapter ${I} added to volume`,"success"),await J(e.id),V([e.id,"volume",$.id])}catch(A){d("Failed to add chapter: "+A.message,"error"),f.disabled=!1,f.textContent="Add"}})}),t.querySelectorAll(".remove-from-vol-btn").forEach(f=>{f.addEventListener("click",async I=>{I.stopPropagation();const $=parseFloat(f.dataset.num),A=b.activeVolume;if(A)try{f.disabled=!0,f.textContent="...";const R=(A.chapters||[]).filter(F=>F!==$);await m.updateVolumeChapters(e.id,A.id,R),d(`Chapter ${$} removed from volume`,"success"),await J(e.id),V([e.id,"volume",A.id])}catch(D){d("Failed to remove chapter: "+D.message,"error"),f.disabled=!1,f.textContent="×"}})});const c=t.querySelector("#edit-vol-btn"),l=t.querySelector("#edit-volume-modal");c&&l&&c.addEventListener("click",()=>{const f=c.dataset.volId,I=e.volumes.find($=>$.id===f);I&&(t.querySelector("#volume-name-input").value=I.name,l.dataset.editingVolId=f,l.classList.add("open"))});const h=t.querySelector("#save-volume-btn");h&&h.addEventListener("click",async()=>{const f=l.dataset.editingVolId,I=t.querySelector("#volume-name-input").value.trim();if(!I)return d("Volume name cannot be empty","error");try{await m.renameVolume(e.id,f,I),d("Volume renamed","success"),l.classList.remove("open"),await J(e.id),V([e.id,"volume",f])}catch($){d($.message,"error")}});const u=t.querySelector("#delete-volume-btn");u&&u.addEventListener("click",async()=>{if(!confirm("Are you sure you want to delete this volume? Chapters will remain in the library."))return;const f=l.dataset.editingVolId;try{await m.deleteVolume(e.id,f),d("Volume deleted","success"),l.classList.remove("open"),window.location.hash=`#/manga/${e.id}`}catch(I){d(I.message,"error")}});const g=t.querySelector("#vol-cover-upload-btn");if(g){let f=document.getElementById("vol-cover-input-hidden");f||(f=document.createElement("input"),f.type="file",f.id="vol-cover-input-hidden",f.accept="image/*",f.style.display="none",document.body.appendChild(f),f.addEventListener("change",async I=>{const $=I.target.files[0];if(!$)return;const A=f.dataset.mangaId,D=f.dataset.volId,R=document.getElementById("vol-cover-upload-btn");if(f.value="",!(!A||!D))try{R&&(R.disabled=!0,R.textContent="Uploading..."),await m.uploadVolumeCover(A,D,$),d("Cover uploaded","success"),await J(A),V([A,"volume",D])}catch(F){d("Upload failed: "+F.message,"error")}finally{R&&(R.disabled=!1,R.innerHTML=`${p("upload")} Upload Image`)}})),g.addEventListener("click",()=>{f.dataset.mangaId=e.id,f.dataset.volId=l.dataset.editingVolId||"",f.click()})}const v=t.querySelector("#vol-cover-selector-btn"),S=t.querySelector("#cover-selector-modal");v&&S&&v.addEventListener("click",async()=>{const f=S.querySelector("#cover-chapter-select");f.innerHTML='<option value="">Select a chapter...</option>';const I=t.querySelector("#edit-volume-modal"),$=I?I.dataset.editingVolId:null;let A=[...e.chapters||[]];if($){const R=e.volumes.find(F=>F.id===$);if(R&&R.chapters){const F=new Set(R.chapters);A=A.filter(O=>F.has(O.number))}}A.sort((R,F)=>R.number-F.number);const D=new Set;A.forEach(R=>{if(!D.has(R.number)){D.add(R.number);const F=document.createElement("option");F.value=R.number,F.textContent=`Chapter ${R.number}`,f.appendChild(F)}}),A.length>0&&(f.value=A[0].number,Ts(e.id,A[0].number)),S.classList.add("open")});const x=t.querySelector("#cover-chapter-select");x&&x.addEventListener("change",f=>{f.target.value&&Ts(e.id,f.target.value)}),t.querySelectorAll(".modal-close, .modal-close-btn").forEach(f=>{f.addEventListener("click",()=>{f.closest(".modal").classList.remove("open")})}),t.querySelectorAll(".modal-overlay").forEach(f=>{f.addEventListener("click",()=>{f.closest(".modal").classList.remove("open")})})}async function Ts(t,e){const s=document.getElementById("cover-images-grid");if(s){s.innerHTML='<div class="loading-center"><div class="loading-spinner"></div></div>';try{const n=(await m.getChapterImages(t,e)).images||[];if(s.innerHTML="",n.length===0){s.innerHTML='<div style="grid-column:1/-1; text-align:center; padding:20px;">No images found.</div>';return}n.forEach(r=>{const o=document.createElement("div");o.className="cover-grid-item",o.style.cssText="cursor:pointer; width:100%; padding-bottom:150%; height:0; border-radius:4px; overflow:hidden; position:relative; background: #222;",o.innerHTML=`<img src="${r}" style="position:absolute; top:0; left:0; width:100%; height:100%; object-fit:cover; object-position:top;" loading="lazy">`,o.addEventListener("click",()=>{const c=document.querySelector('input[name="cover-target"]:checked').value,l=r.split("/").pop();Jr(l,e,c)}),s.appendChild(o)})}catch(a){s.innerHTML=`<div style="color:var(--danger); padding:20px;">Error: ${a.message}</div>`}}}async function Jr(t,e,s){const a=b.manga,n=document.getElementById("edit-volume-modal"),r=document.getElementById("cover-selector-modal");if(confirm(`Set this image as ${s} cover?`))try{if(s==="volume"){const o=n.dataset.editingVolId;if(!o)throw new Error("No volume selected");await m.setVolumeCoverFromChapter(a.id,o,e,t),d("Volume cover updated","success"),r.classList.remove("open"),n.classList.remove("open"),await J(a.id),V([a.id,"volume",o])}else{await m.setMangaCoverFromChapter(a.id,e,t),d("Series cover updated","success"),r.classList.remove("open"),await J(a.id);const o=window.location.hash.replace("#","");b.activeVolumeId?V([a.id,"volume",b.activeVolumeId]):V([a.id])}}catch(o){d("Failed to set cover: "+o.message,"error")}}let fe={series:null,loading:!0};function He(){if(fe.loading)return`
      ${ce("series")}
      <div class="container">
        <div class="loading-center"><div class="loading-spinner"></div></div>
      </div>
      ...
      <div class="series-detail">
        ...
        <div class="series-entries-section">
          ...
          <div class="series-entries-grid">
            ${s.map((r,o)=>Yr(r,o,s.length)).join("")}
          </div>
          </div>
        </div>
      </div>
  ...
  `}function Yr(t,e,s){var r;const a=t.alias||t.title;let n=null;return t.local_cover?n=`/api/public/covers/${t.bookmark_id}/${encodeURIComponent(t.local_cover.split(/[/\\]/).pop())}`:t.localCover?n=`/api/public/covers/${t.bookmark_id}/${encodeURIComponent(t.localCover.split(/[/\\]/).pop())}`:t.cover&&(n=t.cover),`
  ...
  `}function St(){var l,h,u;const t=document.getElementById("app"),e=fe.series;(l=document.getElementById("back-btn"))==null||l.addEventListener("click",()=>q.go("/")),(h=document.getElementById("back-library-btn"))==null||h.addEventListener("click",()=>q.go("/")),t.querySelectorAll(".series-entry-card").forEach(g=>{g.addEventListener("click",v=>{if(v.target.closest("[data-action]"))return;const S=g.dataset.id;q.go(`/manga/${S}`)})}),t.querySelectorAll("[data-action]").forEach(g=>{g.addEventListener("click",async v=>{v.stopPropagation();const S=g.dataset.action,x=g.dataset.id;switch(S){case"move-up":await Ps(x,-1);break;case"move-down":await Ps(x,1);break;case"set-cover":const f=g.dataset.entryid;await Xr(f);break}})});const s=document.getElementById("add-entry-btn"),a=document.getElementById("add-entry-modal"),n=document.getElementById("available-bookmarks-input"),r=document.getElementById("available-bookmarks-list"),o=document.getElementById("confirm-add-entry-btn");let c=[];s&&a&&(s.addEventListener("click",async()=>{try{s.disabled=!0,n&&(n.value="",n.placeholder="Loading...",n.disabled=!0),r&&(r.innerHTML=""),a.classList.add("open");const g=await m.getAvailableBookmarksForSeries();c=g,g.length===0?(n&&(n.placeholder="No available manga found"),o.disabled=!0):(n&&(n.placeholder="Select or type a manga...",n.disabled=!1),r&&(r.innerHTML=g.map(v=>`<option value="${(v.alias||v.title||"").replace(/"/g,"&quot;")}"></option>`).join("")),o.disabled=!1)}catch{d("Failed to load available manga","error"),a.classList.remove("open")}finally{s.disabled=!1}}),o.addEventListener("click",async()=>{const g=n?n.value:"",v=c.find(x=>(x.alias||x.title||"")===g);if(!v){d("Please select a valid manga from the list","warning");return}const S=v.id;try{o.disabled=!0,o.textContent="Adding...",await m.addSeriesEntry(e.id,S),d("Manga added to series","success"),a.classList.remove("open"),await xt(e.id),t.innerHTML=He(),St()}catch(x){d("Failed to add manga: "+x.message,"error")}finally{o.disabled=!1,o.textContent="Add to Series"}})),(u=document.getElementById("edit-series-btn"))==null||u.addEventListener("click",()=>{d("Edit series coming soon","info")})}async function Ps(t,e){const s=fe.series;if(!s)return;const a=s.entries||[],n=a.findIndex(c=>c.bookmark_id===t);if(n===-1)return;const r=n+e;if(r<0||r>=a.length)return;const o=a.map(c=>c.bookmark_id);[o[n],o[r]]=[o[r],o[n]];try{await m.post(`/series/${s.id}/reorder`,{order:o}),d("Order updated","success"),await xt(s.id);const c=document.getElementById("app");c.innerHTML=He(),St()}catch(c){d("Failed to reorder: "+c.message,"error")}}async function Xr(t){const e=fe.series;if(e)try{await m.setSeriesCover(e.id,t),d("Series cover updated","success"),await xt(e.id);const s=document.getElementById("app");s.innerHTML=He(),St()}catch(s){d("Failed to set cover: "+s.message,"error")}}async function xt(t){try{const e=await m.get(`/series/${t}`);fe.series=e,fe.loading=!1}catch{d("Failed to load series","error"),fe.loading=!1}}async function Zr(t=[]){const[e]=t;if(!e){q.go("/");return}const s=document.getElementById("app");fe.loading=!0,fe.series=null,s.innerHTML=He(),await xt(e),s.innerHTML=He(),St()}function ei(){fe.series=null,fe.loading=!0}const ti={mount:Zr,unmount:ei,render:He},si={disabledMangaIds:[],includeLists:!1,includeTrophies:!1,intervalMs:8e3,shuffle:!1};function ai(t){return String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}const ni={mount:async t=>{const e=document.getElementById("app");e.innerHTML=`
            ${ce()}
        ...
        `;let s={};try{const $=await m.get("/settings")||{};s=$;const A=document.getElementById("settings-form"),D=document.getElementById("settings-loader");$.theme&&(document.getElementById("theme").value=$.theme),D.style.display="none",A.style.display="",A.addEventListener("submit",async R=>{R.preventDefault();const F=new FormData(A),O={};for(const[k,L]of F.entries())O[k]=L;try{await m.post("/settings/bulk",O),d("Settings saved successfully"),O.theme}catch(k){console.error(k),d("Failed to save settings","error")}})}catch($){console.error($),document.getElementById("settings-loader").textContent="Error loading settings"}window.location.hash.includes("anilist=connected")&&d("AniList connected");const a=document.getElementById("anilist-group"),n=document.getElementById("anilist-status"),r=document.getElementById("anilist-connect"),o=document.getElementById("anilist-sync"),c=document.getElementById("anilist-disconnect"),l=document.getElementById("anilist-sync-result"),h=async()=>{a.style.display="block";try{const $=await m.anilistStatus();$.configured?$.connected?(n.textContent=`Connected as ${$.anilistUsername||"AniList user"}.`,r.style.display="none",o.style.display="",c.style.display=""):(n.textContent="Not connected. Link your AniList account to sync reading progress.",r.style.display="",o.style.display="none",c.style.display="none"):(n.textContent="Not configured — set ANILIST_CLIENT_ID and ANILIST_CLIENT_SECRET in .env and restart the server.",r.style.display="none",o.style.display="none",c.style.display="none")}catch($){console.error($),n.textContent="Failed to load AniList status — is the server running the latest code?"}};r.addEventListener("click",async()=>{try{const{url:$}=await m.anilistAuthUrl();window.location.href=$}catch($){d($.message||"Failed to start AniList connection","error")}}),c.addEventListener("click",async()=>{try{await m.anilistDisconnect(),d("AniList disconnected"),h()}catch{d("Failed to disconnect","error")}}),o.addEventListener("click",async()=>{o.disabled=!0,n.textContent="Syncing from AniList…";try{const $=await m.anilistPull();$.updated.length===0?l.textContent="Everything already up to date.":l.innerHTML="<ul>"+$.updated.map(A=>`<li>${A.title} — marked read up to chapter ${A.markedUpTo}</li>`).join("")+"</ul>",d(`AniList sync: ${$.updated.length} manga updated`)}catch($){l.textContent="",d($.message||"AniList sync failed","error")}finally{o.disabled=!1,h()}}),h();const u={...si,...s.slideshow||{}};u.disabledMangaIds=[...u.disabledMangaIds||[]];const g=document.getElementById("slideshow-interval"),v=document.getElementById("slideshow-shuffle"),S=document.getElementById("slideshow-lists"),x=document.getElementById("slideshow-trophies"),f=document.getElementById("slideshow-manga-list");g.value=String(u.intervalMs),g.value||(g.value="8000"),v.checked=!!u.shuffle,S.checked=!!u.includeLists,x.checked=!!u.includeTrophies;const I=async()=>{if(!Y.isDemo)try{await m.post("/settings",{key:"slideshow",value:u})}catch($){console.error($),d("Failed to save slideshow settings","error")}};g.addEventListener("change",()=>{u.intervalMs=parseInt(g.value,10)||8e3,I()}),v.addEventListener("change",()=>{u.shuffle=v.checked,I()}),S.addEventListener("change",()=>{u.includeLists=S.checked,I()}),x.addEventListener("change",()=>{u.includeTrophies=x.checked,I()}),document.getElementById("slideshow-start").addEventListener("click",()=>{var $,A;(A=($=document.documentElement).requestFullscreen)==null||A.call($).catch(()=>{}),q.go("/slideshow")});try{const $=await m.getAllVolumes();if($.length===0)f.innerHTML=`<p class="settings-hint">No manga with volumes yet — create volumes from a manga's page first.</p>`;else{const A=new Set(u.disabledMangaIds);f.innerHTML=$.map(D=>{const R=ai(D.alias||D.title),F=D.volumes.filter(L=>L.cover).length,O=D.localCover?`/api/public/covers/${D.id}/${encodeURIComponent(D.localCover.split(/[/\\]/).pop())}`:D.cover,k=F===0;return`
                        <label class="slideshow-manga-row${k?" no-covers":""}" title="${k?"No volume covers yet":R}">
                            ...
                            <span class="slideshow-manga-info">
                                ...
                                <span class="slideshow-manga-meta">${D.volumes.length} volume${D.volumes.length===1?"":"s"} · ${F} cover${F===1?"":"s"}</span>
                            </span>
                        </label>
                    `}).join(""),f.addEventListener("change",D=>{const R=D.target.closest("input[data-manga-id]");if(!R)return;const F=R.dataset.mangaId;R.checked?u.disabledMangaIds=u.disabledMangaIds.filter(O=>O!==F):u.disabledMangaIds.includes(F)||u.disabledMangaIds.push(F),I()})}}catch($){console.error($),f.innerHTML='<p class="settings-hint">Failed to load manga list.</p>'}}},ri={mount:async t=>{const e=document.getElementById("app");if(!Y.isAdmin){e.innerHTML=`
                ${ce()}
        ...
        `,document.querySelectorAll(".admin-tab").forEach(s=>{s.addEventListener("click",()=>{document.querySelectorAll(".admin-tab").forEach(a=>a.classList.remove("active")),s.classList.add("active"),document.querySelectorAll(".admin-section").forEach(a=>a.style.display="none"),document.getElementById(`admin-section-${s.dataset.section}`).style.display=""})}),await Promise.all([ct(),ii(),oi()])}};async function ct(){const t=document.getElementById("admin-section-users");try{const e=await m.listUsers();t.innerHTML=`
            <h2>Users</h2>
                    ...
                    <tbody>
                        ${e.map(s=>{var a;return`
                            <tr data-user-id="${s.id}">
                                <td>${Gt(s.username)}${s.id===((a=Y.user)==null?void 0:a.id)?' <span class="badge">you</span>':""}</td>
                                <td>
        ...
        `,t.querySelectorAll("tr[data-user-id]").forEach(s=>{const a=Number(s.dataset.userId),n=async()=>{try{await m.updateUser(a,{role:s.querySelector(".user-role").value,canDownload:s.querySelector(".user-can-download").checked,canEdit:s.querySelector(".user-can-edit").checked}),d("User updated","success")}catch(r){d(r.message,"error"),ct()}};s.querySelector(".user-role").addEventListener("change",n),s.querySelector(".user-can-download").addEventListener("change",n),s.querySelector(".user-can-edit").addEventListener("change",n),s.querySelector(".user-reset-pw").addEventListener("click",async()=>{const r=prompt("New password for this user:");if(r)try{await m.updateUser(a,{password:r}),d("Password reset","success")}catch(o){d(o.message,"error")}}),s.querySelector(".user-delete").addEventListener("click",async()=>{if(confirm("Delete this user?"))try{await m.deleteUser(a),d("User deleted","success"),ct()}catch(r){d(r.message,"error")}})}),document.getElementById("add-user-form").addEventListener("submit",async s=>{s.preventDefault();try{await m.createUser({username:document.getElementById("new-username").value.trim(),password:document.getElementById("new-password").value,role:document.getElementById("new-role").value,canDownload:document.getElementById("new-can-download").checked,canEdit:document.getElementById("new-can-edit").checked}),d("User created","success"),ct()}catch(a){d(a.message,"error")}})}catch(e){console.error(e),t.innerHTML='<div class="error">Failed to load users</div>'}}async function ii(){const t=document.getElementById("admin-section-demo");try{const e=await m.getBookmarks();t.innerHTML=`
            <h2>Demo Content</h2>
        ...
        `,e.querySelectorAll(".table-link").forEach(s=>{s.addEventListener("click",a=>{a.preventDefault();const n=a.currentTarget.dataset.table;Kt(n),e.querySelectorAll(".table-link").forEach(r=>r.classList.remove("active")),a.currentTarget.classList.add("active")})})}catch(t){console.error(t),document.getElementById("admin-sidebar").innerHTML='<div class="error">Failed to load tables</div>'}}async function Kt(t,e=0){var a,n;const s=document.getElementById("admin-main");s.innerHTML=`<div class="loader">Loading ${t}...</div>`;try{const o=await m.get(`/admin/tables/${t}?page=${e}&limit=50`);if(!o.rows||o.rows.length===0){s.innerHTML=`
                <h2>${t}</h2>
        ...
        `,(a=document.getElementById("prev-page"))==null||a.addEventListener("click",()=>Kt(t,e-1)),(n=document.getElementById("next-page"))==null||n.addEventListener("click",()=>Kt(t,e+1))}catch(r){console.error(r),s.innerHTML=`<div class="error">Failed to load data for ${t}</div>`}}let ne={favorites:{favorites:{},listOrder:[]},trophyPages:{},bookmarks:[],series:[],loading:!0,activeTab:"galleries"};function li(t,e){let s=null;if(e.length>0){const n=e[0];if(n.imagePaths&&n.imagePaths.length>0){const r=n.imagePaths[0];let o;typeof r=="string"?o=r:r&&typeof r=="object"&&(o=r.filename||r.path||r.name||r.url,o&&o.includes("/")&&(o=o.split("/").pop()),o&&o.includes("\\")&&(o=o.split("\\").pop())),o&&(s=`/api/public/chapter-images/${n.mangaId}/${n.chapterNum}/${encodeURIComponent(o)}`)}}const a=e.reduce((n,r)=>{var o;return n+(((o=r.imagePaths)==null?void 0:o.length)||0)},0);return`
  ...
  `}function ci(t){const e=ne.bookmarks.find(s=>s.id===t);return e?e.alias||e.title:t}function di(t){const e=ne.bookmarks.find(s=>s.id===t);if(e&&e.seriesId){const s=ne.series.find(a=>a.id===e.seriesId);if(s)return{id:s.id,name:s.alias||s.title}}return null}function ui(t,e,s,a=!1){return`
  ...
  `}function hi(){const t={};console.log("Building trophy groups from:",ne.trophyPages);for(const e of Object.keys(ne.trophyPages)){const s=ne.trophyPages[e];let a=0;for(const[r,o]of Object.entries(s))a+=Object.keys(o).length;if(console.log(`Manga ${e}: ${a} trophies`),a===0)continue;const n=di(e);if(n)t[n.id]||(t[n.id]={name:n.name,isSeries:!0,count:0,mangaIds:[]}),t[n.id].count+=a,t[n.id].mangaIds.push(e);else{const r=ci(e);console.log(`No series for ${e}, using name: ${r}`),t[e]={name:r,isSeries:!1,count:a,mangaIds:[e]}}}return console.log("Trophy groups result:",t),t}function yt(){if(ne.loading)return`
      ${ce("manga")}
      <div class="container">
        <div class="loading-spinner"></div>
      </div>
  ...
  `;let a="";if(ne.activeTab==="galleries")e.length===0?a=`
      ...
      `:a=`
        <div class="library-grid">
          ${e.map(r=>{const o=t&&t[r]||[];return li(r,o)}).join("")}
        </div>
      `;else{const n=hi(),r=Object.keys(n);r.length===0?a=`
        <div class="empty-state">
      ...
      `:a=`
        <div class="library-grid">
          ${r.map(c=>{const l=n[c];return ui(c,l.name,l.count,l.isSeries)}).join("")}
        </div>
      `}return`
    ${ce("manga")}
    <div class="container">
  ...
  `}function ka(){Le();const t=document.getElementById("app");t.querySelectorAll(".tab-btn").forEach(s=>{s.addEventListener("click",()=>{ne.activeTab=s.dataset.tab,t.innerHTML=yt(),ka()})}),t.querySelectorAll(".gallery-card").forEach(s=>{s.addEventListener("click",()=>{const a=s.dataset.gallery;q.go(`/read/gallery/${encodeURIComponent(a)}`)})}),t.querySelectorAll(".trophy-gallery-card").forEach(s=>{s.addEventListener("click",()=>{const a=s.dataset.trophyId;s.dataset.isSeries==="true"?q.go(`/read/trophies/series-${a}/🏆`):q.go(`/read/trophies/${a}/🏆`)})})}async function pi(){try{const[t,e,s,a]=await Promise.all([ue.loadFavorites(),m.get("/trophy-pages"),ue.loadBookmarks(),ue.loadSeries()]);ne.favorites=t||{favorites:{},listOrder:[]},ne.trophyPages=e||{},ne.bookmarks=s||[],ne.series=a||[],ne.loading=!1}catch(t){console.error("Failed to load favorites:",t),d("Failed to load favorites","error"),ne.loading=!1}}async function mi(){console.log("[Favorites] mount called"),ne.loading=!0;const t=document.getElementById("app");t.innerHTML=yt(),await pi(),console.log("[Favorites] Data loaded, rendering..."),t.innerHTML=yt(),console.log("[Favorites] Calling setupListeners..."),ka(),console.log("[Favorites] setupListeners complete")}function gi(){}const fi={mount:mi,unmount:gi,render:yt},bt="site-challenge-banner",$a="site-cookie-modal",us=new Set;function ie(t){return String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function hs(t,e){window.open(e||`https://${t}/`,"_blank","noopener")}function Ke(){const t=document.getElementById($a);t&&t.remove(),document.removeEventListener("keydown",Ea)}function Ea(t){t.key==="Escape"&&Ke()}function vi(t,e){var n;const s=((n=e.session)==null?void 0:n.cookieCount)??0,a=e.probe;return a&&a.ok?{kind:"ok",html:`<strong>${ie(t)} accepted the cookies.</strong> ${s} saved; update checks for this site resume.
                   ...
                   and paste again.${a.error?`<br><small>${ie(a.error)}</small>`:""}`}:{kind:"ok",html:`<strong>Saved ${s} cookie${s===1?"":"s"}.</strong> The site could not be tested right now; retry your download to find out.`}}function ps({site:t,url:e,stale:s=!1,onImported:a}={}){if(!t)return;if(!Y.isAdmin){d("Only an admin can hand site cookies to the scraper","error");return}Ke();const n=navigator.userAgent||"",r=document.createElement("div");r.id=$a,r.className="modal open site-cookie-modal",r.innerHTML=`
        <div class="modal-overlay"></div>
        <div class="modal-content">
            <div class="modal-header">
    ...
    `,document.body.appendChild(r),document.addEventListener("keydown",Ea);const o=r.querySelector("#site-cookie-input"),c=r.querySelector("#site-cookie-ua"),l=r.querySelector("#site-cookie-result"),h=r.querySelector('[data-act="save"]'),u=(v,S)=>{l.className=`site-cookie-result ${v}`,l.innerHTML=S,l.hidden=!1};r.querySelector(".modal-overlay").addEventListener("click",Ke),r.querySelectorAll('[data-act="close"]').forEach(v=>v.addEventListener("click",Ke)),r.querySelector('[data-act="open"]').addEventListener("click",()=>hs(t,e));let g=!1;h.addEventListener("click",async()=>{var S;if(g)return;const v=o.value.trim();if(!v){u("error","Paste the cookies first."),o.focus();return}g=!0,h.disabled=!0,h.textContent="Saving & testing…",l.hidden=!0;try{const x=await m.importSiteSession(t,v,c.value.trim()),{kind:f,html:I}=vi(t,x),$=x.ignored||{},A=[];$.foreign&&A.push(`${$.foreign} for other sites`),$.expired&&A.push(`${$.expired} already expired`),$.invalid&&A.push(`${$.invalid} unreadable`),u(f,I+(A.length?`<br><small>Skipped: ${A.join(", ")}.</small>`:"")),o.value="",typeof a=="function"&&a(x),(S=x.probe)!=null&&S.ok&&(d(`${t}: cookies accepted, checks resume`,"success"),setTimeout(Ke,2500))}catch(x){u("error",ie(x.message||"Import failed"))}finally{g=!1,h.disabled=!1,h.textContent="Save & test"}}),o.focus()}function yi(t){var n;let e=document.getElementById(bt);e||(e=document.createElement("div"),e.id=bt,e.className="site-challenge-banner",document.body.appendChild(e)),e.dataset.site=t.site;const s=Y.isAdmin;let a=t.sessionStale?`<strong>${ie(t.site)}</strong> no longer accepts the cookies handed over earlier. Complete its verification check again and paste fresh ones.`:`<strong>${ie(t.site)}</strong> is asking for a human verification check. Automatic update checks for this site are paused and downloads stop at the first blocked chapter until someone completes it and hands over its cookies.`;s||(a+=" Ask an admin to do that."),e.innerHTML=`
    ...
    `,e.querySelector('[data-act="open"]').addEventListener("click",()=>hs(t.site,t.url)),(n=e.querySelector('[data-act="import"]'))==null||n.addEventListener("click",()=>{ps({site:t.site,url:t.url,stale:!!t.sessionStale})}),e.querySelector('[data-act="retry"]').addEventListener("click",async()=>{try{await m.clearSiteChallenge(t.site),d(`${t.site}: checks resumed. If the puzzle comes back, hand over its cookies instead.`,"info")}catch(r){d("Failed: "+r.message,"error")}Jt()}),e.querySelector('[data-act="close"]').addEventListener("click",()=>{us.add(t.site),Jt()}),e.classList.add("show")}function Jt(){const t=document.getElementById(bt);t&&t.remove()}function Rs(t){!t||us.has(t.site)||yi(t)}async function zi(){ee.on("site:challenge",t=>{us.delete(t.site),Rs(t)}),ee.on("site:challenge-cleared",({site:t})=>{const e=document.getElementById(bt);e&&e.dataset.site===t&&Jt()});try{const e=((await m.getSiteStatus()).challenges||[])[0];e&&Rs(e)}catch{}}let z={downloads:{},queueTasks:[],historyTasks:[],autoCheck:null,loading:!0,showEmptyChecks:!1,collapsed:{active:!1,scheduled:!1,completed:!1,history:!0}},dt=null,he={};function ms(t){if(!t)return"Never";const e=Date.now()-new Date(t).getTime(),s=Math.floor(e/6e4);if(s<1)return"Just now";if(s<60)return`${s}m ago`;const a=Math.floor(s/60);return a<24?`${a}h ${s%60}m ago`:`${Math.floor(a/24)}d ago`}function bi(t){if(!t)return"Not scheduled";const e=new Date(t).getTime()-Date.now();if(e<=0)return"Running now...";const s=Math.floor(e/6e4);if(s<60)return`in ${s}m`;const a=Math.floor(s/60),n=s%60;if(a<24)return`in ${a}h ${n}m`;const r=Math.floor(a/24),o=a%24;return`in ${r}d ${o}h`}function Ca(t){switch(t){case"download":return p("download");case"scrape":return p("search");case"scan":return p("folder");default:return p("settings")}}function gs(t){switch(t){case"running":return"var(--color-success)";case"queued":case"pending":return"var(--color-warning)";case"paused":return"var(--color-info)";case"complete":return"var(--color-success)";case"error":case"failed":case"cancelled":return"var(--color-error)";default:return"var(--text-secondary)"}}function fs(t){switch(t){case"running":return"● Running";case"queued":case"pending":return"◌ Queued";case"paused":return"❚❚ Paused";case"complete":return"✓ Complete";case"error":case"failed":return"✗ Failed";case"cancelled":return"✗ Cancelled";default:return t}}function wi(t){return!t||t==="default"?"Default (6h)":t==="daily"?"Daily":t==="weekly"?"Weekly":t}function ki(){const t=z.autoCheck;return t?`
    <div class="queue-inline-header">
      <span class="text-muted">${t.enabledCount} monitored · Last: ${ms(t.lastRun)}</span>
      <button class="btn btn-sm btn-primary" id="run-autocheck-btn">${p("play")} Run All Now</button>
    </div>
  `:""}function $i(t){const e=t.nextCheck?bi(t.nextCheck):"Not set",s=t.nextCheck&&new Date(t.nextCheck)<=new Date;return`
        ...
        <div class="task-info">
          ...
          <div>
            ...
            <div class="task-status" style="color: var(--text-secondary)">
              ${wi(t.schedule)}${t.schedule==="weekly"&&t.day?` · ${t.day.charAt(0).toUpperCase()+t.day.slice(1)}`:""}${(t.schedule==="daily"||t.schedule==="weekly")&&t.time?` · ${t.time}`:""}
            </div>
          </div>
        </div>
  ...
  `}function Tt(t){return String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function qs(t,e){const s=e.total>0?Math.round(e.completed/e.total*100):0,a=e.status==="running"||e.status==="queued",n=e.status==="paused",r=e.errors&&e.errors.length>0,o=!a&&!n&&r&&(e.chapterUrls||[]).length>0;return`
    <div class="queue-card task-card" data-task-id="${t}">
      <div class="queue-card-header">
        <div class="task-info">
          ...
          <div>
            ...
            <div class="task-status" style="color: ${gs(e.status)}">${fs(e.status)}</div>
          </div>
        </div>
      ...
      <div class="queue-card-body">
        ...
        ${e.errors&&e.errors.length>0?`
          ...
          <ul class="task-error-list">${e.errors.slice(0,5).map(c=>`<li>${typeof c.chapter=="number"?`Ch. ${c.chapter}: `:""}${Tt(c.error)}</li>`).join("")}</ul>`:""}
        ${e.challenge?(()=>{const c=Tt(e.challenge.site),l=Tt(e.challenge.url||`https://${e.challenge.site}/`),h=Y.isAdmin;return`
...
${s.userAgent}`:""}`:"";n=`<span class="capability-pill capability-yes" title="${we(o)}">✓ ${s.cookieCount} cookie${s.cookieCount===1?"":"s"}${r?` · ${r}`:""}</span>`}else a?n=`<span class="capability-pill capability-soon">${p("triangle-alert")} Check pending</span>`:n='<span class="capability-pill capability-no">None</span>';return`
    ...
    `,Le()}renderScraperList(){const e=document.getElementById("scraper-cards-list");if(!e)return;if(this.scrapers.length===0){e.innerHTML=`
        <div class="empty-state">
    ...
    `,this._setReadBtnEnabled(r,!1);try{const c=await m.get(`/scrapers/info?url=${encodeURIComponent(e.url)}`,{signal:s});if(c.success&&c.info){this.previewInfo={...this.previewInfo,...c.info},Array.isArray(c.info.chapters)&&c.info.chapters.length>1&&((o=c.info.chapters[0])!=null&&o.url)&&(this.previewInfo.readUrl=c.info.chapters[0].url);let l="";c.info.tags&&c.info.tags.length>0&&(l=`
             ...
             ${h}
             ${l}
          `,this._setReadBtnEnabled(r,!0)}else document.getElementById("preview-extended-info").innerHTML='<p class="error-state" style="margin:0; padding:1rem; text-align:left;">Could not fetch extra details.</p>',(this.previewInfo.galleryId||this.previewInfo.url)&&this._setReadBtnEnabled(r,!0)}catch(c){if(c.name==="AbortError"||s.aborted){console.log("Scraper details fetch aborted successfully.");return}console.error("Info error:",c),document.getElementById("preview-extended-info").innerHTML=`<p class="error-state" style="margin:0; padding:1rem; text-align:left;">Failed to load details: ${c.message}</p>`,this._setReadBtnEnabled(r,!0)}}_setReadBtnEnabled(e,s){e&&(e.disabled=!s,e.style.opacity=s?"1":"0.5",e.style.cursor=s?"pointer":"not-allowed",e.style.pointerEvents=s?"auto":"none")}async openTempReader(){if(!this.previewInfo||!this.previewInfo.url&&!this.previewInfo.galleryId)return;const e=this.previewInfo.readUrl||this.previewInfo.url||`https://nhentai.net/g/${this.previewInfo.galleryId}/`,s=this.browseScraper||this.previewInfo.website;sessionStorage.setItem("streamPreviewUrl",e),sessionStorage.setItem("streamPreviewTitle",this.previewInfo.title||"Preview"),s?sessionStorage.setItem("streamPreviewScraper",s):sessionStorage.removeItem("streamPreviewScraper"),document.getElementById("preview-info-modal").style.display="none",window.location.hash="#/read/stream/preview"}}const Mi=new _i,Ds={disabledMangaIds:[],includeLists:!1,includeTrophies:!1,intervalMs:8e3,shuffle:!1};let _=null;function Ti(t){return String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function Fs(t,e=0){for(let s=t.length-1;s>e;s--){const a=e+Math.floor(Math.random()*(s-e+1));[t[s],t[a]]=[t[a],t[s]]}}function Pi(t){let e;return typeof t=="string"?e=t:t&&typeof t=="object"&&(e=t.filename||t.path||t.name||t.url),e?(e.includes("/")&&(e=e.split("/").pop()),e.includes("\\")&&(e=e.split("\\").pop()),e):null}function Ri(t){return p(t==="gallery"?"folder":t==="trophy"?"trophy":"book-open")}function qi(t,e){const s=[];for(const a of t){if(e.has(a.id))continue;const n=a.alias||a.title;for(const r of a.volumes)r.cover&&s.push({url:r.cover,title:n,subtitle:r.name,kind:"volume"})}return s}async function Di(){var a,n;const t=await m.getFavorites(),e=(a=t.listOrder)!=null&&a.length?t.listOrder:Object.keys(t.favorites||{}),s=[];for(const r of e)for(const o of((n=t.favorites)==null?void 0:n[r])||[])for(const c of o.imagePaths||[]){const l=Pi(c);l&&s.push({url:`/api/public/chapter-images/${o.mangaId}/${o.chapterNum}/${encodeURIComponent(l)}`,title:r,subtitle:o.mangaTitle?`${o.mangaTitle} · Ch. ${o.chapterNum}`:`Ch. ${o.chapterNum}`,kind:"gallery"})}return s}async function Fi(t){const e=await m.get("/trophy-pages"),s=await ue.loadBookmarks().catch(()=>[]),a=r=>{const o=s.find(c=>c.id===r);return o?o.alias||o.title:"Trophies"},n=[];for(const[r,o]of Object.entries(e||{}))if(!t.has(r))for(const[c,l]of Object.entries(o||{})){const h=Object.keys(l||{});if(h.length===0)continue;let u;try{u=(await m.getChapterImages(r,c)).images||[]}catch{continue}for(const g of h){const v=u[g];if(!v)continue;let S=typeof v=="string"?v.split("/").pop():(v==null?void 0:v.filename)||(v==null?void 0:v.path);if(S){try{S=decodeURIComponent(S)}catch{}n.push({url:`/api/public/chapter-images/${r}/${c}/${encodeURIComponent(S)}`,title:a(r),subtitle:`Ch. ${c} · Trophy`,kind:"trophy"})}}}return n}function Sa(){_&&(clearTimeout(_.timer),_.playing&&_.slides.length>1&&(_.timer=setTimeout(()=>ke(_.index+1),_.config.intervalMs)))}function Yt(){if(!_)return;const t=_.slides[_.index],e=document.getElementById("ss-counter"),s=document.getElementById("ss-title"),a=document.getElementById("ss-subtitle");e&&(e.textContent=_.slides.length?`${_.index+1} / ${_.slides.length}`:""),s&&t&&(s.innerHTML=`${Ri(t.kind)} ${Ti(t.title)}`),a&&t&&(a.textContent=t.subtitle||"")}function ke(t){if(!_||_.slides.length===0)return;const e=(t%_.slides.length+_.slides.length)%_.slides.length;_.index=e;const s=_.slides[e],a=++_.loadToken,n=1-_.activeLayer,r=_.layers[n],o=_.layers[_.activeLayer];r.onload=()=>{if(!(!_||a!==_.loadToken)&&(_.activeLayer=n,r.classList.add("active"),o.classList.remove("active"),Yt(),Sa(),_.slides.length>1)){const c=_.slides[(e+1)%_.slides.length];c&&(new Image().src=c.url)}},r.onerror=()=>{if(!(!_||a!==_.loadToken)){if(_.slides.splice(e,1),_.slides.length===0){Zt();return}ke(e)}},r.src=s.url,Yt()}function Ns(t){if(!_)return;_.playing=t;const e=document.getElementById("ss-play");e&&(e.innerHTML=p(t?"pause":"play")),Sa()}function ve(){if(!_)return;const t=document.getElementById("slideshow");t&&(t.classList.remove("controls-hidden"),clearTimeout(_.hideTimer),_.hideTimer=setTimeout(()=>{var e;(e=document.getElementById("slideshow"))==null||e.classList.add("controls-hidden")},3e3))}function Xt(){q.go("/settings")}function Zt(){var e;const t=document.getElementById("slideshow");t&&(t.innerHTML=`
    ...
    `,(e=document.getElementById("ss-empty-back"))==null||e.addEventListener("click",Xt))}const Ni={mount:async()=>{const t=document.getElementById("app");t.innerHTML=`
        ...
        `;const e=document.getElementById("ss-stage");_={slides:[],index:0,playing:!0,timer:null,hideTimer:null,loadToken:0,activeLayer:0,layers:[...e.querySelectorAll(".slideshow-img")],config:{...Ds},keyHandler:null,moveHandler:null},document.getElementById("ss-exit").addEventListener("click",Xt),document.getElementById("ss-prev").addEventListener("click",()=>{ke(_.index-1),ve()}),document.getElementById("ss-next").addEventListener("click",()=>{ke(_.index+1),ve()}),document.getElementById("ss-play").addEventListener("click",()=>{Ns(!_.playing),ve()}),document.getElementById("ss-fullscreen").addEventListener("click",()=>{document.fullscreenElement?document.exitFullscreen():document.documentElement.requestFullscreen().catch(()=>d("Fullscreen not supported","info"))}),e.addEventListener("click",l=>{const h=l.clientX/window.innerWidth;if(h<.3)ke(_.index-1),ve();else if(h>.7)ke(_.index+1),ve();else{const u=document.getElementById("slideshow");u.classList.contains("controls-hidden")?ve():(clearTimeout(_.hideTimer),u.classList.add("controls-hidden"))}}),_.keyHandler=l=>{if(_)switch(l.key){case"ArrowLeft":ke(_.index-1),ve();break;case"ArrowRight":ke(_.index+1),ve();break;case" ":l.preventDefault(),Ns(!_.playing),ve();break;case"f":case"F":document.fullscreenElement?document.exitFullscreen():document.documentElement.requestFullscreen().catch(()=>{});break;case"Escape":document.fullscreenElement||Xt();break}},document.addEventListener("keydown",_.keyHandler),_.moveHandler=()=>ve(),document.addEventListener("mousemove",_.moveHandler),ve();let s={};try{s=await m.get("/settings")||{}}catch{}_.config={...Ds,...s.slideshow||{}};const a=new Set(_.config.disabledMangaIds||[]);let n=[];try{n=await m.getAllVolumes()}catch(l){console.error(l)}_.slides=qi(n,a),_.config.shuffle&&Fs(_.slides,-1);const r=document.getElementById("ss-loading");_.slides.length>0&&(r==null||r.remove(),ke(0));const o=l=>{var u;if(!_||l.length===0)return;const h=_.slides.length===0;_.slides.push(...l),_.config.shuffle&&Fs(_.slides,h?-1:_.index),h?((u=document.getElementById("ss-loading"))==null||u.remove(),ke(0)):Yt()},c=[];_.config.includeLists&&c.push(Di().then(o).catch(l=>console.warn("Slideshow: galleries unavailable",l))),_.config.includeTrophies&&c.push(Fi(a).then(o).catch(l=>console.warn("Slideshow: trophies unavailable",l))),_.slides.length===0&&(c.length===0?Zt():Promise.allSettled(c).then(()=>{_&&_.slides.length===0&&Zt()}))},unmount:()=>{_&&(clearTimeout(_.timer),clearTimeout(_.hideTimer),document.removeEventListener("keydown",_.keyHandler),document.removeEventListener("mousemove",_.moveHandler),document.fullscreenElement&&document.exitFullscreen().catch(()=>{}),_=null)}};class Oi{constructor(){this.routes=new Map,this.currentRoute=null,this.currentView=null}init(){window.addEventListener("hashchange",()=>this.navigate()),this.navigate()}register(e,s){this.routes.set(e,s)}async navigate(){console.log("[Router] navigate called");const s=(window.location.hash.slice(1)||"/").split("?")[0],[a,...n]=s.split("/").filter(Boolean),r=`/${a||""}`;this.currentView&&this.currentView.unmount&&(console.log("[Router] calling unmount on current view"),this.currentView.unmount());let o=this.routes.get(r);!o&&this.routes.has("/")&&(o=this.routes.get("/")),o&&(this.currentRoute=r,this.currentView=o,o.mount&&(console.log("[Router] calling mount on view module"),await o.mount(n)),Le())}go(e){window.location.hash=e}back(){window.history.back()}reload(){this.currentView&&this.currentView.mount&&(this.currentView.mount(),Le())}}const q=new Oi;q.register("/",Gn);q.register("/manga",Wr);q.register("/read",yr);q.register("/series",ti);q.register("/settings",ni);q.register("/admin",ri);q.register("/favorites",fi);q.register("/queue",Bi);q.register("/scrapers",Mi);q.register("/slideshow",Ni);export{oe as S,ee as a,zi as i,q as r,Vi as s};
