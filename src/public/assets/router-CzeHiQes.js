import{a as f}from"./api-BzQZs3aS.js";const _e=Object.create(null);_e.open="0";_e.close="1";_e.ping="2";_e.pong="3";_e.message="4";_e.upgrade="5";_e.noop="6";const Mt=Object.create(null);Object.keys(_e).forEach(e=>{Mt[_e[e]]=e});const ds={type:"error",data:"parser error"},va=typeof Blob=="function"||typeof Blob<"u"&&Object.prototype.toString.call(Blob)==="[object BlobConstructor]",ya=typeof ArrayBuffer=="function",ba=e=>typeof ArrayBuffer.isView=="function"?ArrayBuffer.isView(e):e&&e.buffer instanceof ArrayBuffer,_s=({type:e,data:t},s,a)=>va&&t instanceof Blob?s?a(t):Ks(t,a):ya&&(t instanceof ArrayBuffer||ba(t))?s?a(t):Ks(new Blob([t]),a):a(_e[e]+(t||"")),Ks=(e,t)=>{const s=new FileReader;return s.onload=function(){const a=s.result.split(",")[1];t("b"+(a||""))},s.readAsDataURL(e)};function Ys(e){return e instanceof Uint8Array?e:e instanceof ArrayBuffer?new Uint8Array(e):new Uint8Array(e.buffer,e.byteOffset,e.byteLength)}let rs;function gn(e,t){if(va&&e.data instanceof Blob)return e.data.arrayBuffer().then(Ys).then(t);if(ya&&(e.data instanceof ArrayBuffer||ba(e.data)))return t(Ys(e.data));_s(e,!1,s=>{rs||(rs=new TextEncoder),t(rs.encode(s))})}const Js="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/",pt=typeof Uint8Array>"u"?[]:new Uint8Array(256);for(let e=0;e<Js.length;e++)pt[Js.charCodeAt(e)]=e;const fn=e=>{let t=e.length*.75,s=e.length,a,n=0,r,i,c,l;e[e.length-1]==="="&&(t--,e[e.length-2]==="="&&t--);const u=new ArrayBuffer(t),p=new Uint8Array(u);for(a=0;a<s;a+=4)r=pt[e.charCodeAt(a)],i=pt[e.charCodeAt(a+1)],c=pt[e.charCodeAt(a+2)],l=pt[e.charCodeAt(a+3)],p[n++]=r<<2|i>>4,p[n++]=(i&15)<<4|c>>2,p[n++]=(c&3)<<6|l&63;return u},vn=typeof ArrayBuffer=="function",Ps=(e,t)=>{if(typeof e!="string")return{type:"message",data:wa(e,t)};const s=e.charAt(0);return s==="b"?{type:"message",data:yn(e.substring(1),t)}:Mt[s]?e.length>1?{type:Mt[s],data:e.substring(1)}:{type:Mt[s]}:ds},yn=(e,t)=>{if(vn){const s=fn(e);return wa(s,t)}else return{base64:!0,data:e}},wa=(e,t)=>{switch(t){case"blob":return e instanceof Blob?e:new Blob([e]);case"arraybuffer":default:return e instanceof ArrayBuffer?e:e.buffer}},$a="",bn=(e,t)=>{const s=e.length,a=new Array(s);let n=0;e.forEach((r,i)=>{_s(r,!1,c=>{a[i]=c,++n===s&&t(a.join($a))})})},wn=(e,t)=>{const s=e.split($a),a=[];for(let n=0;n<s.length;n++){const r=Ps(s[n],t);if(a.push(r),r.type==="error")break}return a};function $n(){return new TransformStream({transform(e,t){gn(e,s=>{const a=s.length;let n;if(a<126)n=new Uint8Array(1),new DataView(n.buffer).setUint8(0,a);else if(a<65536){n=new Uint8Array(3);const r=new DataView(n.buffer);r.setUint8(0,126),r.setUint16(1,a)}else{n=new Uint8Array(9);const r=new DataView(n.buffer);r.setUint8(0,127),r.setBigUint64(1,BigInt(a))}e.data&&typeof e.data!="string"&&(n[0]|=128),t.enqueue(n),t.enqueue(s)})}})}let os;function Ct(e){return e.reduce((t,s)=>t+s.length,0)}function xt(e,t){if(e[0].length===t)return e.shift();const s=new Uint8Array(t);let a=0;for(let n=0;n<t;n++)s[n]=e[0][a++],a===e[0].length&&(e.shift(),a=0);return e.length&&a<e[0].length&&(e[0]=e[0].slice(a)),s}function kn(e,t){os||(os=new TextDecoder);const s=[];let a=0,n=-1,r=!1;return new TransformStream({transform(i,c){for(s.push(i);;){if(a===0){if(Ct(s)<1)break;const l=xt(s,1);r=(l[0]&128)===128,n=l[0]&127,n<126?a=3:n===126?a=1:a=2}else if(a===1){if(Ct(s)<2)break;const l=xt(s,2);n=new DataView(l.buffer,l.byteOffset,l.length).getUint16(0),a=3}else if(a===2){if(Ct(s)<8)break;const l=xt(s,8),u=new DataView(l.buffer,l.byteOffset,l.length),p=u.getUint32(0);if(p>Math.pow(2,21)-1){c.enqueue(ds);break}n=p*Math.pow(2,32)+u.getUint32(4),a=3}else{if(Ct(s)<n)break;const l=xt(s,n);c.enqueue(Ps(r?l:os.decode(l),t)),a=0}if(n===0||n>e){c.enqueue(ds);break}}}})}const ka=4;function ce(e){if(e)return En(e)}function En(e){for(var t in ce.prototype)e[t]=ce.prototype[t];return e}ce.prototype.on=ce.prototype.addEventListener=function(e,t){return this._callbacks=this._callbacks||{},(this._callbacks["$"+e]=this._callbacks["$"+e]||[]).push(t),this};ce.prototype.once=function(e,t){function s(){this.off(e,s),t.apply(this,arguments)}return s.fn=t,this.on(e,s),this};ce.prototype.off=ce.prototype.removeListener=ce.prototype.removeAllListeners=ce.prototype.removeEventListener=function(e,t){if(this._callbacks=this._callbacks||{},arguments.length==0)return this._callbacks={},this;var s=this._callbacks["$"+e];if(!s)return this;if(arguments.length==1)return delete this._callbacks["$"+e],this;for(var a,n=0;n<s.length;n++)if(a=s[n],a===t||a.fn===t){s.splice(n,1);break}return s.length===0&&delete this._callbacks["$"+e],this};ce.prototype.emit=function(e){this._callbacks=this._callbacks||{};for(var t=new Array(arguments.length-1),s=this._callbacks["$"+e],a=1;a<arguments.length;a++)t[a-1]=arguments[a];if(s){s=s.slice(0);for(var a=0,n=s.length;a<n;++a)s[a].apply(this,t)}return this};ce.prototype.emitReserved=ce.prototype.emit;ce.prototype.listeners=function(e){return this._callbacks=this._callbacks||{},this._callbacks["$"+e]||[]};ce.prototype.hasListeners=function(e){return!!this.listeners(e).length};const Gt=typeof Promise=="function"&&typeof Promise.resolve=="function"?t=>Promise.resolve().then(t):(t,s)=>s(t,0),Ee=typeof self<"u"?self:typeof window<"u"?window:Function("return this")(),Sn="arraybuffer";function Ea(e,...t){return t.reduce((s,a)=>(e.hasOwnProperty(a)&&(s[a]=e[a]),s),{})}const Cn=Ee.setTimeout,xn=Ee.clearTimeout;function Kt(e,t){t.useNativeTimers?(e.setTimeoutFn=Cn.bind(Ee),e.clearTimeoutFn=xn.bind(Ee)):(e.setTimeoutFn=Ee.setTimeout.bind(Ee),e.clearTimeoutFn=Ee.clearTimeout.bind(Ee))}const Ln=1.33;function In(e){return typeof e=="string"?Mn(e):Math.ceil((e.byteLength||e.size)*Ln)}function Mn(e){let t=0,s=0;for(let a=0,n=e.length;a<n;a++)t=e.charCodeAt(a),t<128?s+=1:t<2048?s+=2:t<55296||t>=57344?s+=3:(a++,s+=4);return s}function Sa(){return Date.now().toString(36).substring(3)+Math.random().toString(36).substring(2,5)}function Tn(e){let t="";for(let s in e)e.hasOwnProperty(s)&&(t.length&&(t+="&"),t+=encodeURIComponent(s)+"="+encodeURIComponent(e[s]));return t}function Bn(e){let t={},s=e.split("&");for(let a=0,n=s.length;a<n;a++){let r=s[a].split("=");t[decodeURIComponent(r[0])]=decodeURIComponent(r[1])}return t}class An extends Error{constructor(t,s,a){super(t),this.description=s,this.context=a,this.type="TransportError"}}class qs extends ce{constructor(t){super(),this.writable=!1,Kt(this,t),this.opts=t,this.query=t.query,this.socket=t.socket,this.supportsBinary=!t.forceBase64}onError(t,s,a){return super.emitReserved("error",new An(t,s,a)),this}open(){return this.readyState="opening",this.doOpen(),this}close(){return(this.readyState==="opening"||this.readyState==="open")&&(this.doClose(),this.onClose()),this}send(t){this.readyState==="open"&&this.write(t)}onOpen(){this.readyState="open",this.writable=!0,super.emitReserved("open")}onData(t){const s=Ps(t,this.socket.binaryType);this.onPacket(s)}onPacket(t){super.emitReserved("packet",t)}onClose(t){this.readyState="closed",super.emitReserved("close",t)}pause(t){}createUri(t,s={}){return t+"://"+this._hostname()+this._port()+this.opts.path+this._query(s)}_hostname(){const t=this.opts.hostname;return t.indexOf(":")===-1?t:"["+t+"]"}_port(){return this.opts.port&&(this.opts.secure&&Number(this.opts.port)!==443||!this.opts.secure&&Number(this.opts.port)!==80)?":"+this.opts.port:""}_query(t){const s=Tn(t);return s.length?"?"+s:""}}class _n extends qs{constructor(){super(...arguments),this._polling=!1}get name(){return"polling"}doOpen(){this._poll()}pause(t){this.readyState="pausing";const s=()=>{this.readyState="paused",t()};if(this._polling||!this.writable){let a=0;this._polling&&(a++,this.once("pollComplete",function(){--a||s()})),this.writable||(a++,this.once("drain",function(){--a||s()}))}else s()}_poll(){this._polling=!0,this.doPoll(),this.emitReserved("poll")}onData(t){const s=a=>{if(this.readyState==="opening"&&a.type==="open"&&this.onOpen(),a.type==="close")return this.onClose({description:"transport closed by the server"}),!1;this.onPacket(a)};wn(t,this.socket.binaryType).forEach(s),this.readyState!=="closed"&&(this._polling=!1,this.emitReserved("pollComplete"),this.readyState==="open"&&this._poll())}doClose(){const t=()=>{this.write([{type:"close"}])};this.readyState==="open"?t():this.once("open",t)}write(t){this.writable=!1,bn(t,s=>{this.doWrite(s,()=>{this.writable=!0,this.emitReserved("drain")})})}uri(){const t=this.opts.secure?"https":"http",s=this.query||{};return this.opts.timestampRequests!==!1&&(s[this.opts.timestampParam]=Sa()),!this.supportsBinary&&!s.sid&&(s.b64=1),this.createUri(t,s)}}let Ca=!1;try{Ca=typeof XMLHttpRequest<"u"&&"withCredentials"in new XMLHttpRequest}catch{}const Pn=Ca;function qn(){}class Rn extends _n{constructor(t){if(super(t),typeof location<"u"){const s=location.protocol==="https:";let a=location.port;a||(a=s?"443":"80"),this.xd=typeof location<"u"&&t.hostname!==location.hostname||a!==t.port}}doWrite(t,s){const a=this.request({method:"POST",data:t});a.on("success",s),a.on("error",(n,r)=>{this.onError("xhr post error",n,r)})}doPoll(){const t=this.request();t.on("data",this.onData.bind(this)),t.on("error",(s,a)=>{this.onError("xhr poll error",s,a)}),this.pollXhr=t}}class Ae extends ce{constructor(t,s,a){super(),this.createRequest=t,Kt(this,a),this._opts=a,this._method=a.method||"GET",this._uri=s,this._data=a.data!==void 0?a.data:null,this._create()}_create(){var t;const s=Ea(this._opts,"agent","pfx","key","passphrase","cert","ca","ciphers","rejectUnauthorized","autoUnref");s.xdomain=!!this._opts.xd;const a=this._xhr=this.createRequest(s);try{a.open(this._method,this._uri,!0);try{if(this._opts.extraHeaders){a.setDisableHeaderCheck&&a.setDisableHeaderCheck(!0);for(let n in this._opts.extraHeaders)this._opts.extraHeaders.hasOwnProperty(n)&&a.setRequestHeader(n,this._opts.extraHeaders[n])}}catch{}if(this._method==="POST")try{a.setRequestHeader("Content-type","text/plain;charset=UTF-8")}catch{}try{a.setRequestHeader("Accept","*/*")}catch{}(t=this._opts.cookieJar)===null||t===void 0||t.addCookies(a),"withCredentials"in a&&(a.withCredentials=this._opts.withCredentials),this._opts.requestTimeout&&(a.timeout=this._opts.requestTimeout),a.onreadystatechange=()=>{var n;a.readyState===3&&((n=this._opts.cookieJar)===null||n===void 0||n.parseCookies(a.getResponseHeader("set-cookie"))),a.readyState===4&&(a.status===200||a.status===1223?this._onLoad():this.setTimeoutFn(()=>{this._onError(typeof a.status=="number"?a.status:0)},0))},a.send(this._data)}catch(n){this.setTimeoutFn(()=>{this._onError(n)},0);return}typeof document<"u"&&(this._index=Ae.requestsCount++,Ae.requests[this._index]=this)}_onError(t){this.emitReserved("error",t,this._xhr),this._cleanup(!0)}_cleanup(t){if(!(typeof this._xhr>"u"||this._xhr===null)){if(this._xhr.onreadystatechange=qn,t)try{this._xhr.abort()}catch{}typeof document<"u"&&delete Ae.requests[this._index],this._xhr=null}}_onLoad(){const t=this._xhr.responseText;t!==null&&(this.emitReserved("data",t),this.emitReserved("success"),this._cleanup())}abort(){this._cleanup()}}Ae.requestsCount=0;Ae.requests={};if(typeof document<"u"){if(typeof attachEvent=="function")attachEvent("onunload",Xs);else if(typeof addEventListener=="function"){const e="onpagehide"in Ee?"pagehide":"unload";addEventListener(e,Xs,!1)}}function Xs(){for(let e in Ae.requests)Ae.requests.hasOwnProperty(e)&&Ae.requests[e].abort()}const Dn=function(){const e=xa({xdomain:!1});return e&&e.responseType!==null}();class Nn extends Rn{constructor(t){super(t);const s=t&&t.forceBase64;this.supportsBinary=Dn&&!s}request(t={}){return Object.assign(t,{xd:this.xd},this.opts),new Ae(xa,this.uri(),t)}}function xa(e){const t=e.xdomain;try{if(typeof XMLHttpRequest<"u"&&(!t||Pn))return new XMLHttpRequest}catch{}if(!t)try{return new Ee[["Active"].concat("Object").join("X")]("Microsoft.XMLHTTP")}catch{}}const La=typeof navigator<"u"&&typeof navigator.product=="string"&&navigator.product.toLowerCase()==="reactnative";class Fn extends qs{get name(){return"websocket"}doOpen(){const t=this.uri(),s=this.opts.protocols,a=La?{}:Ea(this.opts,"agent","perMessageDeflate","pfx","key","passphrase","cert","ca","ciphers","rejectUnauthorized","localAddress","protocolVersion","origin","maxPayload","family","checkServerIdentity");this.opts.extraHeaders&&(a.headers=this.opts.extraHeaders);try{this.ws=this.createSocket(t,s,a)}catch(n){return this.emitReserved("error",n)}this.ws.binaryType=this.socket.binaryType,this.addEventListeners()}addEventListeners(){this.ws.onopen=()=>{this.opts.autoUnref&&this.ws._socket.unref(),this.onOpen()},this.ws.onclose=t=>this.onClose({description:"websocket connection closed",context:t}),this.ws.onmessage=t=>this.onData(t.data),this.ws.onerror=t=>this.onError("websocket error",t)}write(t){this.writable=!1;for(let s=0;s<t.length;s++){const a=t[s],n=s===t.length-1;_s(a,this.supportsBinary,r=>{try{this.doWrite(a,r)}catch{}n&&Gt(()=>{this.writable=!0,this.emitReserved("drain")},this.setTimeoutFn)})}}doClose(){typeof this.ws<"u"&&(this.ws.onerror=()=>{},this.ws.close(),this.ws=null)}uri(){const t=this.opts.secure?"wss":"ws",s=this.query||{};return this.opts.timestampRequests&&(s[this.opts.timestampParam]=Sa()),this.supportsBinary||(s.b64=1),this.createUri(t,s)}}const is=Ee.WebSocket||Ee.MozWebSocket;class On extends Fn{createSocket(t,s,a){return La?new is(t,s,a):s?new is(t,s):new is(t)}doWrite(t,s){this.ws.send(s)}}class Un extends qs{get name(){return"webtransport"}doOpen(){try{this._transport=new WebTransport(this.createUri("https"),this.opts.transportOptions[this.name])}catch(t){return this.emitReserved("error",t)}this._transport.closed.then(()=>{this.onClose()}).catch(t=>{this.onError("webtransport error",t)}),this._transport.ready.then(()=>{this._transport.createBidirectionalStream().then(t=>{const s=kn(Number.MAX_SAFE_INTEGER,this.socket.binaryType),a=t.readable.pipeThrough(s).getReader(),n=$n();n.readable.pipeTo(t.writable),this._writer=n.writable.getWriter();const r=()=>{a.read().then(({done:c,value:l})=>{c||(this.onPacket(l),r())}).catch(c=>{})};r();const i={type:"open"};this.query.sid&&(i.data=`{"sid":"${this.query.sid}"}`),this._writer.write(i).then(()=>this.onOpen())})})}write(t){this.writable=!1;for(let s=0;s<t.length;s++){const a=t[s],n=s===t.length-1;this._writer.write(a).then(()=>{n&&Gt(()=>{this.writable=!0,this.emitReserved("drain")},this.setTimeoutFn)})}}doClose(){var t;(t=this._transport)===null||t===void 0||t.close()}}const Hn={websocket:On,webtransport:Un,polling:Nn},Vn=/^(?:(?![^:@\/?#]+:[^:@\/]*@)(http|https|ws|wss):\/\/)?((?:(([^:@\/?#]*)(?::([^:@\/?#]*))?)?@)?((?:[a-f0-9]{0,4}:){2,7}[a-f0-9]{0,4}|[^:\/?#]*)(?::(\d*))?)(((\/(?:[^?#](?![^?#\/]*\.[^?#\/.]+(?:[?#]|$)))*\/?)?([^?#\/]*))(?:\?([^#]*))?(?:#(.*))?)/,jn=["source","protocol","authority","userInfo","user","password","host","port","relative","path","directory","file","query","anchor"];function us(e){if(e.length>8e3)throw"URI too long";const t=e,s=e.indexOf("["),a=e.indexOf("]");s!=-1&&a!=-1&&(e=e.substring(0,s)+e.substring(s,a).replace(/:/g,";")+e.substring(a,e.length));let n=Vn.exec(e||""),r={},i=14;for(;i--;)r[jn[i]]=n[i]||"";return s!=-1&&a!=-1&&(r.source=t,r.host=r.host.substring(1,r.host.length-1).replace(/;/g,":"),r.authority=r.authority.replace("[","").replace("]","").replace(/;/g,":"),r.ipv6uri=!0),r.pathNames=zn(r,r.path),r.queryKey=Qn(r,r.query),r}function zn(e,t){const s=/\/{2,9}/g,a=t.replace(s,"/").split("/");return(t.slice(0,1)=="/"||t.length===0)&&a.splice(0,1),t.slice(-1)=="/"&&a.splice(a.length-1,1),a}function Qn(e,t){const s={};return t.replace(/(?:^|&)([^&=]*)=?([^&]*)/g,function(a,n,r){n&&(s[n]=r)}),s}const ps=typeof addEventListener=="function"&&typeof removeEventListener=="function",Tt=[];ps&&addEventListener("offline",()=>{Tt.forEach(e=>e())},!1);class He extends ce{constructor(t,s){if(super(),this.binaryType=Sn,this.writeBuffer=[],this._prevBufferLen=0,this._pingInterval=-1,this._pingTimeout=-1,this._maxPayload=-1,this._pingTimeoutTime=1/0,t&&typeof t=="object"&&(s=t,t=null),t){const a=us(t);s.hostname=a.host,s.secure=a.protocol==="https"||a.protocol==="wss",s.port=a.port,a.query&&(s.query=a.query)}else s.host&&(s.hostname=us(s.host).host);Kt(this,s),this.secure=s.secure!=null?s.secure:typeof location<"u"&&location.protocol==="https:",s.hostname&&!s.port&&(s.port=this.secure?"443":"80"),this.hostname=s.hostname||(typeof location<"u"?location.hostname:"localhost"),this.port=s.port||(typeof location<"u"&&location.port?location.port:this.secure?"443":"80"),this.transports=[],this._transportsByName={},s.transports.forEach(a=>{const n=a.prototype.name;this.transports.push(n),this._transportsByName[n]=a}),this.opts=Object.assign({path:"/engine.io",agent:!1,withCredentials:!1,upgrade:!0,timestampParam:"t",rememberUpgrade:!1,addTrailingSlash:!0,rejectUnauthorized:!0,perMessageDeflate:{threshold:1024},transportOptions:{},closeOnBeforeunload:!1},s),this.opts.path=this.opts.path.replace(/\/$/,"")+(this.opts.addTrailingSlash?"/":""),typeof this.opts.query=="string"&&(this.opts.query=Bn(this.opts.query)),ps&&(this.opts.closeOnBeforeunload&&(this._beforeunloadEventListener=()=>{this.transport&&(this.transport.removeAllListeners(),this.transport.close())},addEventListener("beforeunload",this._beforeunloadEventListener,!1)),this.hostname!=="localhost"&&(this._offlineEventListener=()=>{this._onClose("transport close",{description:"network connection lost"})},Tt.push(this._offlineEventListener))),this.opts.withCredentials&&(this._cookieJar=void 0),this._open()}createTransport(t){const s=Object.assign({},this.opts.query);s.EIO=ka,s.transport=t,this.id&&(s.sid=this.id);const a=Object.assign({},this.opts,{query:s,socket:this,hostname:this.hostname,secure:this.secure,port:this.port},this.opts.transportOptions[t]);return new this._transportsByName[t](a)}_open(){if(this.transports.length===0){this.setTimeoutFn(()=>{this.emitReserved("error","No transports available")},0);return}const t=this.opts.rememberUpgrade&&He.priorWebsocketSuccess&&this.transports.indexOf("websocket")!==-1?"websocket":this.transports[0];this.readyState="opening";const s=this.createTransport(t);s.open(),this.setTransport(s)}setTransport(t){this.transport&&this.transport.removeAllListeners(),this.transport=t,t.on("drain",this._onDrain.bind(this)).on("packet",this._onPacket.bind(this)).on("error",this._onError.bind(this)).on("close",s=>this._onClose("transport close",s))}onOpen(){this.readyState="open",He.priorWebsocketSuccess=this.transport.name==="websocket",this.emitReserved("open"),this.flush()}_onPacket(t){if(this.readyState==="opening"||this.readyState==="open"||this.readyState==="closing")switch(this.emitReserved("packet",t),this.emitReserved("heartbeat"),t.type){case"open":this.onHandshake(JSON.parse(t.data));break;case"ping":this._sendPacket("pong"),this.emitReserved("ping"),this.emitReserved("pong"),this._resetPingTimeout();break;case"error":const s=new Error("server error");s.code=t.data,this._onError(s);break;case"message":this.emitReserved("data",t.data),this.emitReserved("message",t.data);break}}onHandshake(t){this.emitReserved("handshake",t),this.id=t.sid,this.transport.query.sid=t.sid,this._pingInterval=t.pingInterval,this._pingTimeout=t.pingTimeout,this._maxPayload=t.maxPayload,this.onOpen(),this.readyState!=="closed"&&this._resetPingTimeout()}_resetPingTimeout(){this.clearTimeoutFn(this._pingTimeoutTimer);const t=this._pingInterval+this._pingTimeout;this._pingTimeoutTime=Date.now()+t,this._pingTimeoutTimer=this.setTimeoutFn(()=>{this._onClose("ping timeout")},t),this.opts.autoUnref&&this._pingTimeoutTimer.unref()}_onDrain(){this.writeBuffer.splice(0,this._prevBufferLen),this._prevBufferLen=0,this.writeBuffer.length===0?this.emitReserved("drain"):this.flush()}flush(){if(this.readyState!=="closed"&&this.transport.writable&&!this.upgrading&&this.writeBuffer.length){const t=this._getWritablePackets();this.transport.send(t),this._prevBufferLen=t.length,this.emitReserved("flush")}}_getWritablePackets(){if(!(this._maxPayload&&this.transport.name==="polling"&&this.writeBuffer.length>1))return this.writeBuffer;let s=1;for(let a=0;a<this.writeBuffer.length;a++){const n=this.writeBuffer[a].data;if(n&&(s+=In(n)),a>0&&s>this._maxPayload)return this.writeBuffer.slice(0,a);s+=2}return this.writeBuffer}_hasPingExpired(){if(!this._pingTimeoutTime)return!0;const t=Date.now()>this._pingTimeoutTime;return t&&(this._pingTimeoutTime=0,Gt(()=>{this._onClose("ping timeout")},this.setTimeoutFn)),t}write(t,s,a){return this._sendPacket("message",t,s,a),this}send(t,s,a){return this._sendPacket("message",t,s,a),this}_sendPacket(t,s,a,n){if(typeof s=="function"&&(n=s,s=void 0),typeof a=="function"&&(n=a,a=null),this.readyState==="closing"||this.readyState==="closed")return;a=a||{},a.compress=a.compress!==!1;const r={type:t,data:s,options:a};this.emitReserved("packetCreate",r),this.writeBuffer.push(r),n&&this.once("flush",n),this.flush()}close(){const t=()=>{this._onClose("forced close"),this.transport.close()},s=()=>{this.off("upgrade",s),this.off("upgradeError",s),t()},a=()=>{this.once("upgrade",s),this.once("upgradeError",s)};return(this.readyState==="opening"||this.readyState==="open")&&(this.readyState="closing",this.writeBuffer.length?this.once("drain",()=>{this.upgrading?a():t()}):this.upgrading?a():t()),this}_onError(t){if(He.priorWebsocketSuccess=!1,this.opts.tryAllTransports&&this.transports.length>1&&this.readyState==="opening")return this.transports.shift(),this._open();this.emitReserved("error",t),this._onClose("transport error",t)}_onClose(t,s){if(this.readyState==="opening"||this.readyState==="open"||this.readyState==="closing"){if(this.clearTimeoutFn(this._pingTimeoutTimer),this.transport.removeAllListeners("close"),this.transport.close(),this.transport.removeAllListeners(),ps&&(this._beforeunloadEventListener&&removeEventListener("beforeunload",this._beforeunloadEventListener,!1),this._offlineEventListener)){const a=Tt.indexOf(this._offlineEventListener);a!==-1&&Tt.splice(a,1)}this.readyState="closed",this.id=null,this.emitReserved("close",t,s),this.writeBuffer=[],this._prevBufferLen=0}}}He.protocol=ka;class Wn extends He{constructor(){super(...arguments),this._upgrades=[]}onOpen(){if(super.onOpen(),this.readyState==="open"&&this.opts.upgrade)for(let t=0;t<this._upgrades.length;t++)this._probe(this._upgrades[t])}_probe(t){let s=this.createTransport(t),a=!1;He.priorWebsocketSuccess=!1;const n=()=>{a||(s.send([{type:"ping",data:"probe"}]),s.once("packet",d=>{if(!a)if(d.type==="pong"&&d.data==="probe"){if(this.upgrading=!0,this.emitReserved("upgrading",s),!s)return;He.priorWebsocketSuccess=s.name==="websocket",this.transport.pause(()=>{a||this.readyState!=="closed"&&(p(),this.setTransport(s),s.send([{type:"upgrade"}]),this.emitReserved("upgrade",s),s=null,this.upgrading=!1,this.flush())})}else{const g=new Error("probe error");g.transport=s.name,this.emitReserved("upgradeError",g)}}))};function r(){a||(a=!0,p(),s.close(),s=null)}const i=d=>{const g=new Error("probe error: "+d);g.transport=s.name,r(),this.emitReserved("upgradeError",g)};function c(){i("transport closed")}function l(){i("socket closed")}function u(d){s&&d.name!==s.name&&r()}const p=()=>{s.removeListener("open",n),s.removeListener("error",i),s.removeListener("close",c),this.off("close",l),this.off("upgrading",u)};s.once("open",n),s.once("error",i),s.once("close",c),this.once("close",l),this.once("upgrading",u),this._upgrades.indexOf("webtransport")!==-1&&t!=="webtransport"?this.setTimeoutFn(()=>{a||s.open()},200):s.open()}onHandshake(t){this._upgrades=this._filterUpgrades(t.upgrades),super.onHandshake(t)}_filterUpgrades(t){const s=[];for(let a=0;a<t.length;a++)~this.transports.indexOf(t[a])&&s.push(t[a]);return s}}let Gn=class extends Wn{constructor(t,s={}){const a=typeof t=="object"?t:s;(!a.transports||a.transports&&typeof a.transports[0]=="string")&&(a.transports=(a.transports||["polling","websocket","webtransport"]).map(n=>Hn[n]).filter(n=>!!n)),super(t,a)}};function Kn(e,t="",s){let a=e;s=s||typeof location<"u"&&location,e==null&&(e=s.protocol+"//"+s.host),typeof e=="string"&&(e.charAt(0)==="/"&&(e.charAt(1)==="/"?e=s.protocol+e:e=s.host+e),/^(https?|wss?):\/\//.test(e)||(typeof s<"u"?e=s.protocol+"//"+e:e="https://"+e),a=us(e)),a.port||(/^(http|ws)$/.test(a.protocol)?a.port="80":/^(http|ws)s$/.test(a.protocol)&&(a.port="443")),a.path=a.path||"/";const r=a.host.indexOf(":")!==-1?"["+a.host+"]":a.host;return a.id=a.protocol+"://"+r+":"+a.port+t,a.href=a.protocol+"://"+r+(s&&s.port===a.port?"":":"+a.port),a}const Yn=typeof ArrayBuffer=="function",Jn=e=>typeof ArrayBuffer.isView=="function"?ArrayBuffer.isView(e):e.buffer instanceof ArrayBuffer,Ia=Object.prototype.toString,Xn=typeof Blob=="function"||typeof Blob<"u"&&Ia.call(Blob)==="[object BlobConstructor]",Zn=typeof File=="function"||typeof File<"u"&&Ia.call(File)==="[object FileConstructor]";function Rs(e){return Yn&&(e instanceof ArrayBuffer||Jn(e))||Xn&&e instanceof Blob||Zn&&e instanceof File}function Bt(e,t){if(!e||typeof e!="object")return!1;if(Array.isArray(e)){for(let s=0,a=e.length;s<a;s++)if(Bt(e[s]))return!0;return!1}if(Rs(e))return!0;if(e.toJSON&&typeof e.toJSON=="function"&&arguments.length===1)return Bt(e.toJSON(),!0);for(const s in e)if(Object.prototype.hasOwnProperty.call(e,s)&&Bt(e[s]))return!0;return!1}function er(e){const t=[],s=e.data,a=e;return a.data=hs(s,t),a.attachments=t.length,{packet:a,buffers:t}}function hs(e,t){if(!e)return e;if(Rs(e)){const s={_placeholder:!0,num:t.length};return t.push(e),s}else if(Array.isArray(e)){const s=new Array(e.length);for(let a=0;a<e.length;a++)s[a]=hs(e[a],t);return s}else if(typeof e=="object"&&!(e instanceof Date)){const s={};for(const a in e)Object.prototype.hasOwnProperty.call(e,a)&&(s[a]=hs(e[a],t));return s}return e}function tr(e,t){return e.data=ms(e.data,t),delete e.attachments,e}function ms(e,t){if(!e)return e;if(e&&e._placeholder===!0){if(typeof e.num=="number"&&e.num>=0&&e.num<t.length)return t[e.num];throw new Error("illegal attachments")}else if(Array.isArray(e))for(let s=0;s<e.length;s++)e[s]=ms(e[s],t);else if(typeof e=="object")for(const s in e)Object.prototype.hasOwnProperty.call(e,s)&&(e[s]=ms(e[s],t));return e}const sr=["connect","connect_error","disconnect","disconnecting","newListener","removeListener"];var K;(function(e){e[e.CONNECT=0]="CONNECT",e[e.DISCONNECT=1]="DISCONNECT",e[e.EVENT=2]="EVENT",e[e.ACK=3]="ACK",e[e.CONNECT_ERROR=4]="CONNECT_ERROR",e[e.BINARY_EVENT=5]="BINARY_EVENT",e[e.BINARY_ACK=6]="BINARY_ACK"})(K||(K={}));class ar{constructor(t){this.replacer=t}encode(t){return(t.type===K.EVENT||t.type===K.ACK)&&Bt(t)?this.encodeAsBinary({type:t.type===K.EVENT?K.BINARY_EVENT:K.BINARY_ACK,nsp:t.nsp,data:t.data,id:t.id}):[this.encodeAsString(t)]}encodeAsString(t){let s=""+t.type;return(t.type===K.BINARY_EVENT||t.type===K.BINARY_ACK)&&(s+=t.attachments+"-"),t.nsp&&t.nsp!=="/"&&(s+=t.nsp+","),t.id!=null&&(s+=t.id),t.data!=null&&(s+=JSON.stringify(t.data,this.replacer)),s}encodeAsBinary(t){const s=er(t),a=this.encodeAsString(s.packet),n=s.buffers;return n.unshift(a),n}}class Ds extends ce{constructor(t){super(),this.reviver=t}add(t){let s;if(typeof t=="string"){if(this.reconstructor)throw new Error("got plaintext data when reconstructing a packet");s=this.decodeString(t);const a=s.type===K.BINARY_EVENT;a||s.type===K.BINARY_ACK?(s.type=a?K.EVENT:K.ACK,this.reconstructor=new nr(s),s.attachments===0&&super.emitReserved("decoded",s)):super.emitReserved("decoded",s)}else if(Rs(t)||t.base64)if(this.reconstructor)s=this.reconstructor.takeBinaryData(t),s&&(this.reconstructor=null,super.emitReserved("decoded",s));else throw new Error("got binary data when not reconstructing a packet");else throw new Error("Unknown type: "+t)}decodeString(t){let s=0;const a={type:Number(t.charAt(0))};if(K[a.type]===void 0)throw new Error("unknown packet type "+a.type);if(a.type===K.BINARY_EVENT||a.type===K.BINARY_ACK){const r=s+1;for(;t.charAt(++s)!=="-"&&s!=t.length;);const i=t.substring(r,s);if(i!=Number(i)||t.charAt(s)!=="-")throw new Error("Illegal attachments");a.attachments=Number(i)}if(t.charAt(s+1)==="/"){const r=s+1;for(;++s&&!(t.charAt(s)===","||s===t.length););a.nsp=t.substring(r,s)}else a.nsp="/";const n=t.charAt(s+1);if(n!==""&&Number(n)==n){const r=s+1;for(;++s;){const i=t.charAt(s);if(i==null||Number(i)!=i){--s;break}if(s===t.length)break}a.id=Number(t.substring(r,s+1))}if(t.charAt(++s)){const r=this.tryParse(t.substr(s));if(Ds.isPayloadValid(a.type,r))a.data=r;else throw new Error("invalid payload")}return a}tryParse(t){try{return JSON.parse(t,this.reviver)}catch{return!1}}static isPayloadValid(t,s){switch(t){case K.CONNECT:return Zs(s);case K.DISCONNECT:return s===void 0;case K.CONNECT_ERROR:return typeof s=="string"||Zs(s);case K.EVENT:case K.BINARY_EVENT:return Array.isArray(s)&&(typeof s[0]=="number"||typeof s[0]=="string"&&sr.indexOf(s[0])===-1);case K.ACK:case K.BINARY_ACK:return Array.isArray(s)}}destroy(){this.reconstructor&&(this.reconstructor.finishedReconstruction(),this.reconstructor=null)}}class nr{constructor(t){this.packet=t,this.buffers=[],this.reconPack=t}takeBinaryData(t){if(this.buffers.push(t),this.buffers.length===this.reconPack.attachments){const s=tr(this.reconPack,this.buffers);return this.finishedReconstruction(),s}return null}finishedReconstruction(){this.reconPack=null,this.buffers=[]}}function Zs(e){return Object.prototype.toString.call(e)==="[object Object]"}const rr=Object.freeze(Object.defineProperty({__proto__:null,Decoder:Ds,Encoder:ar,get PacketType(){return K}},Symbol.toStringTag,{value:"Module"}));function xe(e,t,s){return e.on(t,s),function(){e.off(t,s)}}const or=Object.freeze({connect:1,connect_error:1,disconnect:1,disconnecting:1,newListener:1,removeListener:1});class Ma extends ce{constructor(t,s,a){super(),this.connected=!1,this.recovered=!1,this.receiveBuffer=[],this.sendBuffer=[],this._queue=[],this._queueSeq=0,this.ids=0,this.acks={},this.flags={},this.io=t,this.nsp=s,a&&a.auth&&(this.auth=a.auth),this._opts=Object.assign({},a),this.io._autoConnect&&this.open()}get disconnected(){return!this.connected}subEvents(){if(this.subs)return;const t=this.io;this.subs=[xe(t,"open",this.onopen.bind(this)),xe(t,"packet",this.onpacket.bind(this)),xe(t,"error",this.onerror.bind(this)),xe(t,"close",this.onclose.bind(this))]}get active(){return!!this.subs}connect(){return this.connected?this:(this.subEvents(),this.io._reconnecting||this.io.open(),this.io._readyState==="open"&&this.onopen(),this)}open(){return this.connect()}send(...t){return t.unshift("message"),this.emit.apply(this,t),this}emit(t,...s){var a,n,r;if(or.hasOwnProperty(t))throw new Error('"'+t.toString()+'" is a reserved event name');if(s.unshift(t),this._opts.retries&&!this.flags.fromQueue&&!this.flags.volatile)return this._addToQueue(s),this;const i={type:K.EVENT,data:s};if(i.options={},i.options.compress=this.flags.compress!==!1,typeof s[s.length-1]=="function"){const p=this.ids++,d=s.pop();this._registerAckCallback(p,d),i.id=p}const c=(n=(a=this.io.engine)===null||a===void 0?void 0:a.transport)===null||n===void 0?void 0:n.writable,l=this.connected&&!(!((r=this.io.engine)===null||r===void 0)&&r._hasPingExpired());return this.flags.volatile&&!c||(l?(this.notifyOutgoingListeners(i),this.packet(i)):this.sendBuffer.push(i)),this.flags={},this}_registerAckCallback(t,s){var a;const n=(a=this.flags.timeout)!==null&&a!==void 0?a:this._opts.ackTimeout;if(n===void 0){this.acks[t]=s;return}const r=this.io.setTimeoutFn(()=>{delete this.acks[t];for(let c=0;c<this.sendBuffer.length;c++)this.sendBuffer[c].id===t&&this.sendBuffer.splice(c,1);s.call(this,new Error("operation has timed out"))},n),i=(...c)=>{this.io.clearTimeoutFn(r),s.apply(this,c)};i.withError=!0,this.acks[t]=i}emitWithAck(t,...s){return new Promise((a,n)=>{const r=(i,c)=>i?n(i):a(c);r.withError=!0,s.push(r),this.emit(t,...s)})}_addToQueue(t){let s;typeof t[t.length-1]=="function"&&(s=t.pop());const a={id:this._queueSeq++,tryCount:0,pending:!1,args:t,flags:Object.assign({fromQueue:!0},this.flags)};t.push((n,...r)=>(this._queue[0],n!==null?a.tryCount>this._opts.retries&&(this._queue.shift(),s&&s(n)):(this._queue.shift(),s&&s(null,...r)),a.pending=!1,this._drainQueue())),this._queue.push(a),this._drainQueue()}_drainQueue(t=!1){if(!this.connected||this._queue.length===0)return;const s=this._queue[0];s.pending&&!t||(s.pending=!0,s.tryCount++,this.flags=s.flags,this.emit.apply(this,s.args))}packet(t){t.nsp=this.nsp,this.io._packet(t)}onopen(){typeof this.auth=="function"?this.auth(t=>{this._sendConnectPacket(t)}):this._sendConnectPacket(this.auth)}_sendConnectPacket(t){this.packet({type:K.CONNECT,data:this._pid?Object.assign({pid:this._pid,offset:this._lastOffset},t):t})}onerror(t){this.connected||this.emitReserved("connect_error",t)}onclose(t,s){this.connected=!1,delete this.id,this.emitReserved("disconnect",t,s),this._clearAcks()}_clearAcks(){Object.keys(this.acks).forEach(t=>{if(!this.sendBuffer.some(a=>String(a.id)===t)){const a=this.acks[t];delete this.acks[t],a.withError&&a.call(this,new Error("socket has been disconnected"))}})}onpacket(t){if(t.nsp===this.nsp)switch(t.type){case K.CONNECT:t.data&&t.data.sid?this.onconnect(t.data.sid,t.data.pid):this.emitReserved("connect_error",new Error("It seems you are trying to reach a Socket.IO server in v2.x with a v3.x client, but they are not compatible (more information here: https://socket.io/docs/v3/migrating-from-2-x-to-3-0/)"));break;case K.EVENT:case K.BINARY_EVENT:this.onevent(t);break;case K.ACK:case K.BINARY_ACK:this.onack(t);break;case K.DISCONNECT:this.ondisconnect();break;case K.CONNECT_ERROR:this.destroy();const a=new Error(t.data.message);a.data=t.data.data,this.emitReserved("connect_error",a);break}}onevent(t){const s=t.data||[];t.id!=null&&s.push(this.ack(t.id)),this.connected?this.emitEvent(s):this.receiveBuffer.push(Object.freeze(s))}emitEvent(t){if(this._anyListeners&&this._anyListeners.length){const s=this._anyListeners.slice();for(const a of s)a.apply(this,t)}super.emit.apply(this,t),this._pid&&t.length&&typeof t[t.length-1]=="string"&&(this._lastOffset=t[t.length-1])}ack(t){const s=this;let a=!1;return function(...n){a||(a=!0,s.packet({type:K.ACK,id:t,data:n}))}}onack(t){const s=this.acks[t.id];typeof s=="function"&&(delete this.acks[t.id],s.withError&&t.data.unshift(null),s.apply(this,t.data))}onconnect(t,s){this.id=t,this.recovered=s&&this._pid===s,this._pid=s,this.connected=!0,this.emitBuffered(),this._drainQueue(!0),this.emitReserved("connect")}emitBuffered(){this.receiveBuffer.forEach(t=>this.emitEvent(t)),this.receiveBuffer=[],this.sendBuffer.forEach(t=>{this.notifyOutgoingListeners(t),this.packet(t)}),this.sendBuffer=[]}ondisconnect(){this.destroy(),this.onclose("io server disconnect")}destroy(){this.subs&&(this.subs.forEach(t=>t()),this.subs=void 0),this.io._destroy(this)}disconnect(){return this.connected&&this.packet({type:K.DISCONNECT}),this.destroy(),this.connected&&this.onclose("io client disconnect"),this}close(){return this.disconnect()}compress(t){return this.flags.compress=t,this}get volatile(){return this.flags.volatile=!0,this}timeout(t){return this.flags.timeout=t,this}onAny(t){return this._anyListeners=this._anyListeners||[],this._anyListeners.push(t),this}prependAny(t){return this._anyListeners=this._anyListeners||[],this._anyListeners.unshift(t),this}offAny(t){if(!this._anyListeners)return this;if(t){const s=this._anyListeners;for(let a=0;a<s.length;a++)if(t===s[a])return s.splice(a,1),this}else this._anyListeners=[];return this}listenersAny(){return this._anyListeners||[]}onAnyOutgoing(t){return this._anyOutgoingListeners=this._anyOutgoingListeners||[],this._anyOutgoingListeners.push(t),this}prependAnyOutgoing(t){return this._anyOutgoingListeners=this._anyOutgoingListeners||[],this._anyOutgoingListeners.unshift(t),this}offAnyOutgoing(t){if(!this._anyOutgoingListeners)return this;if(t){const s=this._anyOutgoingListeners;for(let a=0;a<s.length;a++)if(t===s[a])return s.splice(a,1),this}else this._anyOutgoingListeners=[];return this}listenersAnyOutgoing(){return this._anyOutgoingListeners||[]}notifyOutgoingListeners(t){if(this._anyOutgoingListeners&&this._anyOutgoingListeners.length){const s=this._anyOutgoingListeners.slice();for(const a of s)a.apply(this,t.data)}}}function ot(e){e=e||{},this.ms=e.min||100,this.max=e.max||1e4,this.factor=e.factor||2,this.jitter=e.jitter>0&&e.jitter<=1?e.jitter:0,this.attempts=0}ot.prototype.duration=function(){var e=this.ms*Math.pow(this.factor,this.attempts++);if(this.jitter){var t=Math.random(),s=Math.floor(t*this.jitter*e);e=Math.floor(t*10)&1?e+s:e-s}return Math.min(e,this.max)|0};ot.prototype.reset=function(){this.attempts=0};ot.prototype.setMin=function(e){this.ms=e};ot.prototype.setMax=function(e){this.max=e};ot.prototype.setJitter=function(e){this.jitter=e};class gs extends ce{constructor(t,s){var a;super(),this.nsps={},this.subs=[],t&&typeof t=="object"&&(s=t,t=void 0),s=s||{},s.path=s.path||"/socket.io",this.opts=s,Kt(this,s),this.reconnection(s.reconnection!==!1),this.reconnectionAttempts(s.reconnectionAttempts||1/0),this.reconnectionDelay(s.reconnectionDelay||1e3),this.reconnectionDelayMax(s.reconnectionDelayMax||5e3),this.randomizationFactor((a=s.randomizationFactor)!==null&&a!==void 0?a:.5),this.backoff=new ot({min:this.reconnectionDelay(),max:this.reconnectionDelayMax(),jitter:this.randomizationFactor()}),this.timeout(s.timeout==null?2e4:s.timeout),this._readyState="closed",this.uri=t;const n=s.parser||rr;this.encoder=new n.Encoder,this.decoder=new n.Decoder,this._autoConnect=s.autoConnect!==!1,this._autoConnect&&this.open()}reconnection(t){return arguments.length?(this._reconnection=!!t,t||(this.skipReconnect=!0),this):this._reconnection}reconnectionAttempts(t){return t===void 0?this._reconnectionAttempts:(this._reconnectionAttempts=t,this)}reconnectionDelay(t){var s;return t===void 0?this._reconnectionDelay:(this._reconnectionDelay=t,(s=this.backoff)===null||s===void 0||s.setMin(t),this)}randomizationFactor(t){var s;return t===void 0?this._randomizationFactor:(this._randomizationFactor=t,(s=this.backoff)===null||s===void 0||s.setJitter(t),this)}reconnectionDelayMax(t){var s;return t===void 0?this._reconnectionDelayMax:(this._reconnectionDelayMax=t,(s=this.backoff)===null||s===void 0||s.setMax(t),this)}timeout(t){return arguments.length?(this._timeout=t,this):this._timeout}maybeReconnectOnOpen(){!this._reconnecting&&this._reconnection&&this.backoff.attempts===0&&this.reconnect()}open(t){if(~this._readyState.indexOf("open"))return this;this.engine=new Gn(this.uri,this.opts);const s=this.engine,a=this;this._readyState="opening",this.skipReconnect=!1;const n=xe(s,"open",function(){a.onopen(),t&&t()}),r=c=>{this.cleanup(),this._readyState="closed",this.emitReserved("error",c),t?t(c):this.maybeReconnectOnOpen()},i=xe(s,"error",r);if(this._timeout!==!1){const c=this._timeout,l=this.setTimeoutFn(()=>{n(),r(new Error("timeout")),s.close()},c);this.opts.autoUnref&&l.unref(),this.subs.push(()=>{this.clearTimeoutFn(l)})}return this.subs.push(n),this.subs.push(i),this}connect(t){return this.open(t)}onopen(){this.cleanup(),this._readyState="open",this.emitReserved("open");const t=this.engine;this.subs.push(xe(t,"ping",this.onping.bind(this)),xe(t,"data",this.ondata.bind(this)),xe(t,"error",this.onerror.bind(this)),xe(t,"close",this.onclose.bind(this)),xe(this.decoder,"decoded",this.ondecoded.bind(this)))}onping(){this.emitReserved("ping")}ondata(t){try{this.decoder.add(t)}catch(s){this.onclose("parse error",s)}}ondecoded(t){Gt(()=>{this.emitReserved("packet",t)},this.setTimeoutFn)}onerror(t){this.emitReserved("error",t)}socket(t,s){let a=this.nsps[t];return a?this._autoConnect&&!a.active&&a.connect():(a=new Ma(this,t,s),this.nsps[t]=a),a}_destroy(t){const s=Object.keys(this.nsps);for(const a of s)if(this.nsps[a].active)return;this._close()}_packet(t){const s=this.encoder.encode(t);for(let a=0;a<s.length;a++)this.engine.write(s[a],t.options)}cleanup(){this.subs.forEach(t=>t()),this.subs.length=0,this.decoder.destroy()}_close(){this.skipReconnect=!0,this._reconnecting=!1,this.onclose("forced close")}disconnect(){return this._close()}onclose(t,s){var a;this.cleanup(),(a=this.engine)===null||a===void 0||a.close(),this.backoff.reset(),this._readyState="closed",this.emitReserved("close",t,s),this._reconnection&&!this.skipReconnect&&this.reconnect()}reconnect(){if(this._reconnecting||this.skipReconnect)return this;const t=this;if(this.backoff.attempts>=this._reconnectionAttempts)this.backoff.reset(),this.emitReserved("reconnect_failed"),this._reconnecting=!1;else{const s=this.backoff.duration();this._reconnecting=!0;const a=this.setTimeoutFn(()=>{t.skipReconnect||(this.emitReserved("reconnect_attempt",t.backoff.attempts),!t.skipReconnect&&t.open(n=>{n?(t._reconnecting=!1,t.reconnect(),this.emitReserved("reconnect_error",n)):t.onreconnect()}))},s);this.opts.autoUnref&&a.unref(),this.subs.push(()=>{this.clearTimeoutFn(a)})}}onreconnect(){const t=this.backoff.attempts;this._reconnecting=!1,this.backoff.reset(),this.emitReserved("reconnect",t)}}const ct={};function bt(e,t){typeof e=="object"&&(t=e,e=void 0),t=t||{};const s=Kn(e,t.path||"/socket.io"),a=s.source,n=s.id,r=s.path,i=ct[n]&&r in ct[n].nsps,c=t.forceNew||t["force new connection"]||t.multiplex===!1||i;let l;return c?l=new gs(a,t):(ct[n]||(ct[n]=new gs(a,t)),l=ct[n]),s.query&&!t.query&&(t.query=s.queryKey),l.socket(s.path,t)}Object.assign(bt,{Manager:gs,Socket:Ma,io:bt,connect:bt});class ir{constructor(){this.socket=null,this.listeners=new Map,this.subscribedMangas=new Set}connect(){var t;(t=this.socket)!=null&&t.connected||(this.socket=bt({autoConnect:!0,reconnection:!0,reconnectionDelay:1e3,reconnectionAttempts:10}),this.socket.on("connect",()=>{console.log("[Socket] Connected:",this.socket.id),this.subscribedMangas.forEach(s=>{this.socket.emit("subscribe:manga",s)}),this.socket.emit("subscribe:global")}),this.socket.on("disconnect",s=>{console.log("[Socket] Disconnected:",s)}),this.socket.on("connect_error",s=>{console.error("[Socket] Connection error:",s.message)}))}disconnect(){this.socket&&(this.socket.disconnect(),this.socket=null)}subscribeToManga(t){var s;this.subscribedMangas.add(t),(s=this.socket)!=null&&s.connected&&this.socket.emit("subscribe:manga",t)}unsubscribeFromManga(t){var s;this.subscribedMangas.delete(t),(s=this.socket)!=null&&s.connected&&this.socket.emit("unsubscribe:manga",t)}on(t,s){this.listeners.has(t)||this.listeners.set(t,new Set),this.listeners.get(t).add(s),this.socket&&this.socket.on(t,s)}off(t,s){this.listeners.has(t)&&this.listeners.get(t).delete(s),this.socket&&this.socket.off(t,s)}emit(t,s){var a;(a=this.socket)!=null&&a.connected&&this.socket.emit(t,s)}}const oe={CHAPTER_DOWNLOADED:"chapter:downloaded",CHAPTER_HIDDEN:"chapter:hidden",CHAPTER_UNHIDDEN:"chapter:unhidden",MANGA_UPDATED:"manga:updated",MANGA_ADDED:"manga:added",MANGA_DELETED:"manga:deleted",DOWNLOAD_PROGRESS:"download:progress",DOWNLOAD_COMPLETED:"download:completed",QUEUE_UPDATED:"queue:updated",ACTION_RECORDED:"action:recorded",ACTION_UNDONE:"action:undone",SITE_CHALLENGE:"site:challenge",SITE_CHALLENGE_CLEARED:"site:challenge-cleared",SITE_SESSION:"site:session",TORRENT_UPDATE:"torrent:update",IMPORT_PROGRESS:"import:progress"},se=new ir,ve={bookmarks:[],series:[],categories:[],favorites:{favorites:{},listOrder:[]}},Le=new Set,le=new Map,ht=new Map;function lr(e){return ve[e]}function cr(e,t){ve[e]=t,Le.add(e),Et(e)}function dr(e,t){return ht.has(e)||ht.set(e,new Set),ht.get(e).add(t),()=>{var s;return(s=ht.get(e))==null?void 0:s.delete(t)}}function Et(e){const t=ht.get(e);t&&t.forEach(s=>s(ve[e]))}function mt(e){Le.delete(e),le.delete(e)}function ur(e){return Le.has(e)}async function gt(e=!1){if(!e&&Le.has("bookmarks"))return ve.bookmarks;if(le.has("bookmarks"))return le.get("bookmarks");const t=f.getBookmarks().then(s=>(ve.bookmarks=s||[],Le.add("bookmarks"),le.delete("bookmarks"),Et("bookmarks"),ve.bookmarks)).catch(s=>{throw le.delete("bookmarks"),s});return le.set("bookmarks",t),t}async function pr(e=!1){if(!e&&Le.has("series"))return ve.series;if(le.has("series"))return le.get("series");const t=f.get("/series").then(s=>(ve.series=s||[],Le.add("series"),le.delete("series"),Et("series"),ve.series)).catch(s=>{throw le.delete("series"),s});return le.set("series",t),t}async function hr(e=!1){if(!e&&Le.has("categories"))return ve.categories;if(le.has("categories"))return le.get("categories");const t=f.get("/categories").then(s=>(ve.categories=s.categories||[],Le.add("categories"),le.delete("categories"),Et("categories"),ve.categories)).catch(s=>{throw le.delete("categories"),s});return le.set("categories",t),t}async function mr(e=!1){if(!e&&Le.has("favorites"))return ve.favorites;if(le.has("favorites"))return le.get("favorites");const t=f.getFavorites().then(s=>(ve.favorites=s||{favorites:{},listOrder:[]},Le.add("favorites"),le.delete("favorites"),Et("favorites"),ve.favorites)).catch(s=>{throw le.delete("favorites"),s});return le.set("favorites",t),t}function gr(){se.on(oe.MANGA_UPDATED,()=>{mt("bookmarks"),gt(!0)}),se.on(oe.MANGA_ADDED,()=>{mt("bookmarks"),gt(!0)}),se.on(oe.MANGA_DELETED,()=>{mt("bookmarks"),gt(!0)}),se.on(oe.DOWNLOAD_COMPLETED,()=>{mt("bookmarks"),gt(!0)})}gr();const be={get:lr,set:cr,subscribe:dr,invalidate:mt,isLoaded:ur,loadBookmarks:gt,loadSeries:pr,loadCategories:hr,loadFavorites:mr};function h(e,t="info"){document.querySelectorAll(".toast").forEach(n=>{n.classList.contains("show")&&n.classList.remove("show")});const a=document.createElement("div");a.className=`toast toast-${t}`,a.textContent=e,document.body.appendChild(a),requestAnimationFrame(()=>a.classList.add("show")),setTimeout(()=>{a.classList.remove("show"),setTimeout(()=>a.remove(),300)},3e3)}const fr={library:'<path d="m16 6 4 14"/><path d="M12 6v14"/><path d="M8 8v12"/><path d="M4 4v16"/>',"book-open":'<path d="M12 7v14"/><path d="M3 18a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1h5a4 4 0 0 1 4 4 4 4 0 0 1 4-4h5a1 1 0 0 1 1 1v13a1 1 0 0 1-1 1h-6a3 3 0 0 0-3 3 3 3 0 0 0-3-3z"/>',"book-marked":'<path d="M10 2v8l3-3 3 3V2"/><path d="M4 19.5v-15A2.5 2.5 0 0 1 6.5 2H19a1 1 0 0 1 1 1v18a1 1 0 0 1-1 1H6.5a1 1 0 0 1 0-5H20"/>',"layout-grid":'<rect width="7" height="7" x="3" y="3" rx="1"/><rect width="7" height="7" x="14" y="3" rx="1"/><rect width="7" height="7" x="14" y="14" rx="1"/><rect width="7" height="7" x="3" y="14" rx="1"/>',star:'<polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/>',trophy:'<path d="M6 9H4.5a2.5 2.5 0 0 1 0-5H6"/><path d="M18 9h1.5a2.5 2.5 0 0 0 0-5H18"/><path d="M4 22h16"/><path d="M10 14.66V17c0 .55-.47.98-.97 1.21C7.85 18.75 7 20.24 7 22"/><path d="M14 14.66V17c0 .55.47.98.97 1.21C16.15 18.75 17 20.24 17 22"/><path d="M18 2H6v7a6 6 0 0 0 12 0V2Z"/>',plus:'<path d="M5 12h14"/><path d="M12 5v14"/>',"circle-plus":'<circle cx="12" cy="12" r="10"/><path d="M8 12h8"/><path d="M12 8v8"/>',check:'<path d="M20 6 9 17l-5-5"/>',pencil:'<path d="M21.174 6.812a1 1 0 0 0-3.986-3.987L3.842 16.174a2 2 0 0 0-.5.83l-1.321 4.352a.5.5 0 0 0 .623.622l4.353-1.32a2 2 0 0 0 .83-.497z"/>',"trash-2":'<path d="M3 6h18"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6"/><path d="M8 6V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/><line x1="10" x2="10" y1="11" y2="17"/><line x1="14" x2="14" y1="11" y2="17"/>',"undo-2":'<path d="M9 14 4 9l5-5"/><path d="M4 9h10.5a5.5 5.5 0 0 1 5.5 5.5a5.5 5.5 0 0 1-5.5 5.5H11"/>',scissors:'<circle cx="6" cy="6" r="3"/><path d="M8.12 8.12 12 12"/><path d="M20 4 8.12 15.88"/><circle cx="6" cy="18" r="3"/><path d="M14.8 14.8 20 20"/>',image:'<rect width="18" height="18" x="3" y="3" rx="2" ry="2"/><circle cx="9" cy="9" r="2"/><path d="m21 15-3.086-3.086a2 2 0 0 0-2.828 0L6 21"/>',palette:'<path d="M12 22a1 1 0 0 1 0-20 10 9 0 0 1 10 9 5 5 0 0 1-5 5h-2.25a1.75 1.75 0 0 0-1.4 2.8l.3.4a1.75 1.75 0 0 1-1.4 2.8z"/><circle cx="13.5" cy="6.5" r=".5" fill="currentColor"/><circle cx="17.5" cy="10.5" r=".5" fill="currentColor"/><circle cx="6.5" cy="12.5" r=".5" fill="currentColor"/><circle cx="8.5" cy="7.5" r=".5" fill="currentColor"/>',tag:'<path d="M12.586 2.586A2 2 0 0 0 11.172 2H4a2 2 0 0 0-2 2v7.172a2 2 0 0 0 .586 1.414l8.704 8.704a2.426 2.426 0 0 0 3.42 0l6.58-6.58a2.426 2.426 0 0 0 0-3.42z"/><circle cx="7.5" cy="7.5" r=".5" fill="currentColor"/>',play:'<polygon points="6 3 20 12 6 21 6 3"/>',pause:'<rect x="14" y="4" width="4" height="16" rx="1"/><rect x="6" y="4" width="4" height="16" rx="1"/>',download:'<path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" x2="12" y1="15" y2="3"/>',upload:'<path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="17 8 12 3 7 8"/><line x1="12" x2="12" y1="3" y2="15"/>',"hard-drive":'<line x1="22" x2="2" y1="12" y2="12"/><path d="M5.45 5.11 2 12v6a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-6l-3.45-6.89A2 2 0 0 0 16.76 4H7.24a2 2 0 0 0-1.79 1.11z"/><line x1="6" x2="6.01" y1="16" y2="16"/><line x1="10" x2="10.01" y1="16" y2="16"/>',save:'<path d="M15.2 3a2 2 0 0 1 1.4.6l3.8 3.8a2 2 0 0 1 .6 1.4V19a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2z"/><path d="M17 21v-7a1 1 0 0 0-1-1H8a1 1 0 0 0-1 1v7"/><path d="M7 3v4a1 1 0 0 0 1 1h7"/>',package:'<path d="M11 21.73a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73z"/><path d="M12 22V12"/><path d="m3.3 7 7.703 4.734a2 2 0 0 0 1.994 0L20.7 7"/>',folder:'<path d="M20 20a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2h-7.9a2 2 0 0 1-1.69-.9L9.6 3.9A2 2 0 0 0 7.93 3H4a2 2 0 0 0-2 2v13a2 2 0 0 0 2 2Z"/>',eye:'<path d="M2 12s3-7 10-7 10 7 10 7-3 7-10 7-10-7-10-7Z"/><circle cx="12" cy="12" r="3"/>',"eye-off":'<path d="M10.733 5.076a10.744 10.744 0 0 1 11.205 6.575 1 1 0 0 1 0 .696 10.747 10.747 0 0 1-1.444 2.49"/><path d="M14.084 14.158a3 3 0 0 1-4.242-4.242"/><path d="M17.479 17.499a10.75 10.75 0 0 1-15.417-5.151 1 1 0 0 1 0-.696 10.75 10.75 0 0 1 4.446-5.143"/><path d="m2 2 20 20"/>',circle:'<circle cx="12" cy="12" r="10"/>',lock:'<rect width="18" height="11" x="3" y="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/>',"lock-open":'<rect width="18" height="11" x="3" y="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 9.9-1"/>',"triangle-alert":'<path d="m21.73 18-8-14a2 2 0 0 0-3.48 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3"/><path d="M12 9v4"/><path d="M12 17h.01"/>',"shield-alert":'<path d="M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z"/><path d="M12 8v4"/><path d="M12 16h.01"/>',"circle-help":'<circle cx="12" cy="12" r="10"/><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"/><path d="M12 17h.01"/>',"traffic-cone":'<path d="M9.3 6.2a4.55 4.55 0 0 0 5.4 0"/><path d="M7.9 10.7c.9.8 2.4 1.3 4.1 1.3s3.2-.5 4.1-1.3"/><path d="M13.9 3.5a1.93 1.93 0 0 0-3.8 0L6.1 19.5a1.93 1.93 0 0 0 1.9 2.5h8a1.93 1.93 0 0 0 1.9-2.5z"/><path d="M2 21h20"/>',sparkles:'<path d="M9.937 15.5A2 2 0 0 0 8.5 14.063l-6.135-1.582a.5.5 0 0 1 0-.962L8.5 9.936A2 2 0 0 0 9.937 8.5l1.582-6.135a.5.5 0 0 1 .963 0L14.063 8.5A2 2 0 0 0 15.5 9.937l6.135 1.581a.5.5 0 0 1 0 .964L15.5 14.063a2 2 0 0 0-1.437 1.437l-1.582 6.135a.5.5 0 0 1-.963 0z"/><path d="M20 3v4"/><path d="M22 5h-4"/>',zap:'<path d="M4 14a1 1 0 0 1-.78-1.63l9.9-10.2a.5.5 0 0 1 .86.46l-1.92 6.02A1 1 0 0 0 13 10h7a1 1 0 0 1 .78 1.63l-9.9 10.2a.5.5 0 0 1-.86-.46l1.92-6.02A1 1 0 0 0 11 14z"/>',clock:'<circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/>',"alarm-clock":'<circle cx="12" cy="13" r="8"/><path d="M12 9v4l2 2"/><path d="M5 3 2 6"/><path d="m22 6-3-3"/><path d="M6.38 18.7 4 21"/><path d="M17.64 18.67 20 21"/>',loader:'<path d="M12 2v4"/><path d="m16.2 7.8 2.9-2.9"/><path d="M18 12h4"/><path d="m16.2 16.2 2.9 2.9"/><path d="M12 18v4"/><path d="m4.9 19.1 2.9-2.9"/><path d="M2 12h4"/><path d="m4.9 4.9 2.9 2.9"/>',search:'<circle cx="11" cy="11" r="8"/><path d="m21 21-4.3-4.3"/>',"search-x":'<path d="m13.5 8.5-5 5"/><path d="m8.5 8.5 5 5"/><circle cx="11" cy="11" r="8"/><path d="m21 21-4.3-4.3"/>',list:'<path d="M8 6h13"/><path d="M8 12h13"/><path d="M8 18h13"/><path d="M3 6h.01"/><path d="M3 12h.01"/><path d="M3 18h.01"/>',"list-checks":'<path d="m3 17 2 2 4-4"/><path d="m3 7 2 2 4-4"/><path d="M13 6h8"/><path d="M13 12h8"/><path d="M13 18h8"/>',"log-out":'<path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"/><polyline points="16 17 21 12 16 7"/><line x1="21" x2="9" y1="12" y2="12"/>',settings:'<path d="M12.22 2h-.44a2 2 0 0 0-2 2v.18a2 2 0 0 1-1 1.73l-.43.25a2 2 0 0 1-2 0l-.15-.08a2 2 0 0 0-2.73.73l-.22.38a2 2 0 0 0 .73 2.73l.15.1a2 2 0 0 1 1 1.72v.51a2 2 0 0 1-1 1.74l-.15.09a2 2 0 0 0-.73 2.73l.22.38a2 2 0 0 0 2.73.73l.15-.08a2 2 0 0 1 2 0l.43.25a2 2 0 0 1 1 1.73V20a2 2 0 0 0 2 2h.44a2 2 0 0 0 2-2v-.18a2 2 0 0 1 1-1.73l.43-.25a2 2 0 0 1 2 0l.15.08a2 2 0 0 0 2.73-.73l.22-.39a2 2 0 0 0-.73-2.73l-.15-.08a2 2 0 0 1-1-1.74v-.5a2 2 0 0 1 1-1.74l.15-.09a2 2 0 0 0 .73-2.73l-.22-.38a2 2 0 0 0-2.73-.73l-.15.08a2 2 0 0 1-2 0l-.43-.25a2 2 0 0 1-1-1.73V4a2 2 0 0 0-2-2z"/><circle cx="12" cy="12" r="3"/>',sliders:'<path d="M20 7h-9"/><path d="M14 17H5"/><circle cx="17" cy="17" r="3"/><circle cx="7" cy="7" r="3"/>',wrench:'<path d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94z"/>',"chevron-up":'<path d="m18 15-6-6-6 6"/>',"chevron-down":'<path d="m6 9 6 6 6-6"/>',"chevron-left":'<path d="m15 18-6-6 6-6"/>',"chevron-right":'<path d="m9 18 6-6-6-6"/>',x:'<path d="M18 6 6 18"/><path d="m6 6 12 12"/>',images:'<path d="M18 22H4a2 2 0 0 1-2-2V6"/><path d="m22 13-1.296-1.296a2.41 2.41 0 0 0-3.408 0L11 18"/><circle cx="12" cy="8" r="2"/><rect width="16" height="16" x="6" y="2" rx="2"/>',"columns-2":'<rect width="18" height="18" x="3" y="3" rx="2"/><path d="M12 3v18"/>',"rectangle-vertical":'<rect width="12" height="20" x="6" y="2" rx="2"/>',maximize:'<path d="M8 3H5a2 2 0 0 0-2 2v3"/><path d="M21 8V5a2 2 0 0 0-2-2h-3"/><path d="M3 16v3a2 2 0 0 0 2 2h3"/><path d="M16 21h3a2 2 0 0 0 2-2v-3"/>',"arrow-left-right":'<path d="M8 3 4 7l4 4"/><path d="M4 7h16"/><path d="m16 21 4-4-4-4"/><path d="M20 17H4"/>',"refresh-cw":'<path d="M3 12a9 9 0 0 1 9-9 9.75 9.75 0 0 1 6.74 2.74L21 8"/><path d="M21 3v5h-5"/><path d="M3 21v-5h5"/><path d="M21 12a9 9 0 0 1-9 9 9.75 9.75 0 0 1-6.74-2.74L3 16"/>',"rotate-cw":'<path d="M21 12a9 9 0 1 1-9-9c2.52 0 4.93 1 6.74 2.74L21 8"/><path d="M21 3v5h-5"/>',"wifi-off":'<path d="M12 20h.01"/><path d="M8.5 16.429a5 5 0 0 1 7 0"/><path d="M5 12.859a10 10 0 0 1 5.17-2.69"/><path d="M19 12.859a10 10 0 0 0-2.007-1.523"/><path d="M2 8.82a15 15 0 0 1 4.177-2.643"/><path d="M22 8.82a15 15 0 0 0-11.288-3.764"/><path d="m2 2 20 20"/>',globe:'<circle cx="12" cy="12" r="10"/><path d="M12 2a14.5 14.5 0 0 0 0 20 14.5 14.5 0 0 0 0-20"/><path d="M2 12h20"/>',plug:'<path d="M12 22v-5"/><path d="M9 8V2"/><path d="M15 8V2"/><path d="M18 8v5a4 4 0 0 1-4 4h-4a4 4 0 0 1-4-4V8Z"/>',link:'<path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"/><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"/>',"message-circle":'<path d="M7.9 20A9 9 0 1 0 4 16.1L2 22Z"/>'};function m(e,t={}){const s=fr[e];if(!s)return console.warn("[icons] unknown icon:",e),"";const{size:a,cls:n="",title:r,spin:i=!1}=t,c=["icon",i?"icon-spin":"",n].filter(Boolean).join(" "),l=a?` width="${a}" height="${a}"`:"",u=r?` role="img" aria-label="${String(r).replace(/"/g,"&quot;")}"`:' aria-hidden="true"';return`<svg class="${c}"${l} viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"${u}>${s}</svg>`}function we(e="book"){return`<div class="placeholder" data-icon="${e}"></div>`}function Re(e,t,s={}){const{kind:a="book",self:n=!1,attrs:r=""}=s,i=String(t??"").replace(/"/g,"&quot;"),c=`<div class=&quot;placeholder&quot; data-icon=&quot;${a}&quot;></div>`,l=n?"this.outerHTML":"this.parentElement.innerHTML";return`<img src="${e}" alt="${i}" loading="lazy"${r?" "+r:""} onerror="${l}='${c}'">`}const ea=`${m("folder")} Scan Folder`,ta=`${m("loader",{spin:!0})} Scanning...`;async function vr(e,t,s){try{e&&(e.disabled=!0,e.innerHTML=ta),t&&(t.innerHTML=ta),h("Scanning downloads folder...","info");const n=(await f.scanLibrary()).found||[];if(n.length===0){h("Scan complete: No new manga found","info"),s&&s();return}yr(n,s)}catch(a){h("Scan failed: "+a.message,"error")}finally{e&&(e.disabled=!1,e.innerHTML=ea),t&&(t.innerHTML=ea)}}async function yr(e,t){const s=document.createElement("div");s.id="import-modal-overlay",s.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.7);z-index:9999;display:flex;align-items:center;justify-content:center;";const a=document.createElement("div");a.style.cssText="background:var(--bg-primary);border-radius:8px;padding:24px;max-width:500px;width:90%;max-height:80vh;overflow-y:auto;",a.innerHTML=`
  ...
  `;const t=Z.isAdmin?`<a href="#/admin" class="btn btn-secondary" title="Admin">${m("wrench",{title:"Admin"})}</a>`:"",s=Z.isAdmin?`<a href="#/admin" class="mobile-menu-item">${m("wrench")} Admin</a>`:"",a=Z.canDownload?`<button class="btn btn-secondary" id="scan-btn">${m("folder")} Scan Folder</button>`:"",n=Z.canDownload?`<button class="mobile-menu-item" id="mobile-scan-btn">${m("folder")} Scan Folder</button>`:"",r=Z.canEdit?e==="series"?`<button class="btn btn-primary" id="add-series-btn">${m("plus")} Add Series</button>`:`<button class="btn btn-primary" id="add-manga-btn">${m("plus")} Add Manga</button>`:"",i=Z.canEdit?e==="series"?`<button class="mobile-menu-item primary" id="mobile-add-series-btn">${m("plus")} Add Series</button>`:`<button class="mobile-menu-item primary" id="mobile-add-btn">${m("plus")} Add Manga</button>`:"";return`
    <header>
      <div class="header-content">
        <a href="#/" class="logo">${sa()}</a>
        ...
        ${s.map(a=>`
          <div class="library-filter-group">
            ...
            <div class="library-filter-options">
              ...
              ${a.options.map(n=>`<button type="button" class="filter-chip ${A.filters[a.key]===n.value?"active":""}" data-group="${a.key}" data-value="${Ft(n.value)}">${Ft(n.label)}</button>`).join("")}
            </div>
          </div>
        `).join("")}
      </div>
  ...
  `}function aa(){const e=document.getElementById("library-grid");if(!e)return;const t=Yt();e.innerHTML=t.map(Jt).join("")||Xt();const s=document.getElementById("library-count");s&&(s.textContent=`${t.length} / ${A.bookmarks.length}`);const a=Ba(),n=document.getElementById("library-filter-btn");n&&(n.classList.toggle("has-filter",a>0),n.innerHTML=`${m("sliders")} Filter${a?` · ${a}`:""}`);const r=document.getElementById("library-filter-reset");r&&(r.hidden=a===0),document.querySelectorAll("#library-filter-menu .filter-chip").forEach(i=>{const c=A.filters[i.dataset.group]||"any";i.classList.toggle("active",i.dataset.value===c)})}function Jt(e){var p,d,g;const t=e.alias||e.title,s=e.downloadedCount??((p=e.downloadedChapters)==null?void 0:p.length)??0,a=new Set(e.excludedChapters||[]),n=(e.chapters||[]).filter($=>!a.has($.number)),r=new Set(n.map($=>$.number)).size||e.uniqueChapters||0,i=e.readCount??((d=e.readChapters)==null?void 0:d.length)??0,c=(e.updatedCount??((g=e.updatedChapters)==null?void 0:g.length)??0)>0,l=e.localCover?`/api/public/covers/${e.id}/${encodeURIComponent(e.localCover.split(/[/\\]/).pop())}`:e.cover,u=e.source==="local";return`
    <div class="manga-card" data-id="${e.id}">
      <div class="manga-card-cover">
        ${l?Re(l,t,{kind:u?"local":"book"}):we(u?"local":"book")}
        <div class="manga-card-badges">
          ...
          ${A.activeCategory==="Favorites"?`<span class="badge badge-play" title="Click to Read">${m("play",{title:"Click to Read"})}</span>`:""}
        </div>
      </div>
  ...
  `}function Ot(){const e=localStorage.getItem("library_view_mode");if(e&&e!==A.viewMode&&(A.viewMode=e),A.activeCategory==="Favorites")return H.go("/favorites"),"";let t="";if(A.viewMode==="series"){const s=A.series.map(Ir).join("");t=`
    ...
    `}else{const s=Yt(),n=A.searchAuthor&&A.searchQuery===A.searchAuthor?`
      <div class="manga-card search-sources-card" id="search-sources-card" title="Search online sources for ${Ft(A.searchAuthor)}"
        ...
        <div style="padding:1rem;color:var(--text-muted, #9aa);">
          ...
          <div style="font-size:.85rem;">Search sources for<br><strong style="color:var(--text-color, #fff);">${Ft(A.searchAuthor)}</strong></div>
        </div>
      ...
      `:""}
      <div class="library-grid" id="library-grid">
        ${A.loading?'<div class="loading-spinner"></div>':r||Xt()}
      </div>
    `}return`
    ${fe(A.viewMode)}
    <div class="container">
    ...
    ${Br()}
    ${Ar()}
  `}function Mr(){const{activeCategory:e}=A,s=(Array.isArray(A.categories)?A.categories:[]).map(n=>typeof n=="object"?n:{name:n,isNsfw:!1}),a=s.some(n=>n.isNsfw);return`
    ...
    ${Tr()}
      `}function Tr(){const t=(Array.isArray(A.categories)?A.categories:[]).map(s=>typeof s=="object"?s:{name:s,isNsfw:!1});return`
  ...
  `}function Br(){return`
      ...
      `}function fs(){A.activeCategory=null,A.artistFilter=null,A.searchQuery="",A.searchAuthor=null,A.searchAuthorSource=null,A.filters={...Dt},localStorage.removeItem("library_active_category"),localStorage.removeItem("library_artist_filter"),localStorage.removeItem("library_search"),localStorage.removeItem("library_search_author"),localStorage.removeItem("library_search_author_source"),localStorage.removeItem("library_filters"),ke()}function _r(){const e=document.getElementById("library-filter-btn"),t=document.getElementById("library-filter-menu");!e||!t||(e.addEventListener("click",s=>{s.stopPropagation();const a=t.classList.toggle("hidden")===!1;e.setAttribute("aria-expanded",String(a))}),t.addEventListener("click",s=>{s.stopPropagation();const a=s.target.closest(".filter-chip");if(a){A.filters[a.dataset.group]=a.dataset.value,$r(),aa();return}s.target.closest("#library-filter-reset")&&(A.filters={...Dt},localStorage.removeItem("library_filters"),aa())}),je&&document.removeEventListener("click",je),je=s=>{!t.classList.contains("hidden")&&!s.target.closest("#library-filter")&&(t.classList.add("hidden"),e.setAttribute("aria-expanded","false"))},document.addEventListener("click",je))}async function vs(e){const t=e.target.closest(".manga-card");if(t){if(t.classList.contains("gallery-card")){const n=t.dataset.gallery;H.go(`/read/gallery/${encodeURIComponent(n)}`);return}const s=t.dataset.id,a=t.dataset.seriesId;if(a){H.go(`/series/${a}`);return}if(s){if(A.activeCategory==="Favorites"){const n=A.bookmarks.find(r=>r.id===s);if(n){let r=n.last_read_chapter;if(!r&&n.chapters&&n.chapters.length>0&&(r=[...n.chapters].sort((c,l)=>c.number-l.number)[0].number),r){H.go(`/read/${s}/${r}`);return}else h("No chapters available to read","warning")}}H.go(`/manga/${s}`)}}}function Aa(){var F,V,X,z,te;const e=document.getElementById("app");e.removeEventListener("click",vs),e.addEventListener("click",vs),window._libraryViewModeListenerSet||(window._libraryViewModeListenerSet=!0,window.addEventListener("viewModeChange",O=>{A.viewMode=O.detail.mode;const S=document.getElementById("app");S.innerHTML=Ot(),Aa(),De()}));const t=document.getElementById("category-fab-btn"),s=document.getElementById("category-fab-menu");t&&s&&(t.addEventListener("click",()=>{s.classList.toggle("hidden")}),s.addEventListener("click",O=>{const S=O.target.closest(".category-menu-item");if(S){const B=S.dataset.category||null;Pr(B),s.classList.add("hidden")}})),(F=document.getElementById("manage-categories-btn"))==null||F.addEventListener("click",O=>{O.stopPropagation();const S=document.getElementById("manage-categories-modal");S&&S.classList.add("open")}),(V=document.getElementById("close-manage-categories-btn"))==null||V.addEventListener("click",()=>{var O;(O=document.getElementById("manage-categories-modal"))==null||O.classList.remove("open")}),(X=document.querySelector("#manage-categories-modal .modal-overlay"))==null||X.addEventListener("click",()=>{var O;(O=document.getElementById("manage-categories-modal"))==null||O.classList.remove("open")}),(z=document.querySelector("#manage-categories-modal .modal-close"))==null||z.addEventListener("click",()=>{var O;(O=document.getElementById("manage-categories-modal"))==null||O.classList.remove("open")}),(te=document.getElementById("add-category-btn"))==null||te.addEventListener("click",async()=>{var B;const O=document.getElementById("new-category-input"),S=(B=O==null?void 0:O.value)==null?void 0:B.trim();if(S)try{await f.post("/categories",{name:S}),O.value="",h("Category added","success"),await Ze(!0),ke()}catch(R){h("Failed: "+R.message,"error")}}),document.querySelectorAll(".nsfw-toggle").forEach(O=>{O.addEventListener("change",async S=>{const B=O.dataset.category;try{await f.put(`/categories/${encodeURIComponent(B)}/nsfw`,{isNsfw:O.checked}),h(`${B} ${O.checked?"marked as 18+":"unmarked"}`,"success"),await Ze(!0),ke()}catch(R){h("Failed: "+R.message,"error"),O.checked=!O.checked}})}),document.querySelectorAll(".delete-category-btn").forEach(O=>{O.addEventListener("click",async()=>{const S=O.dataset.category;if(confirm(`Delete category "${S}"?`))try{await f.delete(`/categories/${encodeURIComponent(S)}`),h("Category deleted","success"),A.activeCategory===S&&(A.activeCategory=null,localStorage.removeItem("library_active_category")),await Ze(!0),ke()}catch(B){h("Failed: "+B.message,"error")}})});const a=document.getElementById("artist-filter-badge");a&&a.addEventListener("click",()=>{A.artistFilter=null,localStorage.removeItem("library_artist_filter"),ke()});const n=document.getElementById("library-search");n&&(n.addEventListener("input",O=>{var B;A.searchQuery=O.target.value,localStorage.setItem("library_search",O.target.value),A.searchAuthor=null,A.searchAuthorSource=null,localStorage.removeItem("library_search_author"),localStorage.removeItem("library_search_author_source");const S=document.getElementById("library-grid");if(S){const R=Yt();S.innerHTML=R.map(Jt).join("")||Xt();const D=document.getElementById("search-clear");!D&&A.searchQuery?(n.parentElement.insertAdjacentHTML("beforeend",'<button class="search-clear" id="search-clear">×</button>'),(B=document.getElementById("search-clear"))==null||B.addEventListener("click",()=>{A.searchQuery="",A.searchAuthor=null,A.searchAuthorSource=null,localStorage.removeItem("library_search"),localStorage.removeItem("library_search_author"),localStorage.removeItem("library_search_author_source"),n.value="",ke()})):D&&!A.searchQuery&&D.remove()}}),A.searchQuery&&n.focus());const r=document.getElementById("search-clear");r&&r.addEventListener("click",()=>{A.searchQuery="",A.searchAuthor=null,A.searchAuthorSource=null,localStorage.removeItem("library_search"),localStorage.removeItem("library_search_author"),localStorage.removeItem("library_search_author_source"),ke()});const i=document.getElementById("search-sources-card");i&&i.addEventListener("click",()=>{const O=A.searchAuthor||A.searchQuery,S=A.searchAuthorSource||"nhentai.net";O&&(window.location.hash=`#/scrapers?browse=${encodeURIComponent(S)}&q=${encodeURIComponent(O)}`)});const c=document.getElementById("library-sort");c&&c.addEventListener("change",O=>{A.sortBy=O.target.value,localStorage.setItem("library_sort",A.sortBy),ke()}),_r(),window.removeEventListener("clearFilters",fs),window.addEventListener("clearFilters",fs);const l=document.getElementById("add-manga-btn"),u=document.getElementById("mobile-add-btn"),p=document.getElementById("add-modal"),d=document.getElementById("add-modal-close"),g=document.getElementById("add-modal-cancel"),$=document.getElementById("add-modal-submit"),v=document.getElementById("mobile-menu"),y=()=>{v&&v.classList.add("hidden"),p&&p.classList.add("open")};l&&l.addEventListener("click",y),u&&u.addEventListener("click",y),d&&d.addEventListener("click",()=>p.classList.remove("open")),g&&g.addEventListener("click",()=>p.classList.remove("open")),$&&$.addEventListener("click",async()=>{const O=document.getElementById("manga-url"),S=O.value.trim();if(!S){h("Please enter a URL","error");return}try{$.disabled=!0,$.textContent="Adding...",await f.addBookmark(S),h("Manga added successfully!","success"),p.classList.remove("open"),O.value="",await Ze(),ke()}catch(B){h("Failed to add manga: "+B.message,"error")}finally{$.disabled=!1,$.textContent="Add"}});const L=document.getElementById("add-series-btn"),w=document.getElementById("mobile-add-series-btn"),x=document.getElementById("add-series-modal"),T=document.getElementById("add-series-modal-close"),k=document.getElementById("add-series-modal-cancel"),I=document.getElementById("add-series-modal-submit"),N=document.getElementById("mobile-menu");if((L||w)&&x){const O=()=>{N&&N.classList.add("hidden"),x.classList.add("open")};L&&L.addEventListener("click",O),w&&w.addEventListener("click",O)}T&&T.addEventListener("click",()=>x.classList.remove("open")),k&&k.addEventListener("click",()=>x.classList.remove("open")),I&&I.addEventListener("click",async()=>{const O=document.getElementById("series-title"),S=document.getElementById("series-alias"),B=O.value.trim(),R=S.value.trim();if(!B){h("Please enter a title","error");return}try{I.disabled=!0,I.textContent="Creating...",await f.createSeries(B,R),h("Series created successfully!","success"),x.classList.remove("open"),O.value="",S.value="",await Ze(!0),ke()}catch(D){h("Failed to create series: "+D.message,"error")}finally{I.disabled=!1,I.textContent="Create"}});const E=x==null?void 0:x.querySelector(".modal-overlay");E&&E.addEventListener("click",()=>x.classList.remove("open"));const b=document.getElementById("empty-add-btn");b&&p&&b.addEventListener("click",()=>p.classList.add("open"));const M=document.getElementById("empty-add-series-btn");M&&x&&M.addEventListener("click",()=>x.classList.add("open"));const _=p==null?void 0:p.querySelector(".modal-overlay");_&&_.addEventListener("click",()=>p.classList.remove("open")),De()}function Pr(e){A.activeCategory=e,e?localStorage.setItem("library_active_category",e):localStorage.removeItem("library_active_category"),ke()}async function Ze(e=!1){try{if(Z.isDemo){const[r,i]=await Promise.all([be.loadBookmarks(e),be.loadSeries(e)]);A.bookmarks=r,A.categories=[],A.series=i,A.favorites={favorites:{},listOrder:[]},A.loading=!1;return}const[t,s,a,n]=await Promise.all([be.loadBookmarks(e),be.loadCategories(e),be.loadSeries(e),be.loadFavorites(e)]);A.bookmarks=t,A.categories=s,A.series=a,A.favorites=n,A.loading=!1}catch{h("Failed to load library","error"),A.loading=!1}}async function ke(){var t;const e=document.getElementById("app");if(Z.isDemo)A.activeCategory=null,A.artistFilter=null,A.searchQuery="",A.searchAuthor=null,A.searchAuthorSource=null;else{const s=localStorage.getItem("library_active_category");A.activeCategory!==s&&(A.activeCategory=s);const a=localStorage.getItem("library_artist_filter")||null;A.artistFilter!==a&&(A.artistFilter=a);const n=localStorage.getItem("library_search")||"";A.searchQuery!==n&&(A.searchQuery=n),A.searchAuthor=localStorage.getItem("library_search_author")||null,A.searchAuthorSource=localStorage.getItem("library_search_author_source")||null}A.loading&&(e.innerHTML=Ot()),A.bookmarks.length===0&&A.loading&&await Ze(),e.innerHTML=Ot(),Aa(),sessionStorage.getItem("open_add_modal")&&(sessionStorage.removeItem("open_add_modal"),(t=document.getElementById("add-modal"))==null||t.classList.add("open")),Nt.forEach(s=>s()),Nt=[be.subscribe("bookmarks",s=>{A.bookmarks=s;const a=document.getElementById("library-grid");if(a){const n=Yt();a.innerHTML=n.map(Jt).join("")||Xt()}})]}function qr(){const e=document.getElementById("app");e&&e.removeEventListener("click",vs),window.removeEventListener("clearFilters",fs),je&&(document.removeEventListener("click",je),je=null),Nt.forEach(t=>t()),Nt=[]}const Rr={mount:ke,unmount:qr,render:Ot},Dr="manga-offline",Nr=1,Ge="images",pe="chapters";let Lt=null;function St(){return new Promise((e,t)=>{if(Lt)return e(Lt);const s=indexedDB.open(Dr,Nr);s.onupgradeneeded=a=>{const n=a.target.result;n.objectStoreNames.contains(Ge)||n.createObjectStore(Ge),n.objectStoreNames.contains(pe)||n.createObjectStore(pe)},s.onsuccess=()=>{Lt=s.result,e(Lt)},s.onerror=()=>t(s.error)})}function Ke(e,t){return St().then(s=>new Promise((a,n)=>{const c=s.transaction(e,"readonly").objectStore(e).get(t);c.onsuccess=()=>a(c.result),c.onerror=()=>n(c.error)}))}function ys(e,t,s){return St().then(a=>new Promise((n,r)=>{const l=a.transaction(e,"readwrite").objectStore(e).put(s,t);l.onsuccess=()=>n(),l.onerror=()=>r(l.error)}))}function bs(e,t){return St().then(s=>new Promise((a,n)=>{const c=s.transaction(e,"readwrite").objectStore(e).delete(t);c.onsuccess=()=>a(),c.onerror=()=>n(c.error)}))}function Ns(e){return St().then(t=>new Promise((s,a)=>{const i=t.transaction(e,"readonly").objectStore(e).getAllKeys();i.onsuccess=()=>s(i.result),i.onerror=()=>a(i.error)}))}function nt(e,t){return`${e}:${t}`}function Fs(e,t,s){return`${e}:${t}:${s}`}function Fr(e){const t=e.split(":");return{mangaId:t[0],chapterNum:parseFloat(t[1])}}async function Os(e,t,s=null){const a=await f.get(`/bookmarks/${e}/chapters/${t}/reader-images`);if(!a||!a.images||a.images.length===0)throw new Error("No images found for this chapter");const n=a.images,r=n.length;let i=0;const c=f.getToken();for(let u=0;u<n.length;u++){const p=typeof n[u]=="string"?n[u]:n[u].url,d=p.startsWith("http")?p:`${window.location.origin}${p}`;try{const g=await fetch(d,{headers:c?{Authorization:`Bearer ${c}`}:{}});if(!g.ok)throw new Error(`HTTP ${g.status}`);const $=await g.blob();await ys(Ge,Fs(e,t,p),$),i++,s&&s(i,r)}catch(g){console.error(`[Offline] Failed to cache image ${u+1}/${r}:`,g)}}const l={mangaId:e,chapterNum:t,imageUrls:n.map(u=>typeof u=="string"?u:u.url),savedAt:Date.now(),imageCount:i};return await ys(pe,nt(e,t),l),{success:!0,imageCount:i}}async function Or(e,t){const s=await Ke(pe,nt(e,t));if(!s)return null;const a=[];for(const n of s.imageUrls){const r=await Ke(Ge,Fs(e,t,n));if(r)a.push(URL.createObjectURL(r));else return a.forEach(i=>URL.revokeObjectURL(i)),null}return a}async function _a(e,t){const s=await Ke(pe,nt(e,t));if(s&&s.imageUrls)for(const a of s.imageUrls)await bs(Ge,Fs(e,t,a));await bs(pe,nt(e,t))}async function Ur(e,t){if(!await Ke(pe,nt(e,t)))return!1;await _a(e,t);try{return await Os(e,t),!0}catch(a){return console.warn("[Offline] Could not re-save chapter after edit:",a),!1}}async function Hr(e,t){return!!await Ke(pe,nt(e,t))}async function Vr(){const e=await Ns(pe),t=[];for(const s of e){if(s.startsWith("auto-offline-"))continue;const a=await Ke(pe,s);a&&t.push(a)}return t}async function Pa(e){const t=await Ns(pe),s=[];for(const a of t)if(!a.startsWith("auto-offline-")&&a.startsWith(`${e}:`)){const{chapterNum:n}=Fr(a);s.push(n)}return s}async function jr(){if(navigator.storage&&navigator.storage.estimate){const e=await navigator.storage.estimate();return{used:e.usage||0,quota:e.quota||0,usedMB:((e.usage||0)/(1024*1024)).toFixed(1),quotaMB:((e.quota||0)/(1024*1024)).toFixed(0)}}return{used:0,quota:0,usedMB:"0",quotaMB:"Unknown"}}async function zr(){const e=await St();await new Promise((t,s)=>{const r=e.transaction(Ge,"readwrite").objectStore(Ge).clear();r.onsuccess=t,r.onerror=s}),await new Promise((t,s)=>{const r=e.transaction(pe,"readwrite").objectStore(pe).clear();r.onsuccess=t,r.onerror=s})}async function Qr(e,t){t?await ys(pe,`auto-offline-${e}`,{enabled:!0,mangaId:e}):await bs(pe,`auto-offline-${e}`)}async function Wr(e){const t=await Ke(pe,`auto-offline-${e}`);return!!(t!=null&&t.enabled)}async function Gr(){return(await Ns(pe)).filter(t=>t.startsWith("auto-offline-")).map(t=>t.replace("auto-offline-",""))}"serviceWorker"in navigator&&navigator.serviceWorker.addEventListener("message",async e=>{var t;if(((t=e.data)==null?void 0:t.type)==="sync-offline"){const s=e.data.mangaId;console.log(`[Offline] Auto-sync triggered for manga ${s}`);try{await qa(s)}catch(a){console.error("[Offline] Auto-sync failed:",a)}}});async function qa(e){try{const t=await f.getBookmark(e);if(!t)return;const s=t.downloadedChapters||[],a=await Pa(e),n=s.filter(r=>!a.includes(r));console.log(`[Offline] ${n.length} new chapters to sync for ${t.alias||t.title}`);for(const r of n)await Os(e,r),console.log(`[Offline] Auto-synced chapter ${r}`)}catch(t){console.error("[Offline] Sync error:",t)}}const Kr={saveChapterOffline:Os,getOfflineChapter:Or,deleteOfflineChapter:_a,refreshOfflineChapter:Ur,isChapterOffline:Hr,getOfflineChapters:Vr,getOfflineChaptersForManga:Pa,getStorageUsage:jr,clearAllOfflineData:zr,setAutoOffline:Qr,isAutoOffline:Wr,getAutoOfflineManga:Gr,syncNewChaptersForManga:qa},Yr=e=>String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");let o={manga:null,chapter:null,versionUrl:null,images:[],trophyPages:{},mode:"manga",direction:"rtl",firstPageSingle:!0,lastPageSingle:!1,singlePageMode:!0,currentPage:0,zoom:100,loading:!0,showControls:!0,isGalleryMode:!1,isCollectionMode:!1,favoriteLists:[],allFavorites:null,navigationDirection:null,nextChapterImage:null,nextChapterNum:null,_preloadCache:null,isStreamingMode:!1,_streamAbortController:null,isVolumeMode:!1,volume:null};function Us(e,t=o.manga){if(!e||!t)return"";const s=(t.chapters||[]).find(n=>n.url===e),a=[];return s&&(s.releaseGroup?a.push(s.releaseGroup):s.title&&s.title!==`Chapter ${s.number}`&&a.push(s.title)),e.startsWith("local://")&&a.push("Local"),a.join(" · ")}function Hs(e){var s,a;const t=(a=(s=o.manga)==null?void 0:s.downloadedVersions)==null?void 0:a[e];return Array.isArray(t)?t:t?[t]:[]}function Jr(){var t;const e=Hs((t=o.chapter)==null?void 0:t.number);return e.length<2||!o.versionUrl?"":Us(o.versionUrl)||`Version ${e.indexOf(o.versionUrl)+1}`}function Ra(){if(!o.manga||!o.chapter||!o.allFavorites||!o.allFavorites.favorites)return!1;if(o.isCollectionMode)return!0;let t=[ks()];if(o.mode==="manga"&&!o.singlePageMode){const n=de()[o.currentPage];n&&Array.isArray(n)?t=n:n&&n.pages&&(t=n.pages)}const s=t.map(a=>{const n=$t(o.images[a]);return n?{filename:n}:null}).filter(Boolean);for(const a in o.allFavorites.favorites){const n=o.allFavorites.favorites[a];if(Array.isArray(n)){for(const r of n)if(r.mangaId===o.manga.id&&r.chapterNum===o.chapter.number&&r.imagePaths)for(const i of r.imagePaths){const c=typeof i=="string"?i:(i==null?void 0:i.filename)||(i==null?void 0:i.path);for(const l of s)if(l&&l.filename===c)return!0}}}return!1}function ws(){const e=document.getElementById("favorites-btn");e&&(Ra()?e.classList.add("active"):e.classList.remove("active"))}function Qe(){var d,g;if(o.loading)return`
    ...
    `;const e=o.manga.alias||o.manga.title,t=(d=o.chapter)==null?void 0:d.number,s=o.isCollectionMode||o.isStreamingMode?"":Jr(),a=!o.isCollectionMode&&!o.isStreamingMode&&Hs(t).length>1,r=de().length,i=o.images.length;let c,l;o.mode==="webtoon"?(c=i-1,l=`${i} pages`):o.singlePageMode?(c=i-1,l=`${o.currentPage+1} / ${i}`):(c=r-1,l=`${o.currentPage+1} / ${r}`);const u=Ra(),p=Oa();return`
    <div class="reader ${o.mode}-mode ${o.showControls?"":"controls-hidden"}">
      ...
      <div class="reader-bar">
        ...
        <div class="reader-bar-tools" id="reader-toolbar">
          ...
          `:`
          ${o.isVolumeMode?"":`<button class="reader-bar-btn ${u?"active":""}" id="favorites-btn" title="Add to favorites">${m("star",{title:"Add to favorites"})}</button>`}
  ...
  `}function Xr(){const e=o.currentPage,t=o.trophyPages[e];if(t&&!t.isSingle&&t.pages&&t.pages.length===2){const[r,i]=t.pages,c=o.images[r],l=o.images[i],u=typeof c=="string"?c:c==null?void 0:c.url,p=typeof l=="string"?l:l==null?void 0:l.url;if(u&&p)return`
            <div class="manga-spread ${o.direction}">
              <div class="manga-page trophy-page"><div class="trophy-indicator">${m("trophy")}</div><img src="${u}" alt="Page ${r+1}"></div>
  ...
  `}function de(){const e=[],t=o.images.length;let s=0;if(o.isCollectionMode){for(let n=0;n<t;n++)e.push([n]);return e}let a=!o.firstPageSingle;for(;s<t;){const n=o.trophyPages[s];if(n){if(!n.isSingle&&n.pages&&n.pages.length===2){const[r,i]=n.pages;e.push([r,i]),s=Math.max(r,i)+1}else e.push([s]),s++;continue}if(!a){a=!0,e.push([s]),s++;continue}if(o.lastPageSingle&&s===t-1){o.nextChapterImage?e.push({type:"link",pages:[s],nextImage:o.nextChapterImage,nextChapter:o.nextChapterNum}):e.push([s]),s++;break}s+1<t?o.trophyPages[s+1]?(e.push([s]),s++):o.lastPageSingle&&s+1===t-1?(e.push([s]),o.nextChapterImage?e.push({type:"link",pages:[s+1],nextImage:o.nextChapterImage,nextChapter:o.nextChapterNum}):e.push([s+1]),s+=2):(e.push([s,s+1]),s+=2):(e.push([s]),s++)}return e}function Oa(){if(o.singlePageMode)return!!o.trophyPages[o.currentPage];const t=de()[o.currentPage];return t?(Array.isArray(t)?t:t.pages||[]).some(a=>!!o.trophyPages[a]):!1}function Vs(){if(o.singlePageMode)return[o.currentPage];const t=de()[o.currentPage];return t?Array.isArray(t)?t:t.pages||[]:[]}async function Zr(){if(!o.manga||!o.chapter||o.isCollectionMode)return;const e=Vs();if(e.length===0)return;if(e.some(s=>!!o.trophyPages[s])){const s=[...e];if(o.singlePageMode){const a=o.trophyPages[o.currentPage];a&&!a.isSingle&&a.pages&&a.pages.length>1&&(s.length=0,s.push(...a.pages))}s.forEach(a=>delete o.trophyPages[a]),h(`Page${s.length>1?"s":""} unmarked as trophy`,"info")}else{let s=e,a=o.singlePageMode||e.length===1;if(!o.singlePageMode&&e.length===2){const r=await Qa(e,"Mark as trophy");if(!r)return;s=r.pages,a=r.pages.length===1}s.forEach(r=>{o.trophyPages[r]={isSingle:a,pages:[...s]}});const n=a?"single":"double";h(`Page${s.length>1?"s":""} marked as trophy (${n})`,"success")}try{await f.saveTrophyPages(o.manga.id,o.chapter.number,o.trophyPages)}catch(s){console.error("Failed to save trophy pages:",s)}qe(),Ua()}function Ua(){const e=document.getElementById("trophy-btn");if(e){const t=Oa();e.classList.toggle("active",t),e.title=t?"Unmark trophy":"Mark as trophy"}}function Ha(){var a;if(!o.manga||!o.chapter||o.isCollectionMode||o.isStreamingMode||!o.images.length)return null;const e=o.images.length;let t=1,s=!1;if(o.mode==="manga"){const n=Vs();n.length>0&&(t=Math.min(...n)+1),s=n.includes(e-1)}else{const n=document.getElementById("reader-content");if(n){const r=[...n.querySelectorAll("img")],i=n.scrollTop;let c=0;r.forEach((p,d)=>{i>=c&&(t=d+1),c+=p.offsetHeight});const l=n.scrollHeight>n.clientHeight+10,u=r.length>0&&r.every(p=>p.complete&&p.naturalHeight>0);s=l?i+n.clientHeight>=n.scrollHeight-4:u}}return s&&(t=e),{mangaId:o.manga.id,chapterNumber:o.chapter.number,volumeId:o.isVolumeMode?(a=o.volume)==null?void 0:a.id:null,currentPage:t,totalPages:e}}async function Ye(e=Ha()){var t,s;if(!(!e||Z.isDemo)){if(e.volumeId){try{if(await f.saveVolumeProgress(e.mangaId,e.volumeId,e.currentPage,e.totalPages),e.currentPage>=e.totalPages&&((t=o.manga)==null?void 0:t.id)===e.mangaId&&o.volume){const a=new Set(o.manga.readChapters||[]);for(const n of o.volume.chapters||[])a.add(n);o.manga.readChapters=[...a]}}catch(a){console.error("Failed to save volume progress:",a)}return}try{if(await f.updateReadingProgress(e.mangaId,e.chapterNumber,e.currentPage,e.totalPages),e.currentPage>=e.totalPages&&((s=o.manga)==null?void 0:s.id)===e.mangaId){const a=new Set(o.manga.readChapters||[]);a.add(e.chapterNumber),o.manga.readChapters=[...a]}}catch(a){console.error("Failed to save progress:",a)}}}let ze=null;function Va(){ze&&clearTimeout(ze),ze=setTimeout(()=>{ze=null,Ye()},1500)}function Ut(){var s,a,n,r,i,c,l,u,p,d,g,$,v,y,L,w,x,T,k,I,N;const e=document.getElementById("app");(s=document.getElementById("reader-close-btn"))==null||s.addEventListener("click",async()=>{o.isStreamingMode||(await Ye(),await Ue()),o.isStreamingMode?H.go("/scrapers"):o.manga&&o.manga.id!=="gallery"?H.go(`/manga/${o.manga.id}`):H.go("/")}),(a=document.getElementById("reader-back-btn"))==null||a.addEventListener("click",()=>{H.go(o.isStreamingMode?"/scrapers":"/")}),(n=document.getElementById("reader-settings-btn"))==null||n.addEventListener("click",()=>{var E;(E=document.getElementById("reader-settings"))==null||E.classList.toggle("hidden")}),(r=document.getElementById("close-settings-btn"))==null||r.addEventListener("click",()=>{var E;(E=document.getElementById("reader-settings"))==null||E.classList.add("hidden")}),(i=document.getElementById("single-page-btn"))==null||i.addEventListener("click",()=>{if(o.singlePageMode){const E=de();let b=0;for(let M=0;M<E.length;M++)if(E[M].includes(o.currentPage)){b=M;break}o.singlePageMode=!1,o.currentPage=b}else{const b=de()[o.currentPage];o.singlePageMode=!0,o.currentPage=b?b[0]:0}localStorage.setItem("reader_single_page",o.singlePageMode?"1":"0"),tt()}),(c=document.getElementById("trophy-btn"))==null||c.addEventListener("click",()=>{Zr()}),e.querySelectorAll("[data-mode]").forEach(E=>{E.addEventListener("click",()=>{var _,F;const b=E.dataset.mode;let M=ks();if(o.mode=b,localStorage.setItem("reader_mode",o.mode),b==="webtoon")o.currentPage=M;else if(o.singlePageMode)o.currentPage=M;else{const V=de();let X=0;for(let z=0;z<V.length;z++)if(V[z].includes(M)){X=z;break}o.currentPage=X}(_=o.manga)!=null&&_.id&&((F=o.chapter)!=null&&F.number)&&Ue(),tt(),b==="webtoon"&&setTimeout(()=>{const V=document.getElementById("reader-content");if(V){const X=V.querySelectorAll("img");X[M]&&X[M].scrollIntoView({behavior:"auto",block:"start"})}},100)})}),e.querySelectorAll("[data-direction]").forEach(E=>{E.addEventListener("click",async()=>{var b,M;o.direction=E.dataset.direction,localStorage.setItem("reader_direction",o.direction),(b=o.manga)!=null&&b.id&&((M=o.chapter)!=null&&M.number)&&await Ue(),tt()})}),(l=document.getElementById("first-page-single"))==null||l.addEventListener("change",async E=>{o.firstPageSingle=E.target.checked,await Ue(),qe()}),(u=document.getElementById("last-page-single"))==null||u.addEventListener("change",async E=>{var b,M;o.lastPageSingle=E.target.checked,await Ue(),o.lastPageSingle&&((b=o.manga)!=null&&b.id)&&((M=o.chapter)!=null&&M.number)?await ja():(o.nextChapterImage=null,o.nextChapterNum=null),qe()}),(p=document.getElementById("zoom-slider"))==null||p.addEventListener("input",E=>{o.zoom=parseInt(E.target.value);const b=document.getElementById("reader-content");b&&(b.style.zoom=`${o.zoom}%`)});const t=document.getElementById("page-slider");if(t&&(t.addEventListener("input",E=>{const b=parseInt(E.target.value),M=document.getElementById("page-indicator");M&&(o.singlePageMode?M.textContent=`${b+1} / ${o.images.length}`:M.textContent=`${b+1} / ${de().length}`)}),t.addEventListener("change",E=>{o.currentPage=parseInt(E.target.value),qe()})),o.mode==="manga"){const E=document.getElementById("reader-content");E==null||E.addEventListener("click",b=>{var V;if(b.target.closest("button, a, .link-overlay"))return;const M=E.getBoundingClientRect(),F=(b.clientX-M.left)/M.width;F<.3?Es():F>.7?At():(o.showControls=!o.showControls,(V=document.querySelector(".reader"))==null||V.classList.toggle("controls-hidden",!o.showControls))})}document.addEventListener("keydown",Wa),(d=document.getElementById("prev-chapter-btn"))==null||d.addEventListener("click",()=>Ht(-1)),(g=document.getElementById("next-chapter-btn"))==null||g.addEventListener("click",()=>Ht(1)),o.mode==="webtoon"&&(($=document.getElementById("reader-content"))==null||$.addEventListener("click",()=>{var E;o.showControls=!o.showControls,(E=document.querySelector(".reader"))==null||E.classList.toggle("controls-hidden",!o.showControls)}),(v=document.getElementById("reader-content"))==null||v.addEventListener("scroll",Va,{passive:!0})),(y=document.getElementById("rotate-btn"))==null||y.addEventListener("click",async()=>{const E=ls();if(!(!E||!o.manga||!o.chapter))try{h("Rotating...","info");const b=await It().rotate(E);b.images&&(await cs(b.images),h("Page rotated","success"))}catch(b){h("Rotate failed: "+b.message,"error")}}),(L=document.getElementById("swap-btn"))==null||L.addEventListener("click",async()=>{const b=de()[o.currentPage];if(!b||b.length!==2||!o.manga||!o.chapter){h("Select a spread with 2 pages to swap","info");return}const M=$t(o.images[b[0]]),_=$t(o.images[b[1]]);if(!(!M||!_))try{h("Swapping...","info");const F=await It().swap(M,_);F.images&&(await cs(F.images),h("Pages swapped","success"))}catch(F){h("Swap failed: "+F.message,"error")}}),(w=document.getElementById("split-btn"))==null||w.addEventListener("click",async()=>{const E=ls();if(!E||!o.manga||!o.chapter||!confirm("Split this page into halves? This is permanent."))return;const b=document.getElementById("split-btn");try{h("Preparing to split...","info"),b&&(b.disabled=!0),o.images=[],o.loading=!0,e.innerHTML=Qe(),await new Promise(_=>setTimeout(_,2e3)),h("Splitting page...","info");const M=await It().split(E);b&&(b.disabled=!1),await Oe(o.manga.id,na(),o.versionUrl),e.innerHTML=Qe(),Ut(),qe(),M.warning?h(M.warning,"warning"):h("Page split into halves","success")}catch(M){b&&(b.disabled=!1),h("Split failed: "+M.message,"error"),await Oe(o.manga.id,na(),o.versionUrl),e.innerHTML=Qe(),Ut()}}),(x=document.getElementById("delete-page-btn"))==null||x.addEventListener("click",async()=>{const E=ls();if(!(!E||!o.manga||!o.chapter)&&confirm(`Delete page "${E}" permanently? This cannot be undone.`))try{h("Deleting...","info");const b=await It().remove(E);b.images&&(await cs(b.images),h("Page deleted","success"))}catch(b){h("Delete failed: "+b.message,"error")}}),(T=document.getElementById("favorites-btn"))==null||T.addEventListener("click",async()=>{try{const M=await f.getFavorites();o.allFavorites=M,o.favoriteLists=Object.keys(M.favorites||M||{})}catch(M){console.error("Failed to load favorites",M),h("Failed to load favorites","error");return}let b=[ks()];if(o.mode==="manga"&&!o.singlePageMode){const _=de()[o.currentPage];_&&Array.isArray(_)?b=_:_&&_.pages&&(b=_.pages)}if(b.length>1){const M=await Qa(b,"Select Page for Favorites");if(!M)return;b=M.pages}no(b)}),(k=document.getElementById("version-btn"))==null||k.addEventListener("click",()=>{so()}),(I=document.getElementById("fullscreen-btn"))==null||I.addEventListener("click",()=>{document.fullscreenElement?document.exitFullscreen():document.documentElement.requestFullscreen().catch(()=>{h("Fullscreen not supported","info")})}),(N=document.getElementById("stream-add-lib-btn"))==null||N.addEventListener("click",async()=>{var M;const E=document.getElementById("stream-add-lib-btn");if(!((M=o.manga)!=null&&M._streamUrl)){h("No URL to add","error");return}const b=E.innerHTML;E.innerHTML=m("loader",{spin:!0}),E.disabled=!0;try{const _=await f.addBookmark(o.manga._streamUrl);if(!_.jobId)throw new Error("No job ID returned");h("Adding to library...","info");const F=setInterval(async()=>{var V;try{const z=(await f.getQueueHistory(20)).find(te=>te.id===_.jobId);z&&(z.status==="completed"?(clearInterval(F),(V=z.result)!=null&&V.bookmark&&(h("Added to library!","success"),E.innerHTML=m("check"),E.title="Added! Click to view",E.disabled=!1,E.onclick=()=>{H.go(`/manga/${z.result.bookmark.id}`)})):z.status==="failed"&&(clearInterval(F),h("Failed to add: "+(z.error||"Unknown error"),"error"),E.innerHTML=b,E.disabled=!1))}catch{}},1500)}catch(_){h("Failed to add: "+_.message,"error"),E.innerHTML=b,E.disabled=!1}}),document.body.classList.add("reader-active")}function $s(e){return-(1e3+(Number(e==null?void 0:e.number)||0))}async function eo(e,t){const s=$s(t.volume);try{let a=await f.getChapterSettings(e,s);!Vt(a)&&t.prev&&(a=await f.getChapterSettings(e,$s(t.prev))),Vt(a)&&Ss(a)}catch(a){console.warn("Failed to load volume settings",a)}try{o.trophyPages=await f.getTrophyPages(e,s)||{}}catch{o.trophyPages={}}}function It(){const e=o.manga.id;if(o.isVolumeMode){const s=o.volume.id;return{rotate:a=>f.rotateVolumePage(e,s,a,90),swap:(a,n)=>f.swapVolumePages(e,s,a,n),split:a=>f.splitVolumePage(e,s,a),remove:a=>f.deleteVolumePage(e,s,a)}}const t=o.chapter.number;return{rotate:s=>f.rotatePage(e,t,s,90,o.versionUrl),swap:(s,a)=>f.swapPages(e,t,s,a,o.versionUrl),split:s=>f.splitPage(e,t,s,o.versionUrl),remove:s=>f.deletePage(e,t,s,o.versionUrl)}}function na(){return o.isVolumeMode?`volume:${o.volume.id}`:o.chapter.number}function $t(e){var n;const t=typeof e=="string"?e:(e==null?void 0:e.url)||((n=e==null?void 0:e.urls)==null?void 0:n[0]);if(!t)return null;const a=t.split("?")[0].split("/");return decodeURIComponent(a[a.length-1])}function ls(){const e=Vs();return e.length===0?null:$t(o.images[e[0]])}async function cs(e){var s,a;(s=o.manga)!=null&&s.id&&((a=o.chapter)!=null&&a.number)&&!o.isStreamingMode&&!o.isVolumeMode&&Kr.refreshOfflineChapter(o.manga.id,o.chapter.number).then(n=>{n&&console.log("[Reader] Refreshed offline copy after page edit")}).catch(n=>console.warn("[Reader] Offline refresh failed:",n));const t=Date.now();if(o.images=e.map(n=>{const r=typeof n=="string"?n:n==null?void 0:n.url;if(!r)return n;const i=r+(r.includes("?")?"&":"?")+`_t=${t}`;return typeof n=="string"?i:{...n,url:i}}),o.mode==="manga")if(o.singlePageMode)o.currentPage=Math.min(o.currentPage,o.images.length-1);else{const n=de();o.currentPage=Math.min(o.currentPage,n.length-1)}o.currentPage=Math.max(0,o.currentPage),qe()}async function ja(){var e,t;if(!(!((e=o.manga)!=null&&e.id)||!((t=o.chapter)!=null&&t.number)||o.isVolumeMode))try{const s=await f.getNextChapterPreview(o.manga.id,o.chapter.number);o.nextChapterImage=s.firstImage||null,o.nextChapterNum=s.nextChapter||null}catch{o.nextChapterImage=null,o.nextChapterNum=null}}async function to(){var r,i;if(!((r=o.manga)!=null&&r.id)||!((i=o.chapter)!=null&&i.number)||o.isCollectionMode||o.isVolumeMode)return;const t=[...o.manga.downloadedChapters||[]].sort((c,l)=>c-l),s=t.indexOf(o.chapter.number);if(s<0||s>=t.length-1)return;const a=t[s+1],n=o.manga.id;if(!(o._preloadCache&&o._preloadCache.chapterNum===a&&o._preloadCache.mangaId===n))try{const l=(o.manga.downloadedVersions||{})[a]||[],u=Array.isArray(l)?l[0]:l,p=u?`/bookmarks/${n}/chapters/${a}/reader-images?version=${encodeURIComponent(u)}`:`/bookmarks/${n}/chapters/${a}/reader-images`,g=(await f.get(p)).images||[];if(g.length===0)return;const $=g.map(v=>{const y=new Image,L=typeof v=="string"?v:v.url;return L&&(y.src=L),y});o._preloadCache={chapterNum:a,mangaId:n,images:g,imageObjects:$,versionUrl:u},console.log(`[Reader] Preloaded ${g.length} images for chapter ${a}`)}catch(c){console.warn("[Reader] Failed to preload next chapter:",c)}}function za(e,t,s=o.manga,a=[],n={}){return new Promise(r=>{const i=document.createElement("div");i.className="version-modal-overlay",i.innerHTML=`
        ...
        `;const c=i.querySelector(".version-list");e.forEach((l,u)=>{const p=document.createElement("button");p.className="version-item";const d=n.current&&n.current===l;d&&p.classList.add("current");const g=(Us(l,s)||`Version ${u+1}`)+(d?" (reading)":""),$=a.find(w=>w.url===l),v=[];if($!=null&&$.imageCount&&v.push(`${$.imageCount} pages`),$!=null&&$.folder&&v.push($.folder),p.innerHTML=`<span class="version-item-title"></span>${v.length?'<span class="version-item-meta"></span>':""}`,p.querySelector(".version-item-title").textContent=g,v.length&&(p.querySelector(".version-item-meta").textContent=v.join(" · ")),p.title=l,p.addEventListener("click",()=>{i.remove(),r(l)}),!n.allowKeep){c.appendChild(p);return}const y=document.createElement("div");y.className="version-item-row",y.appendChild(p);const L=document.createElement("button");L.className="version-item-keep",L.textContent="Keep only",L.title="Delete every other downloaded version of this chapter",L.addEventListener("click",()=>{i.remove(),r({keep:l})}),y.appendChild(L),c.appendChild(y)}),i.querySelector(".version-cancel").addEventListener("click",()=>{i.remove(),r(null)}),i.addEventListener("click",l=>{l.target===i&&(i.remove(),r(null))}),document.body.appendChild(i)})}async function so(){if(!o.manga||!o.chapter||o.isCollectionMode||o.isStreamingMode)return;const e=o.chapter.number,t=Hs(e);if(t.length<2)return;let s=[];try{s=(await f.getChapterVersions(o.manga.id,e)).versions||[]}catch{}const a=await za(t,e,o.manga,s,{current:o.versionUrl,allowKeep:!0});if(a){if(typeof a=="string"){a!==o.versionUrl&&(await Ye(),H.go(`/read/${o.manga.id}/${e}?version=${encodeURIComponent(a)}`));return}a.keep&&await ao(e,a.keep,t)}}async function ao(e,t,s){var c;const a=s.filter(l=>l!==t),n=Us(t)||"this version";if(!confirm(`Keep only "${n}" and delete the other ${a.length} downloaded version${a.length>1?"s":""} of chapter ${e}?`))return;const r=o.manga.id;let i=0;for(const l of a)try{await f.deleteChapterVersion(r,e,l)}catch(u){i++,h("Failed to delete a version: "+u.message,"error")}i===0&&h("Other versions deleted","success");try{const l=await f.getBookmark(r);((c=o.manga)==null?void 0:c.id)===r&&(o.manga=l)}catch{}t!==o.versionUrl?H.go(`/read/${r}/${e}?version=${encodeURIComponent(t)}`):tt()}function no(e){if(!o.manga||!o.chapter)return;const t=e.map(l=>{const u=$t(o.images[l]);return u?{filename:u}:null}).filter(Boolean),s=l=>{if(!o.allFavorites||!o.allFavorites.favorites)return-1;const u=o.allFavorites.favorites[l];if(!Array.isArray(u))return-1;for(let p=0;p<u.length;p++){const d=u[p];if(d.mangaId===o.manga.id&&d.chapterNum===o.chapter.number&&d.imagePaths)for(const g of d.imagePaths){const $=typeof g=="string"?g:(g==null?void 0:g.filename)||(g==null?void 0:g.path);for(const v of t)if(v&&v.filename===$)return p}}return-1},a=document.createElement("div");a.className="page-picker-overlay";let n="";o.favoriteLists.length===0?n='<div style="margin: 20px 0; color: #888;">No favorite lists available.</div>':(n='<div class="favorite-list-selection" style="display: flex; flex-direction: column; gap: 10px; margin-bottom: 20px; max-height: 400px; overflow-y: auto;">',o.favoriteLists.forEach(l=>{const p=s(l)!==-1;n+=`
    ...
    `,a.appendChild(r),a.querySelector(".page-picker-cancel").addEventListener("click",()=>{a.remove(),ws()}),a.addEventListener("click",l=>{l.target===a&&(a.remove(),ws())}),a.querySelectorAll(".list-option").forEach(l=>{l.addEventListener("click",async()=>{const u=l.dataset.list,p=s(u),d=p!==-1;l.style.opacity="0.5",l.style.pointerEvents="none";try{if(d){await f.removeFavoriteItem(u,p);const g=await f.getFavorites();o.allFavorites=g,l.classList.remove("active-list"),l.querySelector("span:last-child").innerHTML=m("plus")}else{const g=e.length>1?"double":"single",$={mangaId:o.manga.id,chapterNum:o.chapter.number,title:`${o.manga.alias||o.manga.title} Ch.${o.chapter.number} p${e[0]+1}`,imagePaths:t,displayMode:g,displaySide:o.direction==="rtl"?"right":"left"};await f.addFavoriteItem(u,$);const v=await f.getFavorites();o.allFavorites=v,l.classList.add("active-list"),l.querySelector("span:last-child").innerHTML=m("check")}}catch(g){console.error(g)}finally{l.style.opacity="1",l.style.pointerEvents="auto"}})}),document.body.appendChild(a)}function Qa(e,t){return new Promise(s=>{const[a,n]=e,r=o.images[a],i=o.images[n],c=typeof r=="string"?r:r==null?void 0:r.url,l=typeof i=="string"?i:i==null?void 0:i.url,u=o.direction==="rtl",p=u?n:a,d=u?a:n,g=u?l:c,$=u?c:l,v=document.createElement("div");v.className="page-picker-overlay",v.innerHTML=`
            <div class="page-picker-modal">
                ...
                <div class="page-picker-previews">
                    ...
                    <button class="page-picker-option" data-choice="right" title="Page ${d+1}">
                        <img src="${$}" alt="Page ${d+1}">
                        <span class="page-picker-label">Page ${d+1}</span>
                    </button>
                </div>
        ...
        `;const y=L=>{v.remove(),s(L)};v.querySelectorAll(".page-picker-option").forEach(L=>{L.addEventListener("click",()=>{const w=L.dataset.choice;w==="left"?y({pages:[p]}):w==="right"?y({pages:[d]}):w==="both"&&y({pages:e})})}),v.querySelector(".page-picker-cancel").addEventListener("click",()=>y(null)),v.addEventListener("click",L=>{L.target===v&&y(null)}),document.body.appendChild(v)})}function ks(){if(o.mode==="webtoon"){const e=document.getElementById("reader-content");if(e){const t=e.querySelectorAll("img");if(t.length>0){const s=e.scrollTop;if(s>10){let a=0;for(let n=0;n<t.length;n++){const r=t[n].offsetHeight;if(a+r>s)return n;a+=r}}}}return 0}else{if(o.singlePageMode)return o.currentPage;{const t=de()[o.currentPage];return t&&t.length>0?t[0]:0}}}function Wa(e){var t;if(!(e.target.tagName==="INPUT"||e.target.tagName==="TEXTAREA")){if(e.key==="Escape"){const s=(t=o.manga)==null?void 0:t.id;Promise.all([Ye(),Ue()]).finally(()=>{s&&H.go(`/manga/${s}`)});return}if(o.mode==="manga")e.key==="ArrowLeft"?o.direction==="rtl"?At():Es():e.key==="ArrowRight"?o.direction==="rtl"?Es():At():e.key===" "&&(e.preventDefault(),At());else if(o.mode==="webtoon"&&e.key===" "){e.preventDefault();const s=document.getElementById("reader-content");if(s){const a=s.clientHeight*.8;s.scrollBy({top:e.shiftKey?-a:a,behavior:"smooth"})}}}}function At(){const e=de(),t=o.singlePageMode?o.images.length-1:e.length-1;if(o.currentPage<t)o.currentPage++,qe();else{const s=e[o.currentPage],a=s&&s.type==="link";Ye(),a&&(o.navigationDirection="next-linked"),Ht(1)}}function Es(){o.currentPage>0?(o.currentPage--,qe()):Ht(-1)}function qe(){const e=document.getElementById("reader-content");if(e){e.innerHTML=o.isCollectionMode?Da():o.mode==="webtoon"?Na():Fa();const t=document.getElementById("page-indicator");t&&(o.singlePageMode?t.textContent=`${o.currentPage+1} / ${o.images.length}`:t.textContent=`${o.currentPage+1} / ${de().length}`);const s=document.getElementById("page-slider");s&&(s.value=o.currentPage,s.max=o.singlePageMode?o.images.length-1:de().length-1),Ua(),ws(),o.mode==="manga"&&Va()}}function tt(){const e=document.getElementById("app");e&&(e.innerHTML=Qe(),Ut())}async function Ht(e){var r,i;if(console.log("[Nav] navigateChapter called with delta:",e),o.isStreamingMode)return;if(!o.manga||!o.chapter){console.log("[Nav] early return - no manga or chapter");return}if(await Ye(),await Ue(),o.isVolumeMode){const c=e>0?(r=o.volume)==null?void 0:r.next:(i=o.volume)==null?void 0:i.prev;c?(o.navigationDirection=e<0?"prev":null,H.go(`/read/${o.manga.id}/volume/${c.id}`)):h(e>0?"Last volume":"First volume","info");return}const s=[...o.manga.downloadedChapters||[]].sort((c,l)=>c-l),a=s.indexOf(o.chapter.number),n=a+e;if(console.log("[Nav]",{delta:e,chapterNumber:o.chapter.number,sorted:s,currentIdx:a,newIdx:n}),n>=0&&n<s.length){o.navigationDirection||(o.navigationDirection=e<0?"prev":null);const c=s[n],u=(o.manga.downloadedVersions||{})[c]||[],p=Array.isArray(u)?u[0]:u,d=p?`?version=${encodeURIComponent(p)}`:"";console.log("[Nav] Calling router.go with:",`/read/${o.manga.id}/${c}${d}`),H.go(`/read/${o.manga.id}/${c}${d}`)}else h(e>0?"Last chapter":"First chapter","info")}async function Oe(e,t,s){var a,n,r,i,c;console.log("[Reader] loadData called:",{mangaId:e,chapterNum:t,versionUrl:s});try{o.mode=localStorage.getItem("reader_mode")||"manga",o.direction=localStorage.getItem("reader_direction")||"rtl",o.singlePageMode=localStorage.getItem("reader_single_page")!=="0",o.firstPageSingle=!0,o.lastPageSingle=!1,o.versionUrl=null,o.isVolumeMode=!1,o.volume=null;let l=null;if(String(t).startsWith("volume:")){const u=String(t).slice(7);o.isVolumeMode=!0,o.isCollectionMode=!1,o.isGalleryMode=!1,o.isStreamingMode=!1;const p=await f.getBookmark(e);o.manga=p;const d=await f.getVolumePages(e,u);o.volume={...d.volume,prev:d.prev||null,next:d.next||null},o.chapter={number:$s(d.volume),title:d.volume.name,volumeId:u},o.images=d.images||[],l=d.progress&&!d.progress.finished?d.progress:null,await eo(e,d)}else if(e==="gallery"){const u=decodeURIComponent(t),d=((a=(await f.getFavorites()).favorites)==null?void 0:a[u])||[];o.images=[];for(const g of d){const $=g.imagePaths||[],v=[];for(const y of $){let L;typeof y=="string"?L=y:y&&typeof y=="object"&&(L=y.filename||y.path||y.name||y.url,L&&L.includes("/")&&(L=L.split("/").pop()),L&&L.includes("\\")&&(L=L.split("\\").pop())),L&&v.push(`/api/public/chapter-images/${g.mangaId}/${g.chapterNum}/${encodeURIComponent(L)}`)}v.length>0&&o.images.push({urls:v,displayMode:g.displayMode||"single",displaySide:g.displaySide||"left"})}o.manga={id:"gallery",title:u,alias:u},o.chapter={number:"Gallery"},o.isGalleryMode=!0,o.isCollectionMode=!0,o.images.length===0&&h("Gallery is empty","warning")}else if(e==="trophies"){const u=t;let p=[],d="Trophies";if(u.startsWith("series-")){const g=u.replace("series-",""),v=(await store.loadSeries()).find(w=>w.id===g);d=v?v.alias||v.title:"Series Trophies";const L=(await store.loadBookmarks()).filter(w=>w.seriesId===g);for(const w of L){const x=await f.getTrophyPagesAll(w.id);for(const T in x)if(!(parseFloat(T)<0))for(const k in x[T]){const I=x[T][k],E=(await f.getChapterImages(w.id,T)).images[k],b=typeof E=="string"?E.split("/").pop():(E==null?void 0:E.filename)||(E==null?void 0:E.path);p.push({mangaId:w.id,chapterNum:T,imagePaths:[{filename:b}],displayMode:I.isSingle?"single":"double",displaySide:"left"})}}}else{const g=await f.getBookmark(u);d=g?g.alias||g.title:"Manga Trophies";const $=await f.getTrophyPagesAll(u);for(const v in $)if(!(parseFloat(v)<0))for(const y in $[v]){const L=$[v][y],x=(await f.getChapterImages(u,v)).images[y],T=typeof x=="string"?x.split("/").pop():(x==null?void 0:x.filename)||(x==null?void 0:x.path);p.push({mangaId:u,chapterNum:v,imagePaths:[{filename:decodeURIComponent(T)}],displayMode:L.isSingle?"single":"double",displaySide:"left"})}}o.images=p.map(g=>{const $=g.imagePaths[0].filename;return{urls:[`/api/public/chapter-images/${g.mangaId}/${g.chapterNum}/${encodeURIComponent($)}`],displayMode:g.displayMode,displaySide:g.displaySide}}),o.manga={id:"trophies",title:d,alias:d},o.chapter={number:"🏆"},o.isCollectionMode=!0,o.isGalleryMode=!1}else if(e==="stream"){o.isStreamingMode=!0,o.isCollectionMode=!1,o.isGalleryMode=!1,o.singlePageMode=!0;const u=sessionStorage.getItem("streamPreviewUrl"),p=sessionStorage.getItem("streamPreviewScraper"),d=sessionStorage.getItem("streamPreviewTitle")||"Preview";o.manga={id:"stream",title:d,alias:d,_streamUrl:u},o.chapter={number:1},o.images=[],u?ro(u,p):h("No stream URL found","error")}else{o.isGalleryMode=!1;const u=await f.getBookmark(e);o.manga=u,console.log("[Reader] manga loaded, finding chapter..."),o.chapter=((n=u.chapters)==null?void 0:n.find(d=>d.number===parseFloat(t)))||{number:parseFloat(t)};const p=parseFloat(t);if(o._preloadCache&&o._preloadCache.mangaId===e&&o._preloadCache.chapterNum===p)console.log("[Reader] Using preloaded images for chapter",t),o.images=o._preloadCache.images||[],o.versionUrl=s||o._preloadCache.versionUrl||null,o._preloadCache=null;else{o.versionUrl=s||null;const d=s?`/bookmarks/${e}/chapters/${t}/reader-images?version=${encodeURIComponent(s)}`:`/bookmarks/${e}/chapters/${t}/reader-images`,g=await f.get(d);console.log("[Reader] images loaded, count:",(r=g.images)==null?void 0:r.length),o.images=g.images||[]}try{const d=await f.getChapterSettings(e,t);if(Vt(d))Ss(d);else try{const $=[...o.manga.downloadedChapters||[]].sort((x,T)=>x-T),v=parseFloat(t),y=$.indexOf(v),L=[];if(y!==-1){for(let x=y-1;x>=0;x--)L.push($[x]);for(let x=y+1;x<$.length;x++)L.push($[x])}const w=12;for(const x of L.slice(0,w)){const T=await f.getChapterSettings(e,x);if(Vt(T)){Ss(T),console.log("[Reader] Inherited settings from chapter",x);break}}}catch(g){console.warn("Failed to inherit chapter settings",g)}}catch(d){console.warn("Failed to load chapter settings",d)}try{const d=await f.getTrophyPages(e,t);o.trophyPages=d||{}}catch(d){console.warn("Failed to load trophy pages",d)}try{const d=await f.getFavorites();o.allFavorites=d,o.favoriteLists=Object.keys(d.favorites||d||{})}catch(d){console.warn("Failed to load favorites",d)}}if(o.isStreamingMode)o.currentPage=0;else{const u=parseFloat(t),p=o.isVolumeMode?l:(c=(i=o.manga)==null?void 0:i.readingProgress)==null?void 0:c[u];if(p&&p.page<p.totalPages)if(o.mode==="manga")if(o.singlePageMode)o.currentPage=Math.max(0,p.page-1);else{const d=Math.max(0,p.page-1),g=de();let $=0;for(let v=0;v<g.length;v++){const y=g[v],L=Array.isArray(y)?y:y.pages||[];if(L.includes(d)||L[0]>=d){$=v;break}$=v}o.currentPage=$}else o.currentPage=0,o._resumeScrollToPage=p.page-1;else o.currentPage=0}}catch(l){console.error("Error loading chapter:",l),h("Failed to load chapter","error")}if(!o.isStreamingMode){if(o.navigationDirection==="prev"&&o.mode==="manga")if(o.singlePageMode)o.currentPage=Math.max(0,o.images.length-1);else{const l=de();o.currentPage=Math.max(0,l.length-1)}else if(o.navigationDirection==="next-linked"&&o.mode==="manga"&&o.images.length>1)if(o.singlePageMode)o.currentPage=1;else{const l=de();let u=0;for(let p=0;p<l.length;p++){const d=l[p];if((Array.isArray(d)?d:d.pages||[]).includes(1)){u=p;break}}o.currentPage=u}}o.navigationDirection=null,o.lastPageSingle&&!o.isStreamingMode&&await ja(),o.loading=!1,tt(),o.isStreamingMode||to(),o.mode==="webtoon"&&o._resumeScrollToPage&&setTimeout(()=>{const l=document.getElementById("reader-content");if(l){const u=l.querySelectorAll("img");u[o._resumeScrollToPage]&&u[o._resumeScrollToPage].scrollIntoView({behavior:"auto",block:"start"})}delete o._resumeScrollToPage},300)}async function ro(e,t){o._streamAbortController&&o._streamAbortController.abort(),o._streamAbortController=new AbortController;const{signal:s}=o._streamAbortController;try{let a="/api/scrapers/preview-images-stream?";t&&(a+=`scraper=${encodeURIComponent(t)}&`),a+=`url=${encodeURIComponent(e)}`;const n=localStorage.getItem("manga_auth_token"),r={};n&&(r.Authorization=`Bearer ${n}`),console.log("[Reader] Starting stream from:",a);const i=await fetch(a,{headers:r,signal:s});if(!i.ok)throw new Error(`Failed to start stream: ${i.statusText}`);const c=i.body.getReader(),l=new TextDecoder;let u="";for(;;){const{value:p,done:d}=await c.read();if(d||s.aborted)break;u+=l.decode(p,{stream:!0});const g=u.split(`

`);u=g.pop();let $=!1;for(const v of g)if(v.startsWith("data: ")){const y=v.substring(6);try{const L=JSON.parse(y);if(L.type==="metadata")o.manga.title=L.title,o.manga.alias=L.title,tt();else if(L.type==="image"){const w=`/api/scrapers/proxy-cover?url=${encodeURIComponent(L.url)}`;o.images.push(w),$=!0}else if(L.type==="error")h("Stream error: "+L.message,"error");else if(L.type==="done")break}catch(L){console.error("Parse error for SSE data:",L)}}$&&qe()}}catch(a){a.name!=="AbortError"&&(console.error("Preview stream error:",a),h("Stream failed: "+a.message,"error"))}finally{o._streamAbortController&&o._streamAbortController.signal===s&&(o._streamAbortController=null)}}async function oo(e=[]){console.log("[Reader] mount called with params:",e);let[t,s]=e,a=null;if(s&&s.includes("?")){const[r,i]=s.split("?");s=r,a=new URLSearchParams(i).get("version")}else{const r=window.location.hash.split("?")[1];r&&(a=new URLSearchParams(r).get("version"))}if(console.log("[Reader] mangaId:",t,"chapterNum:",s,"urlVersion:",a),!t||!s){H.go("/");return}const n=document.getElementById("app");if(o.loading=!0,console.log("[Reader] loading set to true, calling loadData..."),o.images=[],o.singlePageMode=!1,o._resumeScrollToPage=null,o.nextChapterImage=null,o.nextChapterNum=null,n.innerHTML=Qe(),s==="volume"&&e[2])await Oe(t,`volume:${e[2]}`);else if(a)await Oe(t,s,decodeURIComponent(a));else try{const r=await f.getBookmark(t),i=r.downloadedVersions||{},c=new Set(r.deletedChapterUrls||[]),l=i[parseFloat(s)];let u=[];if(Array.isArray(l)&&(u=l.filter(p=>!c.has(p))),u.length>1){let p=[];try{p=(await f.getChapterVersions(t,s)).versions||[]}catch{}const d=await za(u,s,r,p);if(d===null){H.go(`/manga/${t}`);return}await Oe(t,s,d)}else u.length===1?await Oe(t,s,u[0]):await Oe(t,s)}catch(r){console.log("[Reader] Error in version check, falling back:",r),await Oe(t,s)}if(n.innerHTML=Qe(),console.log("[Reader] render called, loading:",o.loading,"manga:",!!o.manga,"images:",o.images.length),Ut(),o.mode==="webtoon"&&o._resumeScrollToPage!=null){const r=o._resumeScrollToPage;o._resumeScrollToPage=null,setTimeout(()=>{const i=document.getElementById("reader-content");if(i){const c=i.querySelectorAll("img");c[r]&&c[r].scrollIntoView({behavior:"auto",block:"start"})}},300)}}async function io(){console.log("[Reader] unmount called"),o._streamAbortController&&(o._streamAbortController.abort(),o._streamAbortController=null),ze&&(clearTimeout(ze),ze=null);const e=Ha(),t=Ga();document.body.classList.remove("reader-active"),document.removeEventListener("keydown",Wa),o.manga=null,o.chapter=null,o.versionUrl=null,o.images=[],o.loading=!0,o.singlePageMode=!1,o.isStreamingMode=!1,o._resumeScrollToPage=null,o._preloadCache=null,await Ye(e),await Ue(t)}function Vt(e){return!!e&&(e.mode!==void 0||e.direction!==void 0||e.firstPageSingle!==void 0||e.lastPageSingle!==void 0)}function Ss(e){e&&(e.mode&&(o.mode=e.mode),e.direction&&(o.direction=e.direction),e.firstPageSingle!==void 0&&(o.firstPageSingle=e.firstPageSingle),e.lastPageSingle!==void 0&&(o.lastPageSingle=e.lastPageSingle))}function Ga(){return!o.manga||!o.chapter||o.isCollectionMode||o.isStreamingMode?null:{mangaId:o.manga.id,chapterNumber:o.chapter.number,settings:{mode:o.mode,direction:o.direction,firstPageSingle:o.firstPageSingle,lastPageSingle:o.lastPageSingle}}}async function Ue(e=Ga()){if(!(!e||Z.isDemo))try{await f.updateChapterSettings(e.mangaId,e.chapterNumber,e.settings)}catch(t){console.error("Failed to save settings:",t)}}async function Ka(e){try{const t=await f.getBookmark(e),s=t.downloadedChapters||[],a=new Set(t.readChapters||[]),n=t.readingProgress||{},r=t.downloadedVersions||{},i=[...s].sort((l,u)=>l-u);let c=null;for(const l of i){const u=n[l];if(u&&u.page<u.totalPages&&!a.has(l)){c=l;break}}if(c===null){for(const l of i)if(!a.has(l)){c=l;break}}if(c===null&&i.length>0&&(c=i[0]),c!==null){const l=r[c]||[],u=Array.isArray(l)?l[0]:l,p=u?`?version=${encodeURIComponent(u)}`:"";H.go(`/read/${e}/${c}${p}`)}else h("No downloaded chapters to read","info")}catch(t){h("Failed to continue reading: "+t.message,"error")}}const lo={mount:oo,unmount:io,render:Qe,continueReading:Ka},Ya="torrent-search-modal",co=3e3;let ra=0,_t=null;function Ie(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function kt(e){if(!e)return"";const t=["B","KB","MB","GB","TB"];let s=0,a=e;for(;a>=1024&&s<t.length-1;)a/=1024,s++;return`${a<10&&s>0?a.toFixed(1):Math.round(a)} ${t[s]}`}function uo(e){if(!e)return"";const t=Math.floor((Date.now()-new Date(e).getTime())/864e5);return t<1?"today":t<30?`${t}d`:t<365?`${Math.floor(t/30)}mo`:`${Math.floor(t/365)}y`}function po(e){return e?e.volume!==null&&e.volume!==void 0?e.volumeEnd?`Vol. ${e.volume}–${e.volumeEnd}`:`Vol. ${e.volume}`:e.chapter!==null&&e.chapter!==void 0?e.chapterEnd?`Ch. ${e.chapter}–${e.chapterEnd}`:`Ch. ${e.chapter}`:"":""}function ho(e){switch(e.status){case"grabbing":return{kind:"pending",text:"Fetching the release for qBittorrent…"};case"downloading":{const t=Math.round((e.progress||0)*100);return{kind:"ok",text:`Downloading in qBittorrent${t?` · ${t}%`:""} · progress on the Queue page`,done:!0}}case"completed":return{kind:"ok",text:"Downloaded, waiting for import",done:!0};case"importing":return{kind:"ok",text:"Importing into the library…",done:!0};case"imported":return{kind:"ok",text:"Imported",done:!0};case"failed":return{kind:"error",text:`Failed: ${e.error||"unknown error"}`,done:!0,retry:!0};case"removed":return{kind:"error",text:"Removed from qBittorrent",done:!0,retry:!0};default:return{kind:"pending",text:e.status}}}function Pt(){var e;(e=document.getElementById(Ya))==null||e.remove(),document.removeEventListener("keydown",Ja),_t&&(_t(),_t=null)}function Ja(e){e.key==="Escape"&&Pt()}async function Xa({query:e="",bookmarkId:t=null,bookmarkTitle:s="",library:a=null,onGrabbed:n}={}){const r=++ra;Pt();let i;try{i=await f.getTorrentStatus()}catch{i={prowlarr:!1,qbittorrent:!1}}if(r!==ra)return;if(!i.prowlarr||!i.qbittorrent){h("Set up Prowlarr and qBittorrent under Settings > Torrents first","info");return}const c=document.createElement("div");c.id=Ya,c.className="modal open torrent-modal";const l=t?`<div class="torrent-target">Releases go to <strong>${Ie(s)}</strong> and are imported as volumes when they finish.</div>`:`<div class="torrent-target">
             <label>Add to
    ...
    `,document.body.appendChild(c),document.addEventListener("keydown",Ja),c.querySelector(".modal-overlay").addEventListener("click",Pt),c.querySelector('[data-act="close"]').addEventListener("click",Pt);const u=c.querySelector("#torrent-results"),p=c.querySelector("#torrent-query");let d=[];const g=new Map;let $=null;const v=(b,M,_)=>{const F=u.querySelector(`.torrent-row-status[data-index="${b}"]`);F&&(F.className=`torrent-row-status ${M}`,F.textContent=_)},y=(b,M,_,F)=>{const V=u.querySelector(`.torrent-grab[data-index="${b}"]`);V&&(V.textContent=M,V.disabled=!_,V.classList.toggle("btn-primary",F),V.classList.toggle("btn-secondary",!F))},L=b=>{if(Array.isArray(b)){for(const[M,_]of g){let F=b.find(X=>X.hash===_.hash);if(F||(F=b.filter(X=>X.releaseTitle===_.title).sort((X,z)=>String(z.addedAt||"").localeCompare(String(X.addedAt||"")))[0]),!F)continue;_.hash=F.hash;const V=ho(F);v(M,V.kind,V.text),V.retry?y(M,"Grab again",!0,!0):V.done&&y(M,"Grabbed",!1,!1),V.done&&(_.done=!0)}[...g.values()].some(M=>!M.done)||k()}},w=b=>L(b==null?void 0:b.torrents),x=async()=>{try{const b=await f.getTorrentDownloads();L(b.torrents)}catch{}},T=()=>{$||($=setInterval(x,co))},k=()=>{$&&(clearInterval($),$=null)};se.on(oe.TORRENT_UPDATE,w),_t=()=>{se.off(oe.TORRENT_UPDATE,w),k()};const I=b=>{if(d=b,g.clear(),k(),b.length===0){u.innerHTML='<div class="torrent-hint">No releases found. Try a shorter title.</div>';return}u.innerHTML=`
            <table class="torrent-table">
                <thead><tr><th>Release</th><th>Vol.</th><th>Size</th><th>Seeds</th><th>Indexer</th><th>Age</th><th></th></tr></thead>
                <tbody>
                ${b.map((M,_)=>{var F;return`
                    <tr>
                        <td class="torrent-title" title="${Ie(M.title)}">
                            <div>${Ie(M.title)}${(F=M.parsed)!=null&&F.digital?' <span class="badge badge-downloaded">Digital</span>':""}${M.infoUrl?` <a href="${Ie(M.infoUrl)}" target="_blank" rel="noopener" class="torrent-info-link" title="Open on the indexer">${m("globe")}</a>`:""}</div>
            ...
            </table>`,u.querySelectorAll(".torrent-grab").forEach(M=>M.addEventListener("click",()=>E(parseInt(M.dataset.index,10),M)))},N=async()=>{const b=p.value.trim();if(b){u.innerHTML=`<div class="torrent-hint">${m("loader",{spin:!0})} Searching the indexers…</div>`;try{const M=await f.searchTorrents(b);I(M.results||[])}catch(M){u.innerHTML=`<div class="torrent-hint error">${Ie(M.message)}</div>`}}},E=async(b,M)=>{var X,z,te;const _=d[b];if(!_)return;const F=c.querySelector("#torrent-target-select"),V=t||F&&F.value||null;M.disabled=!0,M.textContent="Sending…",v(b,"pending","Sending to qBittorrent…");try{const O=((X=c.querySelector("#torrent-auto-import"))==null?void 0:X.checked)??null,S=await f.grabTorrent(_.id,{bookmarkId:V,newSeriesTitle:V?null:((z=_.parsed)==null?void 0:z.title)||null,autoImport:O});g.set(b,{hash:(te=S.torrent)==null?void 0:te.hash,title:_.title,done:!1}),y(b,"Grabbed",!1,!1),S.torrent&&L([S.torrent]),T(),typeof n=="function"&&n(S.torrent)}catch(O){y(b,"Grab again",!0,!0),v(b,"error",`Failed: ${O.message}`)}};c.querySelector("#torrent-magnet-form").addEventListener("submit",async b=>{var O,S;b.preventDefault();const M=c.querySelector("#torrent-magnet"),_=c.querySelector("#torrent-magnet-result"),F=M.value.trim();if(!F){M.focus();return}const V=c.querySelector("#torrent-target-select"),X=t||V&&V.value||null,z=((O=c.querySelector("#torrent-auto-import"))==null?void 0:O.checked)??null,te=b.currentTarget.querySelector("button");te.disabled=!0,_.hidden=!1,_.className="torrent-hint",_.textContent="Sending to qBittorrent…";try{const B=await f.addMagnet(F,{bookmarkId:X,autoImport:z});M.value="",_.textContent=`Added "${((S=B.torrent)==null?void 0:S.name)||"link"}"${X?"":" as a new series"}; follow it on the Queue page.`,B.torrent&&L([B.torrent]),T(),h("Magnet link added","success"),typeof n=="function"&&n(B.torrent)}catch(B){_.className="torrent-hint error",_.textContent=B.message}finally{te.disabled=!1}}),c.querySelector("#torrent-search-form").addEventListener("submit",b=>{b.preventDefault(),N()}),e?N():p.focus()}const Cs="chapter-pages-modal";function Fe(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function mo(e){try{const t=String(e).split("?")[0];return decodeURIComponent(t.slice(t.lastIndexOf("/")+1))}catch{return String(e).slice(String(e).lastIndexOf("/")+1)}}function ft(){var e;(e=document.getElementById(Cs))==null||e.remove(),document.removeEventListener("keydown",Za)}function Za(e){e.key==="Escape"&&ft()}function go({mangaId:e,num:t,title:s="",versions:a=[],versionUrl:n=null,onChanged:r}={}){var k,I,N,E;ft();const i=a.filter(b=>b.url);let c=n&&i.some(b=>b.url===n)?n:((k=i[0])==null?void 0:k.url)??null;const l=document.createElement("div");l.id=Cs,l.className="modal open chapter-pages-modal",l.innerHTML=`
        <div class="modal-overlay"></div>
        <div class="modal-content">
            <div class="modal-header">
    ...
    `,document.body.appendChild(l),document.addEventListener("keydown",Za),l.querySelector(".modal-overlay").addEventListener("click",ft),l.querySelector('[data-act="close"]').addEventListener("click",ft);const u=l.querySelector("#cp-body"),p=l.querySelector("#cp-count");let d=[],g=null,$=!1,v=!1;const y=b=>{d=(b||[]).map(M=>typeof M=="string"?M:M==null?void 0:M.url).filter(Boolean)},L=()=>{if(p.textContent=`${d.length} page${d.length===1?"":"s"}`,d.length===0){u.innerHTML='<div class="torrent-hint">No pages on disk for this version.</div>';return}u.innerHTML=`<div class="chapter-pages-grid">${d.map((b,M)=>{const _=mo(b),F=g===_;return`
            <figure class="chapter-page ${F?"picked":""}" data-name="${Fe(_)}">
    ...
    `,document.body.appendChild(n),document.addEventListener("keydown",en),n.querySelector(".modal-overlay").addEventListener("click",vt),n.querySelector('[data-act="close"]').addEventListener("click",vt);const r=n.querySelector("#review-body"),i=n.querySelector("#review-footer");let c;try{c=a?await f.getFolderContents(e.path,e.bookmarkId||null):await f.getTorrentContents(s.hash)}catch(I){r.innerHTML=`<div class="torrent-hint error">${ye(I.message)}</div>`;return}if(!document.getElementById(jt))return;let l=[];if(!c.bookmarkId)try{const I=await f.getBookmarks();l=(I.bookmarks||I||[]).map(N=>({id:N.id,title:N.alias||N.title})).sort((N,E)=>N.title.localeCompare(E.title))}catch{}const u=c.items||[],p=new Map((((y=c.existing)==null?void 0:y.volumes)||[]).map(I=>[Number(I.number),I.name])),d=new Set((((L=c.existing)==null?void 0:L.chapters)||[]).map(Number));r.innerHTML=`
        ...
        ${u.length===0?'<div class="torrent-hint">Nothing importable in this download: no .cbz/.zip archives or image folders.</div>':`
    ...
    `;const g=()=>[...r.querySelectorAll("tr[data-index]")],$=I=>({index:parseInt(I.dataset.index,10),picked:I.querySelector(".rv-pick").checked,as:I.querySelector(".rv-as").value,number:parseFloat(I.querySelector(".rv-num").value)}),v=()=>{const I=g().map($),N=new Map;for(const M of I){if(!M.picked||!Number.isFinite(M.number))continue;const _=`${M.as}:${M.number}`;N.set(_,(N.get(_)||0)+1)}let E=0;for(const M of g()){const _=$(M),F=M.querySelector(".rv-warn"),V=[];_.picked&&(E++,Number.isFinite(_.number)?(N.get(`${_.as}:${_.number}`)>1&&V.push(`same ${_.as} number as another file`),_.as==="volume"&&p.has(_.number)&&V.push(`replaces ${p.get(_.number)}`),_.as==="chapter"&&d.has(_.number)&&V.push(`replaces downloaded chapter ${_.number}`)):V.push("needs a number")),F.textContent=V.join(" · "),M.classList.toggle("rv-skipped",!_.picked)}const b=i.querySelector("#review-import");b&&(b.disabled=E===0,b.textContent=`Import ${E} selected`)};r.addEventListener("change",v),r.addEventListener("input",v),(x=r.querySelector("#review-all"))==null||x.addEventListener("click",()=>{g().forEach(I=>{I.querySelector(".rv-pick").checked=!0}),v()}),(T=r.querySelector("#review-none"))==null||T.addEventListener("click",()=>{g().forEach(I=>{I.querySelector(".rv-pick").checked=!1}),v()}),i.hidden=!1,i.innerHTML=`
        ...
        ${u.length?'<button type="button" class="btn btn-primary" id="review-import">Import</button>':""}
    `,i.querySelector('[data-act="close"]').addEventListener("click",vt),v(),(k=i.querySelector("#review-import"))==null||k.addEventListener("click",async()=>{var _,F,V,X;const I=i.querySelector("#review-import"),N=g().map($),E=N.map(z=>({path:u[z.index].path,as:z.picked?z.as:"skip",number:z.number})),b=N.filter(z=>z.picked);if(b.length===0)return;if(b.some(z=>!Number.isFinite(z.number))){h("Every selected item needs a number","error");return}const M=c.bookmarkId||((_=r.querySelector("#review-target"))==null?void 0:_.value)||null;I.disabled=!0,I.textContent="Importing…",r.querySelectorAll("input, select, button").forEach(z=>{z.disabled=!0});try{const z=a?await f.importFolder({path:e.path,bookmarkId:M,newSeriesTitle:c.newSeriesTitle||e.name,selection:E}):await f.importTorrent(s.hash,M,E);I.textContent="Importing…",i.querySelector('[data-act="close"]').textContent="Close";const te=await vo(z,r.querySelector("#review-result"));if(!te)return;const O=((F=te.summary)==null?void 0:F.volumes)||[],S=((V=te.summary)==null?void 0:V.chapters)||[],B=((X=te.summary)==null?void 0:X.skipped)||[];r.querySelector("#review-result").innerHTML=`
                <div class="torrent-row-status ok">${m("check")} Imported ${O.length} volume${O.length===1?"":"s"}${O.length?` (${O.map(R=>ye(R.name)).join(", ")})`:""}${S.length?` and ${S.length} chapter${S.length===1?"":"s"}`:""}.</div>
                ${B.length?`<ul class="task-error-list">${B.map(R=>`<li>${ye(R)}</li>`).join("")}</ul>`:""}
                <a href="#/manga/${ye(te.bookmarkId)}" class="btn btn-sm btn-secondary">Open the series</a>
            `,I.textContent="Done",i.querySelector('[data-act="close"]').textContent="Close",typeof t=="function"&&t(te)}catch(z){r.querySelectorAll("input, select, button").forEach(te=>{te.disabled=!1}),r.querySelector("#review-result").innerHTML=`<div class="torrent-row-status error">Import failed: ${ye(z.message)}</div>`,I.disabled=!1,v()}})}const sn="folder-import-modal";function Pe(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function yt(){var e;(e=document.getElementById(sn))==null||e.remove(),document.removeEventListener("keydown",an)}function an(e){e.key==="Escape"&&yt()}function yo({bookmarkId:e=null,bookmarkTitle:t="",onImported:s}={}){yt();const a=document.createElement("div");a.id=sn,a.className="modal open torrent-modal folder-import-modal",a.innerHTML=`
        <div class="modal-overlay"></div>
        <div class="modal-content">
            <div class="modal-header">
    ...
    `,document.body.appendChild(a),document.addEventListener("keydown",an),a.querySelector(".modal-overlay").addEventListener("click",yt),a.querySelectorAll('[data-act="close"]').forEach(d=>d.addEventListener("click",yt));const n=a.querySelector("#fi-crumbs"),r=a.querySelector("#fi-list"),i=a.querySelector("#fi-current"),c=a.querySelector("#fi-import");let l=null;const u=d=>{l=d,c.disabled=!d,c.textContent=(d==null?void 0:d.kind)==="archive"?"Import this archive":"Import this folder",i.textContent=d?d.path:"",r.querySelectorAll(".folder-entry").forEach(g=>g.classList.toggle("picked",!!d&&g.dataset.path===d.path))},p=async d=>{r.innerHTML=`<div class="torrent-hint">${m("loader",{spin:!0})} Loading…</div>`;let g;try{g=await f.browseImportFolders(d)}catch(v){r.innerHTML=`<div class="torrent-hint error">${Pe(v.message)}</div>`,n.innerHTML="",u(null);return}g.path,n.innerHTML=g.path?`<button type="button" class="btn btn-sm btn-secondary" data-go="">${m("hard-drive")} Roots</button>
    ...
    `,document.body.appendChild(n),document.addEventListener("keydown",rn);const r=n.querySelector("#vm-body"),i=n.querySelector("#vm-delete"),c=n.querySelector("#vm-save"),l=()=>{xs(),a&&typeof t=="function"&&t()};n.querySelector(".modal-overlay").addEventListener("click",l),n.querySelectorAll('[data-act="close"]').forEach(w=>w.addEventListener("click",l));const u=()=>{var w,x;r.innerHTML=s.length===0?'<div class="torrent-hint">No volumes left.</div>':`
            <div class="review-tools">
  ...
  `}function Ls(){var N;if(C.loading)return`
      ${fe()}
      <div class="container">
    ...
    `;const t=e.alias||e.title,s=e.chapters||[],a=new Set(e.downloadedChapters||[]),n=new Set(e.readChapters||[]),r=new Set(s.map(E=>E.number)).size,i=new Set(e.excludedChapters||[]),c=new Set(e.deletedChapterUrls||[]),l=e.volumes||[],u=new Set;l.forEach(E=>{(E.chapters||[]).forEach(b=>u.add(b))});let p;C.filter==="hidden"?p=s.filter(E=>i.has(E.number)||c.has(E.url)):p=s.filter(E=>!i.has(E.number)&&!c.has(E.url));const d=p.filter(E=>!u.has(E.number));let g=[];if(C.activeVolume){const E=new Set(C.activeVolume.chapters||[]);g=p.filter(b=>E.has(b.number))}else g=d;const $=new Map;g.forEach(E=>{$.has(E.number)||$.set(E.number,[]),$.get(E.number).push(E)});let v=Array.from($.entries()).sort((E,b)=>E[0]-b[0]);C.filter==="downloaded"?v=v.filter(([E])=>a.has(E)):C.filter==="not-downloaded"?v=v.filter(([E])=>!a.has(E)):C.filter==="main"?v=v.filter(([E])=>Number.isInteger(E)):C.filter==="extra"&&(v=v.filter(([E])=>!Number.isInteger(E)));const y=Math.max(1,Math.ceil(v.length/wt));C.currentPage>=y&&(C.currentPage=Math.max(0,y-1));const L=C.currentPage*wt,x=[...v.slice(L,L+wt)].reverse(),T=$.size,k=[...$.keys()].filter(E=>a.has(E)).length;n.size;let I="";if(C.activeVolume){const E=C.activeVolume;let b=null;E.local_cover?b=`/api/public/covers/${e.id}/${encodeURIComponent(E.local_cover.split(/[/\\]/).pop())}`:E.cover&&(b=E.cover),I=`
      ${fe()}
      <div class="container">
            ...
            <div class="manga-detail-info">
              ...
              <div class="manga-detail-meta">
               ...
               <div class="manga-detail-actions">
                 ...
                 <button class="btn btn-secondary" id="manage-chapters-btn">${C.manageChapters?"Done Managing":`${m("plus")} Add Chapters`}</button>
        ...
        <div class="container">
          <div class="manga-detail">
            <div class="manga-detail-header">
              ...
              ${Z.canDownload?`<button class="btn btn-secondary" id="find-volumes-btn" title="Search the torrent indexers for volume releases of this title">${m("package")} Find volumes</button>`:""}
              ${Z.canDownload?`<button class="btn btn-secondary" id="import-folder-btn" title="Import a release that is already on disk (torrent folder), without downloading it again">${m("folder")} Import from folder</button>`:""}
            ...
            <div class="cbz-section" style="margin-top: 16px; padding: 12px; background: var(--bg-secondary); border-radius: 8px;">
              <h3 style="margin: 0 0 12px 0;">${m("package")} CBZ Files (${C.cbzFiles.length})</h3>
              <div class="cbz-list">
                ${C.cbzFiles.map(b=>`
    ...
    ${I}
        ...
        ${C.activeVolume?C.manageChapters?Ao(e,d):"":_o(e,a)}
  ...
  `}function So(){const e=C.manga;if(!e)return"";const t=e.alias||e.title;return`
  ...
  `}function Co(){const e=C.manga;return e?`
  ...
  `:""}function xo(){const e=C.manga;return e?`
  ...
  `;const n=document.getElementById("anilist-progress-info"),r=document.getElementById("anilist-progress-input"),i=async()=>{try{const d=await f.anilistGetProgress(t.id),g=[`AniList: ${d.anilist!=null?`ch. ${d.anilist}`:"not on your list yet"}`,`read here: ${d.local?`ch. ${d.local}`:"nothing"}`,d.chaptersTotal?`of ${d.chaptersTotal}`:""].filter(Boolean);n.textContent=g.join(" · "),r&&!r.value&&(r.value=d.anilist??d.local??"")}catch(d){n.textContent=`Could not read progress: ${d.message}`}};i(),(c=document.getElementById("anilist-progress-form"))==null||c.addEventListener("submit",async d=>{d.preventDefault();const g=parseInt(r.value,10);if(!Number.isFinite(g)||g<0){h("Enter a chapter number","error");return}const $=d.currentTarget.querySelector("button");$.disabled=!0;try{const v=await f.anilistSetProgress(t.id,g);h(`AniList set to chapter ${v.progress}${v.markedReadUpTo?`; chapters up to ${v.markedReadUpTo} marked read here`:""}`,"success"),await i(),v.markedReadUpTo&&(await ee(t.id),W([t.id]))}catch(v){h("Failed to set progress: "+v.message,"error")}finally{$.disabled=!1}}),(l=document.getElementById("anilist-sync-toggle"))==null||l.addEventListener("change",async d=>{try{await f.anilistSetSyncEnabled(t.id,d.target.checked),h(d.target.checked?"AniList sync enabled":"AniList sync disabled","success")}catch(g){d.target.checked=!d.target.checked,h("Failed to update sync: "+g.message,"error")}}),(u=document.getElementById("anilist-relink-btn"))==null||u.addEventListener("click",()=>{s.style.display="none",a.style.display=""}),(p=document.getElementById("anilist-unlink-btn"))==null||p.addEventListener("click",async()=>{if(confirm(`Unlink "${e.anilist_title}" from AniList?`))try{await f.anilistUnmap(t.id),h("Unlinked from AniList","success"),zt()}catch(d){h("Failed to unlink: "+d.message,"error")}})}function Io(){var t,s;const e=C.manga;return`
    ${e?Eo(e):""}
    ${ai()}
    ${So()}
    ${Co()}
  ...
  `}function ln(e,t){if(t.length===0)return"";const s=Math.min(...t),a=Math.floor(s);return!(e.chapters||[]).some(r=>r.number===a)||t.includes(a)?a:s}function Mo(e){const t=[...C.mergeSelection].sort((a,n)=>a-n),s=ln(e,t);return`
  ...
  `}function To(e,t,s,a,n){var S,B,R,D,U,G,Y,ne;const r=s.has(e),i=a.has(e),c=!Number.isInteger(e),l=((S=n.mergedChapters)==null?void 0:S[e])||null,u=((B=n.downloadedVersions)==null?void 0:B[e])||[],p=new Set(n.deletedChapterUrls||[]),d=t.filter(P=>C.filter==="hidden"?!0:!p.has(P.url)),g=!!C.activeVolume,$=n.chapterSettings||{},v=g?!0:!!((R=$[e])!=null&&R.locked);let y=d;if(g||v){const P=d.filter(Q=>Array.isArray(u)?u.includes(Q.url):u===Q.url);y=P.length>0?P:d}y.sort((P,Q)=>{const J=Array.isArray(u)?u.includes(P.url):u===P.url;return((Array.isArray(u)?u.includes(Q.url):u===Q.url)?1:0)-(J?1:0)});const L=((D=n.chapterFolders)==null?void 0:D[e])||[],w=L.filter(P=>!P.url),x=L.reduce((P,Q)=>Math.max(P,Q.imageCount),0),T=P=>P.imageCount<3||x>=6&&P.imageCount<x/2,k=P=>L.find(Q=>Q.url===P)||null,I=L.filter(P=>P.url&&T(P)),N=y.length>1||w.length>0,E=(U=y[0])!=null&&U.url?encodeURIComponent(y[0].url):null,b=["chapter-item",r?"downloaded":"",i?"read":"",c?"extra":""].filter(Boolean).join(" "),M=Array.isArray(u)?u:u?[u]:[],_=M.length,F=k((G=y[0])==null?void 0:G.url)||L.find(P=>P.url)||L[0]||null,V=F?F.imageCount:((Y=n.downloadedPageCounts)==null?void 0:Y[e])??null,X=r&&V!==null?`<button class="chapter-pages-pill ${F&&T(F)?"warn":""}" data-action="pages" data-num="${e}" ${F!=null&&F.url?`data-url="${encodeURIComponent(F.url)}"`:""} title="${V} pages - view and edit them">${m("images")} ${V}</button>`:"",z=N?`
    <div class="versions-dropdown hidden" id="versions-${e}">
      ${y.map(P=>{const Q=encodeURIComponent(P.url),J=M.includes(P.url),ae=P.url.startsWith("local://"),he=P.title&&P.title!==`Chapter ${e}`?P.title:"",Ne=he||P.releaseGroup||"Version",it=[he&&P.releaseGroup?P.releaseGroup:"",Bo(P.uploadedAt)].filter(Boolean).join(" · ");return`
          <div class="version-row ${J?"downloaded":""}"
               data-version-url="${Q}" data-num="${e}">
            <span class="version-title" style="cursor: pointer; flex: 1;" title="${st(P.url)}">${We(Ne)}${ae?' <span class="badge badge-local" style="background: var(--color-info, #2196f3); color: white; font-size: 0.65em; padding: 1px 5px; border-radius: 3px; margin-left: 6px; vertical-align: middle;">Local</span>':""}${it?`<span class="version-meta">${We(it)}</span>`:""}${(()=>{const Ve=J?k(P.url):null;if(!Ve)return"";const lt=T(Ve);return`<span class="version-meta version-pages ${lt?"warn":""}" title="${st(Ve.folder)}">${Ve.imageCount} pages${lt?" - incomplete?":""}</span>`})()}</span>
            <div class="version-actions">
              ${J?`<button class="btn-icon small success" data-action="read-version" data-num="${e}" data-url="${Q}">${m("play",{title:"Read"})}</button>
                   ${_>1?`<button class="btn-icon small" data-action="keep-version" data-num="${e}" data-url="${Q}" title="Keep only this version (delete the other ${_-1})">${m("check",{title:"Keep only this version"})}</button>`:""}
                   <button class="btn-icon small danger" data-action="delete-version" data-num="${e}" data-url="${Q}">${m("trash-2",{title:"Delete version"})}</button>`:`<button class="btn-icon small" data-action="download-version" data-num="${e}" data-url="${Q}">${m("download",{title:"Download"})}</button>`}
              ${p.has(P.url)?`<button class="btn-icon small warning" data-action="restore-version" data-num="${e}" data-url="${Q}" title="Restore Version">${m("undo-2",{title:"Restore version"})}</button>`:`<button class="btn-icon small" data-action="hide-version" data-num="${e}" data-url="${Q}" title="Hide Version">${m("eye-off",{title:"Hide version"})}</button>`}
            </div>
          </div>
        `}).join("")}
      ${w.map(P=>`
  ...
  `:"",te=(n.excludedChapters||[]).includes(e),O=C.mergeMode&&r&&!te&&!l;return`
    <div class="chapter-group" data-chapter="${e}">
      <div class="${b}" data-num="${e}" style="${te?"opacity: 0.7":""}">
        ${C.mergeMode?`<input type="checkbox" class="merge-pick" data-num="${e}" ${C.mergeSelection.has(e)?"checked":""} ${O?"":"disabled"} title="${O?"Combine this chapter":l?"Already a combined chapter":"Only downloaded chapters can be combined"}">`:""}
        ...
        <div class="chapter-actions">
          ${X}
          ${l&&!te?`<button class="btn-icon small" data-action="split-chapter" data-num="${e}" title="Split back into ${l.sources.map(P=>`Ch. ${P}`).join(", ")}">${m("scissors",{title:"Split"})}</button>`:""}
          ...
          ${!te&&E?p.has((ne=y[0])==null?void 0:ne.url)?`<button class="btn-icon small warning" data-action="unhide-chapter" data-num="${e}" data-url="${E}" title="Unhide Chapter">${m("undo-2",{title:"Unhide chapter"})}</button>`:`<button class="btn-icon small" data-action="hide-chapter" data-num="${e}" data-url="${E}" title="Hide Chapter">${m("eye-off",{title:"Hide chapter"})}</button>`:""}
         ...
         <button class="btn-icon small ${C.offlineChapters.has(e)?"success":""}" data-action="offline-save" data-num="${e}" title="${C.offlineChapters.has(e)?"Remove offline copy":"Save for offline reading"}">
           ${C.offlineChapters.has(e)?m("wifi-off",{title:"Available offline"}):m("hard-drive",{title:"Save offline"})}
          ...
          ${N?`
            <button class="btn-icon small versions-btn" data-action="versions" data-num="${e}" title="${d.length} versions, ${_} downloaded">
              ${_>1?`${_}/`:""}${d.length} ${m("chevron-down")}
            </button>
          `:""}
        </div>
      </div>
  ...
  `}function Bo(e){if(!e)return"";const t=new Date(e);return isNaN(t.getTime())?String(e).slice(0,10):t.toISOString().slice(0,10)}function We(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function st(e){return We(e).replace(/"/g,"&quot;")}function ia(e){return`
  ...
  `}function _o(e,t){var i;const s=e.volumes||[];if(s.length===0)return"";const a=s.map(c=>{const l=c.chapters||[],u=l.filter(d=>t.has(d)).length,p=c.kind==="release";return`
      <div class="volume-card${p?" volume-release":""}" data-volume-id="${c.id}" title="${p?st(`Volume release · ${c.pageCount} pages${c.releaseName?` · ${c.releaseName}`:""}`):`${l.length} chapters`}">
        <div class="volume-cover">
          ...
          <div class="volume-badges">
            ${p?`<span class="badge badge-release">${c.pageCount} pages</span>${l.length?`<span class="badge badge-chapters">${l.length} ch</span>`:""}`:`<span class="badge badge-chapters">${l.length} ch</span>${u>0?`<span class="badge badge-downloaded">${u}</span>`:""}`}
          </div>
          ${p?`<button class="volume-read-btn" data-read-volume="${c.id}" title="Read this volume">${m("play",{title:"Read"})}</button>`:""}
        </div>
        <div class="volume-info">
          <div class="volume-name">${We(c.name)}</div>
          <div class="volume-kind">${p?`${c.source==="torrent"?"Torrent":"Archive"} release`:"Chapter collection"}</div>
        </div>
      </div>
    `}).join(""),n=C.volumesCollapsed,r=s.reduce((c,l)=>c+(l.chapters||[]).filter(u=>t.has(u)).length,0);return`
  ...
  `}function Po(){var n,r,i,c,l,u,p,d,g,$,v,y,L,w,x,T,k,I,N,E,b,M,_,F,V,X,z,te,O;const e=document.getElementById("app"),t=C.manga;if(!t)return;(n=document.getElementById("back-btn"))==null||n.addEventListener("click",()=>H.go("/")),(r=document.getElementById("back-library-btn"))==null||r.addEventListener("click",()=>H.go("/")),e.querySelectorAll(".artist-link").forEach(S=>{S.addEventListener("click",async B=>{B.preventDefault();const R=S.dataset.artist;if(!R)return;localStorage.setItem("library_search",R),localStorage.removeItem("library_artist_filter");let D=null;try{const U=t.website;if(U&&U!=="Local"){const Y=(window._scrapersList||(window._scrapersList=(await f.get("/scrapers/list")).scrapers)||[]).find(ne=>ne.name===U);Y&&Y.supportsBrowse&&(D=U)}}catch{}D?(localStorage.setItem("library_search_author",R),localStorage.setItem("library_search_author_source",D)):(localStorage.removeItem("library_search_author"),localStorage.removeItem("library_search_author_source")),H.go("/")})}),(i=document.getElementById("continue-btn"))==null||i.addEventListener("click",()=>{Ka(t.id)}),(c=document.getElementById("download-all-btn"))==null||c.addEventListener("click",()=>{const S=document.getElementById("download-all-modal");S&&S.classList.add("open")}),(l=document.getElementById("confirm-download-all-btn"))==null||l.addEventListener("click",async()=>{var S;try{h("Queueing downloads...","info");const B=document.getElementsByName("download-version-mode");let R="single";for(const U of B)U.checked&&(R=U.value);(S=document.getElementById("download-all-modal"))==null||S.classList.remove("open");const D=await f.post(`/bookmarks/${t.id}/download`,{all:!0,versionMode:R});D.chaptersCount>0?h(`Download queued: ${D.chaptersCount} versions`,"success"):h("Already have these chapters downloaded","info")}catch(B){h("Failed to download: "+B.message,"error")}}),(u=document.getElementById("check-updates-btn"))==null||u.addEventListener("click",async()=>{try{h("Checking for updates...","info"),await f.post(`/bookmarks/${t.id}/quick-check`),h("Check complete!","success")}catch(S){h("Check failed: "+S.message,"error")}}),(p=document.getElementById("schedule-btn"))==null||p.addEventListener("click",()=>{const S=document.getElementById("schedule-modal");S&&S.classList.add("open")}),(d=document.getElementById("schedule-type"))==null||d.addEventListener("change",S=>{const B=document.getElementById("schedule-day-group");B&&(B.style.display=S.target.value==="weekly"?"":"none")}),(g=document.getElementById("save-schedule-btn"))==null||g.addEventListener("click",async()=>{var S;try{const B=document.getElementById("schedule-type").value,R=document.getElementById("schedule-day").value,D=document.getElementById("schedule-time").value,U=document.getElementById("auto-download-toggle").checked;await f.updateAutoCheckSchedule(t.id,{enabled:!0,schedule:B,day:R,time:D,autoDownload:U}),C.manga.checkSchedule=B,C.manga.checkDay=R,C.manga.checkTime=D,C.manga.autoDownload=U,(S=document.getElementById("schedule-modal"))==null||S.classList.remove("open"),W([t.id]),h("Schedule updated","success")}catch(B){h("Failed to save schedule: "+B.message,"error")}}),($=document.getElementById("disable-schedule-btn"))==null||$.addEventListener("click",async()=>{var S;try{await f.toggleAutoCheck(t.id,!1),C.manga.autoCheck=!1,C.manga.checkSchedule=null,C.manga.checkDay=null,C.manga.checkTime=null,C.manga.nextCheck=null,(S=document.getElementById("schedule-modal"))==null||S.classList.remove("open"),W([t.id]),h("Auto-check disabled","success")}catch(B){h("Failed to disable: "+B.message,"error")}}),(v=document.getElementById("refresh-btn"))==null||v.addEventListener("click",async()=>{const S=document.getElementById("refresh-btn");try{S.disabled=!0,S.innerHTML=`${m("loader",{spin:!0})} Checking...`,h("Checking for updates...","info"),await f.post(`/bookmarks/${t.id}/check`),await ee(t.id),W([t.id]),h("Check complete!","success")}catch(B){h("Check failed: "+B.message,"error"),S&&(S.disabled=!1,S.innerHTML=`${m("refresh-cw")} Refresh`)}}),(y=document.getElementById("scan-folder-btn"))==null||y.addEventListener("click",async()=>{var B,R;const S=document.getElementById("scan-folder-btn");try{S.disabled=!0,S.innerHTML=`${m("loader",{spin:!0})} Scanning...`,h("Scanning folder...","info");const D=await f.scanBookmark(t.id);await ee(t.id),W([t.id]);const U=((B=D.addedChapters)==null?void 0:B.length)||0,G=((R=D.removedChapters)==null?void 0:R.length)||0;U>0||G>0?h(`Scan complete: ${U} added, ${G} removed`,"success"):h("Scan complete: No changes","info")}catch(D){h("Scan failed: "+D.message,"error")}finally{S&&(S.disabled=!1,S.innerHTML=`${m("folder")} Scan Folder`)}}),document.querySelectorAll("[data-cbz-path]").forEach(S=>{S.addEventListener("click",async()=>{const B=decodeURIComponent(S.dataset.cbzPath),R=parseInt(S.dataset.cbzChapter)||1,D=S.dataset.cbzExtracted==="true",U=prompt("Enter chapter number for extraction:",String(R));if(!U)return;const G=parseFloat(U);if(isNaN(G)){h("Invalid chapter number","error");return}try{S.disabled=!0,S.textContent="Extracting...",h("Extracting CBZ...","info"),await f.extractCbz(t.id,B,G,{forceReExtract:D}),h("CBZ extracted successfully!","success"),await ee(t.id),W([t.id])}catch(Y){h("Extract failed: "+Y.message,"error")}finally{S.disabled=!1,S.textContent=D?"Re-Extract":"Extract"}})}),(L=document.getElementById("edit-btn"))==null||L.addEventListener("click",async()=>{const S=document.getElementById("edit-manga-modal");if(S){document.getElementById("edit-alias-input").value=t.alias||"",window._selectedCoverPath=null;try{const[B,R]=await Promise.all([f.getAllArtists(),f.getAllCategories()]),D=document.getElementById("artist-list"),U=document.getElementById("category-list");window._allArtists=B,window._allCategories=R,D&&(D.innerHTML=B.map(ne=>`<option value="${ne}">`).join("")),U&&(U.innerHTML=R.map(ne=>`<option value="${ne}">`).join(""));const G=document.getElementById("edit-artist-input"),Y=document.getElementById("edit-categories-input");G==null||G.addEventListener("input",()=>{const ne=G.value.toLowerCase(),P=G.value.lastIndexOf(","),Q=G.value.substring(P+1).trim().toLowerCase();if(Q.length>0&&window._allArtists){const J=window._allArtists.filter(ae=>ae.toLowerCase().includes(Q));if(D&&J.length>0){const ae=P>=0?G.value.substring(0,P+1)+" ":"";D.innerHTML=J.map(he=>`<option value="${ae}${he}">`).join("")}}}),Y==null||Y.addEventListener("input",()=>{const ne=Y.value.lastIndexOf(","),P=Y.value.substring(ne+1).trim().toLowerCase();if(P.length>0&&window._allCategories){const Q=window._allCategories.filter(J=>J.toLowerCase().includes(P));if(U&&Q.length>0){const J=ne>=0?Y.value.substring(0,ne+1)+" ":"";U.innerHTML=Q.map(ae=>`<option value="${J}${ae}">`).join("")}}})}catch(B){console.error("Failed to load artists/categories:",B)}S.classList.add("open")}}),(w=document.getElementById("save-manga-btn"))==null||w.addEventListener("click",async()=>{var S;try{const B=document.getElementById("edit-alias-input").value.trim(),R=document.getElementById("edit-artist-input").value.trim(),D=document.getElementById("edit-categories-input").value.trim(),U=R?R.split(",").map(Y=>Y.trim()).filter(Y=>Y):[],G=D?D.split(",").map(Y=>Y.trim()).filter(Y=>Y):[];await f.updateBookmark(t.id,{alias:B||null}),await f.setBookmarkArtists(t.id,U),await f.setBookmarkCategories(t.id,G),window._selectedCoverPath&&await f.setBookmarkCoverFromImage(t.id,window._selectedCoverPath),C.manga.alias=B||null,C.manga.artists=U,C.manga.categories=G,(S=document.getElementById("edit-manga-modal"))==null||S.classList.remove("open"),W([t.id]),h("Manga updated","success")}catch(B){h("Failed to update: "+B.message,"error")}}),(x=document.getElementById("change-cover-btn"))==null||x.addEventListener("click",async()=>{try{h("Loading images...","info");const S=await f.getFolderImages(t.id);if(S.length===0){h("No images found in manga folder","warning");return}const B=document.createElement("div");B.id="cover-select-modal",B.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.8);z-index:10000;display:flex;align-items:center;justify-content:center;",B.innerHTML=`
      ...
      `,document.body.appendChild(B),document.getElementById("close-cover-modal").addEventListener("click",()=>B.remove()),B.addEventListener("click",R=>{R.target===B&&B.remove()}),B.querySelectorAll(".cover-option").forEach(R=>{R.addEventListener("click",()=>{window._selectedCoverPath=R.dataset.path;const D=document.getElementById("cover-preview");D&&(D.innerHTML=`<img src="/api/proxy-image?path=${encodeURIComponent(window._selectedCoverPath)}" style="width:100%;height:100%;object-fit:cover;">`),B.remove(),h("Cover selected","success")})})}catch(S){h("Failed to load images: "+S.message,"error")}}),(T=document.getElementById("delete-manga-btn"))==null||T.addEventListener("click",()=>{const S=document.getElementById("delete-manga-modal");S&&S.classList.add("open")}),(k=document.getElementById("confirm-delete-manga-btn"))==null||k.addEventListener("click",async()=>{var B,R;const S=((B=document.getElementById("delete-files-toggle"))==null?void 0:B.checked)||!1;try{await f.deleteBookmark(t.id,S),(R=document.getElementById("delete-manga-modal"))==null||R.classList.remove("open"),h("Manga deleted","success"),H.go("/")}catch(D){h("Failed to delete: "+D.message,"error")}}),(I=document.getElementById("quick-check-btn"))==null||I.addEventListener("click",async()=>{const S=document.getElementById("quick-check-btn");try{S.disabled=!0,S.innerHTML=`${m("loader",{spin:!0})} Checking...`,h("Quick checking for updates...","info");const B=await f.post(`/bookmarks/${t.id}/quick-check`);await ee(t.id),W([t.id]),B.newChaptersCount>0?h(`Found ${B.newChaptersCount} new chapter(s)!`,"success"):h("No new chapters found","info")}catch(B){h("Quick check failed: "+B.message,"error")}finally{S&&(S.disabled=!1,S.innerHTML=`${m("zap")} Quick Check`)}}),(N=document.getElementById("source-label"))==null||N.addEventListener("click",async()=>{const S=document.getElementById("migrate-source-modal");if(S){S.classList.add("open");const B=document.getElementById("migrate-search-scraper");if(B&&B.options.length<=1)try{const R=await f.get("/scrapers/list");if(R.success){const D=R.scrapers.filter(U=>U.supportsSearch);B.innerHTML='<option value="all">All Sources</option>'+D.map(U=>`<option value="${U.name}">${U.name}</option>`).join(""),B.value="all"}}catch(R){console.warn("Failed to load scrapers:",R)}}});const s=async()=>{var G,Y,ne;const S=(Y=(G=document.getElementById("migrate-search-input"))==null?void 0:G.value)==null?void 0:Y.trim(),B=(ne=document.getElementById("migrate-search-scraper"))==null?void 0:ne.value;if(!S)return;const R=document.getElementById("migrate-search-loading"),D=document.getElementById("migrate-search-results"),U=document.getElementById("migrate-results-grid");R.style.display="block",D.style.display="none";try{const Q=(await f.get(`/scrapers/search?q=${encodeURIComponent(S)}&scraper=${encodeURIComponent(B)}`)).results||[];Q.length===0?U.innerHTML='<p class="text-muted" style="text-align: center; padding: 20px;">No results found</p>':(U.innerHTML=Q.map(J=>{var he;const ae=(he=J.cover)!=null&&he.startsWith("/covers/")?J.cover:J.cover?`/api/scrapers/proxy-cover?url=${encodeURIComponent(J.cover)}`:"";return`
          ...
          `}).join(""),U.querySelectorAll(".migrate-result-card").forEach(J=>{J.addEventListener("click",()=>{var he;const ae=J.dataset.url;document.getElementById("migrate-url-input").value=ae,U.querySelectorAll(".migrate-result-card").forEach(Ne=>Ne.style.outline=""),J.style.outline="2px solid var(--color-primary)",h(`Selected: ${(he=J.querySelector(".manga-card-title"))==null?void 0:he.textContent}`,"info")})})),R.style.display="none",D.style.display="block"}catch(P){R.style.display="none",h("Search failed: "+P.message,"error")}};(E=document.getElementById("migrate-search-btn"))==null||E.addEventListener("click",s),(b=document.getElementById("migrate-search-input"))==null||b.addEventListener("keydown",S=>{S.key==="Enter"&&s()}),(M=document.getElementById("confirm-migrate-btn"))==null||M.addEventListener("click",async()=>{var R,D,U;const S=(D=(R=document.getElementById("migrate-url-input"))==null?void 0:R.value)==null?void 0:D.trim();if(!S){h("Please enter a URL","warning");return}const B=document.getElementById("confirm-migrate-btn");try{B.disabled=!0,B.textContent="Migrating...",h("Migrating source...","info");const G=await f.migrateSource(t.id,S);h(`Migrated! ${G.migratedChapters} chapters preserved as local`,"success"),h("Running full check on new source...","info"),await f.post(`/bookmarks/${t.id}/check`),(U=document.getElementById("migrate-source-modal"))==null||U.classList.remove("open"),await ee(t.id),W([t.id]),h("Source migration complete!","success")}catch(G){h("Migration failed: "+G.message,"error")}finally{B&&(B.disabled=!1,B.textContent="Migrate Source")}}),(_=document.getElementById("anilist-track-btn"))==null||_.addEventListener("click",()=>{var S;(S=document.getElementById("anilist-modal"))==null||S.classList.add("open"),zt()});const a=async()=>{var U,G;const S=(G=(U=document.getElementById("anilist-search-input"))==null?void 0:U.value)==null?void 0:G.trim();if(!S)return;const B=document.getElementById("anilist-search-loading"),R=document.getElementById("anilist-search-results"),D=document.getElementById("anilist-results-list");B.style.display="block",R.style.display="none";try{const ne=(await f.anilistSearch(S)).results||[];ne.length===0?D.innerHTML='<p class="text-muted" style="text-align: center; padding: 20px;">No results found</p>':(D.innerHTML=ne.map(P=>{var ae,he,Ne,it,Ve,lt,Gs;const Q=((ae=P.title)==null?void 0:ae.romaji)||((he=P.title)==null?void 0:he.english)||((Ne=P.title)==null?void 0:Ne.native)||"Unknown",J=(it=P.title)!=null&&it.english&&P.title.english!==Q?P.title.english:(Ve=P.title)!=null&&Ve.native&&P.title.native!==Q?P.title.native:"";return`
            <div style="display: flex; gap: 10px; align-items: center; padding: 8px; border: 1px solid var(--border-color); border-radius: 6px; margin-bottom: 8px;">
              ...
              <button class="btn btn-small btn-primary anilist-link-result-btn" data-id="${P.id}" data-title="${Q.replace(/"/g,"&quot;")}">Link</button>
            </div>
          `}).join(""),D.querySelectorAll(".anilist-link-result-btn").forEach(P=>{P.addEventListener("click",async()=>{var Q,J;try{P.disabled=!0,P.textContent="Linking...";const ae=await f.anilistMap(t.id,Number(P.dataset.id)),he=((Q=ae.mapping)==null?void 0:Q.anilist_title)||P.dataset.title,Ne=(J=ae.pull)!=null&&J.markedUpTo?` — pulled progress up to ch. ${ae.pull.markedUpTo}`:"";h(`Linked to AniList: ${he}${Ne}`,"success"),zt()}catch(ae){P.disabled=!1,P.textContent="Link",h("Failed to link: "+ae.message,"error")}})})),B.style.display="none",R.style.display="block"}catch(Y){B.style.display="none",h("AniList search failed: "+Y.message,"error")}};(F=document.getElementById("anilist-search-btn"))==null||F.addEventListener("click",a),(V=document.getElementById("anilist-search-input"))==null||V.addEventListener("keydown",S=>{S.key==="Enter"&&a()}),e.querySelectorAll(".filter-btn[data-filter]").forEach(S=>{S.addEventListener("click",()=>{C.filter=S.dataset.filter,C.currentPage=0,W([t.id])})}),Xo(e,t),e.querySelectorAll("[data-page]").forEach(S=>{S.addEventListener("click",()=>{const B=S.dataset.page,R=Math.ceil(C.manga.chapters.length/wt);switch(B){case"first":C.currentPage=0;break;case"prev":C.currentPage=Math.max(0,C.currentPage-1);break;case"next":C.currentPage=Math.min(R-1,C.currentPage+1);break;case"last":C.currentPage=R-1;break}W([t.id])})}),e.querySelectorAll(".chapter-item").forEach(S=>{S.addEventListener("click",B=>{var U;if(B.target.closest(".chapter-actions"))return;const R=parseFloat(S.dataset.num);if((t.downloadedChapters||[]).includes(R)){const G=((U=t.downloadedVersions)==null?void 0:U[R])||[],Y=Array.isArray(G)?G[0]:G;Y?H.go(`/read/${t.id}/${R}?version=${encodeURIComponent(Y)}`):H.go(`/read/${t.id}/${R}`)}else h("Chapter not downloaded","info")})}),e.querySelectorAll("[data-action]").forEach(S=>{S.addEventListener("click",async B=>{var G;B.stopPropagation();const R=S.dataset.action,D=parseFloat(S.dataset.num),U=S.dataset.url?decodeURIComponent(S.dataset.url):null;switch(R){case"lock":await qo(D);break;case"read":await Fo(D);break;case"download":await Oo(D);break;case"versions":Uo(D);break;case"pages":{const Y=t.chapters.filter(P=>P.number===D),ne=P=>{const Q=Y.find(ae=>ae.url===P);return Q&&((Q.title&&Q.title!==`Chapter ${D}`?Q.title:"")||Q.releaseGroup)||null};go({mangaId:t.id,num:D,title:ne(U)||"",versions:(((G=t.chapterFolders)==null?void 0:G[D])||[]).map(P=>({...P,label:ne(P.url)})),versionUrl:U,onChanged:async()=>{await ee(t.id),W([t.id])}});break}case"read-version":H.go(`/read/${t.id}/${D}?version=${encodeURIComponent(U)}`);break;case"download-version":await jo(D,U);break;case"delete-version":await zo(D,U);break;case"keep-version":await Vo(D,U);break;case"delete-folder":await Ho(D,decodeURIComponent(S.dataset.folder||""));break;case"hide-version":await Qo(D,U);break;case"restore-version":await Wo(D,U);break;case"restore-chapter":await Go(D);break;case"delete-chapter":await Ko(D,U);break;case"hide-chapter":await Yo(D,U);break;case"unhide-chapter":await Jo(D,U);break;case"split-chapter":await ei(D);break}})}),e.querySelectorAll('[data-action="read"], [data-action="hide-chapter"], [data-action="delete-chapter"]').forEach(S=>{Do(S,()=>No(S.dataset.action,parseFloat(S.dataset.num)))}),e.querySelectorAll(".version-row .version-title").forEach(S=>{S.addEventListener("click",B=>{B.stopPropagation();const R=S.closest(".version-row"),D=parseFloat(R.dataset.num),U=R.dataset.versionUrl?decodeURIComponent(R.dataset.versionUrl):null;R.classList.contains("downloaded")&&U?H.go(`/read/${t.id}/${D}?version=${encodeURIComponent(U)}`):h("Version not downloaded yet","info")})}),e.querySelectorAll(".volume-card").forEach(S=>{S.addEventListener("click",()=>{const B=S.dataset.volumeId;H.go(`/manga/${t.id}/volume/${B}`)})}),e.querySelectorAll("[data-read-volume]").forEach(S=>{S.addEventListener("click",B=>{B.stopPropagation(),H.go(`/read/${t.id}/volume/${S.dataset.readVolume}`)})}),(X=e.querySelector("#read-volume-btn"))==null||X.addEventListener("click",S=>{H.go(`/read/${t.id}/volume/${S.currentTarget.dataset.volId}`)}),(z=e.querySelector("#import-folder-btn"))==null||z.addEventListener("click",()=>{yo({bookmarkId:t.id,bookmarkTitle:t.alias||t.title,onImported:async()=>{await ee(t.id),W([t.id])}})}),(te=e.querySelector("#find-volumes-btn"))==null||te.addEventListener("click",()=>{Xa({query:t.alias||t.title,bookmarkId:t.id,bookmarkTitle:t.alias||t.title})}),(O=e.querySelector("#manage-volumes-btn"))==null||O.addEventListener("click",()=>{wo(t,{onChanged:async()=>{await ee(t.id),W([t.id])}})}),ni(e),De(),se.subscribeToManga(t.id)}async function qo(e){var n;const t=C.manga,s=((n=t.chapterSettings)==null?void 0:n[e])||{},a=!s.locked;try{a?await f.lockChapter(t.id,e):await f.unlockChapter(t.id,e),t.chapterSettings||(t.chapterSettings={}),t.chapterSettings[e]={...s,locked:a},h(a?"Chapter locked":"Chapter unlocked","success"),W([t.id])}catch(r){h("Failed: "+r.message,"error")}}const Ro=550;function Do(e,t){let s=null,a=!1;const n=()=>{clearTimeout(s),s=null,e.classList.remove("pressing")};e.addEventListener("pointerdown",r=>{r.button!==void 0&&r.button!==0||(a=!1,n(),e.classList.add("pressing"),s=setTimeout(()=>{a=!0,e.classList.remove("pressing"),t()},Ro))}),e.addEventListener("pointerup",n),e.addEventListener("pointerleave",n),e.addEventListener("pointercancel",n),e.addEventListener("contextmenu",r=>r.preventDefault()),e.addEventListener("click",r=>{a&&(a=!1,r.preventDefault(),r.stopImmediatePropagation())},!0)}async function No(e,t){const s=C.manga;if(!s||!Number.isFinite(t))return;const a=`chapter ${t}`,n=(r,i)=>`${r} ${i}${r===1?"":"s"}`;try{if(e==="read"){if(!confirm(`Mark every chapter up to ${a} as read?`))return;await f.markChaptersReadUpTo(s.id,t),h(`Marked read up to ${a}`,"success")}else if(e==="hide-chapter"){if(!confirm(`Hide every chapter up to ${a}? Their downloaded files are removed too. Locked chapters and chapters in a volume stay.`))return;const r=await f.bulkHideChapters(s.id,t);h(`Hid ${n(r.hidden,"chapter version")}${r.skipped?`, ${r.skipped} protected`:""}`,"success")}else if(e==="delete-chapter"){if(!confirm(`Delete the downloaded files of every chapter up to ${a}? Locked chapters stay.`))return;const r=confirm(`Also hide those chapters, up to ${a}?`),i=await f.bulkDeleteChapters(s.id,t,r);h(`Deleted ${n(i.deleted,"chapter")}${r?`, hid ${i.hidden}`:""}${i.skipped?`, ${i.skipped} skipped`:""}`,"success")}else return;await ee(s.id),W([s.id])}catch(r){h("Failed: "+r.message,"error")}}async function Fo(e){const t=C.manga,s=new Set(t.readChapters||[]),a=s.has(e);try{await f.post(`/bookmarks/${t.id}/chapters/${e}/read`,{isRead:!a}),a?s.delete(e):s.add(e),t.readChapters=[...s],h(a?"Marked unread":"Marked read","success"),W([t.id])}catch(n){h("Failed: "+n.message,"error")}}async function Oo(e){const t=C.manga,s=new Set(t.deletedChapterUrls||[]),a=(t.chapters||[]).find(n=>n.number===e&&!s.has(n.url));try{h(`Downloading chapter ${e}...`,"info");let n;a?n=await f.post(`/bookmarks/${t.id}/download-version`,{chapterNumber:e,url:a.url}):n=await f.post(`/bookmarks/${t.id}/download`,{chapters:[e]}),h("Download queued!","success"),cn(n==null?void 0:n.taskId,`Chapter ${e}`)}catch(n){h("Failed: "+n.message,"error")}}function Uo(e){document.querySelectorAll(".versions-dropdown").forEach(s=>{s.id!==`versions-${e}`&&s.classList.add("hidden")});const t=document.getElementById(`versions-${e}`);t&&t.classList.toggle("hidden")}async function Ho(e,t){const s=C.manga;if(t&&confirm(`Delete the folder "${t}" from disk?`))try{await f.deleteChapterFolder(s.id,e,t),h("Folder deleted","success"),await ee(s.id),W([s.id])}catch(a){h("Failed: "+a.message,"error")}}function cn(e,t){var r;if(!e)return;const s=(r=C.manga)==null?void 0:r.id,a=Date.now(),n=async()=>{var p,d;if(Date.now()-a>30*60*1e3)return;let i;try{i=await f.getDownloadProgress(e)}catch{return}if(!i)return;if(!["complete","error","cancelled"].includes(i.status)){setTimeout(n,3e3);return}const l=i.errors||[],u=(i.completedChapters||[]).length>0&&i.status!=="error";i.status==="cancelled"?h(`${t}: download cancelled`,"info"):u?l.length?h(`${t} downloaded with problems: ${l[0].error}`,"warning"):h(`${t} downloaded${i.pages?` (${i.pages} pages)`:""}`,"success"):h(`${t} failed: ${((p=l[0])==null?void 0:p.error)||"unknown error"}`,"error"),((d=C.manga)==null?void 0:d.id)===s&&window.location.hash.startsWith(`#/manga/${s}`)&&(await ee(s),W([s]))};setTimeout(n,3e3)}async function Vo(e,t){var c;const s=C.manga,a=((c=s.downloadedVersions)==null?void 0:c[e])||[],r=(Array.isArray(a)?a:[a]).filter(l=>l&&l!==t);if(r.length===0){h("This is the only downloaded version","info");return}if(!confirm(`Delete the other ${r.length} downloaded version${r.length>1?"s":""} of chapter ${e}?`))return;let i=0;for(const l of r)try{await f.request(`/bookmarks/${s.id}/chapters`,{method:"DELETE",body:JSON.stringify({chapterNumber:e,url:l})})}catch(u){i++,h("Failed to delete a version: "+u.message,"error")}i===0&&h("Other versions deleted","success"),await ee(s.id),W([s.id])}async function jo(e,t){const s=C.manga;try{h("Downloading version...","info");const a=await f.post(`/bookmarks/${s.id}/download-version`,{chapterNumber:e,url:t});h("Download queued!","success"),cn(a==null?void 0:a.taskId,`Chapter ${e}`)}catch(a){h("Failed: "+a.message,"error")}}async function zo(e,t){const s=C.manga;try{await f.request(`/bookmarks/${s.id}/chapters`,{method:"DELETE",body:JSON.stringify({chapterNumber:e,url:t})}),h("Version deleted","success"),await ee(s.id),W([s.id])}catch(a){h("Failed: "+a.message,"error")}}async function Qo(e,t){const s=C.manga;try{await f.hideVersion(s.id,e,t),h("Version hidden","success"),await ee(s.id),W([s.id])}catch(a){h("Failed: "+a.message,"error")}}async function Wo(e,t){const s=C.manga;try{await f.unhideVersion(s.id,e,t),h("Version restored","success"),await ee(s.id),W([s.id])}catch(a){h("Failed to restore version: "+a.message,"error")}}async function Go(e){const t=C.manga;try{await f.unexcludeChapter(t.id,e),h("Chapter restored","success"),await ee(t.id),W([t.id])}catch(s){h("Failed to restore chapter: "+s.message,"error")}}async function Ko(e,t){const s=C.manga;if(confirm("Delete this chapter's files from disk?"))try{await f.request(`/bookmarks/${s.id}/chapters`,{method:"DELETE",body:JSON.stringify({chapterNumber:e,url:t})}),h("Chapter files deleted","success"),await ee(s.id),W([s.id])}catch(a){h("Failed to delete: "+a.message,"error")}}async function Yo(e,t){const s=C.manga;if(confirm("Hide this chapter? It will be moved to the Hidden filter."))try{await f.hideVersion(s.id,e,t),h("Chapter hidden","success"),await ee(s.id),W([s.id])}catch(a){h("Failed to hide chapter: "+a.message,"error")}}async function Jo(e,t){const s=C.manga;try{await f.unhideVersion(s.id,e,t),h("Chapter unhidden","success"),await ee(s.id),W([s.id])}catch(a){h("Failed to unhide chapter: "+a.message,"error")}}function Xo(e,t){var r,i;const s=e.querySelector("#merge-mode-btn");if(s&&s.addEventListener("click",()=>{C.mergeMode=!C.mergeMode,C.mergeSelection=new Set,C.mergeTargetTouched=!1,C.mergeTitleTouched=!1,W([t.id])}),!C.mergeMode)return;e.querySelectorAll(".merge-pick").forEach(c=>{c.addEventListener("click",l=>l.stopPropagation()),c.addEventListener("change",l=>{l.stopPropagation();const u=parseFloat(c.dataset.num);c.checked?C.mergeSelection.add(u):C.mergeSelection.delete(u),Zo(t)})});const a=e.querySelector("#merge-target"),n=e.querySelector("#merge-title");a==null||a.addEventListener("input",()=>{C.mergeTargetTouched=!0,!C.mergeTitleTouched&&n&&(n.value=a.value!==""?`Chapter ${a.value}`:"")}),n==null||n.addEventListener("input",()=>{C.mergeTitleTouched=!0}),(r=e.querySelector("#merge-cancel"))==null||r.addEventListener("click",()=>{C.mergeMode=!1,C.mergeSelection=new Set,W([t.id])}),(i=e.querySelector("#merge-submit"))==null||i.addEventListener("click",async()=>{var g;const c=[...C.mergeSelection].sort(($,v)=>$-v),l=parseFloat(a==null?void 0:a.value);if(c.length===0)return h("Tick the chapters to combine first","info");if(!Number.isFinite(l))return h("Give the combined chapter a number","error");const u=(n==null?void 0:n.value.trim())||`Chapter ${l}`,p=!!((g=e.querySelector("#merge-delete-sources"))!=null&&g.checked);if(p&&!confirm(`Remove the original folders of ${c.map($=>`Ch. ${$}`).join(", ")} after combining? Splitting later will need them downloaded again.`))return;const d=e.querySelector("#merge-submit");d.disabled=!0,d.textContent="Combining…";try{const $=await f.mergeChapters(t.id,{sources:c,target:l,title:u,deleteSources:p});h(`Chapter ${$.target}: ${$.pageCount} pages from ${c.length} chapter${c.length===1?"":"s"}`,"success"),C.mergeMode=!1,C.mergeSelection=new Set,await ee(t.id),W([t.id])}catch($){h("Combine failed: "+$.message,"error"),d.disabled=!1,d.textContent="Combine"}})}function Zo(e){const t=[...C.mergeSelection].sort((c,l)=>c-l),s=document.getElementById("merge-picked");s&&(s.textContent=t.length?`Picked in page order: ${t.map(c=>`Ch. ${c}`).join(", ")}`:"Tick the downloaded chapters to combine (pages follow chapter order).");const a=document.getElementById("merge-submit");a&&(a.disabled=t.length===0);const n=ln(e,t),r=document.getElementById("merge-target"),i=document.getElementById("merge-title");r&&!C.mergeTargetTouched&&(r.value=n),i&&!C.mergeTitleTouched&&(i.value=n!==""?`Chapter ${n}`:"")}async function ei(e){var r;const t=C.manga,s=(r=t==null?void 0:t.mergedChapters)==null?void 0:r[e];if(!s)return;const a=s.sources.map(i=>`Ch. ${i}`).join(", "),n=s.sources.includes(e)?` Chapter ${e}'s own pages were folded into the combined folder, so it will need downloading again.`:"";if(confirm(`Split chapter ${e} back into ${a}? The combined folder is deleted; the other originals come back as they are on disk.${n}`))try{await f.unmergeChapter(t.id,e),h(`Chapter ${e} split into ${a}`,"success"),await ee(t.id),W([t.id])}catch(i){h("Split failed: "+i.message,"error")}}async function ee(e){try{const[t,s]=await Promise.all([f.getBookmark(e),Z.isDemo?Promise.resolve([]):be.loadCategories()]);if(C.manga=t,C.categories=s,C.loading=!1,C.volumesCollapsed=$o(t),t.website==="Local")try{const r=await f.getCbzFiles(e);C.cbzFiles=r||[]}catch(r){console.error("Failed to load CBZ files:",r),C.cbzFiles=[]}else C.cbzFiles=[];const a=new Set((t.chapters||[]).map(r=>r.number)).size,n=Math.ceil(a/wt);C.currentPage=Math.max(0,n-1),C.activeVolumeId?C.activeVolume=(t.volumes||[]).find(r=>r.id===C.activeVolumeId):C.activeVolume=null}catch{h("Failed to load manga","error"),C.loading=!1}}async function W(e=[]){const[t,s,a]=e;if(!t){H.go("/");return}C.activeVolumeId=s==="volume"?a:null;const n=document.getElementById("app");!C.manga||C.manga.id!==t?(C.loading=!0,C.manga=null,n.innerHTML=Ls(),await ee(t)):C.activeVolumeId?C.activeVolume=(C.manga.volumes||[]).find(r=>r.id===C.activeVolumeId):C.activeVolume=null,n.innerHTML=Ls(),Po(),zt()}function ti(){C.manga&&se.unsubscribeFromManga(C.manga.id),C.manga=null,C.loading=!0}const si={mount:W,unmount:ti,render:Ls};function ai(){return`
  ...
  `}function Zt(){var l,u,p;const e=document.getElementById("app"),t=Se.series;(l=document.getElementById("back-btn"))==null||l.addEventListener("click",()=>H.go("/")),(u=document.getElementById("back-library-btn"))==null||u.addEventListener("click",()=>H.go("/")),e.querySelectorAll(".series-entry-card").forEach(d=>{d.addEventListener("click",g=>{if(g.target.closest("[data-action]"))return;const $=d.dataset.id;H.go(`/manga/${$}`)})}),e.querySelectorAll("[data-action]").forEach(d=>{d.addEventListener("click",async g=>{g.stopPropagation();const $=d.dataset.action,v=d.dataset.id;switch($){case"move-up":await ca(v,-1);break;case"move-down":await ca(v,1);break;case"set-cover":const y=d.dataset.entryid;await ii(y);break}})});const s=document.getElementById("add-entry-btn"),a=document.getElementById("add-entry-modal"),n=document.getElementById("available-bookmarks-input"),r=document.getElementById("available-bookmarks-list"),i=document.getElementById("confirm-add-entry-btn");let c=[];s&&a&&(s.addEventListener("click",async()=>{try{s.disabled=!0,n&&(n.value="",n.placeholder="Loading...",n.disabled=!0),r&&(r.innerHTML=""),a.classList.add("open");const d=await f.getAvailableBookmarksForSeries();c=d,d.length===0?(n&&(n.placeholder="No available manga found"),i.disabled=!0):(n&&(n.placeholder="Select or type a manga...",n.disabled=!1),r&&(r.innerHTML=d.map(g=>`<option value="${(g.alias||g.title||"").replace(/"/g,"&quot;")}"></option>`).join("")),i.disabled=!1)}catch{h("Failed to load available manga","error"),a.classList.remove("open")}finally{s.disabled=!1}}),i.addEventListener("click",async()=>{const d=n?n.value:"",g=c.find(v=>(v.alias||v.title||"")===d);if(!g){h("Please select a valid manga from the list","warning");return}const $=g.id;try{i.disabled=!0,i.textContent="Adding...",await f.addSeriesEntry(t.id,$),h("Manga added to series","success"),a.classList.remove("open"),await es(t.id),e.innerHTML=rt(),Zt()}catch(v){h("Failed to add manga: "+v.message,"error")}finally{i.disabled=!1,i.textContent="Add to Series"}})),(p=document.getElementById("edit-series-btn"))==null||p.addEventListener("click",()=>{h("Edit series coming soon","info")})}async function ca(e,t){const s=Se.series;if(!s)return;const a=s.entries||[],n=a.findIndex(c=>c.bookmark_id===e);if(n===-1)return;const r=n+t;if(r<0||r>=a.length)return;const i=a.map(c=>c.bookmark_id);[i[n],i[r]]=[i[r],i[n]];try{await f.post(`/series/${s.id}/reorder`,{order:i}),h("Order updated","success"),await es(s.id);const c=document.getElementById("app");c.innerHTML=rt(),Zt()}catch(c){h("Failed to reorder: "+c.message,"error")}}async function ii(e){const t=Se.series;if(t)try{await f.setSeriesCover(t.id,e),h("Series cover updated","success"),await es(t.id);const s=document.getElementById("app");s.innerHTML=rt(),Zt()}catch(s){h("Failed to set cover: "+s.message,"error")}}async function es(e){try{const t=await f.get(`/series/${e}`);Se.series=t,Se.loading=!1}catch{h("Failed to load series","error"),Se.loading=!1}}async function li(e=[]){const[t]=e;if(!t){H.go("/");return}const s=document.getElementById("app");Se.loading=!0,Se.series=null,s.innerHTML=rt(),await es(t),s.innerHTML=rt(),Zt()}function ci(){Se.series=null,Se.loading=!0}const di={mount:li,unmount:ci,render:rt},ui={disabledMangaIds:[],includeLists:!1,includeTrophies:!1,intervalMs:8e3,shuffle:!1};function Te(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function pi(){return`
    ...
    `}async function mi(){const e=p=>document.getElementById(p),t=e("cleanup-scan"),s=e("cleanup-summary"),a=e("cleanup-results");if(!t)return;const n=p=>{if(!p)return"0 B";const d=["B","KB","MB","GB","TB"];let g=0,$=p;for(;$>=1024&&g<d.length-1;)$/=1024,g++;return`${$.toFixed($>=100||g===0?0:1)} ${d[g]}`},r={series:"Series folder",chapter:"Chapter folder",volume:"Volume folder",temp:"Unfinished import"},i=()=>[...a.querySelectorAll(".cl-pick:checked")].map(p=>p.value),c=()=>{const p=a.querySelector("#cleanup-delete");if(!p)return;const d=i().length;p.disabled=d===0,p.textContent=d?`Delete ${d} selected`:"Delete selected"},l=p=>{if(!p.groups.length){a.innerHTML='<p class="settings-hint">Nothing left over. Every folder on disk is in use.</p>';return}a.innerHTML=`
            <div class="review-tools">
            ...
            ${p.groups.map(d=>`
                <div class="cleanup-group">
                    <div class="cleanup-series">${m("book-open")} ${Te(d.series)}${d.bookmarkIds.length?"":" <small>(no series in the library)</small>"}</div>
                    ${d.items.map(g=>`
        ...
        `,a.querySelector("#cleanup-all").addEventListener("click",()=>{a.querySelectorAll(".cl-pick").forEach(d=>{d.checked=!0}),c()}),a.querySelector("#cleanup-none").addEventListener("click",()=>{a.querySelectorAll(".cl-pick").forEach(d=>{d.checked=!1}),c()}),a.addEventListener("change",c),a.querySelector("#cleanup-delete").addEventListener("click",async()=>{const d=i();if(!d.length)return;const g=p.groups.flatMap(v=>v.items).filter(v=>d.includes(v.path)).reduce((v,y)=>v+y.size,0);if(!confirm(`Delete ${d.length} folder${d.length===1?"":"s"} from disk (${n(g)})? This cannot be undone.`))return;const $=a.querySelector("#cleanup-delete");$.disabled=!0,$.textContent="Deleting…";try{const v=await f.removeDownloadLeftovers(d);h(`Deleted ${v.removed.length} folder${v.removed.length===1?"":"s"}, freed ${n(v.freed)}`,"success"),v.skipped.length&&(a.querySelector("#cleanup-result").innerHTML=`<ul class="task-error-list">${v.skipped.map(y=>`<li>${Te(y.path)}: ${Te(y.reason)}</li>`).join("")}</ul>`),await u()}catch(v){h(`Delete failed: ${v.message}`,"error"),c()}})},u=async()=>{t.disabled=!0,s.textContent="Scanning…";try{const p=await f.getDownloadLeftovers();s.textContent=p.totalItems?`${p.totalItems} leftover${p.totalItems===1?"":"s"}, ${n(p.totalSize)}`:"Nothing left over",l(p)}catch(p){s.textContent=`Scan failed: ${p.message}`}finally{t.disabled=!1}};t.addEventListener("click",u)}async function gi(){const e=l=>document.getElementById(l),t=e("tor-path-mappings");if(!t)return;const s=l=>{t.innerHTML=l.length?l.map((u,p)=>`
                <div class="tor-mapping" data-index="${p}">
                    <input type="text" class="tor-map-from" value="${Te(u.from)}" placeholder="qBittorrent path, e.g. /downloads">
                    <span class="tor-map-arrow">→</span>
                    <input type="text" class="tor-map-to" value="${Te(u.to)}" placeholder="path this app sees, e.g. /app/torrents">
                    <button type="button" class="btn-icon small danger tor-map-remove" title="Remove">×</button>
                </div>`).join(""):'<p class="settings-hint">No mappings.</p>',t.querySelectorAll(".tor-map-remove").forEach(u=>u.addEventListener("click",()=>{u.closest(".tor-mapping").remove(),t.querySelector(".tor-mapping")||s([])}))},a=()=>[...t.querySelectorAll(".tor-mapping")].map(l=>({from:l.querySelector(".tor-map-from").value.trim(),to:l.querySelector(".tor-map-to").value.trim()})),n=()=>a().filter(l=>l.from&&l.to),r=()=>({prowlarr:{baseUrl:e("tor-prowlarr-url").value.trim(),apiKey:e("tor-prowlarr-key").value},qbittorrent:{baseUrl:e("tor-qbt-url").value.trim(),username:e("tor-qbt-user").value.trim(),password:e("tor-qbt-pass").value,category:e("tor-qbt-category").value.trim()||"manga",savePath:e("tor-qbt-savepath").value.trim()},pathMappings:n(),autoImport:e("tor-auto-import").checked}),i=(l,u,p)=>{l.textContent=p,l.className=`torrents-test-result ${u?"ok":"error"}`};try{const{settings:l}=await f.getTorrentSettings();e("tor-prowlarr-url").value=l.prowlarr.baseUrl||"",e("tor-prowlarr-key").value=l.prowlarr.apiKey||"",e("tor-qbt-url").value=l.qbittorrent.baseUrl||"",e("tor-qbt-user").value=l.qbittorrent.username||"",e("tor-qbt-pass").value=l.qbittorrent.password||"",e("tor-qbt-category").value=l.qbittorrent.category||"manga",e("tor-qbt-savepath").value=l.qbittorrent.savePath||"",e("tor-auto-import").checked=l.autoImport!==!1,s(l.pathMappings||[])}catch(l){s([]),i(e("tor-save-result"),!1,`Could not load torrent settings: ${l.message}`)}e("tor-add-mapping").addEventListener("click",()=>s([...a(),{from:"",to:""}]));const c=async(l,u,p)=>{u.disabled=!0,p.textContent="Testing…",p.className="torrents-test-result";try{const{result:d}=await f.testTorrentService(l,r()[l]);l==="prowlarr"?i(p,!0,`Connected: ${d.appName} ${d.version}${d.indexers!==null?`, ${d.indexers} indexer${d.indexers===1?"":"s"} enabled`:""}`):i(p,!0,`Connected: qBittorrent ${d.version}${d.savePath?`, default save path ${d.savePath}`:""}`)}catch(d){i(p,!1,d.message)}finally{u.disabled=!1}};e("tor-test-prowlarr").addEventListener("click",l=>c("prowlarr",l.currentTarget,e("tor-prowlarr-result"))),e("tor-test-qbt").addEventListener("click",l=>c("qbittorrent",l.currentTarget,e("tor-qbt-result"))),e("tor-save").addEventListener("click",async l=>{const u=l.currentTarget;u.disabled=!0;try{const{settings:p}=await f.saveTorrentSettings(r());e("tor-prowlarr-key").value=p.prowlarr.apiKey||"",e("tor-qbt-pass").value=p.qbittorrent.password||"",i(e("tor-save-result"),!0,"Saved"),h("Torrent settings saved","success")}catch(p){i(e("tor-save-result"),!1,p.message)}finally{u.disabled=!1}})}const fi={mount:async e=>{const t=document.getElementById("app");t.innerHTML=`
            ${fe()}
                    ...
                    <tbody>
                        ${t.map(s=>{var a;return`
                            <tr data-user-id="${s.id}">
                                <td>${Is(s.username)}${s.id===((a=Z.user)==null?void 0:a.id)?' <span class="badge">you</span>':""}</td>
                                <td>
            ...
            <div class="table-responsive">
                <table class="data-table">
                    ...
                    <tbody>
                        ${i.rows.map(l=>`
                            <tr>
                                ${c.map(u=>{const p=l[u];let d=p;return p===null?d='<span class="null">NULL</span>':typeof p=="object"?d=JSON.stringify(p):String(p).length>100&&(d=String(p).substring(0,100)+"..."),`<td>${d}</td>`}).join("")}
                            </tr>
                        `).join("")}
                    </tbody>
                </table>
  ...
  `}function dn(){De();const e=document.getElementById("app");e.querySelectorAll(".tab-btn").forEach(s=>{s.addEventListener("click",()=>{ue.activeTab=s.dataset.tab,e.innerHTML=Qt(),dn()})}),e.querySelectorAll(".gallery-card").forEach(s=>{s.addEventListener("click",()=>{const a=s.dataset.gallery;H.go(`/read/gallery/${encodeURIComponent(a)}`)})}),e.querySelectorAll(".trophy-gallery-card").forEach(s=>{s.addEventListener("click",()=>{const a=s.dataset.trophyId;s.dataset.isSeries==="true"?H.go(`/read/trophies/series-${a}/🏆`):H.go(`/read/trophies/${a}/🏆`)})})}async function Ci(){try{const[e,t,s,a]=await Promise.all([be.loadFavorites(),f.get("/trophy-pages"),be.loadBookmarks(),be.loadSeries()]);ue.favorites=e||{favorites:{},listOrder:[]},ue.trophyPages=t||{},ue.bookmarks=s||[],ue.series=a||[],ue.loading=!1}catch(e){console.error("Failed to load favorites:",e),h("Failed to load favorites","error"),ue.loading=!1}}async function xi(){console.log("[Favorites] mount called"),ue.loading=!0;const e=document.getElementById("app");e.innerHTML=Qt(),await Ci(),console.log("[Favorites] Data loaded, rendering..."),e.innerHTML=Qt(),console.log("[Favorites] Calling setupListeners..."),dn(),console.log("[Favorites] setupListeners complete")}function Li(){}const Ii={mount:xi,unmount:Li,render:Qt},Mi="site-assist-modal",Ti="/assist",Bi=1,Ai=2,_i=4,Pi=8,da=["left","middle","right"];let at=null;function Je(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function ut(e){return(e.altKey?Bi:0)|(e.ctrlKey?Ai:0)|(e.metaKey?_i:0)|(e.shiftKey?Pi:0)}function Xe(){if(!at)return;const{socket:e,modal:t,site:s,onKey:a}=at;at=null,document.removeEventListener("keydown",a,!0),document.removeEventListener("keyup",a,!0);try{e.emit("assist:stop",{site:s})}catch{}try{e.disconnect()}catch{}t.remove()}function ts({site:e,url:t,reason:s,onSolved:a}={}){if(!e)return;if(!Z.isAdmin){h("Only an admin can solve a site check for the scraper","error");return}Xe();const n=document.createElement("div");n.id=Mi,n.className="modal open site-assist-modal",n.innerHTML=`
    ...
    `,document.body.appendChild(n);const r=n.querySelector("#site-assist-canvas"),i=r.getContext("2d"),c=n.querySelector("#site-assist-status"),l=n.querySelector("#site-assist-overlay"),u=(k,I)=>{c.dataset.status=k,c.textContent=I||""},p=bt(Ti,{auth:{token:f.getToken()},reconnection:!0,reconnectionAttempts:3,reconnectionDelay:1e3});let d=!1,g=!1;const $=new Image;let v=null;$.onload=()=>{if((r.width!==$.naturalWidth||r.height!==$.naturalHeight)&&(r.width=$.naturalWidth,r.height=$.naturalHeight),i.drawImage($,0,0),v){const k=v;v=null,$.src=k}},$.onerror=()=>{v=null},p.on("connect",()=>{u("connecting",`Opening ${e} in the scraper's browser…`),p.emit("assist:start",{site:e},k=>{(!k||!k.ok)&&(u("error",(k==null?void 0:k.error)||"The check could not be opened"),l.textContent=(k==null?void 0:k.error)||"The check could not be opened",l.hidden=!1)})}),p.on("connect_error",k=>{u("error",`Not connected: ${k.message}`),l.textContent=`Not connected: ${k.message}`,l.hidden=!1}),p.on("assist:state",k=>{!k||k.site!==e||(k.status==="streaming"&&(d=!0,l.hidden=!0),u(k.status,k.message),k.status==="solved"?(d=!1,h(`${e}: check passed, waiting work resumes`,"success"),typeof a=="function"&&a(),setTimeout(Xe,2500)):k.status==="ended"?(d=!1,g=!0,l.textContent=k.message||"The window was closed.",l.hidden=!1,k.reason!=="solved"&&u("ended",k.message)):k.status==="error"&&(l.textContent=k.message,l.hidden=!1))}),p.on("assist:frame",k=>{if(!k||k.site!==e||g)return;const I=`data:image/jpeg;base64,${k.data}`;$.complete&&!v?$.src=I:v=I,d||(d=!0,l.hidden=!0)});const y=k=>{const I=r.getBoundingClientRect(),N=(k.clientX-I.left)*(r.width/I.width),E=(k.clientY-I.top)*(r.height/I.height);return{x:Math.round(N),y:Math.round(E)}},L=k=>{d&&!g&&p.emit("assist:input",{site:e,...k})};let w=null;const x=()=>{w&&(L(w),w=null)};r.addEventListener("pointerdown",k=>{k.preventDefault(),r.focus(),r.setPointerCapture(k.pointerId);const{x:I,y:N}=y(k);L({type:"mousedown",x:I,y:N,button:da[k.button]||"left",buttons:k.buttons,clickCount:1,modifiers:ut(k)})}),r.addEventListener("pointermove",k=>{const{x:I,y:N}=y(k),E=!w;w={type:"mousemove",x:I,y:N,button:k.buttons&1?"left":k.buttons&2?"right":"none",buttons:k.buttons,modifiers:ut(k)},E&&requestAnimationFrame(x)}),r.addEventListener("pointerup",k=>{k.preventDefault(),x();const{x:I,y:N}=y(k);L({type:"mouseup",x:I,y:N,button:da[k.button]||"left",buttons:k.buttons,clickCount:1,modifiers:ut(k)});try{r.releasePointerCapture(k.pointerId)}catch{}}),r.addEventListener("pointercancel",k=>{const{x:I,y:N}=y(k);L({type:"mouseup",x:I,y:N,button:"left",buttons:0,clickCount:1})}),r.addEventListener("wheel",k=>{k.preventDefault();const{x:I,y:N}=y(k);L({type:"wheel",x:I,y:N,deltaX:k.deltaX,deltaY:k.deltaY,modifiers:ut(k)})},{passive:!1}),r.addEventListener("contextmenu",k=>k.preventDefault());const T=k=>{if(!at||at.modal!==n)return;if(k.key==="Escape"){k.type==="keydown"&&Xe();return}if(document.activeElement!==r)return;k.preventDefault(),k.stopPropagation();const I=k.key.length===1&&!k.ctrlKey&&!k.metaKey;L({type:k.type,key:k.key,code:k.code,keyCode:k.keyCode,text:I?k.key:void 0,modifiers:ut(k)})};document.addEventListener("keydown",T,!0),document.addEventListener("keyup",T,!0),n.querySelector(".modal-overlay").addEventListener("click",Xe),n.querySelectorAll('[data-act="close"]').forEach(k=>k.addEventListener("click",Xe)),n.querySelector('[data-act="paste"]').addEventListener("click",k=>{k.preventDefault(),Xe(),as({site:e,url:t,stale:s==="expired"||s==="rejected"})}),n.querySelector('[data-act="open"]').addEventListener("click",k=>{k.preventDefault(),ss(e,t)}),at={site:e,socket:p,modal:n,onKey:T},r.focus()}const un="site-cookie-modal",js=new Set;function me(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function ss(e,t){window.open(t||`https://${e}/`,"_blank","noopener")}function et(){const e=document.getElementById(un);e&&e.remove(),document.removeEventListener("keydown",pn)}function pn(e){e.key==="Escape"&&et()}function qi(e,t){var n;const s=((n=t.session)==null?void 0:n.cookieCount)??0,a=t.probe;return a&&a.ok?{kind:"ok",html:`<strong>${me(e)} accepted the cookies.</strong> ${s} saved; downloads and checks that were
                   ...
                   and paste again.${a.error?`<br><small>${me(a.error)}</small>`:""}`}:{kind:"ok",html:`<strong>Saved ${s} cookie${s===1?"":"s"}.</strong> The site could not be tested right now; retry your download to find out.`}}function as({site:e,url:t,stale:s=!1,onImported:a}={}){if(!e)return;if(!Z.isAdmin){h("Only an admin can hand site cookies to the scraper","error");return}et();const n=navigator.userAgent||"",r=document.createElement("div");r.id=un,r.className="modal open site-cookie-modal",r.innerHTML=`
        <div class="modal-overlay"></div>
        <div class="modal-content">
            <div class="modal-header">
    ...
    `,document.body.appendChild(r),document.addEventListener("keydown",pn);const i=r.querySelector("#site-cookie-input"),c=r.querySelector("#site-cookie-ua"),l=r.querySelector("#site-cookie-result"),u=r.querySelector('[data-act="save"]'),p=(g,$)=>{l.className=`site-cookie-result ${g}`,l.innerHTML=$,l.hidden=!1};r.querySelector(".modal-overlay").addEventListener("click",et),r.querySelectorAll('[data-act="close"]').forEach(g=>g.addEventListener("click",et)),r.querySelector('[data-act="open"]').addEventListener("click",()=>ss(e,t)),r.querySelector('[data-act="assist"]').addEventListener("click",()=>{et(),ts({site:e,url:t,reason:s?"rejected":"check",onSolved:a})});let d=!1;u.addEventListener("click",async()=>{var $;if(d)return;const g=i.value.trim();if(!g){p("error","Paste the cookies first."),i.focus();return}d=!0,u.disabled=!0,u.textContent="Saving & testing…",l.hidden=!0;try{const v=await f.importSiteSession(e,g,c.value.trim()),{kind:y,html:L}=qi(e,v),w=v.ignored||{},x=[];w.foreign&&x.push(`${w.foreign} for other sites`),w.expired&&x.push(`${w.expired} already expired`),w.invalid&&x.push(`${w.invalid} unreadable`),p(y,L+(x.length?`<br><small>Skipped: ${x.join(", ")}.</small>`:"")),i.value="",typeof a=="function"&&a(v),($=v.probe)!=null&&$.ok&&(h(`${e}: cookies accepted, checks resume`,"success"),setTimeout(et,2500))}catch(v){p("error",me(v.message||"Import failed"))}finally{d=!1,u.disabled=!1,u.textContent="Save & test"}}),i.focus()}const ua="site-challenge-banners",ns=new Map;function Ri(e){const t=`<strong>${me(e.site)}</strong>`,s=" Its downloads and update checks wait in the queue and resume by themselves once the check is passed.";return e.reason==="expired"?`${t}'s verification cookies expired.${s}`:e.sessionStale?`${t} no longer accepts the cookies handed over earlier.${s}`:`${t} is asking for a human verification check.${s}`}function Di(e){var n,r,i;const t=Z.isAdmin,s=document.createElement("div");s.className="site-challenge-banner",s.dataset.site=e.site;const a=e.waiting?` <span class="site-challenge-waiting">${e.waiting} task${e.waiting===1?"":"s"} waiting</span>`:"";return s.innerHTML=`
    ...
    `,(n=s.querySelector('[data-act="assist"]'))==null||n.addEventListener("click",()=>{ts({site:e.site,url:e.url,reason:e.reason||(e.sessionStale?"rejected":"check")})}),(r=s.querySelector('[data-act="open"]'))==null||r.addEventListener("click",()=>ss(e.site,e.url)),(i=s.querySelector('[data-act="import"]'))==null||i.addEventListener("click",()=>{as({site:e.site,url:e.url,stale:!!e.sessionStale||e.reason==="expired"})}),s.querySelector('[data-act="retry"]').addEventListener("click",async()=>{try{await f.clearSiteChallenge(e.site),h(`${e.site}: waiting work resumes. If the puzzle comes back, solve it instead.`,"info")}catch(c){h("Failed: "+c.message,"error")}ns.delete(e.site),Wt()}),s.querySelector('[data-act="close"]').addEventListener("click",()=>{js.add(e.site),Wt()}),s}function Wt(){let e=document.getElementById(ua);const t=[...ns.values()].filter(s=>!js.has(s.site));if(t.length===0){e&&e.remove();return}e||(e=document.createElement("div"),e.id=ua,e.className="site-challenge-banners",document.body.appendChild(e)),e.replaceChildren(...t.map(Di))}function pa(e){!e||!e.site||(ns.set(e.site,e),Wt())}function Ni(e){ns.delete(e),Wt()}async function yl(){se.on("site:challenge",e=>{js.delete(e.site),pa(e)}),se.on("site:challenge-cleared",({site:e})=>Ni(e));try{const e=await f.getSiteStatus();for(const t of e.challenges||[])pa(t)}catch{}}let j={downloads:{},torrents:[],imports:[],queueTasks:[],historyTasks:[],autoCheck:null,loading:!0,showEmptyChecks:!1,collapsed:{torrents:!1,imports:!1,active:!1,scheduled:!1,completed:!1,history:!0}},Rt=null,ie={};function zs(e){if(!e)return"Never";const t=Date.now()-new Date(e).getTime(),s=Math.floor(t/6e4);if(s<1)return"Just now";if(s<60)return`${s}m ago`;const a=Math.floor(s/60);return a<24?`${a}h ${s%60}m ago`:`${Math.floor(a/24)}d ago`}function Fi(e){if(!e)return"Not scheduled";const t=new Date(e).getTime()-Date.now();if(t<=0)return"Running now...";const s=Math.floor(t/6e4);if(s<60)return`in ${s}m`;const a=Math.floor(s/60),n=s%60;if(a<24)return`in ${a}h ${n}m`;const r=Math.floor(a/24),i=a%24;return`in ${r}d ${i}h`}function hn(e){switch(e){case"download":return m("download");case"scrape":return m("search");case"scan":return m("folder");default:return m("settings")}}function Qs(e){switch(e){case"running":return"var(--color-success)";case"queued":case"pending":case"waiting":return"var(--color-warning)";case"paused":return"var(--color-info)";case"complete":return"var(--color-success)";case"error":case"failed":case"cancelled":return"var(--color-error)";default:return"var(--text-secondary)"}}function Ws(e){switch(e){case"running":return"● Running";case"queued":case"pending":return"◌ Queued";case"waiting":return"⏳ Waiting for site";case"paused":return"❚❚ Paused";case"complete":return"✓ Complete";case"error":case"failed":return"✗ Failed";case"cancelled":return"✗ Cancelled";default:return e}}function Oi(e){return!e||e==="default"?"Default (6h)":e==="daily"?"Daily":e==="weekly"?"Weekly":e}function Ui(){const e=j.autoCheck;return e?`
  ...
  `}function re(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function Vi(e){const t=e.challenge||{},s=re(e.waitingFor||t.site||e.site||"the site"),a=re(t.url||`https://${e.waitingFor||t.site||e.site}/`),n=Z.isAdmin,r=t.reason||(t.sessionStale?"rejected":"check");return`
    ...
    </div>`}function ha(e,t){const s=t.total>0?Math.round(t.completed/t.total*100):0,a=t.status==="waiting",n=t.status==="running"||t.status==="queued"||a,r=t.status==="paused",i=(t.errors||[]).filter(u=>!u.waiting),c=i.length>0,l=!n&&!r&&c&&(t.chapterUrls||[]).length>0;return`
    <div class="queue-card task-card" data-task-id="${e}">
      ...
      <div class="queue-card-body">
        ...
        ${c?`
          ...
          <ul class="task-error-list">${i.slice(0,5).map(u=>`<li>${typeof u.chapter=="number"?`Ch. ${u.chapter}: `:""}${re(u.error)}</li>`).join("")}</ul>`:""}
        ${a?Vi(t):l?`
  ...
  `}function ji(e){switch(e.status){case"downloading":return/paused|stopped/i.test(e.state||"")?"Paused":/queued|metaDL|checking/i.test(e.state||"")?"Waiting":"Downloading";case"grabbing":return"Fetching the release for qBittorrent";case"completed":return e.autoImport?"Downloaded, importing soon":"Downloaded";case"importing":return"Importing";case"imported":return"Imported";case"failed":return"Failed";case"removed":return"Removed from qBittorrent";default:return e.status}}function zi(e){return e.status==="imported"?"var(--success)":e.status==="failed"||e.status==="removed"?"var(--error)":e.status==="importing"||e.status==="completed"||e.status==="grabbing"?"var(--warning)":"var(--text-secondary)"}function Qi(e){return!e||e<=0||e>=864e4?"":e<60?`${e}s`:e<3600?`${Math.round(e/60)}m`:`${Math.floor(e/3600)}h ${Math.round(e%3600/60)}m`}function Wi(e){var u,p,d,g;const t=Math.round((e.progress||0)*100),s=e.status==="downloading",a=s&&/paused|stopped/i.test(e.state||""),n=["completed","failed","imported"].includes(e.status)&&(e.progress||0)>=1,r=e.bookmarkId?`<a href="#/manga/${re(e.bookmarkId)}">open series</a>`:e.newSeriesTitle?`new series “${re(e.newSeriesTitle)}”`:"",i=e.importResult,c=i?[(u=i.volumes)!=null&&u.length?`${i.volumes.length} volume${i.volumes.length===1?"":"s"} (${i.volumes.map($=>$.name).join(", ")})`:"",(p=i.chapters)!=null&&p.length?`${i.chapters.length} chapter${i.chapters.length===1?"":"s"}`:"",(d=i.skipped)!=null&&d.length?`${i.skipped.length} skipped`:""].filter(Boolean).join(" · "):"",l=[kt(e.size),s&&e.dlspeed?`${kt(e.dlspeed)}/s`:"",s?Qi(e.eta):"",e.indexer||""].filter(Boolean).join(" · ");return`
  ...
  `}function Gi(e){switch(e.status){case"queued":return"◌ Queued";case"running":return"● Importing";case"done":return"✓ Imported";case"failed":return"✗ Failed";default:return e.status}}function Ki(e){return e.status==="done"?"var(--color-success)":e.status==="failed"?"var(--color-error)":"var(--color-warning)"}function Yi(e){var c,l,u,p;const t=e.total||0,s=e.status==="done"?t:e.done||0,a=t>0?Math.round(s/t*100):e.status==="done"?100:0,n=e.summary,r=n?[(c=n.volumes)!=null&&c.length?`${n.volumes.length} volume${n.volumes.length===1?"":"s"} (${n.volumes.map(d=>d.name).join(", ")})`:"",(l=n.chapters)!=null&&l.length?`${n.chapters.length} chapter${n.chapters.length===1?"":"s"}`:"",(u=n.skipped)!=null&&u.length?`${n.skipped.length} skipped`:""].filter(Boolean).join(" · "):"",i=e.bookmarkId?`<a href="#/manga/${re(e.bookmarkId)}">${re(e.bookmarkTitle||"open series")}</a>`:e.bookmarkTitle?`new series “${re(e.bookmarkTitle)}”`:"";return`
      ...
      <div class="queue-card-header">
        <div class="task-info">
          ...
          <div>
            ...
            <div class="task-status" style="color: ${Ki(e)}">${Gi(e)}${i?` · into ${i}`:""}</div>
          </div>
        </div>
      </div>
      <div class="queue-card-body">
        ...
        ${e.status==="done"&&((p=n==null?void 0:n.skipped)!=null&&p.length)?`<ul class="task-error-list">${n.skipped.slice(0,5).map(d=>`<li>${re(d)}</li>`).join("")}</ul>`:""}
  ...
  `}function Zi(){var p;const e=Object.entries(j.downloads),t=e.filter(([,d])=>d.status!=="complete"),s=e.filter(([,d])=>d.status==="complete"),a=new Set(t.map(([,d])=>d.bookmarkId).filter(Boolean)),n=j.queueTasks.filter(d=>{var g;return!(d.type==="download"&&((g=d.data)!=null&&g.mangaId)&&a.has(d.data.mangaId))}),r=j.torrents.filter(d=>["downloading","completed","importing"].includes(d.status)),i=j.imports.filter(d=>d.status==="running"||d.status==="queued"),c=n.filter(d=>d.type!=="import"),l=t.length+c.length+r.length+i.length,u=((p=j.autoCheck)==null?void 0:p.schedules)||[];return`
    ${fe("manga")}
    <div class="container queue-container">
        ...
        <div class="queue-section ${j.collapsed.scheduled?"collapsed":""}">
          <div class="queue-section-header">
            <h3 class="queue-section-title queue-section-header-collapsible" data-toggle="scheduled">
              <span class="collapse-icon">▼</span> Scheduled Checks (${u.length})
            </h3>
            ${Ui()}
          </div>
          <div class="queue-section-content">
      ...
      ${s.length>0?`
        <div class="queue-section ${j.collapsed.completed?"collapsed":""}">
          ...
          <div class="queue-section-content">
            ${s.map(([d,g])=>ha(d,g)).join("")}
          </div>
        </div>
      `:""}

      ${j.historyTasks&&j.historyTasks.length>0?(()=>{const d=v=>{if(v.type!=="scrape")return!1;const y=v.result||{};return(v.status==="complete"||v.status==="completed")&&(y.newChaptersCount===0||y.updated===!1)},g=j.historyTasks.filter(d).length,$=j.showEmptyChecks?j.historyTasks:j.historyTasks.filter(v=>!d(v));return`
      ...
      ${t.length===0&&n.length===0&&s.length===0&&u.length===0&&(!j.historyTasks||j.historyTasks.length===0)?`
...
${s.userAgent}`:""}`:"";n=`<span class="capability-pill capability-yes" title="${$e(i)}">✓ ${s.cookieCount} cookie${s.cookieCount===1?"":"s"}${r?` · ${r}`:""}</span>`}else a?n=`<span class="capability-pill capability-soon">${m("triangle-alert")} Check pending</span>`:n='<span class="capability-pill capability-no">None</span>';return`
      <div class="capability-row">
        ...
        <span class="scraper-session-cell">
          ${n}
          ${s&&Z.isAdmin?`<button type="button" class="scraper-session-forget" data-scraper="${$e(t.name)}" title="Forget these cookies">Forget</button>`:""}
        </span>
          ...
          <div class="scraper-search-box">
            <form id="scraper-search-form" class="search-form">
              ...
              <div class="search-row">
                ...
                ${Z.canDownload?`<button type="button" class="btn btn-secondary" id="torrent-search-btn" title="Search the torrent indexers (Prowlarr) for volume releases">${m("package")} Volumes</button>`:""}
              </div>
            </form>
          </div>
    ...
    `;try{const n=await f.get(`/scrapers/search?q=${encodeURIComponent(this.currentQuery)}&scraper=${encodeURIComponent(this.currentTarget)}`);if(n.success)this.results=n.results||[],this.renderResults();else throw new Error(n.error||"Failed to search scrapers")}catch(n){console.error("Search error",n),t.innerHTML=`<div class="error-state" style="margin-top: 2rem;">Failed to perform search: ${n.message}</div>`}finally{this.isSearching=!1,s.textContent="Search",s.disabled=!1}}renderResults(){const t=document.getElementById("scraper-results-container");if(!t)return;if(this.results.length===0){t.innerHTML=`
      ...
      `,a.style.display="none";return}let n="";this.browseResults.forEach((r,i)=>{const c=r.cover||"";let l="";c.startsWith("/covers/")?l=c:c&&(l=`/api/scrapers/proxy-cover?url=${encodeURIComponent(c)}`);const u=l?Re(l,"Cover",{kind:"series",self:!0}):we("series");n+=`
