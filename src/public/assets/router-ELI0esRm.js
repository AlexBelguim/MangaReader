...
`);u=b.pop();let S=!1;for(const E of b)if(E.startsWith("data: ")){const g=E.substring(6);try{const x=JSON.parse(g);if(x.type==="metadata")r.manga.title=x.title,r.manga.alias=x.title,Re();else if(x.type==="image"){const A=`/api/scrapers/proxy-cover?url=${encodeURIComponent(x.url)}`;r.images.push(A),S=!0}else if(x.type==="error")d("Stream error: "+x.message,"error");else if(x.type==="done")break}catch(x){console.error("Parse error for SSE data:",x)}}S&&ge()}}catch(a){a.name!=="AbortError"&&(console.error("Preview stream error:",a),d("Stream failed: "+a.message,"error"))}finally{r._streamAbortController&&r._streamAbortController.signal===s&&(r._streamAbortController=null)}}async function mn(t=[]){console.log("[Reader] mount called with params:",t);let[e,s]=t,a=null;if(s&&s.includes("?")){const[o,i]=s.split("?");s=o,a=new URLSearchParams(i).get("version")}if(console.log("[Reader] mangaId:",e,"chapterNum:",s,"urlVersion:",a),!e||!s){R.go("/");return}const n=document.getElementById("app");if(r.loading=!0,console.log("[Reader] loading set to true, calling loadData..."),r.images=[],r.singlePageMode=!1,r._resumeScrollToPage=null,r.nextChapterImage=null,r.nextChapterNum=null,n.innerHTML=Ee(),a)await ke(e,s,decodeURIComponent(a));else try{const o=await f.getBookmark(e),i=o.downloadedVersions||{},c=new Set(o.deletedChapterUrls||[]),l=i[parseFloat(s)];let u=[];if(Array.isArray(l)&&(u=l.filter(h=>!c.has(h))),u.length>1){const h=await un(u,s);if(h===null){R.go(`/manga/${e}`);return}await ke(e,s,h)}else u.length===1?await ke(e,s,u[0]):await ke(e,s)}catch(o){console.log("[Reader] Error in version check, falling back:",o),await ke(e,s)}if(n.innerHTML=Ee(),console.log("[Reader] render called, loading:",r.loading,"manga:",!!r.manga,"images:",r.images.length),Ze(),r.mode==="webtoon"&&r._resumeScrollToPage!=null){const o=r._resumeScrollToPage;r._resumeScrollToPage=null,setTimeout(()=>{const i=document.getElementById("reader-content");if(i){const c=i.querySelectorAll("img");c[o]&&c[o].scrollIntoView({behavior:"auto",block:"start"})}},300)}}async function gn(){console.log("[Reader] unmount called"),r._streamAbortController&&(r._streamAbortController.abort(),r._streamAbortController=null),r.isStreamingMode||(await Oe(),await ve()),document.body.classList.remove("reader-active"),document.removeEventListener("keydown",Ls),r.manga=null,r.chapter=null,r.images=[],r.loading=!0,r.singlePageMode=!1,r.isStreamingMode=!1,r._resumeScrollToPage=null,r._preloadCache=null}function Yt(t){return!!t&&(t.mode!==void 0||t.direction!==void 0||t.firstPageSingle!==void 0||t.lastPageSingle!==void 0||t.singlePageMode!==void 0)}function Jt(t){t&&(t.mode&&(r.mode=t.mode),t.direction&&(r.direction=t.direction),t.firstPageSingle!==void 0&&(r.firstPageSingle=t.firstPageSingle),t.lastPageSingle!==void 0&&(r.lastPageSingle=t.lastPageSingle),t.singlePageMode!==void 0&&(r.singlePageMode=t.singlePageMode))}async function ve(){if(!(!r.manga||!r.chapter||r.manga.id==="gallery"||r.isStreamingMode)&&!Z.isDemo)try{await f.updateChapterSettings(r.manga.id,r.chapter.number,{mode:r.mode,direction:r.direction,firstPageSingle:r.firstPageSingle,lastPageSingle:r.lastPageSingle,singlePageMode:r.singlePageMode})}catch(t){console.error("Failed to save settings:",t)}}async function _s(t){try{const e=await f.getBookmark(t),s=e.downloadedChapters||[],a=new Set(e.readChapters||[]),n=e.readingProgress||{},o=e.downloadedVersions||{},i=[...s].sort((l,u)=>l-u);let c=null;for(const l of i){const u=n[l];if(u&&u.page<u.totalPages&&!a.has(l)){c=l;break}}if(c===null){for(const l of i)if(!a.has(l)){c=l;break}}if(c===null&&i.length>0&&(c=i[0]),c!==null){const l=o[c]||[],u=Array.isArray(l)?l[0]:l,h=u?`?version=${encodeURIComponent(u)}`:"";R.go(`/read/${t}/${c}${h}`)}else d("No downloaded chapters to read","info")}catch(e){d("Failed to continue reading: "+e.message,"error")}}const fn={mount:mn,unmount:gn,render:Ee,continueReading:_s},qe=50;let v={manga:null,categories:[],currentPage:0,filter:"all",loading:!0,selectionMode:!1,selected:new Set,activeVolume:null,activeVolumeId:null,cbzFiles:[],manageChapters:!1,offlineChapters:new Set,isAutoOffline:!1,volumesCollapsed:!1};const Bs=t=>`volumes_collapsed_${t}`;function vn(t){var s;const e=localStorage.getItem(Bs(t==null?void 0:t.id));return e!==null?e==="1":(((s=t==null?void 0:t.volumes)==null?void 0:s.length)||0)>8}function yn(t){if(!(t.autoCheck===!0))return`<button class="btn btn-secondary" id="schedule-btn">${p("alarm-clock")} Schedule</button>`;const s=t.checkSchedule==="weekly"?`${(t.checkDay||"monday").charAt(0).toUpperCase()+(t.checkDay||"monday").slice(1)} ${t.checkTime||"06:00"}`:t.checkSchedule==="daily"?`Daily ${t.checkTime||"06:00"}`:"Every 6h";return`<button class="btn btn-primary" id="schedule-btn">${p("alarm-clock")} ${s}</button>`}function bn(t){const e=t.autoCheck===!0,s=t.checkSchedule||"daily",a=t.checkDay||"monday",n=t.checkTime||"06:00",o=t.autoDownload||!1;return`
  ...
  `}function Ct(){var I;if(v.loading)return`
    ...
    `;const e=t.alias||t.title,s=t.chapters||[],a=new Set(t.downloadedChapters||[]),n=new Set(t.readChapters||[]),o=new Set(s.map(w=>w.number)).size,i=new Set(t.excludedChapters||[]),c=new Set(t.deletedChapterUrls||[]),l=t.volumes||[],u=new Set;l.forEach(w=>{(w.chapters||[]).forEach(L=>u.add(L))});let h;v.filter==="hidden"?h=s.filter(w=>i.has(w.number)||c.has(w.url)):h=s.filter(w=>!i.has(w.number)&&!c.has(w.url));const y=h.filter(w=>!u.has(w.number));let b=[];if(v.activeVolume){const w=new Set(v.activeVolume.chapters||[]);b=h.filter(L=>w.has(L.number))}else b=y;const S=new Map;b.forEach(w=>{S.has(w.number)||S.set(w.number,[]),S.get(w.number).push(w)});let E=Array.from(S.entries()).sort((w,L)=>w[0]-L[0]);v.filter==="downloaded"?E=E.filter(([w])=>a.has(w)):v.filter==="not-downloaded"?E=E.filter(([w])=>!a.has(w)):v.filter==="main"?E=E.filter(([w])=>Number.isInteger(w)):v.filter==="extra"&&(E=E.filter(([w])=>!Number.isInteger(w)));const g=Math.max(1,Math.ceil(E.length/qe));v.currentPage>=g&&(v.currentPage=Math.max(0,g-1));const x=v.currentPage*qe,P=[...E.slice(x,x+qe)].reverse(),U=S.size,q=[...S.keys()].filter(w=>a.has(w)).length;n.size;let C="";if(v.activeVolume){const w=v.activeVolume;let L=null;w.local_cover?L=`/api/public/covers/${t.id}/${encodeURIComponent(w.local_cover.split(/[/\\]/).pop())}`:w.cover&&(L=w.cover),C=`
      ${te()}
      <div class="container">
  ...
  `}function En(t,e,s,a,n){var q,C,I,w;const o=s.has(t),i=a.has(t),c=!Number.isInteger(t),l=((q=n.downloadedVersions)==null?void 0:q[t])||[],u=new Set(n.deletedChapterUrls||[]),h=e.filter(L=>v.filter==="hidden"?!0:!u.has(L.url)),y=!!v.activeVolume,b=n.chapterSettings||{},S=y?!0:!!((C=b[t])!=null&&C.locked);let E=h;if(y||S){const L=h.filter(m=>Array.isArray(l)?l.includes(m.url):l===m.url);E=L.length>0?L:h}E.sort((L,m)=>{const $=Array.isArray(l)?l.includes(L.url):l===L.url;return((Array.isArray(l)?l.includes(m.url):l===m.url)?1:0)-($?1:0)});const g=E.length>1,x=(I=E[0])!=null&&I.url?encodeURIComponent(E[0].url):null,A=["chapter-item",o?"downloaded":"",i?"read":"",c?"extra":""].filter(Boolean).join(" "),P=g?`
    <div class="versions-dropdown hidden" id="versions-${t}">
      ${E.map(L=>{const m=encodeURIComponent(L.url),$=Array.isArray(l)?l.includes(L.url):l===L.url,_=L.url.startsWith("local://");return`
  ...
  `}function Sn(){var a,n,o,i,c,l,u,h,y,b,S,E,g,x,A,P,U,q,C,I,w,L;const t=document.getElementById("app"),e=v.manga;if(!e)return;(a=document.getElementById("back-btn"))==null||a.addEventListener("click",()=>R.go("/")),(n=document.getElementById("back-library-btn"))==null||n.addEventListener("click",()=>R.go("/")),t.querySelectorAll(".artist-link").forEach(m=>{m.addEventListener("click",async $=>{$.preventDefault();const _=m.dataset.artist;if(!_)return;localStorage.setItem("library_search",_),localStorage.removeItem("library_artist_filter");let B=null;try{const T=e.website;if(T&&T!=="Local"){const z=(window._scrapersList||(window._scrapersList=(await f.get("/scrapers/list")).scrapers)||[]).find(M=>M.name===T);z&&z.supportsBrowse&&(B=T)}}catch{}B?(localStorage.setItem("library_search_author",_),localStorage.setItem("library_search_author_source",B)):(localStorage.removeItem("library_search_author"),localStorage.removeItem("library_search_author_source")),R.go("/")})}),(o=document.getElementById("continue-btn"))==null||o.addEventListener("click",()=>{_s(e.id)}),(i=document.getElementById("download-all-btn"))==null||i.addEventListener("click",()=>{const m=document.getElementById("download-all-modal");m&&m.classList.add("open")}),(c=document.getElementById("confirm-download-all-btn"))==null||c.addEventListener("click",async()=>{var m;try{d("Queueing downloads...","info");const $=document.getElementsByName("download-version-mode");let _="single";for(const T of $)T.checked&&(_=T.value);(m=document.getElementById("download-all-modal"))==null||m.classList.remove("open");const B=await f.post(`/bookmarks/${e.id}/download`,{all:!0,versionMode:_});B.chaptersCount>0?d(`Download queued: ${B.chaptersCount} versions`,"success"):d("Already have these chapters downloaded","info")}catch($){d("Failed to download: "+$.message,"error")}}),(l=document.getElementById("check-updates-btn"))==null||l.addEventListener("click",async()=>{try{d("Checking for updates...","info"),await f.post(`/bookmarks/${e.id}/quick-check`),d("Check complete!","success")}catch(m){d("Check failed: "+m.message,"error")}}),(u=document.getElementById("schedule-btn"))==null||u.addEventListener("click",()=>{const m=document.getElementById("schedule-modal");m&&m.classList.add("open")}),(h=document.getElementById("schedule-type"))==null||h.addEventListener("change",m=>{const $=document.getElementById("schedule-day-group");$&&($.style.display=m.target.value==="weekly"?"":"none")}),(y=document.getElementById("save-schedule-btn"))==null||y.addEventListener("click",async()=>{var m;try{const $=document.getElementById("schedule-type").value,_=document.getElementById("schedule-day").value,B=document.getElementById("schedule-time").value,T=document.getElementById("auto-download-toggle").checked;await f.updateAutoCheckSchedule(e.id,{enabled:!0,schedule:$,day:_,time:B,autoDownload:T}),v.manga.checkSchedule=$,v.manga.checkDay=_,v.manga.checkTime=B,v.manga.autoDownload=T,(m=document.getElementById("schedule-modal"))==null||m.classList.remove("open"),H([e.id]),d("Schedule updated","success")}catch($){d("Failed to save schedule: "+$.message,"error")}}),(b=document.getElementById("disable-schedule-btn"))==null||b.addEventListener("click",async()=>{var m;try{await f.toggleAutoCheck(e.id,!1),v.manga.autoCheck=!1,v.manga.checkSchedule=null,v.manga.checkDay=null,v.manga.checkTime=null,v.manga.nextCheck=null,(m=document.getElementById("schedule-modal"))==null||m.classList.remove("open"),H([e.id]),d("Auto-check disabled","success")}catch($){d("Failed to disable: "+$.message,"error")}}),(S=document.getElementById("refresh-btn"))==null||S.addEventListener("click",async()=>{const m=document.getElementById("refresh-btn");try{m.disabled=!0,m.innerHTML=`${p("loader",{spin:!0})} Checking...`,d("Checking for updates...","info"),await f.post(`/bookmarks/${e.id}/check`),await G(e.id),H([e.id]),d("Check complete!","success")}catch($){d("Check failed: "+$.message,"error"),m&&(m.disabled=!1,m.innerHTML=`${p("refresh-cw")} Refresh`)}}),(E=document.getElementById("scan-folder-btn"))==null||E.addEventListener("click",async()=>{var $,_;const m=document.getElementById("scan-folder-btn");try{m.disabled=!0,m.innerHTML=`${p("loader",{spin:!0})} Scanning...`,d("Scanning folder...","info");const B=await f.scanBookmark(e.id);await G(e.id),H([e.id]);const T=(($=B.addedChapters)==null?void 0:$.length)||0,F=((_=B.removedChapters)==null?void 0:_.length)||0;T>0||F>0?d(`Scan complete: ${T} added, ${F} removed`,"success"):d("Scan complete: No changes","info")}catch(B){d("Scan failed: "+B.message,"error")}finally{m&&(m.disabled=!1,m.innerHTML=`${p("folder")} Scan Folder`)}}),document.querySelectorAll("[data-cbz-path]").forEach(m=>{m.addEventListener("click",async()=>{const $=decodeURIComponent(m.dataset.cbzPath),_=parseInt(m.dataset.cbzChapter)||1,B=m.dataset.cbzExtracted==="true",T=prompt("Enter chapter number for extraction:",String(_));if(!T)return;const F=parseFloat(T);if(isNaN(F)){d("Invalid chapter number","error");return}try{m.disabled=!0,m.textContent="Extracting...",d("Extracting CBZ...","info"),await f.extractCbz(e.id,$,F,{forceReExtract:B}),d("CBZ extracted successfully!","success"),await G(e.id),H([e.id])}catch(z){d("Extract failed: "+z.message,"error")}finally{m.disabled=!1,m.textContent=B?"Re-Extract":"Extract"}})}),(g=document.getElementById("edit-btn"))==null||g.addEventListener("click",async()=>{const m=document.getElementById("edit-manga-modal");if(m){document.getElementById("edit-alias-input").value=e.alias||"",window._selectedCoverPath=null;try{const[$,_]=await Promise.all([f.getAllArtists(),f.getAllCategories()]),B=document.getElementById("artist-list"),T=document.getElementById("category-list");window._allArtists=$,window._allCategories=_,B&&(B.innerHTML=$.map(M=>`<option value="${M}">`).join("")),T&&(T.innerHTML=_.map(M=>`<option value="${M}">`).join(""));const F=document.getElementById("edit-artist-input"),z=document.getElementById("edit-categories-input");F==null||F.addEventListener("input",()=>{const M=F.value.toLowerCase(),D=F.value.lastIndexOf(","),j=F.value.substring(D+1).trim().toLowerCase();if(j.length>0&&window._allArtists){const V=window._allArtists.filter(X=>X.toLowerCase().includes(j));if(B&&V.length>0){const X=D>=0?F.value.substring(0,D+1)+" ":"";B.innerHTML=V.map(we=>`<option value="${X}${we}">`).join("")}}}),z==null||z.addEventListener("input",()=>{const M=z.value.lastIndexOf(","),D=z.value.substring(M+1).trim().toLowerCase();if(D.length>0&&window._allCategories){const j=window._allCategories.filter(V=>V.toLowerCase().includes(D));if(T&&j.length>0){const V=M>=0?z.value.substring(0,M+1)+" ":"";T.innerHTML=j.map(X=>`<option value="${V}${X}">`).join("")}}})}catch($){console.error("Failed to load artists/categories:",$)}m.classList.add("open")}}),(x=document.getElementById("save-manga-btn"))==null||x.addEventListener("click",async()=>{var m;try{const $=document.getElementById("edit-alias-input").value.trim(),_=document.getElementById("edit-artist-input").value.trim(),B=document.getElementById("edit-categories-input").value.trim(),T=_?_.split(",").map(z=>z.trim()).filter(z=>z):[],F=B?B.split(",").map(z=>z.trim()).filter(z=>z):[];await f.updateBookmark(e.id,{alias:$||null}),await f.setBookmarkArtists(e.id,T),await f.setBookmarkCategories(e.id,F),window._selectedCoverPath&&await f.setBookmarkCoverFromImage(e.id,window._selectedCoverPath),v.manga.alias=$||null,v.manga.artists=T,v.manga.categories=F,(m=document.getElementById("edit-manga-modal"))==null||m.classList.remove("open"),H([e.id]),d("Manga updated","success")}catch($){d("Failed to update: "+$.message,"error")}}),(A=document.getElementById("change-cover-btn"))==null||A.addEventListener("click",async()=>{try{d("Loading images...","info");const m=await f.getFolderImages(e.id);if(m.length===0){d("No images found in manga folder","warning");return}const $=document.createElement("div");$.id="cover-select-modal",$.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.8);z-index:10000;display:flex;align-items:center;justify-content:center;",$.innerHTML=`
      ...
      `,document.body.appendChild($),document.getElementById("close-cover-modal").addEventListener("click",()=>$.remove()),$.addEventListener("click",_=>{_.target===$&&$.remove()}),$.querySelectorAll(".cover-option").forEach(_=>{_.addEventListener("click",()=>{window._selectedCoverPath=_.dataset.path;const B=document.getElementById("cover-preview");B&&(B.innerHTML=`<img src="/api/proxy-image?path=${encodeURIComponent(window._selectedCoverPath)}" style="width:100%;height:100%;object-fit:cover;">`),$.remove(),d("Cover selected","success")})})}catch(m){d("Failed to load images: "+m.message,"error")}}),(P=document.getElementById("delete-manga-btn"))==null||P.addEventListener("click",()=>{const m=document.getElementById("delete-manga-modal");m&&m.classList.add("open")}),(U=document.getElementById("confirm-delete-manga-btn"))==null||U.addEventListener("click",async()=>{var $,_;const m=(($=document.getElementById("delete-files-toggle"))==null?void 0:$.checked)||!1;try{await f.deleteBookmark(e.id,m),(_=document.getElementById("delete-manga-modal"))==null||_.classList.remove("open"),d("Manga deleted","success"),R.go("/")}catch(B){d("Failed to delete: "+B.message,"error")}}),(q=document.getElementById("quick-check-btn"))==null||q.addEventListener("click",async()=>{const m=document.getElementById("quick-check-btn");try{m.disabled=!0,m.innerHTML=`${p("loader",{spin:!0})} Checking...`,d("Quick checking for updates...","info");const $=await f.post(`/bookmarks/${e.id}/quick-check`);await G(e.id),H([e.id]),$.newChaptersCount>0?d(`Found ${$.newChaptersCount} new chapter(s)!`,"success"):d("No new chapters found","info")}catch($){d("Quick check failed: "+$.message,"error")}finally{m&&(m.disabled=!1,m.innerHTML=`${p("zap")} Quick Check`)}}),(C=document.getElementById("source-label"))==null||C.addEventListener("click",async()=>{const m=document.getElementById("migrate-source-modal");if(m){m.classList.add("open");const $=document.getElementById("migrate-search-scraper");if($&&$.options.length<=1)try{const _=await f.get("/scrapers/list");if(_.success){const B=_.scrapers.filter(T=>T.supportsSearch);$.innerHTML='<option value="all">All Sources</option>'+B.map(T=>`<option value="${T.name}">${T.name}</option>`).join(""),$.value="all"}}catch(_){console.warn("Failed to load scrapers:",_)}}});const s=async()=>{var F,z,M;const m=(z=(F=document.getElementById("migrate-search-input"))==null?void 0:F.value)==null?void 0:z.trim(),$=(M=document.getElementById("migrate-search-scraper"))==null?void 0:M.value;if(!m)return;const _=document.getElementById("migrate-search-loading"),B=document.getElementById("migrate-search-results"),T=document.getElementById("migrate-results-grid");_.style.display="block",B.style.display="none";try{const j=(await f.get(`/scrapers/search?q=${encodeURIComponent(m)}&scraper=${encodeURIComponent($)}`)).results||[];j.length===0?T.innerHTML='<p class="text-muted" style="text-align: center; padding: 20px;">No results found</p>':(T.innerHTML=j.map(V=>{var we;const X=(we=V.cover)!=null&&we.startsWith("/covers/")?V.cover:V.cover?`/api/scrapers/proxy-cover?url=${encodeURIComponent(V.cover)}`:"";return`
